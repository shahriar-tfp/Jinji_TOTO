...
Partial Class ChangePassword
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Page.IsPostBack Then
            ...
            ssql = "Select Code,name from company_Profile order by code desc"
            ...
            lblTitle.Text = "Please enter your Old Password and New Password and Confirm Password"

            If mySQL.ConnectSQLServer = True Then
                Session.Timeout = mySetting.SessionTimeOut
                'set Resolution
                If Session("ScreenResolution") = "" Then
                    Session("PagePath") = "../../ChangePassword.aspx" 'determaine ur path here
    ...
    Protected Sub imgBtnSubmit_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnSubmit.Click
        ...
        ssql1 = "Exec sp_sa_validateSystemLogin '" & "User_ChkPass" & "','" & Session("Company").ToString & "','" & Session("EmpID").ToString & "','" & Trim(txtPassword.Text) & "',''"
        ...
        If myDS1.Tables.Count > 0 Then
            If myDS1.Tables(0).Rows.Count > 0 Then
                If myDS1.Tables(0).Rows(0).Item(0).ToString = "E03" Then
                    pnlResult.Visible = True
                    lblError.Text = "Invalid " & lblPassword.Text
                    lblTitle.Text = "Please enter your Old Password and New Password and Confirm Password"
        ...
        If Session("LoginStatus") = "ChangePass" Then
            ssql = "Exec sp_sa_validateSystemLogin '" & "Change_Pass" & "','" & Session("Company").ToString & "','" & Session("EmpID").ToString & "','" & Trim(txtPassword.Text) & "','" & Trim(txtNewPassword.Text) & "'"
                    ...
                    ElseIf myDS.Tables(0).Rows(0).Item(0).ToString = "SUCCESS" Then
                        ...
                        If myDS1.Tables(0).Rows.Count > 0 Then
                            ...
                            ElseIf myDS1.Tables(0).Rows(0).Item(0).ToString = "SUCCESS" Then
                                lblTitle.Text = "Your password change successfully! Click on [Ok] to Main Page."
                                SetFieldToFalse()
