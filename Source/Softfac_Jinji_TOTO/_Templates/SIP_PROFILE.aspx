<%@ Page Language="VB" AutoEventWireup="false" CodeFile="SIP_PROFILE.aspx.vb" Inherits="PAGES_PAYROLL_SIP_PROFILE" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>SIP_PROFILE</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server"> 
<form id="SIP_PROFILE" runat="server">
<div>
...
<!--// 2 //-->
<asp:imagebutton id="imgKeyOCP_ID_SIP" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblOCP_ID_SIP" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtOCP_ID_SIP" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnOCP_ID_SIP" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
...
<asp:imagebutton id="imgbtnMIN_WAGE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
...
<asp:imagebutton id="imgbtnMAX_WAGE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 5 //-->
<asp:imagebutton id="imgKeyVALUE_EMPLOYEE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblVALUE_EMPLOYEE" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtVALUE_EMPLOYEE" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnVALUE_EMPLOYEE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 6 //-->
<asp:imagebutton id="imgKeyOPTION_VALUE_EMPLOYEE_TYPE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblOPTION_VALUE_EMPLOYEE_TYPE" runat="server" Width="140px" ></asp:label>
<asp:dropdownlist id="ddlOPTION_VALUE_EMPLOYEE_TYPE" runat="server" Width="150px" ></asp:dropdownlist>
<asp:imagebutton id="imgbtnOPTION_VALUE_EMPLOYEE_TYPE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 7 //-->
<asp:imagebutton id="imgKeyVALUE_EMPLOYER" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblVALUE_EMPLOYER" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtVALUE_EMPLOYER" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnVALUE_EMPLOYER" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 8 //-->
<asp:imagebutton id="imgKeyOPTION_VALUE_EMPLOYER_TYPE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblOPTION_VALUE_EMPLOYER_TYPE" runat="server" Width="140px" ></asp:label>
<asp:dropdownlist id="ddlOPTION_VALUE_EMPLOYER_TYPE" runat="server" Width="150px" ></asp:dropdownlist>
<asp:imagebutton id="imgbtnOPTION_VALUE_EMPLOYER_TYPE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
