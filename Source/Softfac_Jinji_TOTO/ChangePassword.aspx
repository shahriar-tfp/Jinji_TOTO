...
<head runat="server">
    <title>JINJI : Organisation - Change Password Page</title>
				...
				<table border="0" cellpadding="0" cellspacing="0" width="100%">
					...
					<tr>
						...
						<table border="0" cellpadding="0" cellspacing="0" width="95%">
							...
							<tr>
								<td align="left">
								    <asp:label id="lblEmployeeID" runat="server" Text="User/Employee Badge" Width="130px" CssClass="wordstyle3"></asp:label>
								</td>
								<td align="left">
							...
							<tr>
								<td align="left">
								    <asp:label id="lblPassword" runat="server" Width="130px" CssClass="wordstyle3" Text="Old Password"></asp:label>
								</td>
								<td align="left">
