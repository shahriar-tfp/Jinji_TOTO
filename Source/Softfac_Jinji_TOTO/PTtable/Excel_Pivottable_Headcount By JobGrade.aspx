<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Excel_Pivottable_Headcount By JobGrade.aspx.vb" Inherits="PTtable_Excel_Pivottable_Headcount_By_JobGrade" %>
...
<div align="center" id="div" runat="server">
   ...
   &lt;x:PlotArea&gt;
    &lt;x:Graph&gt;
     ...
     &lt;x:Series&gt;
      &lt;x:FormatMap&gt;
      &lt;/x:FormatMap&gt;
      &lt;x:Name&gt;DEPT01 (LBT) [Estate Department]&lt;/x:Name&gt;
      &lt;x:Caption&gt;
       &lt;x:DataSourceIndex&gt;-1&lt;/x:DataSourceIndex&gt;
       &lt;x:Data&gt;&amp;quot;DEPT01 (LBT) [Estate Department]&amp;quot;&lt;/x:Data&gt;
      &lt;/x:Caption&gt;
      &lt;x:Index&gt;1&lt;/x:Index&gt;
      &lt;x:Category&gt;
       &lt;x:DataSourceIndex&gt;0&lt;/x:DataSourceIndex&gt;
      ...
      &lt;x:Thickness&gt;10&lt;/x:Thickness&gt;
      &lt;x:DataSourceIndex&gt;0&lt;/x:DataSourceIndex&gt;
      &lt;x:Identifier&gt;!.DEPT01 (LBT) [Estate Department]&lt;/x:Identifier&gt;
     &lt;/x:Series&gt;
     &lt;x:Series&gt;
      &lt;x:FormatMap&gt;
      &lt;/x:FormatMap&gt;
      &lt;x:Name&gt;DEPT05 (PWP) [Finance &amp;amp; Admin Department]&lt;/x:Name&gt;
      &lt;x:Caption&gt;
       &lt;x:DataSourceIndex&gt;-1&lt;/x:DataSourceIndex&gt;
       &lt;x:Data&gt;&amp;quot;DEPT05 (PWP) [Finance &amp;amp; Admin Department]&amp;quot;&lt;/x:Data&gt;
      &lt;/x:Caption&gt;
      &lt;x:Index&gt;2&lt;/x:Index&gt;
      &lt;x:Category&gt;
       &lt;x:DataSourceIndex&gt;0&lt;/x:DataSourceIndex&gt;
      ...
      &lt;x:Thickness&gt;10&lt;/x:Thickness&gt;
      &lt;x:DataSourceIndex&gt;0&lt;/x:DataSourceIndex&gt;
      &lt;x:Identifier&gt;!.DEPT05 (PWP) [Finance &amp;amp; Admin Department]&lt;/x:Identifier&gt;
     &lt;/x:Series&gt;
     &lt;x:Dimension&gt;
      &lt;x:ScaleID&gt;73548568&lt;/x:ScaleID&gt;
      &lt;x:Index&gt;Categories&lt;/x:Index&gt;
     &lt;/x:Dimension&gt;
     &lt;x:Dimension&gt;
      &lt;x:ScaleID&gt;73548772&lt;/x:ScaleID&gt;
      &lt;x:Index&gt;Value&lt;/x:Index&gt;
     &lt;/x:Dimension&gt;
     &lt;x:Dimension&gt;
      &lt;x:ScaleID&gt;73560372&lt;/x:ScaleID&gt;
...
<object classid="clsid:0002E55A-0000-0000-C000-000000000046" id="PivotTable1">
 ...
 &lt;x:PivotTable&gt;
  ...
  &lt;x:CacheDetails/&gt;
  &lt;x:ConnectionString&gt;Provider=SQLOLEDB.1;Persist Security Info=True;User ID=HRISMGR;Initial Catalog=Softfac_Jinji;Data Source=WINSON-PC\SQL2005;Use Procedure for Prepare=1;Auto Translate=True;Packet Size=4096;Workstation ID=WINSON-PC;Use Encryption for Data=False;Tag with column collation when possible=False&lt;/x:ConnectionString&gt;
  ...
  &lt;x:PivotData&gt;
   ...
   &lt;x:InvertedRowMember&gt;!.10 [10]&lt;/x:InvertedRowMember&gt;
   &lt;x:InvertedRowMember&gt;!.11 [11]&lt;/x:InvertedRowMember&gt;
   &lt;x:InvertedRowMember&gt;!.12 [12]&lt;/x:InvertedRowMember&gt;
   &lt;x:InvertedRowMember&gt;!.13 [13]&lt;/x:InvertedRowMember&gt;
   &lt;x:InvertedRowMember&gt;!.15 [15]&lt;/x:InvertedRowMember&gt;
   &lt;x:InvertedRowMember&gt;!.17 [17]&lt;/x:InvertedRowMember&gt;
   &lt;x:InvertedRowMember&gt;!.18 [18]&lt;/x:InvertedRowMember&gt;
   &lt;x:InvertedRowMember&gt;!.5 [5]&lt;/x:InvertedRowMember&gt;
   &lt;x:InvertedRowMember&gt;!.6 [6]&lt;/x:InvertedRowMember&gt;
   &lt;x:InvertedRowMember&gt;!.7 [7]&lt;/x:InvertedRowMember&gt;
   &lt;x:InvertedRowMember&gt;!.8 [8]&lt;/x:InvertedRowMember&gt;
   &lt;x:InvertedRowMember&gt;!.9 [9]&lt;/x:InvertedRowMember&gt;
   &lt;x:InvertedRowMember&gt;!.C (LBT) [Clerical]&lt;/x:InvertedRowMember&gt;
   &lt;x:InvertedRowMember&gt;!.C (PWP) [Clerical]&lt;/x:InvertedRowMember&gt;
   &lt;x:InvertedRowMember&gt;!.GW (PWP) [General Workers]&lt;/x:InvertedRowMember&gt;
   &lt;x:InvertedRowMember&gt;!.S (PWP) [Supervisor]&lt;/x:InvertedRowMember&gt;
