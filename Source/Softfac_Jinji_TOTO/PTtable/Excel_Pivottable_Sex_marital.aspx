<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Excel_Pivottable_Sex_marital.aspx.vb" Inherits="Pivot_Excel_Pivottable_Sex_marital" %>
...
<body>
    ...
    <object classid="clsid:0002E55A-0000-0000-C000-000000000046" id="PivotTable1" style="width: 594px; height: 279px">
 ...
 &lt;x:PivotTable&gt;
  ...
  &lt;x:Name&gt;Headcounts Analysis for Marital Status&lt;/x:Name&gt;
  &lt;x:DataAxisEmpty/&gt;
  &lt;x:PivotField&gt;
  ...
  &lt;x:PivotData&gt;
   ...
   &lt;x:SeqNum&gt;34&lt;/x:SeqNum&gt;
   &lt;x:Expanded/&gt;
  &lt;/x:PivotData&gt;
  &lt;x:PivotView&gt;
   &lt;x:Label&gt;
    &lt;x:Caption&gt;Headcounts Analysis for Marital Status&lt;/x:Caption&gt;
   &lt;/x:Label&gt;
  &lt;/x:PivotView&gt;
 &lt;/x:PivotTable&gt;
&lt;/xml&gt;" />
  ...
  &lt;x:Chart&gt;
   &lt;x:PlotArea&gt;
    &lt;x:Graph&gt;
     ...
     &lt;x:Dimension&gt;
      &lt;x:ScaleID&gt;183437192&lt;/x:ScaleID&gt;
      &lt;x:Index&gt;Categories&lt;/x:Index&gt;
     &lt;/x:Dimension&gt;
     &lt;x:Dimension&gt;
      &lt;x:ScaleID&gt;183437448&lt;/x:ScaleID&gt;
      &lt;x:Index&gt;Value&lt;/x:Index&gt;
     &lt;/x:Dimension&gt;
     &lt;x:Dimension&gt;
      &lt;x:ScaleID&gt;183437668&lt;/x:ScaleID&gt;
