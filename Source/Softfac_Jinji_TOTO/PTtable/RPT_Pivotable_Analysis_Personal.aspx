<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RPT_Pivotable_Analysis_Personal.aspx.vb" Inherits="PAGES_REPORTS_RPT_PIVOTABLE_ANALYSIS_PERSONAL" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>JINJI : Report - Pivotable Analysis Personal</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server"> 
<form id="RPT_PIVOTABLE_ANALYSIS_PERSONAL" runat="server">
<div>
