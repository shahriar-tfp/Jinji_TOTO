<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PivotableCitizenShip.aspx.vb" Inherits="Pivot_PivotableCitizenShip" %>
   ...
   &lt;x:PlotArea&gt;
    &lt;x:Graph&gt;
     ...
     &lt;x:Series&gt;
      &lt;x:FormatMap&gt;
      &lt;/x:FormatMap&gt;
      &lt;x:Name&gt;MALAYSIAN&lt;/x:Name&gt;
      &lt;x:Caption&gt;
       &lt;x:DataSourceIndex&gt;-1&lt;/x:DataSourceIndex&gt;
       &lt;x:Data&gt;&amp;quot;MALAYSIAN&amp;quot;&lt;/x:Data&gt;
      &lt;/x:Caption&gt;
      &lt;x:Index&gt;0&lt;/x:Index&gt;
      &lt;x:Category&gt;
       &lt;x:DataSourceIndex&gt;0&lt;/x:DataSourceIndex&gt;
      ...
      &lt;x:DataSourceIndex&gt;0&lt;/x:DataSourceIndex&gt;
      &lt;x:Identifier&gt;!.MALAYSIAN&lt;/x:Identifier&gt;
     &lt;/x:Series&gt;
     &lt;x:Dimension&gt;
      &lt;x:ScaleID&gt;61946412&lt;/x:ScaleID&gt;
      &lt;x:Index&gt;Categories&lt;/x:Index&gt;
     &lt;/x:Dimension&gt;
     &lt;x:Dimension&gt;
      &lt;x:ScaleID&gt;61946668&lt;/x:ScaleID&gt;
      &lt;x:Index&gt;Value&lt;/x:Index&gt;
     &lt;/x:Dimension&gt;
     &lt;x:Dimension&gt;
      &lt;x:ScaleID&gt;61946888&lt;/x:ScaleID&gt;
...
<object classid="clsid:0002E55A-0000-0000-C000-000000000046" id="PivotTable1">
 ...
 &lt;x:PivotTable&gt;
  ...
  &lt;x:PivotData&gt;
   ...
   &lt;x:InvertedRowMember&gt;!.&lt;/x:InvertedRowMember&gt;
   &lt;x:InvertedRowMember&gt;!.DEPT01 (LBT) [Estate Department]&lt;/x:InvertedRowMember&gt;
   &lt;x:InvertedRowMember&gt;!.DEPT05 (PWP) [Finance &amp;amp; Admin Department]&lt;/x:InvertedRowMember&gt;
