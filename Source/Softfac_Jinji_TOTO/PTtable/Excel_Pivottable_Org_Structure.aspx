<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Excel_Pivottable_Org_Structure.aspx.vb" Inherits="Pivot_Excel_Pivottable_Org_Structure" %>
   ...
   &lt;x:PlotArea&gt;
    &lt;x:Graph&gt;
     ...
     &lt;x:Series&gt;
      &lt;x:FormatMap&gt;
      &lt;/x:FormatMap&gt;
      &lt;x:Name&gt;C (LBT) [Clerical]&lt;/x:Name&gt;
      &lt;x:Caption&gt;
       &lt;x:DataSourceIndex&gt;-1&lt;/x:DataSourceIndex&gt;
       &lt;x:Data&gt;&amp;quot;C (LBT) [Clerical]&amp;quot;&lt;/x:Data&gt;
      &lt;/x:Caption&gt;
      &lt;x:Index&gt;12&lt;/x:Index&gt;
      &lt;x:Category&gt;
       &lt;x:DataSourceIndex&gt;0&lt;/x:DataSourceIndex&gt;
      ...
      &lt;x:Thickness&gt;10&lt;/x:Thickness&gt;
      &lt;x:DataSourceIndex&gt;0&lt;/x:DataSourceIndex&gt;
      &lt;x:Identifier&gt;!.C (LBT) [Clerical]&lt;/x:Identifier&gt;
     &lt;/x:Series&gt;
     &lt;x:Series&gt;
      &lt;x:FormatMap&gt;
      &lt;/x:FormatMap&gt;
      &lt;x:Name&gt;C (PWP) [Clerical]&lt;/x:Name&gt;
      &lt;x:Caption&gt;
       &lt;x:DataSourceIndex&gt;-1&lt;/x:DataSourceIndex&gt;
       &lt;x:Data&gt;&amp;quot;C (PWP) [Clerical]&amp;quot;&lt;/x:Data&gt;
      &lt;/x:Caption&gt;
      &lt;x:Index&gt;13&lt;/x:Index&gt;
      &lt;x:Category&gt;
       &lt;x:DataSourceIndex&gt;0&lt;/x:DataSourceIndex&gt;
      ...
      &lt;x:Thickness&gt;10&lt;/x:Thickness&gt;
      &lt;x:DataSourceIndex&gt;0&lt;/x:DataSourceIndex&gt;
      &lt;x:Identifier&gt;!.C (PWP) [Clerical]&lt;/x:Identifier&gt;
     &lt;/x:Series&gt;
     &lt;x:Series&gt;
      &lt;x:FormatMap&gt;
      &lt;/x:FormatMap&gt;
      &lt;x:Name&gt;GW (PWP) [General Workers]&lt;/x:Name&gt;
      &lt;x:Caption&gt;
       &lt;x:DataSourceIndex&gt;-1&lt;/x:DataSourceIndex&gt;
       &lt;x:Data&gt;&amp;quot;GW (PWP) [General Workers]&amp;quot;&lt;/x:Data&gt;
      &lt;/x:Caption&gt;
      &lt;x:Index&gt;14&lt;/x:Index&gt;
      &lt;x:Category&gt;
       &lt;x:DataSourceIndex&gt;0&lt;/x:DataSourceIndex&gt;
      ...
      &lt;x:Thickness&gt;10&lt;/x:Thickness&gt;
      &lt;x:DataSourceIndex&gt;0&lt;/x:DataSourceIndex&gt;
      &lt;x:Identifier&gt;!.GW (PWP) [General Workers]&lt;/x:Identifier&gt;
     &lt;/x:Series&gt;
     &lt;x:Series&gt;
      &lt;x:FormatMap&gt;
      &lt;/x:FormatMap&gt;
      &lt;x:Name&gt;S (PWP) [Supervisor]&lt;/x:Name&gt;
      &lt;x:Caption&gt;
       &lt;x:DataSourceIndex&gt;-1&lt;/x:DataSourceIndex&gt;
       &lt;x:Data&gt;&amp;quot;S (PWP) [Supervisor]&amp;quot;&lt;/x:Data&gt;
      &lt;/x:Caption&gt;
      &lt;x:Index&gt;15&lt;/x:Index&gt;
      &lt;x:Category&gt;
       &lt;x:DataSourceIndex&gt;0&lt;/x:DataSourceIndex&gt;
      ...
      &lt;x:Thickness&gt;10&lt;/x:Thickness&gt;
      &lt;x:DataSourceIndex&gt;0&lt;/x:DataSourceIndex&gt;
      &lt;x:Identifier&gt;!.S (PWP) [Supervisor]&lt;/x:Identifier&gt;
     &lt;/x:Series&gt;
     &lt;x:Dimension&gt;
      &lt;x:ScaleID&gt;202640644&lt;/x:ScaleID&gt;
      &lt;x:Index&gt;Categories&lt;/x:Index&gt;
     &lt;/x:Dimension&gt;
     &lt;x:Dimension&gt;
      &lt;x:ScaleID&gt;202640900&lt;/x:ScaleID&gt;
      &lt;x:Index&gt;Value&lt;/x:Index&gt;
     &lt;/x:Dimension&gt;
     &lt;x:Dimension&gt;
      &lt;x:ScaleID&gt;202641120&lt;/x:ScaleID&gt;
...
<object classid="clsid:0002E55A-0000-0000-C000-000000000046" id="PivotTable1">
 ...
 &lt;x:PivotTable&gt;
  ...
  &lt;x:PivotData&gt;
   ...
   &lt;x:InvertedRowMember&gt;!.DIV00 (JAVA) [Group Finance &amp;amp; Admin Division]&lt;/x:InvertedRowMember&gt;
   &lt;x:InvertedRowMember&gt;!.DIV01 (JAVA) [Directors' Office]&lt;/x:InvertedRowMember&gt;
   &lt;x:InvertedRowMember&gt;!.DIV01 (LBT) [Plantation Division]&lt;/x:InvertedRowMember&gt;
   &lt;x:InvertedRowMember&gt;!.DIV01 (PWP) [Production Division]&lt;/x:InvertedRowMember&gt;
   &lt;x:InvertedRowMember&gt;!.DIV02 (JAVA) [Group Operations Division]&lt;/x:InvertedRowMember&gt;
   &lt;x:InvertedRowMember&gt;!.DIV05 (JAVA) [Group Marketing Division]&lt;/x:InvertedRowMember&gt;
   &lt;x:InvertedRowMember&gt;!.DIVISION (JAVA) [Division]&lt;/x:InvertedRowMember&gt;
