<%@ Page Language="VB" AutoEventWireup="false" CodeFile="UNI_KPRS_MEMBERLIST.aspx.vb" Inherits="PAGES_UNI_KOPERASI_UNI_KPRS_MEMBERLIST" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>UNI_KPRS_MEMBERLIST</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server"> 
<form id="UNI_KPRS_MEMBERLIST" runat="server">
<div>
...
<!--// 5 //-->
<asp:imagebutton id="imgKeyKPRS_DATE_JOIN" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblKPRS_DATE_JOIN" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtKPRS_DATE_JOIN" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnKPRS_DATE_JOIN" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 6 //-->
<asp:imagebutton id="imgKeyKPRS_DATE_RESIGN" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblKPRS_DATE_RESIGN" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtKPRS_DATE_RESIGN" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnKPRS_DATE_RESIGN" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 7 //-->
<asp:imagebutton id="imgKeyFully_Paid_Date" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblFully_Paid_Date" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtFully_Paid_Date" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnFully_Paid_Date" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
