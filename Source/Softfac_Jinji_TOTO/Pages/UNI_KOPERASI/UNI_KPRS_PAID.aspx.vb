...
Partial Class PAGES_UNI_KOPERASI_UNI_KPRS_PAID
...
#Region "Panel Action"
    ...
    Protected Sub imgBtnEdit_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnEdit.Click
        If ActionValidateEdit() Then
            ...
            If ddlOPTION_STATUS.SelectedValue = "PAID" Then
                txtLOAN.Enabled = False
                txtSHARE.Enabled = False
                txtGUARANTOR_LOAN.Enabled = False
            Else
                txtLOAN.Enabled = True
                txtSHARE.Enabled = True
                txtGUARANTOR_LOAN.Enabled = True
            End If
            imgBtnCancel.CssClass = buttonPosition3
            imgBtnClear.CssClass = buttonPosition2
