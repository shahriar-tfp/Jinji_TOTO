<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Schedule_ViewUpdate.aspx.vb" Inherits="PAGES_ESCHEDULE_SCHEDULE_VIEWUPDATE" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>JINJI : E-Schedule - Schedule View Page</title>
    <link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body>
    <form id="SCHEDULE_VIEWUPDATE" runat="server">
    <div>
	   ...
	   <tr><td>	    
	    <div id="divGridview1" style="top: 200px;left: 15px;position :absolute; width: 98%; height: 150px; overflow: scroll">
            <asp:gridview id="gv1" Width="100%" runat="server" AutoGenerateColumns="true" Visible="true"
                ...
                Caption='<table border="0" width="100%" cellpadding="0" cellspacing="0"><tr><td><font color="#ff0000">Leave Application Records</font></td></tr></table>' CaptionAlign="Top">
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
	   <tr><td><asp:Label ID="lblLeaveType" Text="Leave Type" runat="server" Width="120px" Font-Bold="true"></asp:Label>
    <asp:Dropdownlist ID="ddlLeaveType" runat="server" Width="200px"></asp:Dropdownlist>
    <asp:Label ID="lblBlank1" Text=" " runat="server" Width="80px" Font-Bold="true"></asp:Label>
    <asp:Label ID="lblPeriod" Text="Period" runat="server" Width="120px" Font-Bold="true"></asp:Label>
    <asp:DropDownlist ID="ddlPeriod" runat="server" Width="200px" ></asp:DropDownlist>   
    </td></tr>
    <tr><td><asp:Label ID="lblspace2" Text="&nbsp;" runat="server" Width="10px"></asp:Label></td></tr>
    <tr><td><asp:Label ID="lblDate" Text="Date" runat="server" Width="120px" Font-Bold="true"></asp:Label>
    ...
    <asp:Label ID="lblBlank2" Text=" " runat="server" Width="80px" Font-Bold="true"></asp:Label>
    <asp:Label ID="lblDestination" Text="Destination" runat="server" Width="120px" Font-Bold="true"></asp:Label>
    ...
    <tr><td><asp:Label ID="lblReason" Text="Reason" runat="server" Width="120px" Font-Bold="true" ></asp:Label>
    <asp:TextBox ID="txtReason" runat="server" Width="200px" ></asp:TextBox>
    <asp:ImageButton ID="imgbtnReason" runat="server" Width="21px" Height="21px" Visible="false"/>
    <asp:Label ID="lblBlank3" Text=" " runat="server" Width="80px" Font-Bold="true"></asp:Label>
    <asp:Label ID="lblStatus" Text="Status" runat="server" Width="120px" Font-Bold="true"></asp:Label>
    <asp:dropdownlist ID="ddlStatus" runat="server" Width="200px" AutoPostBack=true></asp:dropdownlist>
    </td></tr>
    <tr><td><asp:Label ID="lblspace3" Text="&nbsp;" runat="server" Width="10px"></asp:Label></td></tr>
    <tr><td><asp:Label ID="lblDateApproved" Text="Date Approved/Rejected" runat="server" Width="120px" Font-Bold="true" ></asp:Label>
    <asp:TextBox ID="txtDateApproved" runat="server" Width="175px" ></asp:TextBox>
    <asp:ImageButton ID="imgbtnDateApproved" runat="server" Width="21px" Height="21px"/>
    <asp:Label ID="lblBlank4" Text=" " runat="server" Width="80px" Font-Bold="true"></asp:Label>
    <asp:Label ID="lblApprovedBy" Text="Approved / Rejected By" runat="server" Width="120px" Font-Bold="true"></asp:Label>
    <asp:dropdownlist ID="ddlApprovedBy" runat="server" Width="200px" AutoPostBack=true></asp:dropdownlist>
    </td></tr>
    <tr><td><asp:Label ID="lblspace4" Text="&nbsp;" runat="server" Width="10px"></asp:Label></td></tr>
    <tr><td><asp:Label ID="lblRemarks" Text="Remarks" runat="server" Width="120px" Font-Bold="true"></asp:Label>
    <asp:TextBox ID="txtRemarks" runat="server" Width="200px" ></asp:TextBox>
    <asp:ImageButton ID="imgbtnremarks" runat="server" Width="21px" Height="21px" Visible="false"/>
    </td></tr>
      <tr><td><asp:Label ID="Label1" Text="&nbsp;" runat="server" Width="10px"></asp:Label></td></tr>
    <tr><td><asp:ImageButton id="imgBtnAdd" runat="server" Width="74" Height="21"/>
    <asp:ImageButton id="imgBtnSubmit" runat="server" Width="74" Height="21" OnClientClick="return confirm('Confirmation! Submit Data ?')"/>
    <asp:ImageButton id="imgBtnEdit" runat="server" Width="74" Height="21"/>
    <asp:ImageButton id="imgBtnUpdate" runat="server" Width="74" Height="21" OnClientClick="return confirm('Confirmation! Update Data ?')"/>
    <asp:ImageButton id="imgBtnCancel" runat="server" Width="74" Height="21"/>
    <asp:ImageButton id="ImgBtnDelete" runat="server" Width="74" Height="21" OnClientClick="return confirm('Confirmation! Delete Data(s) ?')"/>
    <asp:imagebutton id="imgbtnReProcess" runat="server" Height="21px" Width="74px" Visible="false"></asp:imagebutton></td></tr>
</table></div></asp:Panel>
    </asp:Panel>
    </div>
    </form>
