<%@ Page Language="VB" AutoEventWireup="false" CodeFile="UNI_VEHICLE_PROFILE.aspx.vb" Inherits="PAGES_VEHICLE_UNI_VEHICLE_PROFILE" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>UNI_VEHICLE_PROFILE</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server"> 
<form id="UNI_VEHICLE_PROFILE" runat="server">
<div>
...
<!--// 2 //-->
<asp:imagebutton id="imgKeyVISITOR" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblVISITOR" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtVISITOR" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnVISITOR" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 3 //-->
<asp:imagebutton id="imgKeyVEHICLE_REGISTER_NO" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblVEHICLE_REGISTER_NO" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtVEHICLE_REGISTER_NO" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnVEHICLE_REGISTER_NO" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 4 //-->
<asp:imagebutton id="imgKeyVEHICLE_MODEL" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblVEHICLE_MODEL" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtVEHICLE_MODEL" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnVEHICLE_MODEL" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 5 //-->
<asp:imagebutton id="imgKeyCONTACT" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblCONTACT" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtCONTACT" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnCONTACT" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 6 //-->
<asp:imagebutton id="imgKeyEXT_NO" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblEXT_NO" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtEXT_NO" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnEXT_NO" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
...
<!--// 9 //-->
<asp:imagebutton id="imgKeyREGISTER_DATE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblREGISTER_DATE" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtREGISTER_DATE" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnREGISTER_DATE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
