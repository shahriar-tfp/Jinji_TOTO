<%@ Page Language="VB" AutoEventWireup="false" CodeFile="UNI_VEHICLE_SECURITY_VW.aspx.vb" Inherits="PAGES_VEHICLE_UNI_VEHICLE_SECURITY_VW" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>UNI_VEHICLE_SECURITY_VW</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server"> 
<form id="UNI_VEHICLE_SECURITY_VW" runat="server">
<div>
<asp:Panel ID="pnlEdit" runat="server">
<!--// 1 //-->
<asp:imagebutton id="imgKeyIDNAME" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblIDNAME" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtIDNAME" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnIDNAME" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 2 //-->
<asp:imagebutton id="imgKeySTAFF_NAME" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblSTAFF_NAME" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtSTAFF_NAME" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnSTAFF_NAME" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
