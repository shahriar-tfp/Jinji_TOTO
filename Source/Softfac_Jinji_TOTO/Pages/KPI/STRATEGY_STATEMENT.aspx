<%@ Page Language="VB" AutoEventWireup="false" CodeFile="STRATEGY_STATEMENT.aspx.vb" Inherits="PAGES_KPI_STRATEGY_STATEMENT" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>JINJI : KPI - Strategy Page</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server"> 
<form id="STRATEGY_STATEMENT" runat="server">
<div>
...
<!--// 2 //-->
<asp:imagebutton id="imgKeyOBJECTIVE_STATEMENT_CODE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblOBJECTIVE_STATEMENT_CODE" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtOBJECTIVE_STATEMENT_CODE" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnOBJECTIVE_STATEMENT_CODE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
...
<!--// 4 //-->
<asp:imagebutton id="imgKeyOBJECTIVE_STATEMENT_OCP_ID" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblOBJECTIVE_STATEMENT_OCP_ID" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtOBJECTIVE_STATEMENT_OCP_ID" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnOBJECTIVE_STATEMENT_OCP_ID" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
