<%@ Page Language="VB" AutoEventWireup="false" CodeFile="SWOT_ANALYSIS_PROTFOLIO.aspx.vb" Inherits="PAGES_KPI_SWOT_ANALYSIS_PROTFOLIO" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>JINJI : KPI - SWOT Analysis Profolio Page</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server"> 
<form id="SWOT_ANALYSIS_PROTFOLIO" runat="server">
<div>
...
<!--// 2 //-->
<asp:imagebutton id="imgKeyOPTION_GROUP_BY" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblOPTION_GROUP_BY" runat="server" Width="140px" ></asp:label>
<asp:dropdownlist id="ddlOPTION_GROUP_BY" runat="server" Width="150px" AutoPostBack="true" ></asp:dropdownlist>
<asp:imagebutton id="imgbtnOPTION_GROUP_BY" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 3 //-->
<asp:imagebutton id="imgKeySWOT_SETUP_CODE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblSWOT_SETUP_CODE" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtSWOT_SETUP_CODE" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnSWOT_SETUP_CODE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 4 //-->
<asp:imagebutton id="imgKeySWOT" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblSWOT" runat="server" Width="140px" ></asp:label>
<asp:dropdownlist id="ddlSWOT" runat="server" Width="150px" ></asp:dropdownlist>
<asp:imagebutton id="imgbtnSWOT" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 5 //-->
<asp:imagebutton id="imgKeyCOMMENT_GROUP_BY" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblCOMMENT_GROUP_BY" runat="server" Width="140px" ></asp:label>
<asp:dropdownlist id="ddlCOMMENT_GROUP_BY" runat="server" Width="150px" AutoPostBack="true" ></asp:dropdownlist>
<asp:imagebutton id="imgbtnCOMMENT_GROUP_BY" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 6 //-->
<asp:imagebutton id="imgKeyGROUP_OCP_ID" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblGROUP_OCP_ID" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtGROUP_OCP_ID" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnGROUP_OCP_ID" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 7 //-->
<asp:imagebutton id="imgKeyCOMMENT_DATE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblCOMMENT_DATE" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtCOMMENT_DATE" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnCOMMENT_DATE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 8 //-->
<asp:imagebutton id="imgKeyCOMMENT" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblCOMMENT" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtCOMMENT" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnCOMMENT" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 9 //-->
<asp:imagebutton id="imgKeySCORE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblSCORE" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtSCORE" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnSCORE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
