<%@ Page Language="VB" AutoEventWireup="false" CodeFile="KPI_EMP_TARGET.aspx.vb" Inherits="PAGES_KPI_KPI_EMP_TARGET" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>JINJI : KPI - Employee Target</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server"> 
<form id="KPI_EMP_TARGET" runat="server">
<div>
...
<!--// 2 //-->
<asp:imagebutton id="imgKeyMISSION_PROFILE_NO" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblMISSION_PROFILE_NO" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtMISSION_PROFILE_NO" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnMISSION_PROFILE_NO" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
...
<!--// 8 //-->
<asp:imagebutton id="imgKeyOPTION_TARGET_DESCRIPTIONS" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblOPTION_TARGET_DESCRIPTIONS" runat="server" Width="140px" ></asp:label>
<asp:dropdownlist id="ddlOPTION_TARGET_DESCRIPTIONS" runat="server" Width="150px" ></asp:dropdownlist>
<asp:imagebutton id="imgbtnOPTION_TARGET_DESCRIPTIONS" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
