<%@ Page Language="VB" AutoEventWireup="false" CodeFile="COMPANY_REVENUE.aspx.vb" Inherits="PAGES_KPI_COMPANY_REVENUE" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>JINJI : KPI - Company Revenue</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server"> 
<form id="COMPANY_REVENUE" runat="server">
<div>
...
<!--// 2 //-->
<asp:imagebutton id="imgKeyMISSION_PROFILE__NO" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblMISSION_PROFILE__NO" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtMISSION_PROFILE__NO" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnMISSION_PROFILE__NO" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 3 //-->
<asp:imagebutton id="imgKeyREVENUE_DESCRIPTIONS" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblREVENUE_DESCRIPTIONS" runat="server" Width="140px" ></asp:label>
<asp:dropdownlist id="ddlREVENUE_DESCRIPTIONS" runat="server" Width="150px" ></asp:dropdownlist>
<asp:imagebutton id="imgbtnREVENUE_DESCRIPTIONS" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
...
<!--// 6 //-->
<asp:imagebutton id="imgKeySUB_PLAN_REVENUE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblSUB_PLAN_REVENUE" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtSUB_PLAN_REVENUE" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnSUB_PLAN_REVENUE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
...
<!--// 8 //-->
<asp:imagebutton id="imgKeyMONTH_QUARTER" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblMONTH_QUARTER" runat="server" Width="140px" ></asp:label>
<asp:dropdownlist id="ddlMONTH_QUARTER" runat="server" Width="150px" ></asp:dropdownlist>
<asp:imagebutton id="imgbtnMONTH_QUARTER" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
