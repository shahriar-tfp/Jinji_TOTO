<%@ Page Language="VB" AutoEventWireup="false" CodeFile="OBJECTIVE_STATEMENT.aspx.vb" Inherits="PAGES_KPI_OBJECTIVE_STATEMENT" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>JINJI : KPI - Objective Page</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server"> 
<form id="OBJECTIVE_STATEMENT" runat="server">
<div>
...
<!--// 2 //-->
<asp:imagebutton id="imgKeyMISSION_STATEMENT_CODE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblMISSION_STATEMENT_CODE" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtMISSION_STATEMENT_CODE" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnMISSION_STATEMENT_CODE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
