<%@ Page Language="VB" AutoEventWireup="false" CodeFile="COMPANY_TARGET_DISTRIBUTIONS.aspx.vb" Inherits="PAGES_KPI_COMPANY_TARGET_DISTRIBUTIONS" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>JINJI : KPI - Company Target Distributions Page</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server"> 
<form id="COMPANY_TARGET_DISTRIBUTIONS" runat="server">
<div>
...
<!--// 2 //-->
<asp:imagebutton id="imgKeyMISSION_PROFILES_NO" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblMISSION_PROFILES_NO" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtMISSION_PROFILES_NO" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnMISSION_PROFILES_NO" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 3 //-->
<asp:imagebutton id="imgKeyOPTION_REVENUE_DESCRIPTION" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblOPTION_REVENUE_DESCRIPTION" runat="server" Width="140px" ></asp:label>
<asp:dropdownlist id="ddlOPTION_REVENUE_DESCRIPTION" runat="server" Width="150px" ></asp:dropdownlist>
<asp:imagebutton id="imgbtnOPTION_REVENUE_DESCRIPTION" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 4 //-->
<asp:imagebutton id="imgKeyACTURE_REVENUE_PERCENTAGE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblACTURE_REVENUE_PERCENTAGE" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtACTURE_REVENUE_PERCENTAGE" runat="server" Width="150px"></asp:textbox>
<asp:imagebutton id="imgbtnACTURE_REVENUE_PERCENTAGE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 5 //-->
<asp:imagebutton id="imgKeyTARGET_REVENUE_PERCENTAGE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblTARGET_REVENUE_PERCENTAGE" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtTARGET_REVENUE_PERCENTAGE" runat="server" Width="150px" AutoPostBack="true"></asp:textbox>
<asp:imagebutton id="imgbtnTARGET_REVENUE_PERCENTAGE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 6 //-->
<asp:imagebutton id="imgKeyACTURE_REVENUE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblACTURE_REVENUE" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtACTURE_REVENUE" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnACTURE_REVENUE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 7 //-->
<asp:imagebutton id="imgKeyTARGET_REVENUE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblTARGET_REVENUE" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtTARGET_REVENUE" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnTARGET_REVENUE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 8 //-->
<asp:imagebutton id="imgKeyGROUP_BY" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblGROUP_BY" runat="server" Width="140px" ></asp:label>
<asp:dropdownlist id="ddlGROUP_BY" runat="server" Width="150px" AutoPostBack="true" ></asp:dropdownlist>
<asp:imagebutton id="imgbtnGROUP_BY" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
