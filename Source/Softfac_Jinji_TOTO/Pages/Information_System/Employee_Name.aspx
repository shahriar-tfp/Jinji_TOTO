<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Employee_Name.aspx.vb" Inherits="Pages_InformationSystem_Employee_Name" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>JINJI : Info - Employee Name Page</title>
    <link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet">
</head>
<body id="body" runat="server">
    <form id="Employee_Name" runat="server">
    <div>
											...
											<table cellspacing="0" cellpadding="0" border="0">
												...
												<tr>
												    ...
												    <td align="left">
														...
														<asp:imagebutton id="imgBtnPrint" runat="server" Height="21px" Width="74px"></asp:imagebutton>													</td>
													<td align="left">
