...
Partial Class PAGES_INFORMATION_SYSTEM_IMPORT_EMPLOYEE_INCREMENT2
    ...
    Protected Sub imgBtnUpload_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnUpload.Click
        If Not (txtFileName.PostedFile Is Nothing) Then
            Try
                ...
                Dim myData As New OleDbDataAdapter("SELECT * FROM [INCREMENT$]", strConn)
        ...
        Try
            If GVUpload.Rows.Count > 0 Then
                For i = 0 To GVUpload.Rows.Count - 1
                    ...
                    ssql = "exec sp_is_importIncrement "
                    ssql = ssql & " N'" & GVUpload.Rows(i).Cells(1).Text.Trim.ToUpper.Replace("'", "''") & "',N'" & GVUpload.Rows(i).Cells(2).Text.Trim.ToUpper.Replace("'", "''") & "',"
                    ...
                    If myds2.Tables.Count > 0 Then
                        If myds2.Tables(0).Rows(0).Item(0).ToString = "ERROR" Then
                            GVUpload.Rows(i).Cells(0).Text = myds2.Tables(0).Rows(0).Item(1).ToString
                        Else
                            ssql1 = "exec sp_is_importIncrement2 "
                            ssql1 = ssql1 & " N'" & myds2.Tables(0).Rows(0).Item(0).ToString & "',N'" & myds2.Tables(0).Rows(0).Item(1).ToString & "',"
                            ssql1 = ssql1 & "'" & myds2.Tables(0).Rows(0).Item(2).ToString & "',"
                            ssql1 = ssql1 & "'" & myds2.Tables(0).Rows(0).Item(3).ToString & "','" & Session("EmpID").ToString & "'"
