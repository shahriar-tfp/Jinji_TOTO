...
#Region "Private Declaration"
    ...
    Dim ssql2 As String, ssql3 As String, ssql4 As String, ssql5 As String, ssql6 As String, ssql7 As String, ssql8 As String, ssql9 As String
...
#Region "Panel Edit"
    ...
    Protected Sub imgBtnSubmit_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnSubmit.Click
        ...
        If ValidateInsert() = True And ValidateInsert2() = True And ValidateInsert3() = True Then
            ...
            Dim employee_group As String = txtOCP_ID_EMPLOYEE_GROUP.Text.ToString.Trim
            ssql2 = ssql4
            ...
            If employee_group = "OPER [Operator]" Then
                ssql5 = "Insert Into Employee_Salary(Employee_Profile_ID,Basic_Salary,Currency_Profile_Code,Option_Pay_Mode," & _
                    "Option_Pay_Type,Option_Pay_Cycle,DateTime_Create,User_Profile_Code_Create,DateTime_Modify,User_Profile_Code_Modify) Values('" & Session("MaxEmpID").ToString & "',0,'" & GetCompanyProfileCode() & "','BANK','MONTHLY','MONTHLY2',dbo.fn_GetCurrentDate(GetDate()),'" & Session("EmpID").ToString & "',dbo.fn_GetCurrentDate(GetDate()),'" & Session("EmpID").ToString & "')"
            Else
                ssql5 = "Insert Into Employee_Salary(Employee_Profile_ID,Basic_Salary,Currency_Profile_Code,Option_Pay_Mode," & _
            ...
            myDS2 = mySQL.ExecuteSQL("Select ID from organisation_Code_Profile_vw where option_type = 'EMPLOYEE_GROUP' and codename = '" & employee_group & "' and Company_Profile_Code = '" & Session("Company").ToString & "'")
            If myDS2.Tables.Count > 0 Then
                If myDS2.Tables(0).Rows.Count > 0 Then
                    ssql9 = "Insert Into Employee_Group(Employee_Group_ID,Employee_Profile_ID) Values(N'" & myDS2.Tables(0).Rows(0).Item(0).ToString & "',N'" & Session("MaxEmpID").ToString & "')"
                Else
                    ssql9 = ""
                End If
            Else
...
#Region "Panel Action"
    ...
    Private Function GetEmpID(ByVal RowIndex As Integer) As String
        ...
        If Not myDS Is Nothing Then
            For j = 0 To myGridView.HeaderRow.Cells.Count - 1
        ...
        If dataCurrent.Length = 0 Then
            ...
            If myDS.Tables.Count > 0 And myDS.Tables(0).Rows.Count > 0 And myDS.Tables(0).Columns.Count > 2 Then
                ...
                If dataFlag = "YES" Then
                    ...
                    For i = dataFormat.Length - 1 To 0 Step -1
