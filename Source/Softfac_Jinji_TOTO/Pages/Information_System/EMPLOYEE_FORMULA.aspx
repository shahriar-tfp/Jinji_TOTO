<%@ Page Language="VB" AutoEventWireup="false" CodeFile="EMPLOYEE_FORMULA.aspx.vb" Inherits="PAGES_INFORMATION_SYSTEM_EMPLOYEE_FORMULA" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>EMPLOYEE_FORMULA</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server"> 
<form id="EMPLOYEE_FORMULA" runat="server">
<div>
...
<!--// 4 //-->
<asp:imagebutton id="imgKeyOPTION_FORMULA_TYPE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblOPTION_FORMULA_TYPE" runat="server" Width="140px" ></asp:label>
<asp:dropdownlist id="ddlOPTION_FORMULA_TYPE" runat="server" Width="150px" ></asp:dropdownlist>
<asp:imagebutton id="imgbtnOPTION_FORMULA_TYPE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 5 //-->
<asp:imagebutton id="imgKeyFORMULA" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblFORMULA" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtFORMULA" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnFORMULA" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 6 //-->
<asp:imagebutton id="imgKeyOPTION_ROUNDING" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblOPTION_ROUNDING" runat="server" Width="140px" ></asp:label>
<asp:dropdownlist id="ddlOPTION_ROUNDING" runat="server" Width="150px" ></asp:dropdownlist>
<asp:imagebutton id="imgbtnOPTION_ROUNDING" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
