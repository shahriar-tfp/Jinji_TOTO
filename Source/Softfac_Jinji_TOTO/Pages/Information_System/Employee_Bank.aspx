<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Employee_Bank.aspx.vb" Inherits="Pages_InformationSystem_Employee_Bank" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>JINJI : Info - Employee Bank Page</title>
    <link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server">
    <form id="Employee_Bank" runat="server">
    <div>
    ...
    <asp:imagebutton id="imgbtnBANK_PROFILE_CODE" runat="server" Height="21px" ></asp:imagebutton>
    <!--// 5 //-->
    <asp:imagebutton id="imgKeyBRANCH_CODE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
    ...
    <!--// 6 //-->
    <asp:imagebutton id="imgKeyACCOUNT_NO" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
