<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Employee_Emergency_Contact.aspx.vb" Inherits="Pages_InformationSystem_Employee_Emergency_Contact" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>JINJI : Info - Employee Emergency Contact Page</title>
    <link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server">
    <form id="Employee_Emergency_Contact" runat="server">
    <div>
    ...
    <!--// 12 //-->
    <asp:imagebutton id="imgKeyPHONE_NO_OFFICE" runat="server" Width="21px" Height="21px"></asp:imagebutton>
    <asp:label id="lblPHONE_NO_OFFICE" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtPHONE_NO_OFFICE" runat="server" Width="150px"></asp:textbox>
    <asp:imagebutton id="imgbtnPHONE_NO_OFFICE" runat="server" Height="21px"></asp:imagebutton>
    <!--// 13 //-->
    ...
    <asp:RegularExpressionValidator id="valEMAIL_ADDRESS" runat="server"
        ControlToValidate="txtEMAIL_ADDRESS"
