<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Employee_Superior.aspx.vb" Inherits="Pages_InformationSystem_Employee_Superior" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>JINJI : Info - Employee Superior Page</title>
    <link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet">
</head>
<body id="body" runat="server">
    <form id="Employee_Superior" runat="server">
    <div>
