<%@ Page Language="VB" AutoEventWireup="false" CodeFile="EMPLOYEE_COMPANY_BENEFIT.aspx.vb" Inherits="PAGES_INFORMATION_SYSTEM_EMPLOYEE_COMPANY_BENEFIT" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>EMPLOYEE_COMPANY_BENEFIT</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server"> 
<form id="EMPLOYEE_COMPANY_BENEFIT" runat="server">
<div>
...
<!--// 2 //-->
<asp:imagebutton id="imgKeyOPTION_BENEFIT_TYPE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblOPTION_BENEFIT_TYPE" runat="server" Width="140px" ></asp:label>
<asp:dropdownlist id="ddlOPTION_BENEFIT_TYPE" runat="server" Width="150px" ></asp:dropdownlist>
<asp:imagebutton id="imgbtnOPTION_BENEFIT_TYPE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 3 //-->
<asp:imagebutton id="imgKeyISSUE_DATE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblISSUE_DATE" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtISSUE_DATE" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnISSUE_DATE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 4 //-->
<asp:imagebutton id="imgKeyRETURN_DATE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblRETURN_DATE" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtRETURN_DATE" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnRETURN_DATE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 5 //-->
<asp:imagebutton id="imgKeySTART_PERIOD" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblSTART_PERIOD" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtSTART_PERIOD" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnSTART_PERIOD" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 6 //-->
<asp:imagebutton id="imgKeyEND_PERIOD" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblEND_PERIOD" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtEND_PERIOD" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnEND_PERIOD" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 7 //-->
<asp:imagebutton id="imgKeyREMARKS" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblREMARKS" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtREMARKS" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnREMARKS" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
