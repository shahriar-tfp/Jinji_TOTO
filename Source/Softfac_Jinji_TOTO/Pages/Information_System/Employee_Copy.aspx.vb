...
Partial Class Pages_INFORMATION_SYSTEM_EMPLOYEE_COPY
...
#End Region
    ...
    Protected Sub imgBtnPrint_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnPrint.Click
        ...
        ssql = "select dbo.fn_ReturnEmpIDByCodeName('" & Session("Company").ToString & "','" & txtEMPLOYEE_PROFILE_ID.Text & "'),dbo.fn_UnDisplayDate('" & txtDATE.Text & "','" & Session("Company").ToString & "','" & Session("Module").ToString & "'),@@spid"
        myDS = New DataSet()
