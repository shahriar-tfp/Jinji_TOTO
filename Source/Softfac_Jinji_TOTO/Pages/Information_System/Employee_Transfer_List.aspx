<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Employee_Transfer_List.aspx.vb" Inherits="Pages_InformationSystem_Employee_Transfer_List" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>JINJI : Info - Employee Tansfer Page</title>
    <link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server">
    <form id="Employee_Transfer_List" runat="server">
    <div>
  ...
  <!--// 1 //-->
    ...
    <asp:dropdownlist id="ddlOCP_ID_Finance" runat="server" Width="157px" AutoPostBack="true"></asp:dropdownlist>
    ...
    <asp:dropdownlist id="ddlOCP_ID_Employee_Group" runat="server" Width="157px" AutoPostBack="true"></asp:dropdownlist>
    <asp:imagebutton id="imgbtnOCP_ID_Employee_Group" runat="server" Height="21px" ></asp:imagebutton>
    
    <!--// 13 //-->
    <asp:imagebutton id="imgKeySUPERVISOR" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
    <asp:label id="lblSUPERVISOR" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtSUPERVISOR" runat="server" Width="150px"></asp:textbox>
    <asp:imagebutton id="imgbtnSUPERVISOR" runat="server" Height="21px" ></asp:imagebutton>
    ...
    <asp:dropdownlist id="ddlCATEGORY" runat="server" Width="157px" AutoPostBack="true"></asp:dropdownlist>
    <asp:imagebutton id="imgbtnCATEGORY" runat="server" Height="21px" ></asp:imagebutton>
