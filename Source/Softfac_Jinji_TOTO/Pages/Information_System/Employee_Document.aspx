...
<body id="body" runat="server">
    ...
    <!--// 6 //-->
    <asp:imagebutton id="imgKeyLENGTH_OF_SERVICE" runat="server" Width="21px" Height="21px"></asp:imagebutton>
    <asp:label id="lblLENGTH_OF_SERVICE" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtLENGTH_OF_SERVICE" runat="server" Width="150px"></asp:textbox>
    <asp:imagebutton id="imgbtnLENGTH_OF_SERVICE" runat="server" Height="21px"></asp:imagebutton>
