<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Employee_Education.aspx.vb" Inherits="Pages_InformationSystem_Employee_Education" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>JINJI : Info - Employee Education Page</title>
    <link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server">
    <form id="Employee_Education" runat="server">
    <div>
    ...
    <!--// 2 //-->
    <asp:imagebutton id="imgKeySCHOOL_NAME" runat="server" Width="21px" Height="21px"></asp:imagebutton>
    <asp:label id="lblSCHOOL_NAME" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtSCHOOL_NAME" runat="server" Width="150px"></asp:textbox>
    <asp:imagebutton id="imgbtnSCHOOL_NAME" runat="server" Height="21px"></asp:imagebutton>
    <!--// 3 //-->
    ...
    <!--// 5 //-->
    <asp:imagebutton id="imgKeyOPTION_QUALIFICATION" runat="server" Width="21px" Height="21px"></asp:imagebutton>
    <asp:label id="lblOPTION_QUALIFICATION" runat="server" Width="140px"></asp:label>
    <asp:dropdownlist id="ddlOPTION_QUALIFICATION" runat="server" Width="157px"></asp:dropdownlist>
    <asp:imagebutton id="imgbtnOPTION_QUALIFICATION" runat="server" Height="21px"></asp:imagebutton>
    <!--// 6 //-->
    <asp:imagebutton id="imgKeyOPTION_MAJOR" runat="server" Width="21px" Height="21px"></asp:imagebutton>
    <asp:label id="lblOPTION_MAJOR" runat="server" Width="140px"></asp:label>
    <asp:dropdownlist id="ddlOPTION_MAJOR" runat="server" Width="157px"></asp:dropdownlist>
    <asp:imagebutton id="imgbtnOPTION_MAJOR" runat="server" Height="21px"></asp:imagebutton>
    <!--// 7 //-->
    <asp:imagebutton id="imgKeyOPTION_CERTIFICATION" runat="server" Width="21px" Height="21px"></asp:imagebutton>
    <asp:label id="lblOPTION_CERTIFICATION" runat="server" Width="140px"></asp:label>
    <asp:dropdownlist id="ddlOPTION_CERTIFICATION" runat="server" Width="157px"></asp:dropdownlist>
    <asp:imagebutton id="imgbtnOPTION_CERTIFICATION" runat="server" Height="21px"></asp:imagebutton>
    <!--// 8 //-->
    <asp:imagebutton id="imgKeyGRADE" runat="server" Width="21px" Height="21px"></asp:imagebutton>
    <asp:label id="lblGRADE" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtGRADE" runat="server" Width="150px" ></asp:textbox>
    <asp:imagebutton id="imgbtnGRADE" runat="server" Height="21px"></asp:imagebutton>
