<%@ Page Language="VB" AutoEventWireup="false" CodeFile="EMPLOYEE_TRANSFER_HISTORY.aspx.vb" Inherits="PAGES_INFORMATION_SYSTEM_EMPLOYEE_TRANSFER_HISTORY" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>EMPLOYEE_TRANSFER_HISTORY</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server"> 
<form id="EMPLOYEE_TRANSFER_HISTORY" runat="server">
<div>
...
<!--// 4 //-->
<asp:imagebutton id="imgKeyOLD_DIVISION" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblOLD_DIVISION" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtOLD_DIVISION" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnOLD_DIVISION" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 5 //-->
<asp:imagebutton id="imgKeyNEW_DIVISION" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblNEW_DIVISION" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtNEW_DIVISION" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnNEW_DIVISION" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 6 //-->
<asp:imagebutton id="imgKeyOLD_DEPARTMENT" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblOLD_DEPARTMENT" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtOLD_DEPARTMENT" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnOLD_DEPARTMENT" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 7 //-->
<asp:imagebutton id="imgKeyNEW_DEPARTMENT" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblNEW_DEPARTMENT" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtNEW_DEPARTMENT" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnNEW_DEPARTMENT" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 8 //-->
<asp:imagebutton id="imgKeyOLD_SECTION" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblOLD_SECTION" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtOLD_SECTION" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnOLD_SECTION" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 9 //-->
<asp:imagebutton id="imgKeyNEW_SECTION" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblNEW_SECTION" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtNEW_SECTION" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnNEW_SECTION" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 10 //-->
<asp:imagebutton id="imgKeyOLD_LINE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblOLD_LINE" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtOLD_LINE" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnOLD_LINE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 11 //-->
<asp:imagebutton id="imgKeyNEW_LINE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblNEW_LINE" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtNEW_LINE" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnNEW_LINE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 12 //-->
<asp:imagebutton id="imgKeyOLD_GROUP" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblOLD_GROUP" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtOLD_GROUP" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnOLD_GROUP" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 13 //-->
<asp:imagebutton id="imgKeyNEW_GROUP" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblNEW_GROUP" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtNEW_GROUP" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnNEW_GROUP" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 14 //-->
<asp:imagebutton id="imgKeyOLD_PROCESS" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblOLD_PROCESS" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtOLD_PROCESS" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnOLD_PROCESS" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 15 //-->
<asp:imagebutton id="imgKeyNEW_PROCESS" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblNEW_PROCESS" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtNEW_PROCESS" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnNEW_PROCESS" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 16 //-->
<asp:imagebutton id="imgKeyOLD_FINANCE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblOLD_FINANCE" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtOLD_FINANCE" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnOLD_FINANCE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 17 //-->
<asp:imagebutton id="imgKeyNEW_FINANCE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblNEW_FINANCE" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtNEW_FINANCE" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnNEW_FINANCE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 18 //-->
<asp:imagebutton id="imgKeyOLD_TMS" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblOLD_TMS" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtOLD_TMS" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnOLD_TMS" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 19 //-->
<asp:imagebutton id="imgKeyNEW_TMS" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblNEW_TMS" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtNEW_TMS" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnNEW_TMS" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 20 //-->
<asp:imagebutton id="imgKeyOLD_EMPLOYEE_GROUP" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblOLD_EMPLOYEE_GROUP" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtOLD_EMPLOYEE_GROUP" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnOLD_EMPLOYEE_GROUP" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 21 //-->
<asp:imagebutton id="imgKeyNEW_EMPLOYEE_GROUP" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblNEW_EMPLOYEE_GROUP" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtNEW_EMPLOYEE_GROUP" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnNEW_EMPLOYEE_GROUP" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
