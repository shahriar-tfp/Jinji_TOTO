<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Employee_Category.aspx.vb" Inherits="Pages_InformationSystem_Employee_Category" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>JINJI : Info - Employee Category Page</title>
    <link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server">
    <form id="Employee_Category" runat="server">
    <div>
    ...
    <!--// 3 //-->
    <asp:imagebutton id="imgKeyOCP_ID_CATEGORY01" runat="server" Width="21px" Height="21px"></asp:imagebutton>
    <asp:label id="lblOCP_ID_CATEGORY01" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtOCP_ID_CATEGORY01" runat="server" Width="150px"></asp:textbox>
    <asp:imagebutton id="imgbtnOCP_ID_CATEGORY01" runat="server" Height="21px"></asp:imagebutton>
    <!--// 4 //-->
    <asp:imagebutton id="imgKeyOCP_ID_CATEGORY02" runat="server" Width="21px" Height="21px"></asp:imagebutton>
    <asp:label id="lblOCP_ID_CATEGORY02" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtOCP_ID_CATEGORY02" runat="server" Width="150px"></asp:textbox>
    <asp:imagebutton id="imgbtnOCP_ID_CATEGORY02" runat="server" Height="21px"></asp:imagebutton>
    <!--// 5 //-->
    <asp:imagebutton id="imgKeyOCP_ID_CATEGORY03" runat="server" Width="21px" Height="21px"></asp:imagebutton>
    <asp:label id="lblOCP_ID_CATEGORY03" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtOCP_ID_CATEGORY03" runat="server" Width="150px"></asp:textbox>
    <asp:imagebutton id="imgbtnOCP_ID_CATEGORY03" runat="server" Height="21px"></asp:imagebutton>
    <!--// 6 //-->
    <asp:imagebutton id="imgKeyOCP_ID_CATEGORY04" runat="server" Width="21px" Height="21px"></asp:imagebutton>
    <asp:label id="lblOCP_ID_CATEGORY04" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtOCP_ID_CATEGORY04" runat="server" Width="150px"></asp:textbox>
    <asp:imagebutton id="imgbtnOCP_ID_CATEGORY04" runat="server" Height="21px"></asp:imagebutton>
    <!--// 7 //-->
    <asp:imagebutton id="imgKeyOCP_ID_CATEGORY05" runat="server" Width="21px" Height="21px"></asp:imagebutton>
    <asp:label id="lblOCP_ID_CATEGORY05" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtOCP_ID_CATEGORY05" runat="server" Width="150px"></asp:textbox>
    <asp:imagebutton id="imgbtnOCP_ID_CATEGORY05" runat="server" Height="21px"></asp:imagebutton>
    <!--// 8 //-->
    <asp:imagebutton id="imgKeyOCP_ID_CATEGORY06" runat="server" Width="21px" Height="21px"></asp:imagebutton>
    <asp:label id="lblOCP_ID_CATEGORY06" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtOCP_ID_CATEGORY06" runat="server" Width="150px"></asp:textbox>
    <asp:imagebutton id="imgbtnOCP_ID_CATEGORY06" runat="server" Height="21px"></asp:imagebutton>
    <!--// 9 //-->
    <asp:imagebutton id="imgKeyOCP_ID_CATEGORY07" runat="server" Width="21px" Height="21px"></asp:imagebutton>
    <asp:label id="lblOCP_ID_CATEGORY07" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtOCP_ID_CATEGORY07" runat="server" Width="150px"></asp:textbox>
    <asp:imagebutton id="imgbtnOCP_ID_CATEGORY07" runat="server" Height="21px"></asp:imagebutton>
    <!--// 10 //-->
    <asp:imagebutton id="imgKeyOCP_ID_CATEGORY08" runat="server" Width="21px" Height="21px"></asp:imagebutton>
    <asp:label id="lblOCP_ID_CATEGORY08" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtOCP_ID_CATEGORY08" runat="server" Width="150px"></asp:textbox>
    <asp:imagebutton id="imgbtnOCP_ID_CATEGORY08" runat="server" Height="21px"></asp:imagebutton>
    <!--// 11 //-->
    <asp:imagebutton id="imgKeyOCP_ID_CATEGORY09" runat="server" Width="21px" Height="21px"></asp:imagebutton>
    <asp:label id="lblOCP_ID_CATEGORY09" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtOCP_ID_CATEGORY09" runat="server" Width="150px"></asp:textbox>
    <asp:imagebutton id="imgbtnOCP_ID_CATEGORY09" runat="server" Height="21px"></asp:imagebutton>
    <!--// 12 //-->
    <asp:imagebutton id="imgKeyOCP_ID_CATEGORY10" runat="server" Width="21px" Height="21px"></asp:imagebutton>
    <asp:label id="lblOCP_ID_CATEGORY10" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtOCP_ID_CATEGORY10" runat="server" Width="150px"></asp:textbox>
    <asp:imagebutton id="imgbtnOCP_ID_CATEGORY10" runat="server" Height="21px"></asp:imagebutton>
    <!--// 3 //-->
