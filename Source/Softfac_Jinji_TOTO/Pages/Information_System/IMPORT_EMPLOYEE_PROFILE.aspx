<%@ Page Language="VB" AutoEventWireup="false" CodeFile="IMPORT_EMPLOYEE_PROFILE.aspx.vb" Inherits="PAGES_INFORMATION_SYSTEM_IMPORT_EMPLOYEE_PROFILE" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>IMPORT_EMPLOYEE_PROFILE</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server"> 
<form id="IMPORT_EMPLOYEE_PROFILE" runat="server">
<div>
...
<!--// 3 //-->
<asp:imagebutton id="imgKeyEMPLOYEE_NAME" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblEMPLOYEE_NAME" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtEMPLOYEE_NAME" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnEMPLOYEE_NAME" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
...
<asp:dropdownlist id="ddlOPTION_TITLE" runat="server" Width="150px" ></asp:dropdownlist>
<asp:imagebutton id="imgbtnOPTION_TITLE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 5 //-->
<asp:imagebutton id="imgKeyNEW_IDENTITY_CARD_NO" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblNEW_IDENTITY_CARD_NO" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtNEW_IDENTITY_CARD_NO" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnNEW_IDENTITY_CARD_NO" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
...
<asp:imagebutton id="imgbtnOLD_IDENTITY_CARD_NO" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 7 //-->
<asp:imagebutton id="imgKeyIDENTITY_CARD_COLOR" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblIDENTITY_CARD_COLOR" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtIDENTITY_CARD_COLOR" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnIDENTITY_CARD_COLOR" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
...
<asp:imagebutton id="imgbtnPLACE_OF_BIRTH" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
