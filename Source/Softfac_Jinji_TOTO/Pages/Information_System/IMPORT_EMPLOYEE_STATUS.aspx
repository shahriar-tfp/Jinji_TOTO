<%@ Page Language="VB" AutoEventWireup="false" CodeFile="IMPORT_EMPLOYEE_STATUS.aspx.vb" Inherits="PAGES_INFORMATION_SYSTEM_IMPORT_EMPLOYEE_STATUS" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>IMPORT_EMPLOYEE_STATUS</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server"> 
<form id="IMPORT_EMPLOYEE_STATUS" runat="server">
<div>
