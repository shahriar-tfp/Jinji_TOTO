<%@ Page Language="VB" AutoEventWireup="false" CodeFile="LOAN_ITEM.aspx.vb" Inherits="PAGES_INFORMATION_SYSTEM_LOAN_ITEM" %>
...
<form id="LOAN_ITEM" runat="server">
<div>
...
<!--// 3 //-->
<asp:imagebutton id="imgKeyLOANITEM" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblLOANITEM" runat="server" Width="140px" ></asp:label>
<asp:dropdownlist id="ddlLOANITEM" runat="server" Width="150px" ></asp:dropdownlist>
<asp:imagebutton id="imgbtnLOANITEM" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 4 //-->
<asp:imagebutton id="imgKeyLOAN_DATE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblLOAN_DATE" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtLOAN_DATE" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnLOAN_DATE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
