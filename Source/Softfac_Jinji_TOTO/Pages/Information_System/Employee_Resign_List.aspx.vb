...
Partial Class Pages_InformationSystem_Employee_Resign_List
...
#Region "Private Declaration"
    ...
    Dim EMPID As String, Finance As String = "NULL", EmployeeGroup As String = "NULL", Supervisor As String = "NULL", EmployeeID As String = "NULL"
    Dim Join_date, Confirm_Date, Resign_Date, Receive_Date, Submit_Date, Actual_last_Date, Promoted_Date, Transfer_Date As String
...
#Region "Panel Edit"
    Protected Sub imgBtnSubmit_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnSubmit.Click
        ...
        If ValidateInsert() = True Then
            ssql = Nothing
            ssql = "Exec sp_is_InsUpdDelEmployeeResign 'ADD',N'" & txtCOMPANY_PROFILE_CODE.Text & "',N'" & txtEMPLOYEE_PROFILE_ID.Text & "',N'" & txtJOIN_DATE.Text & _
            "',N'" & txtCONFIRM_DATE.Text & "',N'" & ddlOPTION_RESIGN_FLAG.SelectedValue & "',N'" & ddlOPTION_RESIGN_TYPE.SelectedValue & "',N'" & txtSUBMIT_DATE.Text & _
            "',N'" & txtRECEIVE_DATE.Text & "',N'" & txtRESIGN_DATE.Text & "',N'" & txtACTUALLASTDATE.Text & "',N'" & ddlOPTION_ELIGIBLE.SelectedValue & "',N'" & txtSHORTNOTICE.Text & _
            "',N'" & ddlOPTION_NOTICE.SelectedValue & "',N'" & txtADJUSTNOTICE.Text & "',N'" & txtREMARK.Text & "',N'" & Session("EmpID").ToString & "',N'ADD'"
    ...
    Protected Sub imgBtnUpdate_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnUpdate.Click
        If ValidateUpdate() Then
            ssql = Nothing
            If validateupdate2() Then
                ssql = "Exec sp_is_InsUpdDelEmployeeResign N'" & txtCOMPANY_PROFILE_CODE.Text & "',N'" & txtEMPLOYEE_PROFILE_ID.Text & "',N'" & Join_date & _
                "',N'" & Confirm_Date & "',N'" & ddlOPTION_RESIGN_FLAG.SelectedValue & "',N'" & ddlOPTION_RESIGN_TYPE.SelectedValue & "',N'" & Submit_Date & _
                "',N'" & Receive_Date & "',N'" & Resign_Date & "',N'" & Actual_last_Date & "',N'" & ddlOPTION_ELIGIBLE.SelectedValue & "',N'" & txtSHORTNOTICE.Text & _
                "',N'" & ddlOPTION_NOTICE.SelectedValue & "',N'" & txtADJUSTNOTICE.Text & "',N'" & txtREMARK.Text & "',N'" & Session("EmpID").ToString & "',N'ADD',N'" & _
                Promoted_Date & "',N'" & Transfer_Date & "'"
                mySQL.ExecuteSQL(ssql, Session("Company").ToString, Session("EmpID").ToString)
                pnlEdit.Visible = False
                pnlMain.Visible = True
                BindGrid()
...
#Region "Panel Action"
    ...
    Protected Sub imgBtnEdit_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnEdit.Click
        If ActionValidateEdit() Then
            ...
            If ddlOPTION_RESIGN_FLAG.SelectedValue = "ACTIVE" Then
                txtSHORTNOTICE.Enabled = False
                txtSUBMIT_DATE.Enabled = False
                imgKeySUBMIT_DATE.Visible = False
                imgbtnSUBMIT_DATE.Enabled = False
                txtRESIGN_DATE.Enabled = False
                imgKeyRESIGN_DATE.Visible = False
                imgbtnRESIGN_DATE.Enabled = False
                txtACTUALLASTDATE.Enabled = False
                imgKeyACTUALLASTDATE.Visible = False
                imgbtnACTUALLASTDATE.Enabled = False
                txtADJUSTNOTICE.Enabled = False
                txtRECEIVE_DATE.Enabled = False
                imgKeyRECEIVE_DATE.Visible = False
                imgbtnRECEIVE_DATE.Enabled = False
                ddlOPTION_RESIGN_TYPE.Enabled = False
                ddlOPTION_ELIGIBLE.Enabled = False
                ddlOPTION_NOTICE.Enabled = False
            ElseIf ddlOPTION_RESIGN_FLAG.SelectedValue = "RESIGN" Then
                txtSHORTNOTICE.Enabled = False
                txtSUBMIT_DATE.Enabled = True
                imgKeySUBMIT_DATE.Visible = True
                imgbtnSUBMIT_DATE.Enabled = True
                txtRESIGN_DATE.Enabled = True
                imgKeyRESIGN_DATE.Visible = True
                imgbtnRESIGN_DATE.Enabled = True
                txtACTUALLASTDATE.Enabled = False
                imgKeyACTUALLASTDATE.Visible = False
                imgbtnACTUALLASTDATE.Enabled = False
                txtRECEIVE_DATE.Enabled = True
                imgKeyRECEIVE_DATE.Visible = True
                imgbtnRECEIVE_DATE.Enabled = True
                ddlOPTION_RESIGN_TYPE.Enabled = True
                ddlOPTION_ELIGIBLE.Enabled = True
                ddlOPTION_NOTICE.Enabled = True
                If ddlOPTION_NOTICE.SelectedValue = "YES" Then
                    txtADJUSTNOTICE.Enabled = True
                Else
                    txtADJUSTNOTICE.Enabled = False
                End If
                ssql = "Exec sp_is_GetEmpResign '" & txtCOMPANY_PROFILE_CODE.Text & "','" & txtEMPLOYEE_PROFILE_ID.Text.Replace("'", "''") & "','RESIGN'"
                myDS = mySQL.ExecuteSQL(ssql, Session("Company").ToString, Session("EmpID").ToString)

                If myDS.Tables.Count > 0 Then
                    If myDS.Tables(0).Rows.Count > 0 Then
                        txtSUBMIT_DATE.Text = myDS.Tables(0).Rows(0).Item(0).ToString
                        txtRESIGN_DATE.Text = myDS.Tables(0).Rows(0).Item(1).ToString
                        txtRECEIVE_DATE.Text = myDS.Tables(0).Rows(0).Item(2).ToString
                        txtACTUALLASTDATE.Text = myDS.Tables(0).Rows(0).Item(3).ToString
                        ddlOPTION_ELIGIBLE.SelectedValue = myDS.Tables(0).Rows(0).Item(4).ToString
                        ddlOPTION_NOTICE.SelectedValue = myDS.Tables(0).Rows(0).Item(5).ToString
                        txtSHORTNOTICE.Text = myDS.Tables(0).Rows(0).Item(6).ToString
                        txtADJUSTNOTICE.Text = myDS.Tables(0).Rows(0).Item(7).ToString
                    End If
                End If

            ElseIf ddlOPTION_RESIGN_FLAG.SelectedValue = "RESIGN_PAID" Then
                txtSHORTNOTICE.Enabled = False
                txtSUBMIT_DATE.Enabled = False
                imgKeySUBMIT_DATE.Visible = False
                imgbtnSUBMIT_DATE.Enabled = False
        ...
        If ActionValidateDelete() Then
            For i = 0 To myGridView.Rows.Count - 1
                ...
                If chkDelete.Checked Then
                    ssql = "Exec sp_is_insupddelEmpTransfer 'DEL',N'" & gvHistory.Rows(i).Cells(1).Text & "',N'" & gvHistory.Rows(i).Cells(3).Text & "',N'',N'',N'',N'',N'',N'',N'',N'',N'',N'',N'',N'" & _
            mySetting.UnDisplayDateTime(gvHistory.Rows(i).Cells(2).Text, Session("Company").ToString, Session("Module").ToString) & "',N'',N'" & Session("EmpID").ToString & "'"
                    mySQL.ExecuteSQL(ssql, Session("Company").ToString, Session("EmpID").ToString)
...
#Region "Sub & Function"
                        ...
                        If myTextBox.Visible = True Then
                            If mySetting.CheckTextNullAndReplaceSingleQuote(myTextBox) = True Then
                                ...
                                If myDS.Tables(0).Rows(i).Item(0).ToString.ToUpper = "EMPLOYEE_PROFILE_ID" Then
                                    ...
                                    EmployeeID = mySetting.GetEmployeeIDbyCodeName_ReturnString(Session("Company").ToString, myTextBox.Text.ToString)
                                    If IsNumeric(EmployeeID) = True Then
                                        ssql3 = ssql3 & myDS.Tables(0).Rows(i).Item(0) & "=" & EmployeeID & " And "
                                    Else
                                        ssql3 = ssql3 & myDS.Tables(0).Rows(i).Item(0) & "='" & EmployeeID & "' And "
                                    End If
                                Else
                    ...
                    Select Case myDR(2).ToString
                        Case "OPTION"
                            ...
                            If myDDL.Visible = True And myDDL.SelectedValue <> "" Then
                                ...
                                Else
                                    ssql3 = ssql3 & myDDL.SelectedItem.ToString.Trim & "@@"
                                End If

                                htbFilterCriteria.Add(myDR(0).ToString.Trim, myDDL.SelectedItem.ToString.Trim)
                            End If
                            myDDL = Nothing
                        Case "DATE"
            ...
            For i = 0 To myDS.Tables(0).Rows.Count - 1
                Select Case myDS.Tables(0).Rows(i).Item(2).ToString
                    Case "OPTION"
                        Dim myDropdownlist As DropDownList = Page.FindControl("ddl" & Trim(myDS.Tables(0).Rows(i).Item(0)))
                        If myDropdownlist.Visible = True Then
                            If myDS.Tables(0).Rows(i).Item(0).ToString.ToUpper = "OCP_ID_FINANCE" Then
                                Finance = "N'" & Trim(myDropdownlist.SelectedValue) & "'"
                            ElseIf myDS.Tables(0).Rows(i).Item(0).ToString.ToUpper = "OCP_ID_EMPLOYEE_GROUP" Then
                                EmployeeGroup = "N'" & Trim(myDropdownlist.SelectedValue) & "'"
                            End If
                            If mySetting.CheckTextNull(myDropdownlist.SelectedValue) = True Then
                                If mySetting.ValidateInput(myDropdownlist, myDS.Tables(0).Rows(i).Item(1).ToString) = True Then
    ...
    Private Function ReturnSessionValue(ByVal strRequest As String) As String
        ...
        Return strOutput
    End Function
    Public Function validateupdate2() As Boolean
        Join_date = ""
        Confirm_Date = ""
        Resign_Date = ""
        Receive_Date = ""
        ...
        Promoted_date = ""
        Transfer_Date = ""
        Join_date = mySetting.UnDisplayDateTime(txtJOIN_DATE.Text, Session("Company"), Session("Module"))
        Confirm_Date = mySetting.UnDisplayDateTime(txtCONFIRM_DATE.Text, Session("Company"), Session("Module"))
        Resign_Date = mySetting.UnDisplayDateTime(txtRESIGN_DATE.Text, Session("Company"), Session("Module"))
        Receive_Date = mySetting.UnDisplayDateTime(txtRECEIVE_DATE.Text, Session("Company"), Session("Module"))
        Submit_Date = mySetting.UnDisplayDateTime(txtSUBMIT_DATE.Text, Session("Company"), Session("Module"))
        Actual_last_Date = mySetting.UnDisplayDateTime(txtACTUALLASTDATE.Text, Session("Company"), Session("Module"))
        Promoted_date = mySetting.UnDisplayDateTime(txtPROMOTED_DATE.Text, Session("Company"), Session("Module"))
        Transfer_Date = mySetting.UnDisplayDateTime(txtTRANSFER_DATE.Text, Session("Company"), Session("Module"))

        If ddlOPTION_RESIGN_FLAG.SelectedValue = "ACTIVE" Then
            If Not Isdate(Join_date) Then
                lblresult2.Text = "Invalid Date Format! " + lblJOIN_DATE.Text
                Return False
            ElseIf Not Isdate(Confirm_Date) Then
                lblresult2.Text = "Invalid Date Format! " + lblJOIN_DATE.Text
                Return False
            End If
        ElseIf ddlOPTION_RESIGN_FLAG.SelectedValue = "RESIGN" Then
            If Not Isdate(Join_date) Then
                ...
                Return False
            ElseIf Not Isdate(Confirm_Date) Then
                lblresult2.Text = "Invalid Date Format! " + lblCONFIRM_DATE.Text
                Return False
            ElseIf Not Isdate(Resign_Date) Then
                lblresult2.Text = "Invalid Date Format! " + lblRESIGN_DATE.Text
                Return False
            ElseIf Not Isdate(Submit_Date) Then
                lblresult2.Text = "Invalid Date Format! " + lblSUBMIT_DATE.Text
                Return False
            ElseIf Not Isdate(Receive_Date) Then
                lblresult2.Text = "Invalid Date Format! " + lblRECEIVE_DATE.Text
                Return False
            ElseIf Not Isdate(Actual_last_Date) Then
                lblresult2.Text = "Invalid Date Format! " + lblACTUALLASTDATE.Text
                Return False
            End If
        ElseIf ddlOPTION_RESIGN_FLAG.SelectedValue = "RESIGN_PAID" Then
            If Not Isdate(Join_date) Then
        ...
        Return True
    End Function
    Private Function Isdate(ByVal string1 As String) As Boolean
        Dim ssql5 As String
        Dim myDS5 As DataSet

        ssql5 = "select isdate(convert(nvarchar,left('" & string1 & "',8),112))"
        myDS5 = mySQL.ExecuteSQL(ssql5, Session("Company"), Session("EmpID"))
        If myDS5.Tables.Count > 0 Then
            If myDS5.Tables(0).Rows.Count > 0 Then
                If myDS5.Tables(0).Rows(0).Item(0).ToString = "0" Then
                    Return False
                Else
                    Return True
                End If
    ...
    End Function
    Sub BindOPTION()
        mySetting.GetDropdownlistValue("EMPLOYEE_RESIGN", "OPTION_RESIGN_FLAG", ddlOPTION_RESIGN_FLAG)
        mySetting.GetDropdownlistValue("EMPLOYEE_RESIGN", "OPTION_RESIGN_TYPE", ddlOPTION_RESIGN_TYPE)
        mySetting.GetDropdownlistValue("JOB_GRADE_PROFILE", "OPTION_ATTENDANCE", ddlOPTION_ELIGIBLE)
        mySetting.GetDropdownlistValue("JOB_GRADE_PROFILE", "OPTION_ATTENDANCE", ddlOPTION_NOTICE)
    End Sub
#End Region
    ...
    Protected Sub ddlOPTION_RESIGN_FLAG_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ddlOPTION_RESIGN_FLAG.SelectedIndexChanged
        If ddlOPTION_RESIGN_FLAG.SelectedValue = "ACTIVE" Then
            txtSUBMIT_DATE.Text = ""
            txtSHORTNOTICE.Text = ""
            txtSHORTNOTICE.Enabled = False
            ...
            imgbtnRESIGN_DATE.Enabled = False
            txtACTUALLASTDATE.Enabled = False
            txtACTUALLASTDATE.Text = ""
            imgKeyACTUALLASTDATE.Visible = False
            imgbtnACTUALLASTDATE.Enabled = False
            txtADJUSTNOTICE.Enabled = False
            txtADJUSTNOTICE.Text = ""
            txtRECEIVE_DATE.Enabled = False
            txtRECEIVE_DATE.Text = ""
            imgKeyRECEIVE_DATE.Visible = False
            imgbtnRECEIVE_DATE.Enabled = False
            ddlOPTION_RESIGN_TYPE.Enabled = False
            ddlOPTION_RESIGN_TYPE.SelectedIndex = -1
            ddlOPTION_ELIGIBLE.Enabled = False
            ddlOPTION_ELIGIBLE.SelectedIndex = -1
            ddlOPTION_NOTICE.SelectedIndex = -1
            ddlOPTION_NOTICE.Enabled = False
        ElseIf ddlOPTION_RESIGN_FLAG.SelectedValue = "RESIGN" Then
            txtSHORTNOTICE.Enabled = False
            txtSUBMIT_DATE.Enabled = True
    ...
    Protected Sub txtRESIGN_DATE_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtRESIGN_DATE.TextChanged
        If ddlOPTION_RESIGN_FLAG.SelectedValue = "RESIGN" Then
            ssql = "Exec sp_is_GetEmpResign '" & txtCOMPANY_PROFILE_CODE.Text & "','" & txtEMPLOYEE_PROFILE_ID.Text.Replace("'", "''") & "','NOTICE','" & txtSUBMIT_DATE.Text & "','" & txtRESIGN_DATE.Text & "'"
            myDS = mySQL.ExecuteSQL(ssql, Session("Company").ToString, Session("EmpID").ToString)

            If myDS.Tables.Count > 0 Then
                If myDS.Tables(0).Rows.Count > 0 Then
                    txtSHORTNOTICE.Text = myDS.Tables(0).Rows(0).Item(0).ToString
                End If
            End If
        End If
    End Sub

    Protected Sub ddlOPTION_NOTICE_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ddlOPTION_NOTICE.SelectedIndexChanged
        If ddlOPTION_NOTICE.SelectedValue = "YES" Then
            txtADJUSTNOTICE.Enabled = True
            If txtADJUSTNOTICE.Text = 0 Then
                txtADJUSTNOTICE.Text = txtSHORTNOTICE.Text
            End If
        Else
            txtADJUSTNOTICE.Enabled = False
        End If
    ...
    Protected Sub txtSUBMIT_DATE_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtSUBMIT_DATE.TextChanged
        ssql = "Exec sp_is_GetEmpResign '" & txtCOMPANY_PROFILE_CODE.Text & "','" & txtEMPLOYEE_PROFILE_ID.Text.Replace("'", "''") & "','LASTDAY','" & txtSUBMIT_DATE.Text & "','" & txtRESIGN_DATE.Text & "'"
        myDS = mySQL.ExecuteSQL(ssql, Session("Company").ToString, Session("EmpID").ToString)

        If myDS.Tables.Count > 0 Then
            If myDS.Tables(0).Rows.Count > 0 Then
                txtACTUALLASTDATE.Text = myDS.Tables(0).Rows(0).Item(0).ToString
                If myDS.Tables.Count > 1 Then
                    If myDS.Tables(1).Rows.Count > 0 Then
                        txtSHORTNOTICE.Text = myDS.Tables(1).Rows(0).Item(0).ToString
                    End If
                End If
            End If
        End If
    ...
    Protected Sub txtJOIN_DATE_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtJOIN_DATE.TextChanged
        Dim empid As String = mySetting.GetEmployeeIDbyCodeName_ReturnString(Session("Company").ToString, txtEMPLOYEE_PROFILE_ID.Text.Replace("'", "''"))
        If txtCONFIRM_DATE.Text = "" Or txtCONFIRM_DATE.Text = "01/01/1900" Then
            ssql = "Exec sp_is_SelConfirmDate """ & Session("Company").ToString & """, """ & empid & """, """ & txtJOIN_DATE.Text & """"
            myDS = mySQL.ExecuteSQL(ssql, Session("Company").ToString, Session("EmpID").ToString)
            If myDS.Tables.Count > 0 Then
                If myDS.Tables(0).Rows.Count > 0 Then
                    txtCONFIRM_DATE.Text = myDS.Tables(0).Rows(0).Item(0).ToString
                End If
            End If
        End If
    End Sub
