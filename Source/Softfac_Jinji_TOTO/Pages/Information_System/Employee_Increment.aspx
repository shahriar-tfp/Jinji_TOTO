...
<body id="body" runat="server">
    ...
    <asp:dropdownlist id="ddlOCP_ID_JOB_GRADE_OLD" runat="server" Width="157px"></asp:dropdownlist>
    ...
    <asp:dropdownlist id="ddlOCP_ID_JOB_TITLE_OLD" runat="server" Width="157px"  ></asp:dropdownlist>
