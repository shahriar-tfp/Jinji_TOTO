<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Employee_Experience.aspx.vb" Inherits="Pages_InformationSystem_Employee_Experience" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>JINJI : Info - Employee Experience Page</title>
    <link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server">
    <form id="Employee_Experience" runat="server">
    <div>
    ...
    <asp:imagebutton id="imgbtnRESIGN_DATE" runat="server" Height="21px"></asp:imagebutton>
     <!--// 17 //-->
    <asp:imagebutton id="imgKeyPOSITION" runat="server" Width="21px" Height="21px"></asp:imagebutton>
    <asp:label id="lblPOSITION" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtPOSITION" runat="server" Width="150px"></asp:textbox>
    <asp:imagebutton id="imgbtnPOSITION" runat="server" Height="21px"></asp:imagebutton>
     <!--// 18 //-->
    ...
    <asp:imagebutton id="imgbtnSALARY" runat="server" Height="21px"></asp:imagebutton>
     <!--// 19 //-->
