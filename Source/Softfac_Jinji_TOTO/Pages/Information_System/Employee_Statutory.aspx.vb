                            ...
                            If mySetting.CheckTextNullAndReplaceSingleQuote(myTextBox) = True Then
                                ...
                                Else
                                    ...
                                    If myDST.Tables(0).Rows.Count > 0 Then
                                        ...
                                        Else
                                            If myDS.Tables(0).Rows(i).Item(0).ToString.ToUpper = "OCP_ID_TYPE" And myDST.Tables(0).Rows(0).Item(2).ToString.Trim = "" Then
                                            ...
                                            ElseIf myDS.Tables(0).Rows(i).Item(0).ToString.ToUpper = "OCP_ID_TYPE" And myDST.Tables(0).Rows(0).Item(2).ToString.Trim = "COMPANY" Then
                                                ssql2 = ssql2 & "ISNULL(" & myDST.Tables(0).Rows(0).Item(0).ToString & "(N'" & myTextBox.Text.ToString & "',N'" & ddlOPTION_TYPE_STATUTORY.SelectedValue.ToString & "',N'" & Session("Company") & "'),''),"
                                            Else
                            ...
                            If mySetting.CheckTextNullAndReplaceSingleQuote(myTextBox) = True Then
                                ...
                                Else
                                    ...
                                    If myDST.Tables(0).Rows.Count > 0 Then
                                        ...
                                        Else
                                            If myDS.Tables(0).Rows(i).Item(0).ToString.ToUpper = "OCP_ID_TYPE" And myDST.Tables(0).Rows(0).Item(2).ToString = "" Then
                                            ...
                                            ElseIf myDS.Tables(0).Rows(i).Item(0).ToString.ToUpper = "OCP_ID_TYPE" And myDST.Tables(0).Rows(0).Item(2).ToString = "COMPANY" Then
                                                ssql = ssql & myDS.Tables(0).Rows(i).Item(0) & "=ISNULL(" & myDST.Tables(0).Rows(0).Item(0).ToString & "(N'" & myTextBox.Text.ToString & "',N'" & ddlOPTION_TYPE_STATUTORY.SelectedValue.ToString & "',N'" & Session("Company") & "'),''),"
                                            Else
                                ...
                                If mySetting.CheckTextNullAndReplaceSingleQuote(myTextBox) = True Then
                                    ...
                                    Else
                                        ...
                                        If myDST2.Tables(0).Rows.Count > 0 Then
                                            ...
                                            Else
                                                If myDS2.Tables(0).Rows(i).Item(0).ToString.ToUpper = "OCP_ID_TYPE" And myDST2.Tables(0).Rows(0).Item(2).ToString = "" Then
                                                ...
                                                ElseIf myDS2.Tables(0).Rows(i).Item(0).ToString.ToUpper = "OCP_ID_TYPE" And myDST2.Tables(0).Rows(0).Item(2).ToString = "COMPANY" Then
                                                    ssql = ssql & myDS2.Tables(0).Rows(i).Item(0) & "=ISNULL(" & myDST2.Tables(0).Rows(0).Item(0).ToString & "(N'" & myTextBox.Text.ToString & "',N'" & ddlOPTION_TYPE_STATUTORY.SelectedValue.ToString & "',N'" & Session("Company") & "'),'') And "
                                                Else
