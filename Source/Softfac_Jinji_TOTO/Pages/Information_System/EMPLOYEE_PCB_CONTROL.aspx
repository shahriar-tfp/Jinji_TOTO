<%@ Page Language="VB" AutoEventWireup="false" CodeFile="EMPLOYEE_PCB_CONTROL.aspx.vb" Inherits="PAGES_INFORMATION_SYSTEM_EMPLOYEE_PCB_CONTROL" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>EMPLOYEE_PCB_CONTROL</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server"> 
<form id="EMPLOYEE_PCB_CONTROL" runat="server">
<div>
