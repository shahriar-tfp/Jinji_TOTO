<%@ Page Language="VB" AutoEventWireup="false" CodeFile="EMPLOYEE_PREVIOUS_SALARY.aspx.vb" Inherits="PAGES_INFORMATION_SYSTEM_EMPLOYEE_PREVIOUS_SALARY" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>EMPLOYEE_PREVIOUS_SALARY</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server"> 
<form id="EMPLOYEE_PREVIOUS_SALARY" runat="server">
<div>
...
<!--// 4 //-->
<asp:imagebutton id="imgKeyGROSS_SALARY" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblGROSS_SALARY" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtGROSS_SALARY" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnGROSS_SALARY" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 5 //-->
<asp:imagebutton id="imgKeyEPF" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblEPF" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtEPF" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnEPF" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
...
<!--// 8 //-->
<!--//<asp:imagebutton id="imgKeyTravel" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblTravel" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtTravel" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnTravel" runat="server" Width="21px" Height="21px" ></asp:imagebutton>//-->
