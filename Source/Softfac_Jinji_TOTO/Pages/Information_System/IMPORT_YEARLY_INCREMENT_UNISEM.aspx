<%@ Page Language="VB" AutoEventWireup="false" CodeFile="IMPORT_YEARLY_INCREMENT_UNISEM.aspx.vb" Inherits="PAGES_INFORMATION_SYSTEM_IMPORT_YEARLY_INCREMENT_UNISEM" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>IMPORT_EMPLOYEE_INCREMENT</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server"> 
<form id="IMPORT_YEARLY_INCREMENT_UNISEM" runat="server">
<div>
...
<!--// 2 //-->
<asp:imagebutton id="imgKeySALARY" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblSALARY" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtSALARY" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnSALARY" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
