...
Partial Class Pages_InformationSystem_Employee_Transfer_List
...
#Region "Private Declaration"
    ...
    Dim div, dept, sect, line, grp, pcs, tms, fin, EmpGrp, Sup, CatGory As String
...
#Region "Page Setting"
    ...
    Sub PagePreload()
        ...
        'BindJobTitle()
        'bind Finance field dropdownlist
        BindFinance()
        'Bind EmployeeGroup
        BindEmployeeGroup()
        BindCategory()
...
#Region "Panel Edit"
    Protected Sub imgBtnSubmit_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnSubmit.Click
        ...
        If ValidateInsert() = True Then
            ssql = Nothing
            GetAllString()
            ssql = "Exec sp_is_insupddelEmpTransfer 'ADD',N'" & txtCOMPANY_PROFILE_CODE.Text & "',N'" & txtEMPLOYEE_PROFILE_ID.Text & "',N'" & div & "',N'" & _
            dept & "',N'" & sect & "',N'" & line & "',N'" & grp & "',N'" & _
            pcs & "',N'" & txtOCP_ID_TMS.Text & "',N'" & fin & "',N'" & EmpGrp & "',N'" & Sup & "',N'" & CatGory & "',N'" & _
            mySetting.UnDisplayDateTime(txtEFFECTIVE_DATE.Text, Session("Company").ToString, Session("Module").ToString) & "',N'',N'" & Session("EmpID").ToString & "'"
                            ...
                            If gvHistory.HeaderRow.Cells(intColumn).Text.ToString = myDS.Tables(0).Rows(j).Item(2).ToString Then
                                Select Case myDS.Tables(0).Rows(j).Item(1).ToString.Trim
                                    Case "OPTION"
                                        ...
                                        myDDL = Nothing
                                        If myDS.Tables(0).Rows(j).Item(0).ToString.Trim = "OCP_ID_DIVISION" Then
        ...
        Try
            ...
            If ddlOCP_ID_SECTION.SelectedIndex > 0 Then
                If Not sender Is Nothing Then
                    ...
                    Else
                        'get back prev value if hv
                        For i = 0 To tmpDS3.Tables(0).Rows.Count - 1
    ...
    Protected Sub ddlOCP_ID_LINE_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ddlOCP_ID_LINE.SelectedIndexChanged
        ...
        If ddlOCP_ID_LINE.SelectedIndex > 0 Then
            If Not sender Is Nothing Then
                ...
                Else
                    'get back prev value if hv
                    For i = 0 To tmpDS4.Tables(0).Rows.Count - 1
    ...
    Protected Sub ddlOCP_ID_GROUP_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ddlOCP_ID_GROUP.SelectedIndexChanged
        ...
        If ddlOCP_ID_GROUP.SelectedIndex > 0 Then
            If Not sender Is Nothing Then
                ...
                Else
                    'get back prev value if hv
                    For i = 0 To tmpDS5.Tables(0).Rows.Count - 1
    ...
    Protected Sub ddlOCP_ID_PROCESS_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ddlOCP_ID_PROCESS.SelectedIndexChanged
        ...
        If ddlOCP_ID_PROCESS.SelectedIndex > 0 Then
            If Not sender Is Nothing Then
                ...
                Else
                    'get back prev value if hv
                    For i = 0 To tmpDS6.Tables(0).Rows.Count - 1
...
#Region "Sub & Function"
    ...
    Sub BindEmployeeGroup()
        ssql = "exec [sp_org_getOCPIDObject] 'EMPLOYEE_GROUP_0','" & Session("Company") & "','','','','','','',''"
        myDS2 = mySQL.ExecuteSQL(ssql)
        If myDS2.Tables.Count > 0 Then
            If myDS2.Tables(0).Columns.Count > 1 Then
                ddlOCP_ID_Employee_Group.DataTextField = "Name"
                ddlOCP_ID_Employee_Group.DataValueField = "Code"
                ddlOCP_ID_Employee_Group.DataSource = myDS2
                ddlOCP_ID_Employee_Group.DataBind()
            End If
        End If
        myDS2 = Nothing
    End Sub
    ...
    Sub BindCategory()
        ssql = "exec [sp_org_getOCPIDObject] 'CATEGORY_0','" & Session("Company") & "','','','','','','',''"
        myDS2 = mySQL.ExecuteSQL(ssql)
        If myDS2.Tables.Count > 0 Then
            If myDS2.Tables(0).Columns.Count > 1 Then
    ...
    End Sub
    Sub BindFinance()
        ssql = "exec [sp_org_getOCPIDObject] 'Finance_0','" & Session("Company") & "','','','','','','',''"
        myDS2 = mySQL.ExecuteSQL(ssql)
        If myDS2.Tables.Count > 0 Then
            If myDS2.Tables(0).Columns.Count > 1 Then
                ddlOCP_ID_Finance.DataTextField = "Name"
                ddlOCP_ID_Finance.DataValueField = "Code"
                ddlOCP_ID_Finance.DataSource = myDS2
                ddlOCP_ID_Finance.DataBind()
            End If
        End If
        myDS2 = Nothing
    End Sub
            ...
            For i = 0 To myDS.Tables(0).Rows.Count - 1
                Select Case myDS.Tables(0).Rows(i).Item(1).ToString
                    Case "DATE"
                        ...
                        If myTextBox.Visible = True Then
                            If mySetting.CheckTextNullAndReplaceSingleQuote(myTextBox) = True Then
                                If DateTime.TryParseExact(mySetting.ConvertDateToDecimal(myTextBox.Text, Session("Company").ToString, Session("Module").ToString), "yyyyMMddHHmmss", Nothing, DateTimeStyles.None, Nothing) = True Then
                    ...
                    Case "DATETIME"
                        ...
                        If myTextBox.Visible = True Then
                            If mySetting.CheckTextNullAndReplaceSingleQuote(myTextBox) = True Then
                                If DateTime.TryParseExact(mySetting.UnDisplayDateTime(myTextBox.Text, Session("Company").ToString, Session("Module").ToString), "yyyyMMddHHmmss", Nothing, DateTimeStyles.None, Nothing) = True Then
                                    ssql = ssql & myDS.Tables(0).Rows(i).Item(0) & ","
                                    Dim myDST As New DataSet
                                    myDST = mySQL.ExecuteSQL("Select Function_Name,Default_Value From User_Define_Function Where Company_Profile_Code='" & Session("Company").ToString & "' And Module_Profile_Code='" & Session("Module").ToString & "' And Table_Profile_Code='" & Form.ID & "' And Table_Field_Code='" & myDS.Tables(0).Rows(i).Item(0).ToString & "' And Query_Action='INSERT'")
                                    If myDST.Tables(0).Rows.Count > 0 Then
                    ...
                    Case "TIME"
                        ...
                        If myTextBox.Visible = True Then
                            If mySetting.CheckTextNullAndReplaceSingleQuote(myTextBox) = True Then
                                If DateTime.TryParseExact(mySetting.UnDisplayTime(myTextBox.Text.ToString, Session("Company").ToString, Session("Module").ToString), "HHmmss", Nothing, DateTimeStyles.None, Nothing) = True Then
                                    ssql = ssql & myDS.Tables(0).Rows(i).Item(0) & ","
                                    Dim myDST As New DataSet
                                    myDST = mySQL.ExecuteSQL("Select Function_Name,Default_Value From User_Define_Function Where Company_Profile_Code='" & Session("Company").ToString & "' And Module_Profile_Code='" & Session("Module").ToString & "' And Table_Profile_Code='" & Form.ID & "' And Table_Field_Code='" & myDS.Tables(0).Rows(i).Item(0).ToString & "' And Query_Action='INSERT'")
                                    If myDST.Tables(0).Rows.Count > 0 Then
    ...
    Private Sub GetAllString()
        ...
        Sup = ""
        CatGory = ""
        If ddlOCP_ID_DIVISION.SelectedIndex > -1 Then
            div = ddlOCP_ID_DIVISION.SelectedItem.ToString
        Else
            div = ""
        End If
        If ddlOCP_ID_DEPARTMENT.SelectedIndex > -1 Then
            dept = ddlOCP_ID_DEPARTMENT.SelectedItem.ToString
        Else
            dept = ""
        End If
        If ddlOCP_ID_SECTION.SelectedIndex > -1 Then
            sect = ddlOCP_ID_SECTION.SelectedItem.ToString
        Else
            sect = ""
        End If
        If ddlOCP_ID_LINE.SelectedIndex > -1 Then
            line = ddlOCP_ID_LINE.SelectedItem.ToString
        Else
            line = ""
        End If
        If ddlOCP_ID_GROUP.SelectedIndex > -1 Then
            grp = ddlOCP_ID_GROUP.SelectedItem.ToString
        Else
            grp = ""
        End If
        If ddlOCP_ID_PROCESS.SelectedIndex > -1 Then
            pcs = ddlOCP_ID_PROCESS.SelectedItem.ToString
        Else
            pcs = ""
        End If
        If ddlOCP_ID_Finance.SelectedIndex > -1 Then
            fin = ddlOCP_ID_Finance.SelectedItem.ToString
        Else
            fin = ""
        End If
        If ddlOCP_ID_Employee_Group.SelectedIndex > -1 Then
            EmpGrp = ddlOCP_ID_Employee_Group.SelectedItem.ToString
        Else
            EmpGrp = ""
        End If
        If txtSupervisor.Text <> "" Then
            Sup = txtSupervisor.Text
        Else
            Sup = ""
        End If
        If ddlCATEGORY.SelectedIndex > -1 Then
            CatGory = ddlCATEGORY.SelectedItem.ToString
        Else
            CatGory = ""
        End If
    End Sub
