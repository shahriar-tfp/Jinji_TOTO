<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Employee_Copy.aspx.vb" Inherits="PAGES_INFORMATION_SYSTEM_EMPLOYEE_COPY" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>JINJI : INFORMATION SYSTEM - Employee Copy Page</title>
    <link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body>
    <form id="Employee_Copy" runat="server">
    <div>
