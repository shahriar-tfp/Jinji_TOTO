<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Employee_Transfer.aspx.vb" Inherits="Pages_InformationSystem_Employee_Transfer" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>JINJI : Info - Employee Transfer Page</title>
    <link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet">
</head>
<body id="body" runat="server">
    <form id="Employee_Transfer" runat="server">
    <div>
   ...
   <!--// 1 //-->
    ...
    <asp:dropdownlist id="ddlOPTION_TYPE" runat="server" Width="157px" AutoPostBack="true"></asp:dropdownlist>
    <asp:imagebutton id="imgbtnOPTION_TYPE" runat="server" Height="21px" ></asp:imagebutton>
    <!--// 5 //-->
    <asp:imagebutton id="imgKeyVALUE_BEFORE_CHANGED" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
    <asp:label id="lblVALUE_BEFORE_CHANGED" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtVALUE_BEFORE_CHANGED" runat="server" Width="150px"></asp:textbox>
    <asp:imagebutton id="imgbtnVALUE_BEFORE_CHANGED" runat="server" Height="21px" ></asp:imagebutton>
    <!--// 6 //-->
    <asp:imagebutton id="imgKeyVALUE_AFTER_CHANGED" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
    <asp:label id="lblVALUE_AFTER_CHANGED" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtVALUE_AFTER_CHANGED" runat="server" Width="150px"></asp:textbox>
    <asp:imagebutton id="imgbtnVALUE_AFTER_CHANGED" runat="server" Height="21px" ></asp:imagebutton>
    <!--// 7 //-->
