<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Employee_Resign_List.aspx.vb" Inherits="Pages_InformationSystem_Employee_Resign_List" %>
...
<body id="body" runat="server">
    <form id="Employee_Resign_List" runat="server">
    <div>
  ...
  <!--// 1 //-->
    ...
    <asp:textbox id="txtJOIN_DATE" runat="server" Width="150px" AutoPostBack ="true"></asp:textbox>
    ...
    <asp:dropdownlist id="ddlOPTION_RESIGN_TYPE" runat="server" Width="157px" AutoPostBack="true"></asp:dropdownlist>
    ...
    <asp:dropdownlist id="ddlOPTION_RESIGN_FLAG" runat="server" Width="157px" AutoPostBack="true"></asp:dropdownlist>
    ...
    <asp:textbox id="txtSUBMIT_DATE" runat="server" Width="150px" AutoPostBack ="true"></asp:textbox>
    <asp:imagebutton id="imgbtnSUBMIT_DATE" runat="server" Height="21px" ></asp:imagebutton>
    <!--// 7 //-->
    <asp:imagebutton id="imgKeyRECEIVE_DATE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
    <asp:label id="lblRECEIVE_DATE" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtRECEIVE_DATE" runat="server" Width="150px" AutoPostBack="true"></asp:textbox>
    <asp:imagebutton id="imgbtnRECEIVE_DATE" runat="server" Height="21px" ></asp:imagebutton>
    <!--// 8 //-->
    ...
    <asp:textbox id="txtRESIGN_DATE" runat="server" Width="150px" AutoPostBack ="true"></asp:textbox>
    <asp:imagebutton id="imgbtnRESIGN_DATE" runat="server" Height="21px" ></asp:imagebutton>
    
    <!--// 10 //-->
    <asp:imagebutton id="imgKeyACTUALLASTDATE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
    <asp:label id="lblACTUALLASTDATE" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtACTUALLASTDATE" runat="server" Width="150px"></asp:textbox>
    <asp:imagebutton id="imgbtnACTUALLASTDATE" runat="server" Height="21px" ></asp:imagebutton>
    <!--// 11 //-->
    <asp:imagebutton id="imgKeyOPTION_ELIGIBLE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
    <asp:label id="lblOPTION_ELIGIBLE" runat="server" Width="140px"></asp:label>
    <asp:dropdownlist id="ddlOPTION_ELIGIBLE" runat="server" Width="157px" AutoPostBack="true"></asp:dropdownlist>
    <asp:imagebutton id="imgbtnOPTION_ELIGIBLE" runat="server" Height="21px" ></asp:imagebutton>
    
    <asp:imagebutton id="imgKeySHORTNOTICE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
    <asp:label id="lblSHORTNOTICE" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtSHORTNOTICE" runat="server" Width="150px"></asp:textbox>
    <asp:imagebutton id="imgbtnSHORTNOTICE" runat="server" Height="21px" ></asp:imagebutton>
    <!--// 12 //-->
    <asp:imagebutton id="imgKeyOPTION_NOTICE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
    <asp:label id="lblOPTION_NOTICE" runat="server" Width="140px"></asp:label>
    <asp:dropdownlist id="ddlOPTION_NOTICE" runat="server" Width="157px" AutoPostBack="true"></asp:dropdownlist>
    <asp:imagebutton id="imgbtnOPTION_NOTICE" runat="server" Height="21px" ></asp:imagebutton>
    
    <!--// 13 //-->
    <asp:imagebutton id="imgKeyADJUSTNOTICE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
    <asp:label id="lblADJUSTNOTICE" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtADJUSTNOTICE" runat="server" Width="150px"></asp:textbox>
    <asp:imagebutton id="imgbtnADJUSTNOTICE" runat="server" Height="21px" ></asp:imagebutton>
    ...
    <!--// 17 //-->
    <asp:imagebutton id="imgKeyPROMOTED_DATE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
    <asp:label id="lblPROMOTED_DATE" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtPROMOTED_DATE" runat="server" Width="150px"></asp:textbox>
    <asp:imagebutton id="imgbtnPROMOTED_DATE" runat="server" Height="21px" ></asp:imagebutton>
    <!--// 18 //-->
    <asp:imagebutton id="imgKeyTRANSFER_DATE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
    <asp:label id="lblTRANSFER_DATE" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtTRANSFER_DATE" runat="server" Width="150px"></asp:textbox>
    <asp:imagebutton id="imgbtnTRANSFER_DATE" runat="server" Height="21px" ></asp:imagebutton>
