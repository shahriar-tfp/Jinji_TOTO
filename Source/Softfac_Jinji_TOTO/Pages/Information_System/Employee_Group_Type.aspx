<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Employee_Group_Type.aspx.vb" Inherits="PAGES_INFORMATION_SYSTEM_EMPLOYEE_GROUP_TYPE" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>JINJI : Info - Employee Group Type</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server"> 
<form id="EMPLOYEE_GROUP_TYPE" runat="server">
<div>
...
<asp:imagebutton id="imgbtnOCP_ID_GROUP" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
