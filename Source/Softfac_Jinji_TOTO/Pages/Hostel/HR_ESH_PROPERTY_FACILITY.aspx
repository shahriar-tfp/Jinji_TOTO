<%@ Page Language="VB" AutoEventWireup="false" CodeFile="HR_ESH_PROPERTY_FACILITY.aspx.vb" Inherits="PAGES_HOSTEL_HR_ESH_PROPERTY_FACILITY" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>JINJI : Hostel - Property Facility Page</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server">
<form id="HR_ESH_PROPERTY_FACILITY" runat="server">
<div>
...
<!--// 4 //-->
<asp:imagebutton id="imgKeyOPTION_RESTRICTION" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblOPTION_RESTRICTION" runat="server" Width="140px" ></asp:label>
<asp:dropdownlist id="ddlOPTION_RESTRICTION" runat="server" Width="157px" ></asp:dropdownlist>
<asp:imagebutton id="imgbtnOPTION_RESTRICTION" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 5 //-->
<asp:imagebutton id="imgKeyOPTION_PROPERTY_TYPE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblOPTION_PROPERTY_TYPE" runat="server" Width="140px" ></asp:label>
<asp:dropdownlist id="ddlOPTION_PROPERTY_TYPE" runat="server" Width="157px" ></asp:dropdownlist>
<asp:imagebutton id="imgbtnOPTION_PROPERTY_TYPE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
