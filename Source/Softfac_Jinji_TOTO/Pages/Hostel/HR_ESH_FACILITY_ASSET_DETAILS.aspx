<%@ Page Language="VB" AutoEventWireup="false" CodeFile="HR_ESH_FACILITY_ASSET_DETAILS.aspx.vb" Inherits="PAGES_HOSTEL_HR_ESH_FACILITY_ASSET_DETAILS" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>JINJI : Hostel - Facility Asset Details Page</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server">
<form id="HR_ESH_FACILITY_ASSET_DETAILS" runat="server">
<div>
...
<!--// 2 //-->
<asp:imagebutton id="imgKeyOCP_ID_FACILITY" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblOCP_ID_FACILITY" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtOCP_ID_FACILITY" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnOCP_ID_FACILITY" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 3 //-->
<asp:imagebutton id="imgKeyOCP_ID_ITEM" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblOCP_ID_ITEM" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtOCP_ID_ITEM" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnOCP_ID_ITEM" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 4 //-->
<asp:imagebutton id="imgKeyASSET_CODE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblASSET_CODE" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtASSET_CODE" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnASSET_CODE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 5 //-->
<asp:imagebutton id="imgKeyOPTION_ASSET_CONDITION" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblOPTION_ASSET_CONDITION" runat="server" Width="140px" ></asp:label>
<asp:dropdownlist id="ddlOPTION_ASSET_CONDITION" runat="server" Width="157px" ></asp:dropdownlist>
<asp:imagebutton id="imgbtnOPTION_ASSET_CONDITION" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 6 //-->
<asp:imagebutton id="imgKeyPURCHASE_DATE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblPURCHASE_DATE" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtPURCHASE_DATE" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnPURCHASE_DATE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 7 //-->
<asp:imagebutton id="imgKeyPURCHASE_BY" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblPURCHASE_BY" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtPURCHASE_BY" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnPURCHASE_BY" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 8 //-->
<asp:imagebutton id="imgKeyCOMPANY_OWN_QTY" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblCOMPANY_OWN_QTY" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtCOMPANY_OWN_QTY" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnCOMPANY_OWN_QTY" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 9 //-->
<asp:imagebutton id="imgKeyOWNER_QTY" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblOWNER_QTY" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtOWNER_QTY" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnOWNER_QTY" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 10 //-->
<asp:imagebutton id="imgKeyOCCUPANT_QTY" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblOCCUPANT_QTY" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtOCCUPANT_QTY" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnOCCUPANT_QTY" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
