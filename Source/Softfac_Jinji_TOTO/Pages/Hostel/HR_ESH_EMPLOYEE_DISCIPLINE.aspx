<%@ Page Language="VB" AutoEventWireup="false" CodeFile="HR_ESH_EMPLOYEE_DISCIPLINE.aspx.vb" Inherits="PAGES_HOSTEL_HR_ESH_EMPLOYEE_DISCIPLINE" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>JINJI : Hostel Employee Discipline Page</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server">
<form id="HR_ESH_EMPLOYEE_DISCIPLINE" runat="server">
<div>
...
<!--// 2 //-->
<asp:imagebutton id="imgKeyOCP_ID_OFENSE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblOCP_ID_OFENSE" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtOCP_ID_OFENSE" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnOCP_ID_OFENSE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 3 //-->
<asp:imagebutton id="imgKeyOFFENSE_DATETIME" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblOFFENSE_DATETIME" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtOFFENSE_DATETIME" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnOFFENSE_DATETIME" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 4 //-->
<asp:imagebutton id="imgKeyREPORT_DATETIME" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblREPORT_DATETIME" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtREPORT_DATETIME" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnREPORT_DATETIME" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
...
<!--// 6 //-->
<asp:imagebutton id="imgKeyCOUNSELLING_DATETIME" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblCOUNSELLING_DATETIME" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtCOUNSELLING_DATETIME" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnCOUNSELLING_DATETIME" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 7 //-->
<asp:imagebutton id="imgKeyCOUNSELLER" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblCOUNSELLER" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtCOUNSELLER" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnCOUNSELLER" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 8 //-->
<asp:imagebutton id="imgKeyCOUNSELLING_REPORT" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblCOUNSELLING_REPORT" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtCOUNSELLING_REPORT" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnCOUNSELLING_REPORT" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 9 //-->
<asp:imagebutton id="imgKeyOCP_ID_ACTION" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblOCP_ID_ACTION" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtOCP_ID_ACTION" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnOCP_ID_ACTION" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
...
<asp:imagebutton id="imgbtnDATETIME_MODIFY" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
	...
	<table id="tblUserCategoryGroup" style="Z-INDEX: 115; LEFT: 10px; POSITION: absolute; TOP: 10px" cellSpacing="0" cellPadding="0" align="center" border="0" runat="server">
					<tr>
						<td>
