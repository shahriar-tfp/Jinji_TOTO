<%@ Page Language="VB" AutoEventWireup="false" CodeFile="HR_ESH_FACILITY_ASSET_PROFILE.aspx.vb" Inherits="PAGES_HOSTEL_HR_ESH_FACILITY_ASSET_PROFILE" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>JINJI : Hostel - Facility Asset Profile Page</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server">
<form id="HR_ESH_FACILITY_ASSET_PROFILE" runat="server">
<div>
...
<!--// 2 //-->
<asp:imagebutton id="imgKeyITEM_COST" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblITEM_COST" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtITEM_COST" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnITEM_COST" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 3 //-->
<asp:imagebutton id="imgKeyLIFESPAN" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblLIFESPAN" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtLIFESPAN" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnLIFESPAN" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 4 //-->
<asp:imagebutton id="imgKeyOPTION_MAINTENANCE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblOPTION_MAINTENANCE" runat="server" Width="140px" ></asp:label>
<asp:dropdownlist id="ddlOPTION_MAINTENANCE" runat="server" Width="157px" ></asp:dropdownlist>
<asp:imagebutton id="imgbtnOPTION_MAINTENANCE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 5 //-->
<asp:imagebutton id="imgKeyOPTION_ITEM_UOM" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblOPTION_ITEM_UOM" runat="server" Width="140px" ></asp:label>
<asp:dropdownlist id="ddlOPTION_ITEM_UOM" runat="server" Width="157px" ></asp:dropdownlist>
<asp:imagebutton id="imgbtnOPTION_ITEM_UOM" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 6 //-->
<asp:imagebutton id="imgKeyOPTION_LIFESPAN_TYPE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblOPTION_LIFESPAN_TYPE" runat="server" Width="140px" ></asp:label>
<asp:dropdownlist id="ddlOPTION_LIFESPAN_TYPE" runat="server" Width="157px" ></asp:dropdownlist>
<asp:imagebutton id="imgbtnOPTION_LIFESPAN_TYPE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
