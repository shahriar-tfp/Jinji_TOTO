<%@ Page Language="VB" AutoEventWireup="false" CodeFile="HR_EST_BUS_ROUTE.aspx.vb" Inherits="PAGES_HOSTEL_HR_EST_BUS_ROUTE" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>JINJI : Hostel - BUS Route Page</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server">
<form id="HR_EST_BUS_ROUTE" runat="server">
<div>
<asp:Panel ID="pnlEdit" runat="server">
<!--// 1 //-->
<asp:imagebutton id="imgKeyOCP_ID_ZONE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblOCP_ID_ZONE" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtOCP_ID_ZONE" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnOCP_ID_ZONE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 2 //-->
<asp:imagebutton id="imgKeyOCP_ID_ROUTE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblOCP_ID_ROUTE" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtOCP_ID_ROUTE" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnOCP_ID_ROUTE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:imagebutton id="imgbtnOCP_ID_ROUTE2" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
...
<!--// listbox //-->
	...
	<table id="tblUserCategoryGroup" style="Z-INDEX: 115; LEFT: 10px; POSITION: absolute; TOP: 10px; border-color: #e4d6fe; vertical-align:middle "
					...
					<tr>
						<td>
							...
							<table id="tblGridView" cellspacing="0" cellpadding="0" width="100%" style="vertical-align:middle " border="0" runat="server">
								<tr>
									<td>
