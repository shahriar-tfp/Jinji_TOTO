<%@ Page Language="VB" AutoEventWireup="false" CodeFile="HR_ESH_UTILITY_COST.aspx.vb" Inherits="PAGES_HOSTEL_HR_ESH_UTILITY_COST" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>JINJI : Hostel - Utility Cost Page</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server">
<form id="HR_ESH_UTILITY_COST" runat="server">
<div>
...
<!--// 4 //-->
<asp:imagebutton id="imgKeyOPTION_BILL_TYPE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblOPTION_BILL_TYPE" runat="server" Width="140px" ></asp:label>
<asp:dropdownlist id="ddlOPTION_BILL_TYPE" runat="server" Width="157px" ></asp:dropdownlist>
<asp:imagebutton id="imgbtnOPTION_BILL_TYPE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 5 //-->
<asp:imagebutton id="imgKeyCOMPANY_AMOUNT" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblCOMPANY_AMOUNT" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtCOMPANY_AMOUNT" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnCOMPANY_AMOUNT" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 6 //-->
<asp:imagebutton id="imgKeyOCCUPANT_AMOUNT" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblOCCUPANT_AMOUNT" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtOCCUPANT_AMOUNT" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnOCCUPANT_AMOUNT" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
