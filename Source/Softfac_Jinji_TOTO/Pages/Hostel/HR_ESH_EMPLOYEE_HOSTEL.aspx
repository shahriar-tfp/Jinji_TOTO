<%@ Page Language="VB" AutoEventWireup="false" CodeFile="HR_ESH_EMPLOYEE_HOSTEL.aspx.vb" Inherits="PAGES_HOSTEL_HR_ESH_EMPLOYEE_HOSTEL" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>JINJI : Hostel - Employee Hostel Page</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />

</head>
<body id="body" runat="server">
<form id="HR_ESH_EMPLOYEE_HOSTEL" runat="server">
<div>
...
<!--// 4 //-->
<asp:imagebutton id="imgKeyCHECK_IN_DATE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblCHECK_IN_DATE" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtCHECK_IN_DATE" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnCHECK_IN_DATE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 5 //-->
<asp:imagebutton id="imgKeyCHECK_OUT_DATE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblCHECK_OUT_DATE" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtCHECK_OUT_DATE" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnCHECK_OUT_DATE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 6 //-->
<asp:imagebutton id="imgKeyOPTION_EMPLOYEE_TYPE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblOPTION_EMPLOYEE_TYPE" runat="server" Width="140px" ></asp:label>
<asp:dropdownlist id="ddlOPTION_EMPLOYEE_TYPE" runat="server" Width="157px" ></asp:dropdownlist>
<asp:imagebutton id="imgbtnOPTION_EMPLOYEE_TYPE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 7 //-->
<asp:imagebutton id="imgKeyRENTAL" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblRENTAL" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtRENTAL" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnRENTAL" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 8 //-->
<asp:imagebutton id="imgKeyOPTION_GA_STATUS" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblOPTION_GA_STATUS" runat="server" Width="140px" ></asp:label>
<asp:dropdownlist id="ddlOPTION_GA_STATUS" runat="server" Width="157px" ></asp:dropdownlist>
<asp:imagebutton id="imgbtnOPTION_GA_STATUS" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
