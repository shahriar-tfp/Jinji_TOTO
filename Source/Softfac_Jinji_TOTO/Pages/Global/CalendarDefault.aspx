<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CalendarDefault.aspx.vb" Inherits="Pages_Global_CalendarDefault" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>Global : Calendar Default Page</title>
    <link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body>
    <form id="CalendarDefault" runat="server">
    <div>
