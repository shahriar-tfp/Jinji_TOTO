<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Language_Profile.aspx.vb" Inherits="Pages_System_Language_Profile" %>
...
<body id="body" runat="server">
    <form id="Language_Profile" runat="server">
    <div>
    ...
    <!--// 3 //-->
    <asp:imagebutton id="imgKeyOPTION_BYTE" runat="server" Width="21px" Height="21px"></asp:imagebutton>
    <asp:label id="lblOPTION_BYTE" runat="server" Width="140px"></asp:label>
    <asp:dropdownlist id="ddlOPTION_BYTE" runat="server" Width="157px"></asp:dropdownlist>
    <asp:imagebutton id="imgbtnOPTION_BYTE" runat="server" Height="21px"></asp:imagebutton>
