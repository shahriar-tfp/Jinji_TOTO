<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Address_Country.aspx.vb" Inherits="Pages_System_Address_Country" %>
...
<body id="body" runat="server">
    <form id="Address_Country" runat="server">
    <div>
    ...
    <!--// 4 //-->
    <asp:imagebutton id="imgKeyLanguage_Profile_Code" runat="server" Width="21px" Height="21px"></asp:imagebutton>
    ...
    <!--// 5 //-->
    <asp:imagebutton id="imgKeyRegional_Profile_Code" runat="server" Width="21px" Height="21px"></asp:imagebutton>
    <asp:label id="lblRegional_Profile_Code" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtREGIONAL_PROFILE_CODE" runat="server" Width="150px"></asp:textbox>
    <asp:imagebutton id="imgbtnRegional_Profile_Code" runat="server" Height="21px"></asp:imagebutton>
    <!--// 6 //-->
    ...
    <asp:imagebutton id="imgbtnCountry_Code" runat="server" Height="21px"></asp:imagebutton>
	...
	<table id="Table7" style="left: 10px; position: absolute; top: 10px" width="100%" cellspacing="0" cellpadding="0" border="0" runat="server">
        <tr>
