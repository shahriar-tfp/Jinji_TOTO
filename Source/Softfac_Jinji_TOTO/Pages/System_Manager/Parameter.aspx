<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Parameter.aspx.vb" Inherits="Pages_System_Parameter" %>
...
<body id="body" runat="server">
    <form id="Parameter" runat="server">
    <div>
    ...
    <!--// 2 //-->
    <asp:image id="imgMODULE_PROFILE_CODE" runat="server" Height="21px" Width="21px"></asp:image>
    ...
    <!--// 3 //-->
    <asp:image id="imgCODE" runat="server" Height="21px" Width="21px"></asp:image>
    <asp:label id="lblCODE" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtCODE" runat="server" Width="150px"></asp:textbox>
    <asp:imagebutton id="imgBtnCODE" runat="server" Height="21px" Width="21px"></asp:imagebutton>
    <!--// 4 //-->
    <asp:image id="imgNAME" runat="server" Height="21px" Width="21px"></asp:image>
    <asp:label id="lblNAME" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtNAME" runat="server" Width="150px"></asp:textbox>
    <asp:imagebutton id="imgBtnNAME" runat="server" Height="21px" Width="21px"></asp:imagebutton>
    <!--// 5 //-->
    <asp:image id="imgString_Value1" runat="server" Height="21px" Width="21px"></asp:image>
    <asp:label id="lblString_Value1" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtString_Value1" runat="server" Width="150px"></asp:textbox>
    <asp:imagebutton id="imgBtnString_Value1" runat="server" Height="21px" Width="21px"></asp:imagebutton>
    <!--// 6 //-->
    <asp:image id="imgString_Value2" runat="server" Height="21px" Width="21px"></asp:image>
    <asp:label id="lblString_Value2" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtString_Value2" runat="server" Width="150px"></asp:textbox>
    <asp:imagebutton id="imgBtnString_Value2" runat="server" Height="21px" Width="21px"></asp:imagebutton>
    <!--// 7 //-->
    <asp:image id="imgString_Value3" runat="server" Height="21px" Width="21px"></asp:image>
    <asp:label id="lblString_Value3" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtString_Value3" runat="server" Width="150px"></asp:textbox>
    <asp:imagebutton id="imgBtnString_Value3" runat="server" Height="21px" Width="21px"></asp:imagebutton>
    <!--// 8 //-->
    <asp:image id="imgString_Value4" runat="server" Height="21px" Width="21px"></asp:image>
    <asp:label id="lblString_Value4" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtString_Value4" runat="server" Width="150px"></asp:textbox>
    <asp:imagebutton id="imgBtnString_Value4" runat="server" Height="21px" Width="21px"></asp:imagebutton>
    <!--// 9 //-->
    <asp:image id="imgString_Value5" runat="server" Height="21px" Width="21px"></asp:image>
    <asp:label id="lblString_Value5" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtString_Value5" runat="server" Width="150px"></asp:textbox>
    <asp:imagebutton id="imgBtnString_Value5" runat="server" Height="21px" Width="21px"></asp:imagebutton>
    <!--// 10 //-->
    <asp:image id="imgDecimal_Value1" runat="server" Height="21px" Width="21px"></asp:image>
    <asp:label id="lblDecimal_Value1" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtDecimal_Value1" runat="server" Width="150px"></asp:textbox>
    <asp:imagebutton id="imgBtnDecimal_Value1" runat="server" Height="21px" Width="21px"></asp:imagebutton>
    <!--// 11 //-->
    <asp:image id="imgDecimal_Value2" runat="server" Height="21px" Width="21px"></asp:image>
    <asp:label id="lblDecimal_Value2" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtDecimal_Value2" runat="server" Width="150px"></asp:textbox>
    <asp:imagebutton id="imgBtnDecimal_Value2" runat="server" Height="21px" Width="21px"></asp:imagebutton>
    <!--// 12 //-->
    <asp:image id="imgDecimal_Value3" runat="server" Height="21px" Width="21px"></asp:image>
    <asp:label id="lblDecimal_Value3" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtDecimal_Value3" runat="server" Width="150px"></asp:textbox>
    <asp:imagebutton id="imgBtnDecimal_Value3" runat="server" Height="21px" Width="21px"></asp:imagebutton>
    <!--// 13 //-->
    <asp:image id="imgDecimal_Value4" runat="server" Height="21px" Width="21px"></asp:image>
    <asp:label id="lblDecimal_Value4" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtDecimal_Value4" runat="server" Width="150px"></asp:textbox>
    <asp:imagebutton id="imgBtnDecimal_Value4" runat="server" Height="21px" Width="21px"></asp:imagebutton>
    <!--// 14 //-->
    <asp:image id="imgDecimal_Value5" runat="server" Height="21px" Width="21px"></asp:image>
    <asp:label id="lblDecimal_Value5" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtDecimal_Value5" runat="server" Width="150px"></asp:textbox>
    <asp:imagebutton id="imgBtnDecimal_Value5" runat="server" Height="21px" Width="21px"></asp:imagebutton>
    <!--// 15 //-->
    <asp:image id="imgRemark" runat="server" Height="21px" Width="21px"></asp:image>
    <asp:label id="lblRemark" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtRemark" TextMode="MultiLine" runat="server" Width="350px" Height="45px"></asp:textbox>
    <asp:imagebutton id="imgBtnRemark" runat="server" Height="21px" Width="21px"></asp:imagebutton>
	<!--// Panel //-->
