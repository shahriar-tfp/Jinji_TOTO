<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Report_Medical_ByMonthYear.aspx.vb" Inherits="Pages_Reports_Report_Medical_ByMonthYear" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>JINJI : Report - Medical By Month Year Page</title>
    <link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body>
    <form id="Report_Medical_ByMonthYear" runat="server">
    <div>
    ...
    <asp:DropDownList ID="ddlOPTION_MONTH" runat="server" Width="150px"></asp:DropDownList>
    ...
    <asp:ImageButton ID="imgKeyPanel_Doctor" runat="server" Width="21px" Height="21px"/>
    <asp:Label ID="lblPanel_Doctor" runat="server" Width="120px"></asp:Label>
    <asp:TextBox ID="txtPanel_Doctor" runat="server" Width="150px"></asp:TextBox>
    <asp:ImageButton ID="imgbtnPanel_Doctor" runat="server" Width="21px" Height="21px"/>
