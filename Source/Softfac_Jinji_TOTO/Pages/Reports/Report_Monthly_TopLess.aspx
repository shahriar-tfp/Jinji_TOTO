<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Report_Monthly_TopLess.aspx.vb" Inherits="Pages_Reports_Report_Monthly_TopLess" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>JINJI : Report - Monthly Top Less Page</title>
    <link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body>
    <form id="Report_Monthly_TopLess" runat="server">
    <div>
    ...
    <asp:ImageButton ID="imgKeyTOPLESS" runat="server" Width="21px" Height="21px"/>
    <asp:Label ID="lblTOPLESS" runat="server" Width="120px"></asp:Label>
    <asp:TextBox ID="txtTOPLESS" runat="server" Width="150px"></asp:TextBox>
    <asp:ImageButton ID="imgbtnTOPLESS" runat="server" Width="21px" Height="21px"/>
