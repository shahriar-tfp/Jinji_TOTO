...
Partial Class Pages_Reports_Report_Monthly_Details
            ...
            If ValidatePrint(myDS) = True Then
                If myDS.Tables(0).Rows.Count = 1 Then
                    ...
                    For k = 0 To itemCount - 1
                        ssql1 = "exec sp_RPT_InsDelRptControlID2 '" & Session("Company").ToString & "','" & ddlOPTION_GROUP.SelectedValue & "','" & lstright.Items(k).Value & "','" & spid & "','ADD','" & Session("EmpID").ToString & "'"
                        myDS1 = New DataSet()
                        myDS1 = mySQL.ExecuteSQL(ssql1)
                    ...
                    ssql = "Exec sp_pr_SelRptPayrollDetails3 """ & Session("Company").ToString & """,""" & Session("EmpID").ToString & """,""" & ddlOPTION_YEAR.SelectedValue & """,""" & ddlOPTION_MONTH.SelectedValue & """,""" & _
                    ddlOPTION_PAY_CYCLE.SelectedValue & """," & spid & ",""" & ddlOPTION_GROUP.SelectedValue & """,""" & ddlOPTION_TYPE.SelectedValue & """,""" & ddlOPTION_REPORT.SelectedValue & """"

                    Dim rpx As New SectionReport
                    Dim ds As New DataSet()
                    Dim xtr As New System.Xml.XmlTextReader(Server.MapPath("~") & "\_Templates\Ar\PayrollDetailsSummaryForMonthly.rpx")

                    If ddlOPTION_REPORT.SelectedValue = "ALLOW" Or ddlOPTION_REPORT.SelectedValue = "DEDUCT" Then
                        xtr = New System.Xml.XmlTextReader(Server.MapPath("~") & "\_Templates\Ar\DeductionsSummaryForMonthEndJounal.rpx")
                        ssql = "Exec sp_pr_SelRptAllowDeduct """ & Session("Company").ToString & """,""" & Session("EmpID").ToString & """,""" & ddlOPTION_YEAR.SelectedValue & """,""" & ddlOPTION_MONTH.SelectedValue & """,""" & _
                        ddlOPTION_PAY_CYCLE.SelectedValue & """," & spid & ",""" & ddlOPTION_GROUP.SelectedValue & """,""" & ddlOPTION_TYPE.SelectedValue & """,""" & ddlOPTION_REPORT.SelectedValue & """"
                    End If
