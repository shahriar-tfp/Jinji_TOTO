<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Report_TOTO_SKILL.aspx.vb" Inherits="Pages_Reports_Report_TOTO_SKILL" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>JINJI : Report - TOTO SKILL Page</title>
    <link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body>
    <form id="REPORT_TOTO_SKILL" runat="server">
    <div>
    ...
    <asp:Label ID="lblLEVEL" runat="server" Width="120px"></asp:Label>
    <asp:DropDownList ID="ddlLEVEL" runat="server" Width="157px"></asp:DropDownList>
    <asp:ImageButton ID="imgbtnLEVEL" runat="server" Width="21px" Height="21px"/>
