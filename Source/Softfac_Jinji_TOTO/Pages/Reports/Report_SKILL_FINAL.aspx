<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Report_SKILL_FINAL.aspx.vb" Inherits="Pages_Reports_Report_SKILL_FINAL" %>
...
<body>
    <form id="REPORT_SKILL_FINAL" runat="server">
    <div>
    ...
    <asp:DropDownList ID="ddlOPTION_CATEGORY" runat="server" Width="157px" AutoPostBack="true"></asp:DropDownList>
    ...
    <asp:image id="imgKeyEMPLOYEE_PROFILE_ID" runat="server" Height="21px" Width="21px"></asp:image>
