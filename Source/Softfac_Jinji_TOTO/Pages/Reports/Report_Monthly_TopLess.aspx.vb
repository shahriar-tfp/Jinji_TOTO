...
Partial Class Pages_Reports_Report_Monthly_TopLess
...
#End Region
    ...
    Sub AutoAdjustPosition(ByVal strSelect As String)
        ...
        If myDS.Tables(0).Rows.Count > 0 Then
            For i = 0 To myDS.Tables(0).Rows.Count - 1
                ...
                If UCase(myDS.Tables(0).Rows(i).Item(1).ToString) = "TOPLESS" Then
                    If lblTOPLESS.Visible = True And txtTOPLESS.Visible = True Then
                        autonum += 1
                        imgKeyTOPLESS.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        imgKeyTOPLESS.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        imgKeyTOPLESS.Style.Add("position", "absolute")
                        autonum += 1
                        lblTOPLESS.CssClass = "wordstyle12"
                        lblTOPLESS.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        lblTOPLESS.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        lblTOPLESS.Style.Add("position", "absolute")
                        autonum += 1
                        txtTOPLESS.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        txtTOPLESS.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        txtTOPLESS.Style.Add("position", "absolute")
                        txtTOPLESS.Width = ddlWidth
                        autonum += 1
                        imgbtnTOPLESS.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        imgbtnTOPLESS.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        imgbtnTOPLESS.Style.Add("position", "absolute")
                    End If
                End If
    ...
    Protected Sub imgBtnPrint_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnPrint.Click
        Try
            ...
            ssql = "select N'" & Session("Company").ToString & "','" & ddlOPTION_PAY_CYCLE.SelectedValue & "',N'" & ddlOPTION_YEAR.SelectedValue & "','" & ddlOPTION_MONTH.SelectedValue & "','" & txtTOPLESS.Text & "',@@spid"
            myDS = New DataSet()
            ...
            If ValidatePrint(myDS) = True Then
                If myDS.Tables(0).Rows.Count = 1 Then
                    ...
                    For k = 0 To itemCount - 1
                        ...
                        ssql1 = Nothing
                    Next
                    myTargetURL = myTargetURL & "&Company_Profile_Code=" & Session("Company").ToString & "&Option_Pay_Cycle=" & myDS.Tables(0).Rows(0).Item(1).ToString & "&Month=" & myDS.Tables(0).Rows(0).Item(3).ToString & "&Year=" & myDS.Tables(0).Rows(0).Item(2).ToString & "&Top=" & myDS.Tables(0).Rows(0).Item(4).ToString & "&Spid=" & spid & "&User_Profile_Code=" & Session("EmpID").ToString & "&rdTemplate=" & ddlOPTION_TYPE.SelectedValue & "&GrpType=" & ddlOPTION_GROUP.SelectedValue
    ...
    Private Function ValidatePrint(ByVal myds As DataSet) As Boolean
        ...
        ElseIf myds.Tables(0).Rows(0).Item(4).ToString = "" Then
            lblresult2.Text = "[" & lblTOPLESS.Text & "] Is A Required Field!"
            txtTOPLESS.Focus()
            Return False
