<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Report_BankList.aspx.vb" Inherits="Pages_Reports_Report_BankList" %>
...
<body>
    <form id="Report_BankList" runat="server">
    <div>
    ...
    <asp:ImageButton ID="imgKeyCOMPANY_PAY_BANK" runat="server" Width="21px" Height="21px"/>
    <asp:Label ID="lblCOMPANY_PAY_BANK" runat="server" Width="120px"></asp:Label>
    <asp:TextBox ID="txtCOMPANY_PAY_BANK" runat="server" Width="150px"></asp:TextBox>
    <asp:ImageButton ID="imgbtnCOMPANY_PAY_BANK" runat="server" Width="21px" Height="21px"/>
    
    <asp:ImageButton ID="imgKeyEMPLOYEE_BANK" runat="server" Width="21px" Height="21px"/>
    <asp:Label ID="lblEMPLOYEE_BANK" runat="server" Width="120px"></asp:Label>
    <asp:TextBox ID="txtEMPLOYEE_BANK" runat="server" Width="150px"></asp:TextBox>
    <asp:ImageButton ID="imgbtnEMPLOYEE_BANK" runat="server" Width="21px" Height="21px"/>
