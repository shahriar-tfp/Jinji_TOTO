...
Partial Class Pages_Reports_REPORT_PAYCASHDENO
    ...
    Sub AutoAdjustPosition(ByVal strSelect As String)
        ...
        If myDS.Tables(0).Rows.Count > 0 Then
            For i = 0 To myDS.Tables(0).Rows.Count - 1
                ...
                If UCase(myDS.Tables(0).Rows(i).Item(1).ToString) = "OPTION_NEGATIVE" Then
                    If lblOPTION_REPORT.Visible = True And ddlOPTION_NEGATIVE.Visible = True Then
                        autonum += 1
                        imgKeyOPTION_NEGATIVE.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        imgKeyOPTION_NEGATIVE.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        imgKeyOPTION_NEGATIVE.Style.Add("position", "absolute")
                        autonum += 1
                        lblOPTION_NEGATIVE.CssClass = "wordstyle12"
                        lblOPTION_NEGATIVE.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        lblOPTION_NEGATIVE.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        lblOPTION_NEGATIVE.Style.Add("position", "absolute")
                        autonum += 1
                        ddlOPTION_NEGATIVE.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        ddlOPTION_NEGATIVE.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        ddlOPTION_NEGATIVE.Style.Add("position", "absolute")
                        ddlOPTION_NEGATIVE.Width = txtWidth
                        autonum += 1
                        imgbtnOPTION_NEGATIVE.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        imgbtnOPTION_NEGATIVE.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        imgbtnOPTION_NEGATIVE.Style.Add("position", "absolute")
                    End If
                End If

                If UCase(myDS.Tables(0).Rows(i).Item(1).ToString) = "PROCESS_DATE" Then
                    If lblPAY_DATE.Visible = True And txtPROCESS_DATE.Visible = True Then
                        autonum += 1
                        imgKeyPROCESS_DATE.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        imgKeyPROCESS_DATE.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        imgKeyPROCESS_DATE.Style.Add("position", "absolute")
                        autonum += 1
                        lblPROCESS_DATE.CssClass = "wordstyle12"
                        lblPROCESS_DATE.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        lblPROCESS_DATE.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        lblPROCESS_DATE.Style.Add("position", "absolute")
                        autonum += 1
                        txtPROCESS_DATE.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        txtPROCESS_DATE.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        txtPROCESS_DATE.Style.Add("position", "absolute")
                        txtPROCESS_DATE.Width = txtWidth
                        autonum += 1
                        imgbtnPROCESS_DATE.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        imgbtnPROCESS_DATE.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        imgbtnPROCESS_DATE.Style.Add("position", "absolute")
                    End If
                End If
...
#End Region
    ...
    Protected Sub imgBtnPrint_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnPrint.Click
        Try
            ...
            ssql = "select dbo.fn_GetEmpID(N'" & Session("EmpID").ToString & "'),dbo.fn_datepart('month',dbo.fn_UnDisplayDate('" & txtYEAR_MONTH.Text & "',N'" & Session("Company").ToString & "','" & Session("Module").ToString & "')),dbo.fn_datepart('year',dbo.fn_UnDisplayDate('" & txtYEAR_MONTH.Text & "',N'" & Session("Company").ToString & "','" & Session("Module").ToString & "')),dbo.fn_UnDisplayDate('" & txtPROCESS_DATE.Text & "',N'" & Session("Company").ToString & "','" & Session("Module").ToString & "'),@@spid"
            myDS = New DataSet()
            ...
            If ValidatePrint(myDS) = True Then
                If myDS.Tables(0).Rows.Count = 1 Then
                    ...
                    ssql1 = Nothing
                    'Next
                    myTargetURL = myTargetURL & "&Company_Profile_Code=" & Session("Company").ToString & "&Month=" & myDS.Tables(0).Rows(0).Item(1).ToString & "&Year=" & myDS.Tables(0).Rows(0).Item(2).ToString & "&SpID=" & spid & "&Option_Pay_Mode=" & ddlOption_Paymode.SelectedValue & "&Date=" & txtPAY_DATE.Text & "&Cheque=" & txtCHEQUE.Text & "&ByRpt=" & ddlOPTION_REPORT.SelectedValue & "&User_Profile_Code=" & Session("EmpID").ToString & "&Option_Pay_Cycle=" & ddlOPTION_PAY_CYCLE.SelectedValue & "&NEGATIVE=" & ddlOPTION_NEGATIVE.SelectedValue & "&ProcessDate=" & myDS.Tables(0).Rows(0).Item(3).ToString & "&rdTemplate=Payroll_CashDenoList"
