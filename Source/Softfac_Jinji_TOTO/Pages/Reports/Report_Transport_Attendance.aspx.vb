...
Partial Class Pages_Reports_Report_Transport_Attendance
        ...
        Try
            ...
            If ValidatePrint(myDS) = True Then
                If myDS.Tables(0).Rows.Count = 1 Then
                    ...
                    "&Option_Pay_Cycle=" & ddlOPTION_PAY_CYCLE.SelectedValue & "&User_Profile_Code=" & Session("EmpID").ToString & "&rdTemplate=TransportAttendanceByMonth"
