...
Partial Class Pages_Reports_Report_SKILL_FINAL
    ...
    Sub PagePreload()
        ...
        If myDS.Tables.Count > 1 Then
            ...
            If myDT2.Rows.Count > 0 Then
                ...
                ddlYearssql = ddlYearssql + "Insert Into #Result Select year(getdate())-5,year(getdate())-5;Insert Into #Result Select year(getdate())-4,year(getdate())-4;"
                ddlYearssql = ddlYearssql + "Insert Into #Result Select year(getdate())-3,year(getdate())-3;Insert Into #Result Select year(getdate())-2,year(getdate())-2"
                ...
                ddlYEAR.SelectedValue = Year(Date.Now())
                blindCategory()
                ddlOPTION_CATEGORY.SelectedValue = "DIRECT"
                blindDepartment()
                blindSection()
        ...
        If myDS.Tables(0).Rows.Count > 0 Then
            For i = 0 To myDS.Tables(0).Rows.Count - 1
                ...
                If UCase(myDS.Tables(0).Rows(i).Item(1).ToString) = "YEAR" Then
                    If lblYEAR.Visible = True And ddlYEAR.Visible = True Then
                        autonum += 1
                        ...
                        autonum += 1
                        ddlYEAR.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        ddlYEAR.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        ddlYEAR.Style.Add("position", "absolute")
                        ddlYEAR.Width = txtWidth
                        autonum += 1
                ...
                If UCase(myDS.Tables(0).Rows(i).Item(1).ToString) = "OCP_ID_DEPARTMENT" Then
                    If lblOCP_ID_DEPARTMENT.Visible = True And ddlOCP_ID_DEPARTMENT.Visible = True Then
                        autonum += 1
                        imgKeyOCP_ID_DEPARTMENT.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        imgKeyOCP_ID_DEPARTMENT.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        imgKeyOCP_ID_DEPARTMENT.Style.Add("position", "absolute")
                        autonum += 1
                        ...
                        autonum += 1
                        ddlOCP_ID_DEPARTMENT.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        ddlOCP_ID_DEPARTMENT.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        ddlOCP_ID_DEPARTMENT.Style.Add("position", "absolute")
                        ddlOCP_ID_DEPARTMENT.Width = ddlWidth
                        autonum += 1
                ...
                If UCase(myDS.Tables(0).Rows(i).Item(1).ToString) = "OCP_ID_SECTION" Then
                    If lblOCP_ID_SECTION.Visible = True And ddlOCP_ID_SECTION.Visible = True Then
                        autonum += 1
                        imgKeyOCP_ID_SECTION.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        imgKeyOCP_ID_SECTION.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        imgKeyOCP_ID_SECTION.Style.Add("position", "absolute")
                        autonum += 1
                        ...
                        autonum += 1
                        ddlOCP_ID_SECTION.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        ddlOCP_ID_SECTION.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        ddlOCP_ID_SECTION.Style.Add("position", "absolute")
                        ddlOCP_ID_SECTION.Width = ddlWidth
                        autonum += 1
                ...
                If UCase(myDS.Tables(0).Rows(i).Item(1).ToString) = "MODEL" Then
                    If lblMODEL.Visible = True And ddlMODEL.Visible = True Then
                        autonum += 1
                        imgKeyMODEL.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        imgKeyMODEL.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        imgKeyMODEL.Style.Add("position", "absolute")
                        autonum += 1
                        lblMODEL.CssClass = "wordstyle12"
                        lblMODEL.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        lblMODEL.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        lblMODEL.Style.Add("position", "absolute")
                        autonum += 1
                        ddlMODEL.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        ddlMODEL.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        ddlMODEL.Style.Add("position", "absolute")
                        ddlMODEL.Width = ddlWidth
                        autonum += 1
                        imgBtnMODEL.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        imgBtnMODEL.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        imgBtnMODEL.Style.Add("position", "absolute")
                    End If
                End If
...
#End Region
        ...
        Try
            ...
            If ValidatePrint(myDS) = True Then
                If myDS.Tables(0).Rows.Count = 1 Then
                    ...
                    myTargetURL = myTargetURL & "&User_Profile_Code=" & Session("EmpID").ToString & "&Year=" & ddlYEAR.SelectedValue & _
                         "&Department=" & ddlOCP_ID_DEPARTMENT.SelectedValue & "&Section=" & ddlOCP_ID_SECTION.SelectedValue & "&Direct=" & ddlOPTION_CATEGORY.SelectedValue & _
                         "&Model=" & ddlMODEL.SelectedValue & "&SpID=" & spid & "&rdTemplate=TOTOKPI_Final"
                    'ssql2 = "Select Report_Name from REPORT_APPRAISAL_BYYEAR where Company_Profile_Code = '" & Session("Company").ToString & "' and " & ddlYEAR.SelectedValue & " between from_year and to_year and option_category = '" & ddlOPTION_CATEGORY.SelectedValue & "'"
                    'myDS3 = mySQL.ExecuteSQL(ssql2)

                    'If myDS3.Tables.Count > 0 Then
                    '    If myDS3.Tables(0).Rows.Count > 0 Then
                    '        myTargetURL = myTargetURL & myDS3.Tables(0).Rows(0).Item(0).ToString
                    '    Else
                    '        If ddlOPTION_CATEGORY.SelectedValue = "DIRECT" Then
                    '            myTargetURL = myTargetURL & "TOTOKPI_PerformanceAppraisal_Direct"
                    '        End If

                    '        If ddlOPTION_CATEGORY.SelectedValue = "INDIRECT" Then
                    '            myTargetURL = myTargetURL & "TOTOKPI_PerformanceAppraisal_InDirect"
                    '        End If
                    '    End If
                    'Else
                    '    If ddlOPTION_CATEGORY.SelectedValue = "DIRECT" Then
    ...
    Private Function ValidatePrint(ByVal myds As DataSet) As Boolean
        ...
        ElseIf ddlOCP_ID_SECTION.SelectedValue = "" And ddlOCP_ID_SECTION.Items.Count > 1 Then
            ...
            Return False
        ElseIf ddlOPTION_CATEGORY.SelectedValue = "" Then
            lblresult2.Text = "[" & lblOPTION_CATEGORY.Text & "] Is A Required Field!"
            ddlOPTION_CATEGORY.Focus()
            Return False
        Else
            Return True
        End If
    ...
    Protected Sub blindDepartment()
        ssql1 = "Exec sp_KPI_rptFinalEvalaution '" & Session("EmpID").ToString & "','" & ddlOPTION_CATEGORY.SelectedValue & "','','','" & ddlYEAR.SelectedValue & "','BLINDDept'"
        myDS1 = New DataSet()
        myDS1 = mySQL.ExecuteSQL(ssql1)
    ...
    Protected Sub blindModel()
        ...
        ssql1 = "Exec sp_KPI_SelRptDropDownlist '" & Session("Company").ToString & "','" & Session("EmpID").ToString & "','" & ddlOPTION_CATEGORY.SelectedValue & "','" & ddlOCP_ID_DEPARTMENT.SelectedValue & "','" & ddlOCP_ID_SECTION.SelectedValue & "','','','','','','BLINDModel','" & ddlYEAR.SelectedValue & "'"
        myDS1 = New DataSet()
        myDS1 = mySQL.ExecuteSQL(ssql1)
        If myDS1.Tables.Count > 0 Then
    ...
    Protected Sub blindSection()
        ssql1 = "Exec sp_KPI_rptFinalEvalaution '" & Session("EmpID").ToString & "','" & ddlOPTION_CATEGORY.SelectedValue & "','','','" & ddlYEAR.SelectedValue & "','BLINDSect'"
        myDS1 = New DataSet()
        myDS1 = mySQL.ExecuteSQL(ssql1)
        If myDS1.Tables.Count > 0 Then
    ...
    Protected Sub blindCategory()
        ssql1 = "Exec sp_KPI_rptFinalEvalaution '" & Session("EmpID").ToString & "','','','','" & ddlYEAR.SelectedValue & "','BlindDirect'"
        myDS1 = New DataSet()
        myDS1 = mySQL.ExecuteSQL(ssql1)
        If myDS1.Tables.Count > 0 Then
    ...
    Protected Sub ddlOCP_ID_DEPARTMENT_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ddlOCP_ID_DEPARTMENT.SelectedIndexChanged
        ...
        ssql1 = "Exec sp_KPI_rptFinalEvalaution '" & Session("EmpID").ToString & "','" & ddlOPTION_CATEGORY.SelectedValue & "','" & ddlOCP_ID_DEPARTMENT.SelectedValue & "','','" & ddlYEAR.SelectedValue & "','BLINDSect'"
        myDS1 = New DataSet()
        myDS1 = mySQL.ExecuteSQL(ssql1)
        If myDS1.Tables.Count > 0 Then
            ddlOCP_ID_SECTION.DataSource = myDS1.Tables(0)
    ...
    Protected Sub ddlOCP_ID_SECTION_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ddlOCP_ID_SECTION.SelectedIndexChanged
        ssql1 = "Exec sp_KPI_rptFinalEvalaution '" & Session("EmpID").ToString & "','" & ddlOPTION_CATEGORY.SelectedValue & "','','" & ddlOCP_ID_SECTION.SelectedValue & "','" & ddlYEAR.SelectedValue & "','BLINDDept'"
        myDS1 = New DataSet()
        myDS1 = mySQL.ExecuteSQL(ssql1)
        If myDS1.Tables.Count > 0 Then
            ddlOCP_ID_DEPARTMENT.DataSource = myDS1.Tables(0)
    ...
    Protected Sub ddlOPTION_CATEGORY_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ddlOPTION_CATEGORY.SelectedIndexChanged
        Dim department As String, sectiong As String
        department = ddlOCP_ID_DEPARTMENT.SelectedValue
        sectiong = ddlOCP_ID_SECTION.SelectedValue
        blindDepartment()
        'ddlOCP_ID_DEPARTMENT.SelectedValue = department
    End Sub
    ...
    Protected Sub imgBtnEMPLOYEE_PROFILE_ID2_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnEMPLOYEE_PROFILE_ID2.Click
        ssql1 = "Exec sp_KPI_rptFinalEvalaution '" & Session("EmpID").ToString & "','" & ddlOPTION_CATEGORY.SelectedValue & "','" & ddlOCP_ID_DEPARTMENT.SelectedValue & "','" & ddlOCP_ID_SECTION.SelectedValue & "','" & ddlYEAR.SelectedValue & "','BlindEmpList'"
        myDS1 = New DataSet()
        myDS1 = mySQL.ExecuteSQL(ssql1)
        If myDS1.Tables(0).Rows.Count > 0 Then
            lstleft.DataSource = myDS1.Tables(0)
