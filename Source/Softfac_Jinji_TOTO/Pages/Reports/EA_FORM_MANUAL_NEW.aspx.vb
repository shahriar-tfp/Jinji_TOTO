...
Partial Class PAGES_REPORTS_EA_FORM_MANUAL_NEW
...
#Region "Panel Edit"
    Protected Sub imgBtnSubmit_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnSubmit.Click
        lblresult2.Text = ""
        Try
            ssql = "select dbo.fn_ReturnCompanyProfileCode(N'" & txtCOMPANY_PROFILE_CODE.Text & "'),dbo.fn_ReturnEmpIDByCodeName('" & Session("Company") & "','" & txtEMPLOYEE_PROFILE_ID.Text & "')"
            myDS = New DataSet()
            myDS = mySQL.ExecuteSQL(ssql)
            If ValidateAutoFill(myDS) Then
                ...
                txtCAR_MODEL.Text & "','" & txtHOUSE_ADDRESS.Text & "','" & ddlOPTION_BLOCK.SelectedValue & "'"
