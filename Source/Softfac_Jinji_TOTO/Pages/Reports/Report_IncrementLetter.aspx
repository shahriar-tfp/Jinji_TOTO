<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Report_IncrementLetter.aspx.vb" Inherits="Pages_Reports_Report_IncrementLetter" %>
...
<body>
    <form id="Report_incrementletter" runat="server">
    <div>
