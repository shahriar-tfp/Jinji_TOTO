<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Report_Attendance_Summary.aspx.vb" Inherits="Pages_Reports_Report_Attendance_Summary" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>JINJI : Report - Attendance Summary Page</title>
    <link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body>
    <form id="Report_Attendance_Summary" runat="server">
    <div>
    ...
    <asp:ImageButton ID="imgKeyOPTION_CITIZENSHIP" runat="server" Width="21px" Height="21px"/>
    <asp:Label ID="lblOPTION_CITIZENSHIP" runat="server" Width="120px"></asp:Label>
    <asp:DropDownList ID="ddlOPTION_CITIZENSHIP" runat="server" Width="157px"></asp:DropDownList>
    <asp:ImageButton ID="imgbtnOPTION_CITIZENSHIP" runat="server" Width="21px" Height="21px"/>
