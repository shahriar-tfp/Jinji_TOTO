<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Report_Appraisal_Letter.aspx.vb" Inherits="Pages_Reports_Report_Appraisal_Letter" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>JINJI : Report - Appraisal Letter Page</title>
    <link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body>
    <form id="Report_Appraisal_Letter" runat="server">
    <div>
    ...
    <asp:ImageButton ID="imgKeyOPTION_APPRAISALPERIOD" runat="server" Width="21px" Height="21px"/>
    <asp:Label ID="lblOPTION_APPRAISALPERIOD" runat="server" Width="120px"></asp:Label>
    <asp:Dropdownlist ID="ddlOPTION_APPRAISALPERIOD" runat="server" Width="150px"></asp:Dropdownlist>
    <asp:ImageButton ID="imgbtnOPTION_APPRAISALPERIOD" runat="server" Width="21px" Height="21px"/>
    ...
    <asp:DropDownList ID="ddlOPTION_REPORT" runat="server" Width="150px"></asp:DropDownList>
