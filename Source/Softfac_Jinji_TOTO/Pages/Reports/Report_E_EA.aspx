<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Report_E_EA.aspx.vb" Inherits="Pages_Reports_Report_E_EA" %>
...
<body>
    <form id="Report_E_EA" runat="server">
    <div>
    ...
    <asp:ImageButton ID="imgKeyBONUS1" runat="server" Width="21px" Height="21px"/>
    <asp:Label ID="lblBONUS1" runat="server" Width="120px"></asp:Label>
    <asp:TextBox ID="txtBONUS1" runat="server" Width="150px"></asp:TextBox>
    <asp:ImageButton ID="imgbtnBONUS1" runat="server" Width="21px" Height="21px"/>
    
    <asp:ImageButton ID="imgKeyBONUS2" runat="server" Width="21px" Height="21px"/>
    <asp:Label ID="lblBONUS2" runat="server" Width="120px"></asp:Label>
    <asp:TextBox ID="txtBONUS2" runat="server" Width="150px"></asp:TextBox>
    <asp:ImageButton ID="imgbtnBONUS2" runat="server" Width="21px" Height="21px"/>
