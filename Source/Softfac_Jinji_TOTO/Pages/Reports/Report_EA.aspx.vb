        ...
        End If
            ...
            If ValidatePrint(myDS) = True Then
                ...
                For k = 0 To itemCount - 1
                    ssql1 = "exec sp_pr_InsDelTempEAForm '" & ddlOPTION_GROUP.SelectedValue & "','" & myDS.Tables(0).Rows(0).Item(0).ToString & "','" & lstright.Items(k).Value & "','" & myDS.Tables(0).Rows(0).Item(1).ToString & "','" & myDS.Tables(0).Rows(0).Item(2).ToString & "'"
                    myDS1 = New DataSet()
                    myDS1 = mySQL.ExecuteSQL(ssql1)
                    myDS1 = Nothing
                    ssql1 = Nothing
