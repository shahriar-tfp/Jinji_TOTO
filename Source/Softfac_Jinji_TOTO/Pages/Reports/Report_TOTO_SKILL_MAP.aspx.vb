...
Partial Class Pages_Reports_Report_TOTO_SKILL_MAP
            ...
            If ValidatePrint(myDS) = True Then
                If myDS.Tables(0).Rows.Count = 1 Then
                    ...
                    myTargetURL = myTargetURL & "&Company_Profile_Code=" & Session("Company").ToString & "&SPID=" & spid & "&Year=" & ddlYEAR.SelectedValue & _
                     "&User_Profile_Code=" & Session("EmpID").ToString & "&ByType=" & ddlOPTION_GROUP.SelectedValue & "&rdTemplate=TOTOKPI_SkillMap"
