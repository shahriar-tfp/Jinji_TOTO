<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Report_Medical_Balance.aspx.vb" Inherits="Pages_Reports_Report_Medical_Balance" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>Report Medical Balance</title>
    <link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body>
    <form id="Report_Medical_Balance" runat="server">
    <div>
    ...
    <asp:DropDownList ID="ddlOPTION_YEAR" runat="server" Width="157px"></asp:DropDownList>
