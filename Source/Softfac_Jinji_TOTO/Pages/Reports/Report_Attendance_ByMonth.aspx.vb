...
Partial Class Pages_Reports_Report_Attendance_ByMonth
            ...
            If myDT2.Rows.Count > 0 Then
                ...
                If myDS5.Tables.Count > 0 Then
                    If myDS5.Tables(0).Columns.Count > 1 Then
                        ...
                        ddlOPTION_YEAR.SelectedValue = Year(Now())
                    End If
                End If
                myDS5 = Nothing
            End If
...
#End Region
    ...
    Protected Sub imgBtnPrint_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnPrint.Click
        Try
            ...
            ssql = "select dbo.fn_ReturnCompanyProfileCode(N'" & txtCOMPANY_PROFILE_CODE.Text & "'),'" & ddlOPTION_MONTH.Text & "','" & ddlOPTION_YEAR.Text & "',@@spid"
            myDS = New DataSet()
            ...
            If ValidatePrint(myDS) = True Then
                If myDS.Tables(0).Rows.Count = 1 Then
                    ...
                    For k = 0 To itemCount - 1
                        ...
                        ssql1 = Nothing
                    Next
                    myTargetURL = myTargetURL & "&Company_Profile_Code=" & Session("Company").ToString & "&spid=" & spid & "&Month=" & myDS.Tables(0).Rows(0).Item(1).ToString & "&Year=" & myDS.Tables(0).Rows(0).Item(2).ToString & "&User_Profile_Code=" & Session("EmpID").ToString & "&By_type=" & ddlOPTION_GROUP.SelectedValue & "&rdTemplate=" & ddlOPTION_TYPE.SelectedValue
    ...
    Private Function ValidatePrint(ByVal myds As DataSet) As Boolean
        If myds.Tables(0).Rows(0).Item(0).ToString = "" Then
            ...
            Return False
        ElseIf ddlOPTION_MONTH.SelectedValue = "" Then
