...
Partial Class Pages_Reports_Report_Monthly_Advance
...
#End Region
    ...
    Protected Sub imgBtnPrint_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnPrint.Click
        ...
        If ValidatePrint() = True Then
            myTargetURL = myTargetURL & "&Company_Profile_Code=" & Session("Company").ToString & "&Month=" & ddlOPTION_MONTH.SelectedValue & "&Year=" & ddlOPTION_YEAR.SelectedValue & "&Option_Pay_Cycle=" & ddlOPTION_PAY_CYCLE.SelectedValue & "&UserID=" & Session("EmpID").ToString & "&OCP_ID_Salary=" & txtOCP_ID_Salary.Text & "&rdTemplate=Monthly_Advance"
    ...
    Private Function ValidatePrint() As Boolean
        If ddlOPTION_PAY_CYCLE.SelectedValue = "" Then
