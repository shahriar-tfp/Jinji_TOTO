...
Partial Class Pages_Reports_Report_TOTO_SKILL
    ...
    Sub AutoAdjustPosition(ByVal strSelect As String)
        ...
        If myDS.Tables(0).Rows.Count > 0 Then
            For i = 0 To myDS.Tables(0).Rows.Count - 1
                ...
                If UCase(myDS.Tables(0).Rows(i).Item(1).ToString) = "LEVEL" Then
                    If lblLEVEL.Visible = True And ddlLEVEL.Visible = True Then
                        autonum += 1
                        imgKeyLEVEL.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        imgKeyLEVEL.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        imgKeyLEVEL.Style.Add("position", "absolute")
                        autonum += 1
                        lblLEVEL.CssClass = "wordstyle12"
                        lblLEVEL.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        lblLEVEL.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        lblLEVEL.Style.Add("position", "absolute")
                        autonum += 1
                        ddlLEVEL.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        ddlLEVEL.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        ddlLEVEL.Style.Add("position", "absolute")
                        ddlLEVEL.Width = ddlWidth
                        autonum += 1
                        imgbtnLEVEL.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        imgbtnLEVEL.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        imgbtnLEVEL.Style.Add("position", "absolute")
                    End If
                End If
...
#End Region
        ...
        Try
            ...
            If ValidatePrint(myDS) = True Then
                If myDS.Tables(0).Rows.Count = 1 Then
                    ...
                    myTargetURL = myTargetURL & "&Company_Profile_Code=" & Session("Company").ToString & "&User_Profile_Code=" & Session("EmpID").ToString & "&Year=" & ddlYEAR.SelectedValue & _
                     ...
                     "&Level=" & ddlLEVEL.SelectedValue & "&rdTemplate=" & ddlOPTION_REPORT.SelectedValue
    ...
    Private Function ValidatePrint(ByVal myds As DataSet) As Boolean
        ...
        ElseIf ddlOPTION_CATEGORY.SelectedValue = "" Then
            ...
            Return False
        ElseIf ddlLEVEL.SelectedValue = "" Then
            lblresult2.Text = "[" & lblLEVEL.Text & "] Is A Required Field!"
            ddlLEVEL.Focus()
            Return False
        ElseIf ddlOPTION_REPORT.SelectedValue = "" Then
