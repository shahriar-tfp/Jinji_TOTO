<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Report_Leave_Balance.aspx.vb" Inherits="Pages_Reports_Report_Leave_Balance" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>Report Leave Balance</title>
    <link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body>
    <form id="Report_Leave_Balance" runat="server">
    <div>
    ...
    <asp:ImageButton ID="imgKeyOCP_ID_LEAVE" runat="server" Width="21px" Height="21px"/>
    <asp:Label ID="lblOCP_ID_LEAVE" runat="server" Width="120px"></asp:Label>
    <asp:TextBox ID="txtOCP_ID_LEAVE" runat="server" Width="150px"></asp:TextBox>
    <asp:ImageButton ID="imgbtnOCP_ID_LEAVE" runat="server" Width="21px" Height="21px"/>
