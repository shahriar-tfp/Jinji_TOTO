...
Partial Class Pages_Reports_Report_Appraisal_Master
...
#End Region
    ...
    Private Sub PagePreload()
        ...
        mySetting.GetImgUrl(imgKeyOPTION_APPRAISALPERIOD, clsGlobalSetting.ImageType._KEY, Session("Company").ToString)
        mySetting.GetImgUrl(imgKeyCOMPANY_PROFILE_CODE, clsGlobalSetting.ImageType._KEY, Session("Company").ToString)
        mySetting.GetImgUrl(imgbtnOPTION_APPRAISALPERIOD, clsGlobalSetting.ImageType._DATE, Session("Company").ToString)
    ...
    Protected Sub imgBtnPrint_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnPrint.Click
        ...
        If ValidatePrint(myDS) = True Then
            If myDS.Tables(0).Rows.Count = 1 Then
                myTargetURL = myTargetURL & "&Company_Profile_Code=" & myDS.Tables(0).Rows(0).Item(0).ToString & "&User_Profile_Code=" & Session("EmpID").ToString & "&Period=" & ddlOPTION_APPRAISALPERIOD.SelectedValue & "&rdTemplate=AppraisalMasterReport"
