<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Report_CP22A_Set.aspx.vb" Inherits="Pages_Reports_Report_CP22A_Set" %>
...
<body>
    <form id="Report_CP22A_Set" runat="server">
    <div>
    ...
    <asp:ImageButton ID="imgKeyOPTION_FIELD" runat="server" Width="21px" Height="21px"/>
    <asp:Label ID="lblOPTION_FIELD" runat="server" Width="120px"></asp:Label>
    <asp:DropDownList ID="ddlOPTION_FIELD" runat="server" Width="157px"></asp:DropDownList>
    <asp:ImageButton ID="imgbtnOPTION_FIELD" runat="server" Width="21px" Height="21px"/>
    
    <asp:ImageButton ID="imgKeyOPTION_CATEGORIZE" runat="server" Width="21px" Height="21px"/>
    <asp:Label ID="lblOPTION_CATEGORIZE" runat="server" Width="120px"></asp:Label>
    <asp:DropDownList ID="ddlOPTION_CATEGORIZE" runat="server" Width="157px"></asp:DropDownList>
    <asp:ImageButton ID="imgbtnOPTION_CATEGORIZE" runat="server" Width="21px" Height="21px"/>
