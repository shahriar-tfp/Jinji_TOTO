<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RPT_Pivotable_ANALYSIS_PAYROLL.aspx.vb" Inherits="PAGES_REPORTS_RPT_PIVOTABLE_ANALYSIS_PAYROLL" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>JINJI : Report - Pivotable Analysis Payroll</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server"> 
<form id="RPT_PIVOTABLE_ANALYSIS_PAYROLL" runat="server">
<div>
...
<!--// 5 //-->
<asp:imagebutton id="imgKeySHAREPOINT_NAME" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblSHAREPOINT_NAME" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtSHAREPOINT_NAME" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnSHAREPOINT_NAME" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 6 //-->
<asp:imagebutton id="imgKeyLINK_FOLDER" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblLINK_FOLDER" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtLINK_FOLDER" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnLINK_FOLDER" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
					...
					<tr>
						...
						<table id="Table6" cellspacing="0" cellpadding="0" width="100%" border="0" runat="server">
					        ...
					        <table id="Table90" cellspacing="0" cellpadding="0" border="0" runat="server">
					            <tr>
					                <td style ="height:15px"><asp:label id="lblMonth" runat="server" Width="140px" text="Month"></asp:label><asp:dropdownlist id="ddlMonth" runat="server" Width="150px" ></asp:dropdownlist></td>
					                <td style ="height:15px"> &nbsp;</td>
					                <td style ="height:15px"><asp:label id="lblYear" runat="server" Width="140px" text="Year"></asp:label><asp:dropdownlist id="ddlYear" runat="server" Width="150px" ></asp:dropdownlist></td>
					            </tr>
					        </table>
					        <table id="Table91" cellspacing="0" cellpadding="0" border="0" runat="server">
					            <tr>
					                <td style ="height:15px"></td>
					            </tr>
					        </table>
											...
											<table cellspacing="0" cellpadding="0" border="0">
												...
												<tr>
												    ...
												    <td align="left">
														...
														<asp:imagebutton id="imgBtnPrintReport" runat="server" Height="21px" Width="74px"></asp:imagebutton>
													</td>
													<td align="left">
