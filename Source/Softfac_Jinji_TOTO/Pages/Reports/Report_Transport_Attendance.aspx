<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Report_Transport_Attendance.aspx.vb" Inherits="Pages_Reports_Report_Transport_Attendance" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>JINJI : Report - Transport Attendance Page</title>
    <link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body>
    <form id="Report_Transport_Attendance" runat="server">
    <div>
    ...
    <asp:ImageButton ID="imgKeyMONTH" runat="server" Width="21px" Height="21px"/>
    <asp:Label ID="lblMONTH" runat="server" Width="120px"></asp:Label>
    <asp:DropDownList ID="ddlMONTH" runat="server" Width="150px"></asp:DropDownList>
    <asp:ImageButton ID="imgbtnMONTH" runat="server" Width="21px" Height="21px"/>
