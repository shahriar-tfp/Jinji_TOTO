<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Report_OvertimeForm.aspx.vb" Inherits="Pages_Reports_Report_OvertimeForm" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>JINJI : Report - Overtime Form Page</title>
    <link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body>
    <form id="Report_OvertimeForm" runat="server">
    <div>
    ...
    <asp:ImageButton ID="imgkeyFORMID" runat="server" Width="21px" Height="21px"/>
    <asp:Label ID="lblFORMID" runat="server" Width="120px"></asp:Label>
    <asp:DropDownList ID="ddlFORMID" runat="server" Width="150px" AutoPostBack="true" ></asp:DropDownList>
    <asp:ImageButton ID="imgbtnFORMID" runat="server" Width="21px" Height="21px"/>
