        ...
        Try
            ...
            If ValidatePrint(myDS) = True Then
                If myDS.Tables(0).Rows.Count = 1 Then
                    ...
                    'Dim xtr As New System.Xml.XmlTextReader(Server.MapPath("~") & "\_Templates\Ar\payslip_p_section.rpx")
                    Dim xtr As New System.Xml.XmlTextReader(Server.MapPath("~") & "\_Templates\Ar\pr_Payslip2.rpx")

                    If ddlOPTION_REPORT.SelectedValue = "PAYSLIP" Then
                        'ssql = "exec sp_pr_RptCusPayslip_Unisem '" & myDS.Tables(0).Rows(0).Item(0).ToString & "','" & myDS.Tables(0).Rows(0).Item(1).ToString & "','" & myDS.Tables(0).Rows(0).Item(2).ToString & "','" & myDS.Tables(0).Rows(0).Item(3).ToString & "','" & ddlOPTION_PAY_TYPE.SelectedValue & "','" & ddlOPTION_PAY_MODE.SelectedValue & "','" & ddlOPTION_GROUP.SelectedValue & "','" & Session("EmpID").ToString & "','" & ddlOPTION_PAY_CYCLE.SelectedValue & "'"
                        'ssql = "exec sp_pr_rptcuspayslip_kajima '" & myDS.Tables(0).Rows(0).Item(0).ToString & "','" & myDS.Tables(0).Rows(0).Item(1).ToString & "','" & myDS.Tables(0).Rows(0).Item(2).ToString & "','" & myDS.Tables(0).Rows(0).Item(3).ToString & "','" & ddlOPTION_PAY_TYPE.SelectedValue & "','" & ddlOPTION_PAY_MODE.SelectedValue & "','" & ddlOPTION_GROUP.SelectedValue & "','" & Session("EmpID").ToString & "','" & ddlOPTION_PAY_CYCLE.SelectedValue & "'"
                        ssql = "exec sp_pr_rptcuspayslip_kajima '" & myDS.Tables(0).Rows(0).Item(0).ToString & "','" & myDS.Tables(0).Rows(0).Item(1).ToString & "','" & myDS.Tables(0).Rows(0).Item(2).ToString & "','" & myDS.Tables(0).Rows(0).Item(3).ToString & "','" & ddlOPTION_PAY_TYPE.SelectedValue & "','" & ddlOPTION_PAY_MODE.SelectedValue & "','" & ddlOPTION_GROUP.SelectedValue & "','" & Session("EmpID").ToString & "','" & ddlOPTION_PAY_CYCLE.SelectedValue & "'"
                    ElseIf ddlOPTION_REPORT.SelectedValue = "ADV" Then
                        'ssql = "exec sp_pr_RptCusPayslip_Unisem '" & myDS.Tables(0).Rows(0).Item(0).ToString & "','" & myDS.Tables(0).Rows(0).Item(1).ToString & "','" & myDS.Tables(0).Rows(0).Item(2).ToString & "','" & myDS.Tables(0).Rows(0).Item(3).ToString & "','" & ddlOPTION_PAY_TYPE.SelectedValue & "','" & ddlOPTION_PAY_MODE.SelectedValue & "','" & ddlOPTION_GROUP.SelectedValue & "','" & Session("EmpID").ToString & "','" & ddlOPTION_PAY_CYCLE.SelectedValue & "'"
                        ssql = "exec sp_pr_rptcuspayslip_kajima '" & myDS.Tables(0).Rows(0).Item(0).ToString & "','" & myDS.Tables(0).Rows(0).Item(1).ToString & "','" & myDS.Tables(0).Rows(0).Item(2).ToString & "','" & myDS.Tables(0).Rows(0).Item(3).ToString & "','" & ddlOPTION_PAY_TYPE.SelectedValue & "','" & ddlOPTION_PAY_MODE.SelectedValue & "','" & ddlOPTION_GROUP.SelectedValue & "','" & Session("EmpID").ToString & "','" & ddlOPTION_PAY_CYCLE.SelectedValue & "'"
                    ...
                    Else
                        'ssql = "exec sp_pr_RptCusPayslip_Unisem '" & myDS.Tables(0).Rows(0).Item(0).ToString & "','" & myDS.Tables(0).Rows(0).Item(1).ToString & "','" & myDS.Tables(0).Rows(0).Item(2).ToString & "','" & myDS.Tables(0).Rows(0).Item(3).ToString & "','" & ddlOPTION_PAY_TYPE.SelectedValue & "','" & ddlOPTION_PAY_MODE.SelectedValue & "','" & ddlOPTION_GROUP.SelectedValue & "','" & Session("EmpID").ToString & "','" & ddlOPTION_PAY_CYCLE.SelectedValue & "'
                        ssql = "exec sp_pr_RptCusEPayslip_Kajima '" & myDS.Tables(0).Rows(0).Item(0).ToString & "','" & myDS.Tables(0).Rows(0).Item(1).ToString & "','" & myDS.Tables(0).Rows(0).Item(2).ToString & "','" & myDS.Tables(0).Rows(0).Item(3).ToString & "','" & ddlOPTION_PAY_TYPE.SelectedValue & "','" & ddlOPTION_PAY_MODE.SelectedValue & "','" & ddlOPTION_GROUP.SelectedValue & "','" & Session("EmpID").ToString & "','" & ddlOPTION_PAY_CYCLE.SelectedValue & "'"
                    End If
                    ...
                    '        Response.Write("<script>window.open('../../ReportViewer.aspx');</script>")
                End If
                End If
                ssql = Nothing
                myDS = Nothing
                ...
                'ssql = "insert into Report_Control_Temp "
                'ssql &= "select '500','1000','1','rwem' union "
                'ssql &= "select '500','1001','1','rwem' union "
                'ssql &= "select '500','1002','1','rwem' union "
                'ssql &= "select '500','1003','1','rwem' union "
                'ssql &= "select '500','1004','1','rwem' "
