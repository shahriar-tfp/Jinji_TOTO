<%@ Page Language="VB" AutoEventWireup="false" CodeFile="REPORT_PAYCASHDENO.aspx.vb" Inherits="Pages_Reports_REPORT_PAYCASHDENO" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>JINJI : Report - CASH DENOMINATION Page</title>
    <link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body>
    <form id="REPORT_PAYCASHDENO" runat="server">
    <div>
    ...
    <asp:ImageButton ID="imgbtnOPTION_REPORT" runat="server" Width="21px" Height="21px"/>
     ...
     <asp:ImageButton ID="imgKeyOPTION_NEGATIVE" runat="server" Width="21px" Height="21px"/>
    <asp:Label ID="lblOPTION_NEGATIVE" runat="server" Width="120px"></asp:Label>
    <asp:DropDownList ID="ddlOPTION_NEGATIVE" runat="server" Width="157px"></asp:DropDownList>
    <asp:ImageButton ID="imgbtnOPTION_NEGATIVE" runat="server" Width="21px" Height="21px"/>
    
    <asp:ImageButton ID="imgKeyPROCESS_DATE" runat="server" Width="21px" Height="21px"/>
    <asp:Label ID="lblPROCESS_DATE" runat="server" Width="120px"></asp:Label>
    <asp:TextBox ID="txtPROCESS_DATE" runat="server" Width="150px"></asp:TextBox>
    <asp:ImageButton ID="imgbtnPROCESS_DATE" runat="server" Width="21px" Height="21px"/>
