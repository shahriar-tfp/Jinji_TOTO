<%@ Page Language="VB" AutoEventWireup="false" CodeFile="SUCCESSOR_PLAN_PROFILE.aspx.vb" Inherits="PAGES_MBO_SUCCESSOR_PLAN_PROFILE" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>SUCCESSOR_PLAN_PORFILE</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server"> 
<form id="SUCCESSOR_PLAN_PORFILE" runat="server">
<div>
...
<!--// 4 //-->
<asp:imagebutton id="imgKeyDATEFORM" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblDATEFORM" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtDATEFORM" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnDATEFORM" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 5 //-->
<asp:imagebutton id="imgKeyDATETO" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblDATETO" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtDATETO" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnDATETO" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
