...
Partial Class PAGES_ELMS_UNI_TRAININGATTEND
                            ...
                            If mySetting.CheckTextNullAndReplaceSingleQuote(myTextBox) = True Then
                                ...
                                Else
                                    ...
                                    If myDST.Tables(0).Rows.Count > 0 Then
                                        ...
                                        ElseIf myDST.Tables(0).Rows(0).Item(1).ToString.Trim = "" And myDST.Tables(0).Rows(0).Item(2).ToString.Trim <> "" Then
                                            ssql2 = ssql2 & "ISNULL(" & myDST.Tables(0).Rows(0).Item(0).ToString & "(N'" & myTextBox.Text.ToString & "',N'" & Session("Company") & "'),''),"
                                        Else
                                        ...
                                        If myDS.Tables(0).Rows(i).Item(6).ToString = "YES" Then
                                            ...
                                            ElseIf myDST.Tables(0).Rows(0).Item(1).ToString.Trim = "" And myDST.Tables(0).Rows(0).Item(2).ToString.Trim <> "" Then
                                                ssql3 = ssql3 & myDS.Tables(0).Rows(i).Item(0) & "=ISNULL(" & myDST.Tables(0).Rows(0).Item(0).ToString & "(N'" & myTextBox.Text.ToString & "',N'" & Session("Company") & "'),0) And "
                                            Else
                                    ...
                                    Else
                                        ...
                                        If myDST2.Tables(0).Rows.Count > 0 Then
                                           'Edit Default Value2'
                                            ...
                                            ElseIf myDST2.Tables(0).Rows(0).Item(1).ToString.Trim = "" And myDST2.Tables(0).Rows(0).Item(2).ToString.Trim <> "" Then
                                                ssql = ssql & myDS2.Tables(0).Rows(i).Item(0) & "=ISNULL(" & myDST2.Tables(0).Rows(0).Item(0).ToString & "(N'" & myTextBox.Text.ToString & "',N'" & Session("Company") & "'),'') And "
                                            Else
