<%@ Page Language="VB" AutoEventWireup="false" CodeFile="UNI_TRAININGATTEND.aspx.vb" Inherits="PAGES_ELMS_UNI_TRAININGATTEND" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>UNI_TRAININGATTEND</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server"> 
<form id="UNI_TRAININGATTEND" runat="server">
<div>
...
<!--// 3 //-->
<asp:imagebutton id="imgKeyCOURSE_TITLE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblCOURSE_TITLE" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtCOURSE_TITLE" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnCOURSE_TITLE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 4 //-->
<asp:imagebutton id="imgKeyCOURSE_STARTDATE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblCOURSE_STARTDATE" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtCOURSE_STARTDATE" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnCOURSE_STARTDATE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 5 //-->
<asp:imagebutton id="imgKeyOPERATION" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblOPERATION" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtOPERATION" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnOPERATION" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 6 //-->
<asp:imagebutton id="imgKeyCOURSE_ENDDATE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblCOURSE_ENDDATE" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtCOURSE_ENDDATE" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnCOURSE_ENDDATE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 7 //-->
<asp:imagebutton id="imgKeyCERT_DATE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblCERT_DATE" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtCERT_DATE" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnCERT_DATE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 8 //-->
<asp:imagebutton id="imgKeyTRAINING_HOUR" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblTRAINING_HOUR" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtTRAINING_HOUR" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnTRAINING_HOUR" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 9 //-->
<asp:imagebutton id="imgKeyVALIDATION_PERIOD" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblVALIDATION_PERIOD" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtVALIDATION_PERIOD" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnVALIDATION_PERIOD" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 10 //-->
<asp:imagebutton id="imgKeyTRAINNING_PROVIDER" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblTRAINNING_PROVIDER" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtTRAINNING_PROVIDER" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnTRAINNING_PROVIDER" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 11 //-->
<asp:imagebutton id="imgKeyDECERT_DATE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblDECERT_DATE" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtDECERT_DATE" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnDECERT_DATE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 12 //-->
<asp:imagebutton id="imgKeyTRAINING_EXPENSE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblTRAINING_EXPENSE" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtTRAINING_EXPENSE" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnTRAINING_EXPENSE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
...
<!--// 14 //-->
<asp:imagebutton id="imgKeyBOND_EXPIRY_DATE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblBOND_EXPIRY_DATE" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtBOND_EXPIRY_DATE" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnBOND_EXPIRY_DATE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 15 //-->
<asp:imagebutton id="imgKeyQUALIFY_DATE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblQUALIFY_DATE" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtQUALIFY_DATE" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnQUALIFY_DATE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 16 //-->
<asp:imagebutton id="imgKeyBOND_DURATION" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblBOND_DURATION" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtBOND_DURATION" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnBOND_DURATION" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
