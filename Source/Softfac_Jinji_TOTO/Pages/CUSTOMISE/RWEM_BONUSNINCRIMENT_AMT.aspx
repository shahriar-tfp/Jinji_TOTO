<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RWEM_BONUSNINCRIMENT_AMT.aspx.vb" Inherits="PAGES_CUSTOMISE_RWEM_BONUSNINCRIMENT_AMT" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>RWEM_BONUSNINCRIMENT_AMT</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server"> 
<form id="RWEM_BONUSNINCRIMENT_AMT" runat="server">
<div>
...
<!--// 2 //-->
<asp:imagebutton id="imgKeyAPPRAISAL_PERIOD" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblAPPRAISAL_PERIOD" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtAPPRAISAL_PERIOD" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnAPPRAISAL_PERIOD" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
