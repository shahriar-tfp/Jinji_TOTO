<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RWEM_PERFORMANCE_EVALUATION.aspx.vb" Inherits="PAGES_CUSTOMISE_RWEM_PERFORMANCE_EVALUATION" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>RWEM_PERFORMANCE_EVALUATION</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server"> 
<form id="RWEM_PERFORMANCE_EVALUATION" runat="server">
<div>
...
<!--// 3 //-->
<asp:imagebutton id="imgKeyEVALUATION_PERIOD" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblEVALUATION_PERIOD" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtEVALUATION_PERIOD" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnEVALUATION_PERIOD" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
...
<!--// 5 //-->
<asp:imagebutton id="imgKeyEVALUATION_POINT" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblEVALUATION_POINT" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtEVALUATION_POINT" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnEVALUATION_POINT" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
