<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RWEM_TRAINRECODE.aspx.vb" Inherits="PAGES_CUSTOMISE_RWEM_TRAINRECODE" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>RWEM_TRAINRECODE</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server"> 
<form id="RWEM_TRAINRECODE" runat="server">
<div>
...
<!--// 3 //-->
<asp:imagebutton id="imgKeyOPTION_TRAIN_TYPE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblOPTION_TRAIN_TYPE" runat="server" Width="140px" ></asp:label>
<asp:dropdownlist id="ddlOPTION_TRAIN_TYPE" runat="server" Width="150px" ></asp:dropdownlist>
<asp:imagebutton id="imgbtnOPTION_TRAIN_TYPE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 4 //-->
<asp:imagebutton id="imgKeyOPTION_TRAIN_CATEGORY" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblOPTION_TRAIN_CATEGORY" runat="server" Width="140px" ></asp:label>
<asp:dropdownlist id="ddlOPTION_TRAIN_CATEGORY" runat="server" Width="150px" ></asp:dropdownlist>
<asp:imagebutton id="imgbtnOPTION_TRAIN_CATEGORY" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 5 //-->
<asp:imagebutton id="imgKeyTRAIN_TITLE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblTRAIN_TITLE" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtTRAIN_TITLE" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnTRAIN_TITLE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 6 //-->
<asp:imagebutton id="imgKeyTRAIN_VENUE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblTRAIN_VENUE" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtTRAIN_VENUE" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnTRAIN_VENUE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
...
<!--// 8 //-->
<asp:imagebutton id="imgKeyEND_DATE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
...
<asp:imagebutton id="imgbtnEND_DATE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 9 //-->
<asp:imagebutton id="imgKeyTRAIN_PROVIDER" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblTRAIN_PROVIDER" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtTRAIN_PROVIDER" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnTRAIN_PROVIDER" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 10 //-->
<asp:imagebutton id="imgKeyTRAIN_OBJECTIVE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblTRAIN_OBJECTIVE" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtTRAIN_OBJECTIVE" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnTRAIN_OBJECTIVE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 11 //-->
<asp:imagebutton id="imgKeyEVALU_METHOD" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblEVALU_METHOD" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtEVALU_METHOD" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnEVALU_METHOD" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 12 //-->
<asp:imagebutton id="imgKeyEVALU_RESULT" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblEVALU_RESULT" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtEVALU_RESULT" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnEVALU_RESULT" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 13 //-->
<asp:imagebutton id="imgKeyCONFIRMATION" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblCONFIRMATION" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtCONFIRMATION" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnCONFIRMATION" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 14 //-->
<asp:imagebutton id="imgKeySOURCE_TRAIN" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblSOURCE_TRAIN" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtSOURCE_TRAIN" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnSOURCE_TRAIN" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 15 //-->
<asp:imagebutton id="imgKeyCOST" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblCOST" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtCOST" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnCOST" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
