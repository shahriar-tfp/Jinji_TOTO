<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RWEM_OT_APPLICATION.aspx.vb" Inherits="PAGES_CUSTOMISE_RWEM_OT_APPLICATION" %>
...
<form id="RWEM_OT_APPLICATION" runat="server">
<div>
...
<!--// 9 //-->
<asp:imagebutton id="imgKeyPRE_FROM_TIME" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblPRE_FROM_TIME" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtPRE_FROM_TIME" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnPRE_FROM_TIME" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 10 //-->
<asp:imagebutton id="imgKeyPRE_TO_TIME" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblPRE_TO_TIME" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtPRE_TO_TIME" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnPRE_TO_TIME" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 11 //-->
<asp:imagebutton id="imgKeyPRE_TOTAL" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblPRE_TOTAL" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtPRE_TOTAL" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnPRE_TOTAL" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 12 //-->
<asp:imagebutton id="imgKeyACTUAL_FROM_TIME" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblACTUAL_FROM_TIME" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtACTUAL_FROM_TIME" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnACTUAL_FROM_TIME" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 13 //-->
<asp:imagebutton id="imgKeyACTUAL_TO_TIME" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblACTUAL_TO_TIME" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtACTUAL_TO_TIME" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnACTUAL_TO_TIME" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 14 //-->
<asp:imagebutton id="imgKeyACTUAL_TOTAL" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblACTUAL_TOTAL" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtACTUAL_TOTAL" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnACTUAL_TOTAL" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
...
<asp:imagebutton id="imgbtnWORKING_HOUR" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
...
<asp:label id="lblAdjustPreFromTime" runat="server" Width="140px"></asp:label>
<asp:textbox id="txtAdjustPreFromTime" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnAdjustPreFromTime" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblAdjustPreToTime" runat="server" Width="140px"></asp:label>
<asp:textbox id="txtAdjustPreToTime" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnAdjustPreToTime" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblAdjustActFromTime" runat="server" Width="140px"></asp:label>
<asp:textbox id="txtAdjustActFromTime" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnAdjustActFromTime" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblAdjustActToTime" runat="server" Width="140px"></asp:label>
<asp:textbox id="txtAdjustActToTime" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnAdjustActToTime" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
