    ...
    Sub AutoAdjustPosition(ByVal strSelect As String)
        ...
        Try
            ...
            If pnlgridview1.Visible = True Then
                ...
                autonum2 = autonum2 + 26 + EditRowCount
                ...
                autonum2 = autonum2 + 1
                txtREASON.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum2, "X"))
                txtREASON.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum2, "Y"))
                ...
                labelPosition1 = labelPosition1 & autonum + 1 + rowCount + 3
...
#End Region
    ...
    Private Sub insupdOTForm()
        ...
        "'),''),isnull(dbo.fn_UnDisplayDatetime('" & txtAdjustPreFromTime.Text & "',dbo.fn_ReturnCompanyProfileCode(N'" & txtCOMPANY_PROFILE_CODE.Text & "'),'" & Session("Module").ToString & _
        "'),''),isnull(dbo.fn_UnDisplayDatetime('" & txtAdjustPreToTime.Text & "',dbo.fn_ReturnCompanyProfileCode(N'" & txtCOMPANY_PROFILE_CODE.Text & "'),'" & Session("Module").ToString & _
        "'),''),isnull(dbo.fn_UnDisplayDatetime('" & txtAdjustActFromTime.Text & "',dbo.fn_ReturnCompanyProfileCode(N'" & txtCOMPANY_PROFILE_CODE.Text & "'),'" & Session("Module").ToString & _
        "'),''),isnull(dbo.fn_UnDisplayDatetime('" & txtAdjustActToTime.Text & "',dbo.fn_ReturnCompanyProfileCode(N'" & txtCOMPANY_PROFILE_CODE.Text & "'),'" & Session("Module").ToString & _
        "'),''),'" & ddlOCP_ID_DIVISION.SelectedValue & "','" & ddlOCP_ID_DEPARTMENT.SelectedValue & "'," & _
        "isnull(dbo.fn_getOCPIDBYCODENAME('" & txtOCP_ID_TMS.Text & "','TMS'),''),isnull(dbo.fn_getOCPIDBYCODENAME('" & txtOCP_ID_SHIFT.Text & "','SHIFT'),'')," & _
        "isnull(dbo.fn_getOCPIDBYCODENAME('" & txtOCP_ID_DAY_TYPE.Text & "','DAY_TYPE'),'')"
            myDS = New DataSet()
            myDS = mySQL.ExecuteSQL(ssql)
            If ValidateForm2(myDS) Then
                For i = 0 To myGridView1.Rows.Count - 1
                    ...
                    If chkEdit.Checked Then
                        txtEMPLOYEE_PROFILE_ID.Text = Replace(Replace(Server.HtmlDecode(myGridview2.Rows(i).Cells(1).Text.ToString.Trim), "&nbsp;", "&"), "&amp;", "&")
                        txtWORKING_HOUR.Text = Replace(Replace(Server.HtmlDecode(myGridview2.Rows(i).Cells(2).Text.ToString.Trim), "&nbsp;", "&"), "&amp;", "&")

                        If txtWORKING_HOUR.Text < 60 Then
                            ssql = "exec sp_tms_insupddelOTApplication """ & myDS.Tables(0).Rows(0).Item(0).ToString & """,""" & txtFORMID.Text & """,""" & txtEMPLOYEE_PROFILE_ID.Text & """,""" & _
                            myDS.Tables(0).Rows(0).Item(1).ToString & """,""" & myDS.Tables(0).Rows(0).Item(6).ToString & """,""" & myDS.Tables(0).Rows(0).Item(7).ToString & """,""" & myDS.Tables(0).Rows(0).Item(8).ToString & """,""" & _
                            myDS.Tables(0).Rows(0).Item(9).ToString & """,""" & myDS.Tables(0).Rows(0).Item(10).ToString & """,""" & myDS.Tables(0).Rows(0).Item(2).ToString & """,""" & myDS.Tables(0).Rows(0).Item(3).ToString & """,""" & _
                            myDS.Tables(0).Rows(0).Item(4).ToString & """,""" & myDS.Tables(0).Rows(0).Item(5).ToString & """,""" & txtWORKING_HOUR.Text & """,""" & txtREASON.Text & """,'ADD'"
    ...
    Private Function ValidateForm2(ByVal myds As DataSet) As Boolean
        ...
        ElseIf myDS.Tables(0).Rows(0).Item(1).ToString = "" Then
            ...
            txtDATE.Focus()
            Return False
        ElseIf (myDS.Tables(0).Rows(0).Item(2).ToString = "" Or myDS.Tables(0).Rows(0).Item(3).ToString = "") Then
            lblresult2.Text = "Pre-Approve Time Is A Required Field!."
            txtAdjustPreFromTime.Focus()
            Return False
        ElseIf IsNumeric(myDS.Tables(0).Rows(0).Item(2).ToString) = False Then
            lblresult2.Text = "Invalid Input Date Format For [" & lblAdjustPreFromTime.Text & "] !"
            txtAdjustPreFromTime.Focus()
            Return False
        ElseIf IsNumeric(myDS.Tables(0).Rows(0).Item(3).ToString) = False Then
            lblresult2.Text = "Invalid Input Date Format For [" & lblAdjustPreToTime.Text & "] !"
            txtAdjustPreToTime.Focus()
            Return False
        ElseIf IsNumeric(myds.Tables(0).Rows(0).Item(4).ToString) = False And txtAdjustActFromTime.Text <> "" Then
            lblresult2.Text = "Invalid Input Date Format For [" & lblAdjustActFromTime.Text & "] !"
            txtAdjustActFromTime.Focus()
            Return False
        ElseIf IsNumeric(myds.Tables(0).Rows(0).Item(5).ToString) = False And txtAdjustActFromTime.Text <> "" Then
            lblresult2.Text = "Invalid Input Date Format For [" & lblAdjustActToTime.Text & "] !"
            txtAdjustActToTime.Focus()
            Return False
        ...
        ElseIf myds.Tables(0).Rows(0).Item(8).ToString = "" Then
            ...
            txtOCP_ID_TMS.Focus()
            Return False
        ElseIf myds.Tables(0).Rows(0).Item(9).ToString = "" Then
            lblresult2.Text = "[" & lblOCP_ID_SHIFT.Text & "] Is A Required Field!"
            txtOCP_ID_SHIFT.Focus()
            Return False
        ElseIf myds.Tables(0).Rows(0).Item(10).ToString = "" Then
            lblresult2.Text = "[" & lblOCP_ID_DAY_TYPE.Text & "] Is A Required Field!"
            txtOCP_ID_DAY_TYPE.Focus()
            Return False
        End If
