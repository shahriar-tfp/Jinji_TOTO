<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Employee_Payroll_Header.aspx.vb" Inherits="Pages_Payroll_Employee_Payroll_Header" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>JINJI : Payroll - Employee Payroll Header Page</title>
    <link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server">
    <form id="Employee_Payroll_Header" runat="server">
<div>
    ...
    <!--// 8 //-->
    <asp:imagebutton id="imgKeyHRP_RATE" runat="server" Width="21px" Height="21px"></asp:imagebutton>
    <asp:label id="lblHRP_RATE" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtHRP_RATE" runat="server" Width="150px"></asp:textbox>
    <asp:imagebutton id="imgbtnHRP_RATE" runat="server" Height="21px"></asp:imagebutton>
    <!--// 9 //-->
    ...
    <!--// 10 //-->
    <asp:imagebutton id="imgKeyEMPLOYEE_STATUTORY_VALUE_EPF" runat="server" Width="21px" Height="21px"></asp:imagebutton>
    <asp:label id="lblEMPLOYEE_STATUTORY_VALUE_EPF" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtEMPLOYEE_STATUTORY_VALUE_EPF" runat="server" Width="150px"></asp:textbox>
    <asp:imagebutton id="imgbtnEMPLOYEE_STATUTORY_VALUE_EPF" runat="server" Height="21px"></asp:imagebutton>
    <!--// 11 //-->
    ...
    <asp:textbox id="txtOCP_ID_LINE" runat="server" Width="150px"></asp:textbox>
    ...
    <asp:textbox id="txtOCP_ID_GROUP" runat="server" Width="150px"></asp:textbox>
    ...
    <asp:textbox id="txtOCP_ID_PROCESS" runat="server" Width="150px"></asp:textbox>
    ...
    <asp:imagebutton id="imgbtnPROCESS_DATE" runat="server" Height="21px"></asp:imagebutton>
    <!--// 23 //-->
    <asp:imagebutton id="imgKeyOPTION_EMPLOYMENT_STATUS" runat="server" Width="21px" Height="21px"></asp:imagebutton>
    <asp:label id="lblOPTION_EMPLOYMENT_STATUS" runat="server" Width="140px"></asp:label>
    <asp:dropdownlist id="ddlOPTION_EMPLOYMENT_STATUS" runat="server" Width="157px"></asp:dropdownlist>
    <asp:imagebutton id="imgbtnOPTION_EMPLOYMENT_STATUS" runat="server" Height="21px"></asp:imagebutton>
    <!--// 24 //-->
    ...
    <div id="divbottom" style="height: 30px; width: 100%">
       <table id="Table4" cellpadding="0" cellspacing="0" border="0" runat="server">
        <tr>
            <td>
                <asp:Image ID="imgbottom" Height="30px" runat="server" />
            </td>
        </tr>
       </table>
    </div>
	...
	<table id="tblUserCategoryGroup" style="Z-INDEX: 115; LEFT: 10px; POSITION: absolute; TOP: 10px" 
					cellpadding="0" cellspacing="0" width="100%" border="0" runat="server">
					<tr>
						<td>
