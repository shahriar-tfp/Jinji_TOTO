<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Employee_Late_Summary.aspx.vb" Inherits="Pages_Payroll_Employee_Late_Summary" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>JINJI : Payroll - Employee Late Summary Page</title>
    <link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server">
    <form id="Employee_Late_Summary" runat="server">
<div>
    ...
    <asp:dropdownlist id="ddlOPTION_ID_CUT_OFF" runat="server" Width="157px"></asp:dropdownlist>
    <asp:imagebutton id="imgbtnOPTION_ID_CUT_OFF" runat="server" Height="21px"></asp:imagebutton>
    <!--// 6 //-->
    <asp:imagebutton id="imgKeyTOTAL_LATE" runat="server" Width="21px" Height="21px"></asp:imagebutton>
    <asp:label id="lblTOTAL_LATE" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtTOTAL_LATE" runat="server" Width="150px"></asp:textbox>
    <asp:imagebutton id="imgbtnTOTAL_LATE" runat="server" Height="21px"></asp:imagebutton>
    <!--// 7 //-->
    <asp:imagebutton id="imgKeyTOTAL_LEAVE_EARLY" runat="server" Width="21px" Height="21px"></asp:imagebutton>
    <asp:label id="lblTOTAL_LEAVE_EARLY" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtTOTAL_LEAVE_EARLY" runat="server" Width="150px"></asp:textbox>
    <asp:imagebutton id="imgbtnTOTAL_LEAVE_EARLY" runat="server" Height="21px"></asp:imagebutton>
    <!--// 8 //-->
    <asp:imagebutton id="imgKeyTOTAL_ABSENT_HOUR" runat="server" Width="21px" Height="21px"></asp:imagebutton>
    <asp:label id="lblTOTAL_ABSENT_HOUR" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtTOTAL_ABSENT_HOUR" runat="server" Width="150px"></asp:textbox>
    <asp:imagebutton id="imgbtnTOTAL_ABSENT_HOUR" runat="server" Height="21px"></asp:imagebutton>
