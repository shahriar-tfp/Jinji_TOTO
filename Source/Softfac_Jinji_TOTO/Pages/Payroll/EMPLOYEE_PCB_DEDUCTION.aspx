<%@ Page Language="VB" AutoEventWireup="false" CodeFile="EMPLOYEE_PCB_DEDUCTION.aspx.vb" Inherits="PAGES_PAYROLL_EMPLOYEE_PCB_DEDUCTION" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>EMPLOYEE_PCB_DEDUCTION</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server"> 
<form id="EMPLOYEE_PCB_DEDUCTION" runat="server">
<div>
...
<!--// 3 //-->
<asp:imagebutton id="imgKeyPCB_DEDUCTION_PROFILE_CODE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblPCB_DEDUCTION_PROFILE_CODE" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtPCB_DEDUCTION_PROFILE_CODE" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnPCB_DEDUCTION_PROFILE_CODE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
