<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Employee_Shift_Adjustment.aspx.vb" Inherits="PAGES_PAYROLL_EMPLOYEE_SHIFT_ADJUSTMENT" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>JINJI : Payroll - Employee Shift Adjustment</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server"> 
<form id="EMPLOYEE_SHIFT_ADJUSTMENT" runat="server">
<div>
...
<asp:dropdownlist id="ddlOPTION_CUT_OFF" runat="server" Width="150px" ></asp:dropdownlist>
...
<asp:imagebutton id="imgbtnFREQUENCY" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
