<%@ Page Language="VB" AutoEventWireup="false" CodeFile="EPF_Profile.aspx.vb" Inherits="Pages_Payroll_EPF_Profile" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>JINJI : Payroll - EPF Profile Page</title>
    <link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server">
    <form id="EPF_Profile" runat="server">
    <div>
    <asp:Panel ID="pnlEdit" runat="server">
<!--// 1 //-->
    <asp:imagebutton id="imgKeyOCP_ID_EPF" runat="server" Width="21px" Height="21px"></asp:imagebutton>
    <asp:label id="lblOCP_ID_EPF" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtOCP_ID_EPF" runat="server" Width="150px"></asp:textbox>
    <asp:imagebutton id="imgbtnOCP_ID_EPF" runat="server" Height="21px"></asp:imagebutton>
    <!--// 2 //-->
