<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Employee_CP39.aspx.vb" Inherits="Pages_Payroll_Employee_CP39" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>JINJI : Payroll - Employee CP39 Page</title>
    <link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server">
    <form id="Employee_CP39" runat="server">
    <div>
    ...
    <asp:imagebutton id="imgbtnEMPLOYEE_PROFILE_ID" runat="server" Height="21px"></asp:imagebutton>
       ...
       <!--// 2 //-->
    <asp:imagebutton id="imgKeyRECEIPT_NUMBER" runat="server" Width="21px" Height="21px"></asp:imagebutton>
    <asp:label id="lblRECEIPT_NUMBER" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtRECEIPT_NUMBER" runat="server" Width="150px"></asp:textbox>
    <asp:imagebutton id="imgbtnRECEIPT_NUMBER" runat="server" Height="21px"></asp:imagebutton>
    ...
    <asp:imagebutton id="imgbtnREMARKS" runat="server" Height="21px"></asp:imagebutton>
