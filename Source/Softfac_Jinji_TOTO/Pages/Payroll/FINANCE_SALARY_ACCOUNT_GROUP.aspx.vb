                            ...
                            If mySetting.CheckTextNullAndReplaceSingleQuote(myTextBox) = True Then
                                ...
                                Else
                                    ...
                                    If myDST.Tables(0).Rows.Count > 0 Then
                                        ...
                                        ElseIf myDST.Tables(0).Rows(0).Item(1).ToString.Trim <> "" And myDST.Tables(0).Rows(0).Item(2).ToString.Trim = "COMPANY" Then
                                ...
                                If mySetting.CheckTextNullAndReplaceSingleQuote(myTextBox) = True Then
                                    If IsNumeric(mySetting.UnDisplayTime(myTextBox.Text, Session("Company").ToString, Session("Module").ToString)) = True Then
                                        ...
                                        If myDST2.Tables(0).Rows.Count > 0 Then
                                            ...
                                            ElseIf myDST2.Tables(0).Rows(0).Item(1).ToString.Trim <> "" And myDST2.Tables(0).Rows(0).Item(2).ToString.Trim = "COMPANY" Then
                                                ssql = ssql & myDS2.Tables(0).Rows(i).Item(0) & "=ISNULL(" & myDST2.Tables(1).Rows(0).Item(0).ToString & "(" & myDST2.Tables(0).Rows(0).Item(1).ToString.Trim & ",'" & Session("Company").ToString & "'),'') And "
                                            Else
                                                ssql = ssql & myDS2.Tables(0).Rows(i).Item(0) & "=ISNULL(" & myDST2.Tables(1).Rows(0).Item(0).ToString & "(" & myDST2.Tables(0).Rows(0).Item(1).ToString.Trim & "),'') And "
                                            End If
                                        Else
