<%@ Page Language="VB" AutoEventWireup="false" CodeFile="EMPLOYEE_BONUS.aspx.vb" Inherits="PAGES_PAYROLL_EMPLOYEE_BONUS" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>EMPLOYEE_BONUS</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server"> 
<form id="EMPLOYEE_BONUS" runat="server">
<div>
...
<asp:imagebutton id="imgbtnOCP_ID_BONUS" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
...
<asp:imagebutton id="imgbtnOCP_ID_APPRAISAL" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 5 //-->
<asp:imagebutton id="imgKeyBONUS_AMOUNT" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblBONUS_AMOUNT" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtBONUS_AMOUNT" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnBONUS_AMOUNT" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 6 //-->
<asp:imagebutton id="imgKeyATTENDANCE_RATIO" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblATTENDANCE_RATIO" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtATTENDANCE_RATIO" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnATTENDANCE_RATIO" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 7 //-->
<asp:imagebutton id="imgKeySERVICE_RATIO" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblSERVICE_RATIO" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtSERVICE_RATIO" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnSERVICE_RATIO" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
