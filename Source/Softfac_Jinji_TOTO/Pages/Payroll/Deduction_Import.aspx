<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Deduction_Import.aspx.vb" Inherits="PAGES_PAYROLL_DEDUCTION_IMPORT" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>JINJI : Payroll - Allowance Import Page</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server"> 
<form id="DEDUCTION_IMPORT" runat="server">
<div>
...
<asp:imagebutton id="imgbtnDATE_FROM" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
...
<asp:imagebutton id="imgbtnDATE_TO" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
...
<asp:dropdownlist id="ddlOPTION_CALCULATE_ON" runat="server" Width="150px" ></asp:dropdownlist>
<asp:imagebutton id="imgbtnOPTION_CALCULATE_ON" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
