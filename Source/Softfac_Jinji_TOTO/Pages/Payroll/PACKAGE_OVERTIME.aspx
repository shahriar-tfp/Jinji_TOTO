<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PACKAGE_OVERTIME.aspx.vb" Inherits="PAGES_PAYROLL_PACKAGE_OVERTIME" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>PACKAGE_OVERTIME</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server"> 
<form id="PACKAGE_OVERTIME" runat="server">
<div>
...
<!--// 4 //-->
<asp:imagebutton id="imgKeyMIN_TIME" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblMIN_TIME" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtMIN_TIME" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnMIN_TIME" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 5 //-->
<asp:imagebutton id="imgKeyMAX_TIME" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblMAX_TIME" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtMAX_TIME" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnMAX_TIME" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 6 //-->
<asp:imagebutton id="imgKeyOPTION_PAY_METHOD" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblOPTION_PAY_METHOD" runat="server" Width="140px" ></asp:label>
<asp:dropdownlist id="ddlOPTION_PAY_METHOD" runat="server" Width="150px" ></asp:dropdownlist>
<asp:imagebutton id="imgbtnOPTION_PAY_METHOD" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
...
<!--// 8 //-->
<asp:imagebutton id="imgKeyOPTION_HRP_METHOD" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblOPTION_HRP_METHOD" runat="server" Width="140px" ></asp:label>
<asp:dropdownlist id="ddlOPTION_HRP_METHOD" runat="server" Width="150px" ></asp:dropdownlist>
<asp:imagebutton id="imgbtnOPTION_HRP_METHOD" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
