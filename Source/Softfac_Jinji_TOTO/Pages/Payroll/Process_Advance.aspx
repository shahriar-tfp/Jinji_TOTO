        ...
        <table>
            <tr>
                <td>
                    ...
                    <asp:Dropdownlist ID="ddlMONTH" runat="server" Width="70px" AutoPostBack="true"></asp:Dropdownlist>
                </td>
                <td>
            ...
            <tr>
                ...
                <td><asp:ImageButton ID="imgKeyCATEGORY_LEVEL" runat="server" Width="21px" Height="21px" />
                    <asp:Label ID="lblCATEGORY_LEVEL" runat="server" Width="120px"></asp:Label>
                    <asp:Dropdownlist ID="ddlCATEGORY_LEVEL" runat="server" Width="157px" AutoPostBack="true"></asp:Dropdownlist></td>
            ...
            <tr>
                <td> <asp:ImageButton ID="imgKeyOCP_ID_Salary" runat="server" Width="21px" Height="21px"/>
                    ...
                    <asp:ImageButton ID="imgBtnOCP_ID_Salary" runat="server" Width="21px" Height="21px"/></td><td></td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                <td>
                    <asp:ImageButton ID="imgKeyOPTION_RACE" runat="server" Width="21px" Height="21px"/>
                ...
                <td><asp:ImageButton ID="imgKeyOPTION_RELIGION" runat="server" Width="21px" Height="21px" />
                    <asp:Label ID="lblOPTION_RELIGION" runat="server" Width="120px"></asp:Label>
                    <asp:Dropdownlist ID="ddlOPTION_RELIGION" runat="server" Width="157px"></asp:Dropdownlist></td>
            </tr>
        </table>
