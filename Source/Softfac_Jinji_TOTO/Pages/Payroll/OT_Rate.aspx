<%@ Page Language="VB" AutoEventWireup="false" CodeFile="OT_Rate.aspx.vb" Inherits="Pages_Payroll_OT_Rate" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>JINJI : Payroll - OT Rate Page</title>
    <link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server">
    <form id="OT_Rate" runat="server">
    <div>
    ...
    <!--// 3 //-->
    <asp:imagebutton id="imgKeyOPTION_OCP_ID_TYPE" runat="server" Width="21px" Height="21px"></asp:imagebutton>
    <asp:label id="lblOPTION_OCP_ID_TYPE" runat="server" Width="140px"></asp:label>
    <asp:dropdownlist id="ddlOPTION_OCP_ID_TYPE" runat="server" Width="157px" AutoPostBack="true"></asp:dropdownlist>
    <asp:imagebutton id="imgbtnOPTION_OCP_ID_TYPE" runat="server" Height="21px"></asp:imagebutton>
    <!--// 4 //-->
    ...
    <!--// 8 //-->
    <asp:imagebutton id="imgKeyTIME_START" runat="server" Width="21px" Height="21px"></asp:imagebutton> 
    <asp:label id="lblTIME_START" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtTIME_START" runat="server" Width="150px"></asp:textbox>
    <asp:imagebutton id="imgbtnTIME_START" runat="server" Height="21px"></asp:imagebutton>
    <%--<asp:dropdownlist id="ddlTIME_START" runat="server" Width="45px"></asp:dropdownlist>--%>
    <!--// 9 //-->
    <asp:imagebutton id="imgKeyTIME_END" runat="server" Width="21px" Height="21px"></asp:imagebutton> 
    <asp:label id="lblTIME_END" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtTIME_END" runat="server" Width="150px"></asp:textbox>
    <asp:imagebutton id="imgbtnTIME_END" runat="server" Height="21px"></asp:imagebutton> 
    <!--// 10 //-->
    ...
    <asp:dropdownlist id="ddlOPTION_PAY_METHOD" runat="server" Width="157px"></asp:dropdownlist>
    <asp:imagebutton id="imgbtnOPTION_PAY_METHOD" runat="server" Height="21px"></asp:imagebutton>
    <!--// 11 //-->
    ...
    <asp:imagebutton id="imgbtnOT_RATE_TYPE" runat="server" Height="21px"></asp:imagebutton>
    <!--// 13 //-->
    <asp:imagebutton id="imgKeySALARY_RANGE" runat="server" Width="21px" Height="21px"></asp:imagebutton> 
    <asp:label id="lblSALARY_RANGE" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtSALARY_RANGE" runat="server" Width="150px"></asp:textbox>
    <asp:imagebutton id="imgbtnSALARY_RANGE" runat="server" Height="21px"></asp:imagebutton>
