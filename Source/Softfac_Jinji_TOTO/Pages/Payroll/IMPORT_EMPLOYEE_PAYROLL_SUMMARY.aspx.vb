    ...
    Protected Sub imgBtnUpload_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnUpload.Click
        If Not (txtFileName.PostedFile Is Nothing) Then
            Try
                ...
                Dim myData As New OleDbDataAdapter("SELECT * FROM [UploadTms$]", strConn)
    ...
    Protected Sub imgBtnUpdateImport_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnUpdateImport.Click
        Try
            ...
            If GVUpload.Rows.Count > 0 Then
                ...
                ssql = "delete from Import_Employee_Payroll_Details"
                mySQL.ExecuteSQL(ssql)
                ssql = Nothing
                For i = 0 To GVUpload.Rows.Count - 1
                    ssql = "insert into Import_Employee_Payroll_Details values(N'"
                    ssql = ssql + GVUpload.Rows(i).Cells(0).Text.Trim + "',N'"
                    ...
                    ssql = ssql + GVUpload.Rows(i).Cells(23).Text.Trim + "',N'"
                    ssql = ssql + GVUpload.Rows(i).Cells(24).Text.Trim + "',N'"
                    ssql = ssql + GVUpload.Rows(i).Cells(25).Text.Trim + "',N'"
                    ssql = ssql + GVUpload.Rows(i).Cells(26).Text.Trim + "',N'"
                    ssql = ssql + GVUpload.Rows(i).Cells(27).Text.Trim + "',N'"
                    ssql = ssql + GVUpload.Rows(i).Cells(28).Text.Trim + "',N'"
                    ssql = ssql + GVUpload.Rows(i).Cells(29).Text.Trim + "',N'"
                    ssql = ssql + GVUpload.Rows(i).Cells(30).Text.Trim + "',N'"
                    ssql = ssql + GVUpload.Rows(i).Cells(31).Text.Trim + "',N'"
                    ssql = ssql + GVUpload.Rows(i).Cells(32).Text.Trim + "',N'"
                    ssql = ssql + GVUpload.Rows(i).Cells(33).Text.Trim + "',N'"
                    ssql = ssql + GVUpload.Rows(i).Cells(34).Text.Trim + "',N'"
                    ssql = ssql + GVUpload.Rows(i).Cells(35).Text.Trim + "',N'"
                    ssql = ssql + GVUpload.Rows(i).Cells(36).Text.Trim + "',N'"
                    ssql = ssql + GVUpload.Rows(i).Cells(37).Text.Trim + "',N'"
                    ssql = ssql + GVUpload.Rows(i).Cells(38).Text.Trim + "',N'"
                    ssql = ssql + GVUpload.Rows(i).Cells(39).Text.Trim + "',N'"
                    ssql = ssql + GVUpload.Rows(i).Cells(40).Text.Trim + "')"
                    mySQL.ExecuteSQL(ssql)
                    ssql = Nothing
                Next
                ssql = "exec sp_pr_calAttpayrolldetail"
