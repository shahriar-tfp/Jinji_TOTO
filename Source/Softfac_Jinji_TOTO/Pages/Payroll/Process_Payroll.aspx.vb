...
Partial Class Pages_Payroll_Process_Payroll
    ...
    Private Sub PagePreload()
        ...
        mySetting.GetImgUrl(imgKeyCATEGORY_LEVEL, clsGlobalSetting.ImageType._KEY, Session("Company").ToString)
    ...
    Protected Sub ddlPAY_CYCLE_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ddlPAY_CYCLE.SelectedIndexChanged
        ...
        End If
    End Sub
    Protected Sub ddlCATEGORY_LEVEL_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ddlCATEGORY_LEVEL.SelectedIndexChanged
        If ddlFILTER_BY.SelectedValue.ToString.ToUpper <> "E" And ddlFILTER_BY.SelectedValue.ToString.ToUpper <> "" Then
            gvMessage.Visible = False
            pnlProgress.Visible = False
            pnlGridview.Visible = True
