<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Employee_Payslip.aspx.vb" Inherits="Pages_Payroll_Employee_Payslip" %>
...
<body id="body" runat="server">
    <form id="EMPLOYEE_PAYSLIP_VW" runat="server">
    <div>
			               ...
			               <table>
		                       <tr>
		                           <td>
		                                ...
		                                <asp:ImageButton ID="imgbtnDelete" runat="server" OnClientClick="return confirm('Do You wish to Delete ?')"/>
		                           </td>
		                       </tr>
			               </table>
