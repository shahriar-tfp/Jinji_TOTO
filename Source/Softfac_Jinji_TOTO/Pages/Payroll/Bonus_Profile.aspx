<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Bonus_Profile.aspx.vb" Inherits="Pages_Payroll_Bonus_Profile" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>JINJI : Payroll - Bonus Profile Page</title>
    <link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server">
    <form id="Bonus_Profile" runat="server">
    <div>
    ...
    <!--// 3 //-->
    <asp:imagebutton id="imgKeyOPTION_MONTH" runat="server" Width="21px" Height="21px"></asp:imagebutton>
    <asp:label id="lblOPTION_MONTH" runat="server" Width="140px"></asp:label>
    <asp:dropdownlist id="ddlOPTION_MONTH" runat="server" Width="157px"></asp:dropdownlist>
    <asp:imagebutton id="imgbtnOPTION_MONTH" runat="server" Height="21px"></asp:imagebutton>
    <!--// 4 //-->
    <asp:imagebutton id="imgKeyDATE_START" runat="server" Width="21px" Height="21px"></asp:imagebutton>
    <asp:label id="lblDATE_START" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtDATE_START" runat="server" Width="150px"></asp:textbox>
    <asp:imagebutton id="imgbtnDATE_START" runat="server" Height="21px"></asp:imagebutton>
    <!--// 5 //-->
    <asp:imagebutton id="imgKeyDATE_END" runat="server" Width="21px" Height="21px"></asp:imagebutton>
    <asp:label id="lblDATE_END" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtDATE_END" runat="server" Width="150px"></asp:textbox>
    <asp:imagebutton id="imgbtnDATE_END" runat="server" Height="21px"></asp:imagebutton>
    <!--// 6 //-->
