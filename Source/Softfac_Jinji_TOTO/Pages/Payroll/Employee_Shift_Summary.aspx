<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Employee_Shift_Summary.aspx.vb" Inherits="Pages_Payroll_Employee_Shift_Summary" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>JINJI : Payroll - Employee Shift Summary Page</title>
    <link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server">
    <form id="Employee_Shift_Summary" runat="server">
<div>
    ...
    <!--// 8 //-->
    <asp:imagebutton id="imgKeyFREQUENCY" runat="server" Width="21px" Height="21px"></asp:imagebutton>
    <asp:label id="lblFREQUENCY" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtFREQUENCY" runat="server" Width="150px"></asp:textbox>
    <asp:imagebutton id="imgbtnFREQUENCY" runat="server" Height="21px"></asp:imagebutton>
