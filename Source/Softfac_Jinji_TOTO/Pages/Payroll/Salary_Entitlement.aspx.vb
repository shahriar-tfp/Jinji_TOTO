                            ...
                            If mySetting.CheckTextNullAndReplaceSingleQuote(myTextBox) = True Then
                                ...
                                Else
                                    ...
                                    If myDST.Tables(0).Rows.Count > 0 Then
                                        ...
                                        Else
                                            If Left(myDS.Tables(0).Rows(i).Item(0).ToString.ToUpper, 6) = "OCP_ID" And myDST.Tables(0).Rows(0).Item(2).ToString.Trim = "" Then
                                            ...
                                            ElseIf Left(myDS.Tables(0).Rows(i).Item(0).ToString.ToUpper, 6) = "OCP_ID" And myDST.Tables(0).Rows(0).Item(2).ToString.Trim = "COMPANY" And myDS.Tables(0).Rows(i).Item(0).ToString = "OCP_ID" Then
                                                ssql2 = ssql2 & "ISNULL(" & myDST.Tables(0).Rows(0).Item(0).ToString & "(N'" & myTextBox.Text.ToString & "',N'" & ddlOPTION_OCP_TYPE.SelectedValue.ToString & "',N'" & Session("Company") & "'),''),"
                                            ElseIf Left(myDS.Tables(0).Rows(i).Item(0).ToString.ToUpper, 6) = "OCP_ID" And myDST.Tables(0).Rows(0).Item(2).ToString.Trim = "COMPANY" And myDS.Tables(0).Rows(i).Item(0).ToString <> "OCP_ID" Then
                                        ...
                                        If myDS.Tables(0).Rows(i).Item(6).ToString = "YES" Then
                                            ...
                                            Else
                                                ...
                                                ElseIf Left(myDS.Tables(0).Rows(i).Item(0).ToString.ToUpper, 6) = "OCP_ID" And myDST.Tables(0).Rows(0).Item(2).ToString.Trim = "COMPANY" And myDS.Tables(0).Rows(i).Item(0).ToString = "OCP_ID" Then
                                                    ssql3 = ssql3 & myDS.Tables(0).Rows(i).Item(0) & "=ISNULL(" & myDST.Tables(0).Rows(0).Item(0).ToString & "(N'" & myTextBox.Text.ToString & "',N'" & ddlOPTION_OCP_TYPE.SelectedValue.ToString & "',N'" & Session("Company") & "'),0) And "
                                                ElseIf Left(myDS.Tables(0).Rows(i).Item(0).ToString.ToUpper, 6) = "OCP_ID" And myDST.Tables(0).Rows(0).Item(2).ToString.Trim = "COMPANY" And myDS.Tables(0).Rows(i).Item(0).ToString <> "OCP_ID" Then
                            ...
                            If mySetting.CheckTextNullAndReplaceSingleQuote(myTextBox) = True Then
                                ...
                                Else
                                    ...
                                    If myDST.Tables(0).Rows.Count > 0 Then
                                        ...
                                        Else
                                            If myDS.Tables(0).Rows(i).Item(0).ToString.ToUpper = "OCP_ID" And myDST.Tables(0).Rows(0).Item(2).ToString.Trim = "" Then
                                            ...
                                            ElseIf myDS.Tables(0).Rows(i).Item(0).ToString.ToUpper = "OCP_ID" And myDST.Tables(0).Rows(0).Item(2).ToString.Trim = "COMPANY" Then
                                                ssql = ssql & myDS.Tables(0).Rows(i).Item(0) & "=ISNULL(" & myDST.Tables(0).Rows(0).Item(0).ToString & "(N'" & myTextBox.Text.ToString & "',N'" & ddlOPTION_OCP_TYPE.SelectedValue.ToString & "',N'" & Session("Company") & "'),''),"
                                            Else
                                ...
                                If mySetting.CheckTextNullAndReplaceSingleQuote(myTextBox) = True Then
                                    ...
                                    Else
                                        ...
                                        If myDST2.Tables(0).Rows.Count > 0 Then
                                            ...
                                            Else
                                                If myDS2.Tables(0).Rows(i).Item(0).ToString.ToUpper = "OCP_ID" And myDST2.Tables(0).Rows(0).Item(2).ToString.Trim = "" Then
                                                ...
                                                ElseIf myDS2.Tables(0).Rows(i).Item(0).ToString.ToUpper = "OCP_ID" And myDST2.Tables(0).Rows(0).Item(2).ToString.Trim = "COMPANY" Then
                                                    ssql = ssql & myDS2.Tables(0).Rows(i).Item(0) & "=ISNULL(" & myDST2.Tables(0).Rows(0).Item(0).ToString & "(N'" & myTextBox.Text.ToString & "',N'" & ddlOPTION_OCP_TYPE.SelectedValue.ToString & "',N'" & Session("Company") & "'),'') And "
                                                Else
