<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PCB_EXCLUDE_DETAILS.aspx.vb" Inherits="PAGES_PAYROLL_PCB_EXCLUDE_DETAILS" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>PCB_EXCLUDE_DETAILS</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server"> 
<form id="PCB_EXCLUDE_DETAILS" runat="server">
<div>
...
<!--// 2 //-->
<asp:imagebutton id="imgKeyPCB_EXCLUDE_CODE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblPCB_EXCLUDE_CODE" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtPCB_EXCLUDE_CODE" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnPCB_EXCLUDE_CODE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
