<%@ Page Language="VB" AutoEventWireup="false" CodeFile="EMPLOYEE_PAYROLL_RETRO_BALANCE.aspx.vb" Inherits="PAGES_PAYROLL_EMPLOYEE_PAYROLL_RETRO_BALANCE" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>EMPLOYEE_PAYROLL_RETRO_BALANCE</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server"> 
<form id="EMPLOYEE_PAYROLL_RETRO_BALANCE" runat="server">
<div>
...
<asp:textbox id="txtOPTION_ALLOWANCE_DEDUCTION" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnOPTION_ALLOWANCE_DEDUCTION" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
...
<asp:imagebutton id="imgbtnOCP_ID_SALARY" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 7 //-->
<asp:imagebutton id="imgKeyEMPLOYEE_CREDIT" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblEMPLOYEE_CREDIT" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtEMPLOYEE_CREDIT" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnEMPLOYEE_CREDIT" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 8 //-->
<asp:imagebutton id="imgKeyEMPLOYEE_DEBIT" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblEMPLOYEE_DEBIT" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtEMPLOYEE_DEBIT" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnEMPLOYEE_DEBIT" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 9 //-->
<asp:imagebutton id="imgKeyCOMPANY_CREDIT" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblCOMPANY_CREDIT" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtCOMPANY_CREDIT" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnCOMPANY_CREDIT" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 10 //-->
<asp:imagebutton id="imgKeyCOMPANY_DEBIT" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblCOMPANY_DEBIT" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtCOMPANY_DEBIT" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnCOMPANY_DEBIT" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 11 //-->
<asp:imagebutton id="imgKeyOT_HOUR" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblOT_HOUR" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtOT_HOUR" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnOT_HOUR" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 12 //-->
<asp:imagebutton id="imgKeyPROCESS_DATE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblPROCESS_DATE" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtPROCESS_DATE" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnPROCESS_DATE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 13 //-->
<asp:imagebutton id="imgKeyPAY_MONTH" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblPAY_MONTH" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtPAY_MONTH" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnPAY_MONTH" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 14 //-->
<asp:imagebutton id="imgKeyPAY_YEAR" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblPAY_YEAR" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtPAY_YEAR" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnPAY_YEAR" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 15 //-->
<asp:imagebutton id="imgKeyPAY_OPTION_PAY_CYCLE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblPAY_OPTION_PAY_CYCLE" runat="server" Width="140px" ></asp:label>
<asp:dropdownlist id="ddlPAY_OPTION_PAY_CYCLE" runat="server" Width="150px" ></asp:dropdownlist>
<asp:imagebutton id="imgbtnPAY_OPTION_PAY_CYCLE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 16 //-->
<asp:imagebutton id="imgKeyTRANSFER_STATUS" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblTRANSFER_STATUS" runat="server" Width="140px" ></asp:label>
<asp:dropdownlist id="ddlTRANSFER_STATUS" runat="server" Width="150px" ></asp:dropdownlist>
<asp:imagebutton id="imgbtnTRANSFER_STATUS" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
