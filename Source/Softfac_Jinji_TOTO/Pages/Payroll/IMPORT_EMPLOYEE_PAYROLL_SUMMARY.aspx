<%@ Page Language="VB" AutoEventWireup="false" CodeFile="IMPORT_EMPLOYEE_PAYROLL_SUMMARY.aspx.vb" Inherits="PAGES_PAYROLL_IMPORT_EMPLOYEE_PAYROLL_SUMMARY" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>IMPORT_EMPLOYEE_PAYROLL_SUMMARY</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server"> 
<form id="IMPORT_EMPLOYEE_PAYROLL_SUMMARY" runat="server">
<div>
...
<!--// 6 //-->
<asp:imagebutton id="imgKeyPACKAGE_PROFILE_CODE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblPACKAGE_PROFILE_CODE" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtPACKAGE_PROFILE_CODE" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnPACKAGE_PROFILE_CODE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 7 //-->
<asp:imagebutton id="imgKeyTOLDAYS" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblTOLDAYS" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtTOLDAYS" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnTOLDAYS" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 8 //-->
<asp:imagebutton id="imgKeyTOLWORKDAYS" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblTOLWORKDAYS" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtTOLWORKDAYS" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnTOLWORKDAYS" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 9 //-->
<asp:imagebutton id="imgKeyRD_DAY" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblRD_DAY" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtRD_DAY" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnRD_DAY" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 10 //-->
<asp:imagebutton id="imgKeyPH_DAY" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblPH_DAY" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtPH_DAY" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnPH_DAY" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 11 //-->
<asp:imagebutton id="imgKeyCO_DAY" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblCO_DAY" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtCO_DAY" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnCO_DAY" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 12 //-->
<asp:imagebutton id="imgKeyMORNING_SHIFT" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblMORNING_SHIFT" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtMORNING_SHIFT" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnMORNING_SHIFT" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 13 //-->
<asp:imagebutton id="imgKeyNIGHT_SHIFT" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblNIGHT_SHIFT" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtNIGHT_SHIFT" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnNIGHT_SHIFT" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
...
<!--// 16 //-->
<asp:imagebutton id="imgKeyND1" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblND1" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtND1" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnND1" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 17 //-->
<asp:imagebutton id="imgKeyND2" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblND2" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtND2" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnND2" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 18 //-->
<asp:imagebutton id="imgKeyOD1" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblOD1" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtOD1" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnOD1" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 19 //-->
<asp:imagebutton id="imgKeyOD2" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblOD2" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtOD2" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnOD2" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 20 //-->
<asp:imagebutton id="imgKeyRD1" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblRD1" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtRD1" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnRD1" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 21 //-->
<asp:imagebutton id="imgKeyRD2" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblRD2" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtRD2" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnRD2" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 22 //-->
<asp:imagebutton id="imgKeyPH1" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblPH1" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtPH1" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnPH1" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 23 //-->
<asp:imagebutton id="imgKeyPH2" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblPH2" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtPH2" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnPH2" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
...
<asp:imagebutton id="imgbtnDATETIME_MODIFY" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
    ...
    <table id="Tableimport1" cellspacing="0" cellpadding="0" border="0" runat="server">
					            <tr>
					                <td style ="height:15px"></td>
					            </tr>
					        </table>
    <table id="tableimport" cellspacing="0" cellpadding="0" border="0" runat="server" >
        <tr>
            <td style ="height:15px"></td>
        </tr>
        <tr><td><asp:Label ID="lblFileName" Width="140px" runat="server" Text="File Name"></asp:Label><input type="file" id="txtFileName" runat="server" /></td>
        </tr><tr><td><asp:imagebutton runat="server" ID="imgBtnUpload" Width="74px" Height="21px"></asp:imagebutton></td>
        </tr>
    </table>
    <table id="Tableimport3" cellspacing="0" cellpadding="0" border="0" runat="server">
					            <tr>
					                <td style ="height:15px"></td>
					            </tr>
					        </table>
    <table id="Tableimport2" cellspacing="0" cellpadding="0" width="100%" align="center" border="0" runat="server">
								<tr>
									<td>
										<asp:panel id="PnlUploadGrid" runat="server" visible="true" ScrollBars="auto">
											<asp:gridview id="GVUpload" Width="100%" runat="server" AutoGenerateColumns="true" AutoGenerateEditButton="false" AutoGenerateDeleteButton="false" AutoGenerateSelectButton="false" 
            CssClass="wordstyle" cellspacing="0" cellpadding="1" EmptyDataText="No data found!">
                                                ...
                                                <HeaderStyle BackColor="#001B97" Height="21" CssClass="dgstyle_h" />
												<Columns>
													<asp:TemplateField HeaderText="Remark" ItemStyle-Width="100">
													</asp:TemplateField>
												</Columns>
											</asp:GridView>
											<asp:SqlDataSource ID="myDSR2" runat="server"></asp:SqlDataSource>
										</asp:panel>
									</td>
								</tr>
								<tr><td><asp:panel id="pnlImportAction" runat="server" visible="true">
											<table cellspacing="0" cellpadding="0" border="0">
												...
												<tr>
												    ...
												    <td align="left">
														<asp:imagebutton id="imgBtnUpdateImport" runat="server" Height="21px" Width="74px"></asp:imagebutton>
													</td>
													<td align="left">
													    <asp:panel id="Panel2" runat="server" visible="true">
									                        <table cellspacing="0" cellpadding="0" border="0">
												                <tr>
										                            <td><asp:Image ID="Image2" ImageUrl="../../../images/company/default/gif/px1.gif" Width="5px" runat="server" /></td>
											                        <td align="left"><asp:Label id="lblresult3" runat="server" CssClass="wordstyle2"></asp:Label></td>
										                        </tr>
									                        </table>
								                        </asp:panel> 
													</td>
