<%@ Page Language="VB" AutoEventWireup="false" CodeFile="FINANCE_SALARY_ACCOUNT_GROUP.aspx.vb" Inherits="PAGES_PAYROLL_FINANCE_SALARY_ACCOUNT_GROUP" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>FINANCE_SALARY_ACCOUNT_GROUP</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server"> 
<form id="FINANCE_SALARY_ACCOUNT_GROUP" runat="server">
<div>
...
<!--// 2 //-->
<asp:imagebutton id="imgKeyFINANCE_CODE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblFINANCE_CODE" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtFINANCE_CODE" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnFINANCE_CODE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
