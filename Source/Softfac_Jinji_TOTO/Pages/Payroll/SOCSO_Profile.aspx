<%@ Page Language="VB" AutoEventWireup="false" CodeFile="SOCSO_Profile.aspx.vb" Inherits="Pages_Payroll_SOCSO_Profile" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>JINJI : Payroll - SOCSO Profile Page</title>
    <link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server">
    <form id="SOCSO_Profile" runat="server">
    <div>
    <asp:Panel ID="pnlEdit" runat="server">
    <!--// 1 //-->
    <asp:imagebutton id="imgKeyOCP_ID_SOCSO" runat="server" Width="21px" Height="21px"></asp:imagebutton>
    <asp:label id="lblOCP_ID_SOCSO" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtOCP_ID_SOCSO" runat="server" Width="150px"></asp:textbox>
    <asp:imagebutton id="imgbtnOCP_ID_SOCSO" runat="server" Height="21px"></asp:imagebutton>
    <!--// 2 //-->
    ...
    <asp:imagebutton id="imgbtnVALUE_EMPLOYEE" runat="server" Height="21px"></asp:imagebutton>
    <!--// 5 //-->
    ...
    <asp:dropdownlist id="ddlOPTION_VALUE_EMPLOYEE_TYPE" runat="server" Width="157px"></asp:dropdownlist>
    <asp:imagebutton id="imgbtnOPTION_VALUE_EMPLOYEE_TYPE" runat="server" Height="21px"></asp:imagebutton>
      <!--// 6 //-->
    ...
    <asp:imagebutton id="imgbtnVALUE_EMPLOYER" runat="server" Height="21px"></asp:imagebutton>
        <!--// 7 //-->
    ...
    <asp:dropdownlist id="ddlOPTION_VALUE_EMPLOYER_TYPE" runat="server" Width="157px"></asp:dropdownlist>
    <asp:imagebutton id="imgbtnOPTION_VALUE_EMPLOYER_TYPE" runat="server" Height="21px"></asp:imagebutton>
