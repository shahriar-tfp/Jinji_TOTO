<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Employee_Advance_Payment.aspx.vb" Inherits="PAGES_PAYROLL_EMPLOYEE_ADVANCE_PAYMENT" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>JINJI : Payroll - Employee Advance Payment Page</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server"> 
<form id="EMPLOYEE_ADVANCE_PAYMENT" runat="server">
<div>
...
<asp:dropdownlist id="ddlOPTION_PAY_MODE" runat="server" Width="150px" ></asp:dropdownlist>
<asp:imagebutton id="imgbtnOPTION_PAY_MODE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 7 //-->
<asp:imagebutton id="imgKeyOPTION_PROCESS_CYCLE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblOPTION_PROCESS_CYCLE" runat="server" Width="140px" ></asp:label>
<asp:dropdownlist id="ddlOPTION_PROCESS_CYCLE" runat="server" Width="150px" ></asp:dropdownlist>
<asp:imagebutton id="imgbtnOPTION_PROCESS_CYCLE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
...
<asp:dropdownlist id="ddlOPTION_PAY_TYPE" runat="server" Width="150px" ></asp:dropdownlist>
<asp:imagebutton id="imgbtnOPTION_PAY_TYPE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 9 //-->
<asp:imagebutton id="imgKeyOPTION_CALCULATE_METHOD" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblOPTION_CALCULATE_METHOD" runat="server" Width="140px" ></asp:label>
<asp:dropdownlist id="ddlOPTION_CALCULATE_METHOD" runat="server" Width="150px" ></asp:dropdownlist>
<asp:imagebutton id="imgbtnOPTION_CALCULATE_METHOD" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
...
<asp:imagebutton id="imgbtnVALUE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
...
<!--// 13 //-->
<asp:imagebutton id="imgKeyNEW_JOIN_DATE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblNEW_JOIN_DATE" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtNEW_JOIN_DATE" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnNEW_JOIN_DATE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
