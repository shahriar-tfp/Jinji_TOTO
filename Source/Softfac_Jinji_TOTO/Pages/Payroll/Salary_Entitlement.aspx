<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Salary_Entitlement.aspx.vb" Inherits="Pages_Payroll_Salary_Entitlement" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>JINJI : Payroll - Salary Entitlement Page</title>
    <link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server">
    <form id="Salary_Entitlement" runat="server">
    <div>
...
<!--// 1 //-->
    ...
    <asp:dropdownlist id="ddlOPTION_OCP_TYPE" runat="server" Width="157px" AutoPostBack="true"></asp:dropdownlist>
    ...
    <asp:imagebutton id="imgbtnAMOUNT" runat="server" Height="21px"></asp:imagebutton>
    <!--// 7 //-->
