<%@ Page Language="VB" AutoEventWireup="false" CodeFile="FOOD_SUBSIDY_ENTITLE.aspx.vb" Inherits="PAGES_PAYROLL_FOOD_SUBSIDY_ENTITLE" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>FOOD_SUBSIDY_ENTITLE</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server"> 
<form id="FOOD_SUBSIDY_ENTITLE" runat="server">
<div>
...
<!--// 7 //-->
<asp:imagebutton id="imgKeyOPTION_CONDITION" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblOPTION_CONDITION" runat="server" Width="140px" ></asp:label>
<asp:dropdownlist id="ddlOPTION_CONDITION" runat="server" Width="150px" ></asp:dropdownlist>
<asp:imagebutton id="imgbtnOPTION_CONDITION" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 8 //-->
<asp:imagebutton id="imgKeyOTHOUR" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblOTHOUR" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtOTHOUR" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnOTHOUR" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
