<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Publish_EPayslip.aspx.vb" Inherits="Pages_Payroll_Publish_EPayslip" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>JINJI : Payroll - Publish E-Payslip Page</title>
...
<body id="body" runat="server">
    ...
    <asp:Panel ID="pnlEdit" runat="server">
        ...
        <table id="tblEditButton" runat="server">
            <tr align="left">
                <td>
                    <asp:ImageButton ID="imgbtnUpdate" runat="server" Width="74" Height="21" OnClientClick="return confirm('Confirm Publish To E-Payslip ?')"></asp:ImageButton>
