<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PCB_FORMULA_PROFILE.aspx.vb" Inherits="PAGES_PAYROLL_PCB_FORMULA_PROFILE" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>PCB_FORMULA_PROFILE</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server"> 
<form id="PCB_FORMULA_PROFILE" runat="server">
<div>
...
<asp:imagebutton id="imgbtnOCP_ID_PCB" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
...
<!--// 4 //-->
<asp:imagebutton id="imgKeyFIRST_AMOUNT" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblFIRST_AMOUNT" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtFIRST_AMOUNT" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnFIRST_AMOUNT" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
