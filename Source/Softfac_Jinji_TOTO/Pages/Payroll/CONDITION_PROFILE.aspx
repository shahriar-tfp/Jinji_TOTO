<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CONDITION_PROFILE.aspx.vb" Inherits="PAGES_PAYROLL_CONDITION_PROFILE" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>CONDITION_PROFILE</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server"> 
<form id="CONDITION_PROFILE" runat="server">
<div>
...
<!--// 3 //-->
<asp:imagebutton id="imgKeyBY_TYPE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblBY_TYPE" runat="server" Width="140px" ></asp:label>
<asp:dropdownlist id="ddlBY_TYPE" runat="server" Width="150px" ></asp:dropdownlist>
<asp:imagebutton id="imgbtnBY_TYPE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
...
<!--// 6 //-->
<asp:imagebutton id="imgKeyBY_CONDITION" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblBY_CONDITION" runat="server" Width="140px" ></asp:label>
<asp:dropdownlist id="ddlBY_CONDITION" runat="server" Width="150px" ></asp:dropdownlist>
<asp:imagebutton id="imgbtnBY_CONDITION" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
...
<!--// 8 //-->
<asp:imagebutton id="imgKeyCUTOFF" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblCUTOFF" runat="server" Width="140px" ></asp:label>
<asp:dropdownlist id="ddlCUTOFF" runat="server" Width="150px" ></asp:dropdownlist>
<asp:imagebutton id="imgbtnCUTOFF" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
