<%@ Page Language="VB" AutoEventWireup="false" CodeFile="OTBASE_BYGROUP.aspx.vb" Inherits="PAGES_PAYROLL_OTBASE_BYGROUP" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>OTBASE_BYGROUP</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server"> 
<form id="OTBASE_BYGROUP" runat="server">
<div>
...
<!--// 2 //-->
<asp:imagebutton id="imgKeyOPTION_GROUP" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblOPTION_GROUP" runat="server" Width="140px" ></asp:label>
<asp:dropdownlist id="ddlOPTION_GROUP" runat="server" Width="150px" ></asp:dropdownlist>
<asp:imagebutton id="imgbtnOPTION_GROUP" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
...
<!--// 4 //-->
<asp:imagebutton id="imgKeyFROM_DATE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblFROM_DATE" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtFROM_DATE" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnFROM_DATE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 5 //-->
<asp:imagebutton id="imgKeyTO_DATE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblTO_DATE" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtTO_DATE" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnTO_DATE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 6 //-->
<asp:imagebutton id="imgKeyBASEON" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblBASEON" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtBASEON" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnBASEON" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
