...
<body id="body" runat="server">
    ...
    <asp:textbox id="txtADate_From" runat="server" Width="150px" Visible="false"></asp:textbox>
    ...
    <asp:textbox id="txtADate_To" runat="server" Width="150px" Visible="false"></asp:textbox>
