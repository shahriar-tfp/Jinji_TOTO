<%@ Page Language="VB" AutoEventWireup="false" CodeFile="COMMISION_LAST_YEAR.aspx.vb" Inherits="PAGES_PAYROLL_COMMISION_LAST_YEAR" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>COMMISION_LAST_YEAR</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server"> 
<form id="COMMISION_LAST_YEAR" runat="server">
<div>
...
<!--// 5 //-->
<asp:imagebutton id="imgKeyPAY_ON" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblPAY_ON" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtPAY_ON" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnPAY_ON" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
