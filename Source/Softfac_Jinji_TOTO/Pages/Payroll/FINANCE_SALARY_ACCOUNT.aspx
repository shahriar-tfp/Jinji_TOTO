<%@ Page Language="VB" AutoEventWireup="false" CodeFile="FINANCE_SALARY_ACCOUNT.aspx.vb" Inherits="PAGES_PAYROLL_FINANCE_SALARY_ACCOUNT" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>FINANCE_SALARY_ACCOUNT</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server"> 
<form id="FINANCE_SALARY_ACCOUNT" runat="server">
<div>
...
<!--// 5 //-->
<asp:imagebutton id="imgKeyACCOUNT_SEQ_2" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblACCOUNT_SEQ_2" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtACCOUNT_SEQ_2" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnACCOUNT_SEQ_2" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 6 //-->
<asp:imagebutton id="imgKeyOPTION_DEBIT_CREDIT" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblOPTION_DEBIT_CREDIT" runat="server" Width="140px" ></asp:label>
<asp:dropdownlist id="ddlOPTION_DEBIT_CREDIT" runat="server" Width="150px" ></asp:dropdownlist>
<asp:imagebutton id="imgbtnOPTION_DEBIT_CREDIT" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 7 //-->
<asp:imagebutton id="imgKeyBY_FINANCE_CODE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblBY_FINANCE_CODE" runat="server" Width="140px" ></asp:label>
<asp:dropdownlist id="ddlBY_FINANCE_CODE" runat="server" Width="150px" ></asp:dropdownlist>
<asp:imagebutton id="imgbtnBY_FINANCE_CODE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 8 //-->
<asp:imagebutton id="imgKeyACCOUNT_SEQ_5" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblACCOUNT_SEQ_5" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtACCOUNT_SEQ_5" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnACCOUNT_SEQ_5" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
