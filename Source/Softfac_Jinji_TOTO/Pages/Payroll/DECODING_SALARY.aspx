<%@ Page Language="VB" AutoEventWireup="false" CodeFile="DECODING_SALARY.aspx.vb" Inherits="PAGES_PAYROLL_DECODING_SALARY" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>DECODING_SALARY</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server"> 
<form id="DECODING_SALARY" runat="server">
<div>
...
<!--// 2 //-->
<asp:imagebutton id="imgKeyDATE_OPEN" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblDATE_OPEN" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtDATE_OPEN" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnDATE_OPEN" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 3 //-->
<asp:imagebutton id="imgKeyDECODE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblDECODE" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtDECODE" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnDECODE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
