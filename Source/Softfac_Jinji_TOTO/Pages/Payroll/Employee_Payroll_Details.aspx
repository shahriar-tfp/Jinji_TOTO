<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Employee_Payroll_Details.aspx.vb" Inherits="Pages_Payroll_Employee_Payroll_Details" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>JINJI : Payroll - Employee Payroll Details Page</title>
    <link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server">
    <form id="Employee_Payroll_Details" runat="server">
<div>
    ...
    <!--// 6 //-->
    <asp:imagebutton id="imgKeyEXCHANGE_RATE" runat="server" Width="21px" Height="21px"></asp:imagebutton>
    <asp:label id="lblEXCHANGE_RATE" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtEXCHANGE_RATE" runat="server" Width="150px"></asp:textbox>
    <asp:imagebutton id="imgbtnEXCHANGE_RATE" runat="server" Height="21px"></asp:imagebutton>
    <!--// 7 //-->
    ...
    <asp:imagebutton id="imgbtnEMPLOYEE_CREDIT" runat="server" Height="21px"></asp:imagebutton>
    <!--// 10 //-->
    ...
    <asp:imagebutton id="imgbtnEMPLOYEE_DEBIT" runat="server" Height="21px"></asp:imagebutton>
    <!--// 11 //-->
    ...
    <asp:imagebutton id="imgbtnCOMPANY_CREDIT" runat="server" Height="21px"></asp:imagebutton>
    <!--// 12 //-->
    ...
    <asp:imagebutton id="imgbtnCOMPANY_DEBIT" runat="server" Height="21px"></asp:imagebutton>
    <!--// 13 //-->
    ...
    <!--// 19 //-->
    <asp:imagebutton id="imgKeyEA_AMOUNT" runat="server" Width="21px" Height="21px"></asp:imagebutton>
    <asp:label id="lblEA_AMOUNT" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtEA_AMOUNT" runat="server" Width="150px"></asp:textbox>
    <asp:imagebutton id="imgbtnEA_AMOUNT" runat="server" Height="21px"></asp:imagebutton>
    <!--// 20 //-->
    <asp:imagebutton id="imgKeyCALCULATE_BASE_AMOUNT" runat="server" Width="21px" Height="21px"></asp:imagebutton>
    <asp:label id="lblCALCULATE_BASE_AMOUNT" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtCALCULATE_BASE_AMOUNT" runat="server" Width="150px"></asp:textbox>
    <asp:imagebutton id="imgbtnCALCULATE_BASE_AMOUNT" runat="server" Height="21px"></asp:imagebutton>
    <!--// 21 //-->
    ...
    <asp:dropdownlist id="ddlOPTION_BLOCK" runat="server" Width="157px"></asp:dropdownlist>
    <asp:imagebutton id="imgbtnOPTION_BLOCK" runat="server" Height="21px"></asp:imagebutton>
