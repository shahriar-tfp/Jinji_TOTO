<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Approval_Profile.aspx.vb" Inherits="Pages_Approval_Approval_Profile" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>JINJI : APPROVAL PROFILE PAGE</title> 
    <link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server">
    <form id="Approval_Profile" runat="server">
    <div>
	...
	<!--// 3 //-->
	<asp:image id="imgOPTION_VIEW_TYPE" runat="server" Height="21px" Width="21px"></asp:image>
	<asp:label id="lblOPTION_VIEW_TYPE" runat="server" Width="140px"></asp:label>
	<asp:dropdownlist id="ddlOPTION_VIEW_TYPE" runat="server" Width="157"></asp:dropdownlist>
	<asp:imagebutton id="imgBtnOPTION_VIEW_TYPE" runat="server" Height="21px"></asp:imagebutton>
	<!--// 4 //-->
	<asp:image id="imgNO_OF_APPROVAL" runat="server" Height="21px" Width="21px"></asp:image>
	<asp:label id="lblNO_OF_APPROVAL" runat="server" Width="140px"></asp:label>
	<asp:textbox id="txtNO_OF_APPROVAL" runat="server" Width="150px"></asp:textbox>
	<asp:imagebutton id="imgBtnNO_OF_APPROVAL" runat="server" Height="21px"></asp:imagebutton>
	<!--// Panel //-->
