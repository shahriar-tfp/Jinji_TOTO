<%@ Page Language="VB" AutoEventWireup="false" CodeFile="EMAIL_SCHEDULE.aspx.vb" Inherits="PAGES_APPROVAL_EMAIL_SCHEDULE" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>EMAIL_SCHEDULE</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server"> 
<form id="EMAIL_SCHEDULE" runat="server">
<div>
<asp:Panel ID="pnlEdit" runat="server">
<!--// 1 //-->
<asp:imagebutton id="imgKeyMODULE_PROFILE_ID" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblMODULE_PROFILE_ID" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtMODULE_PROFILE_ID" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnMODULE_PROFILE_ID" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
...
<!--// 3 //-->
<asp:imagebutton id="imgKeyTIME" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblTIME" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtTIME" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnTIME" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
