<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Approval_Condition.aspx.vb" Inherits="Pages_Approval_Approval_Condition" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>JINJI : APPROVAL CONDITION PAGE</title>
    <link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server">
    <form id="Approval_Condition" runat="server">
    <div>
	...
	<!--// 3 //-->
	<asp:image id="imgAPPROVAL_LEVEL" runat="server" Height="21px" Width="21px"></asp:image>
	<asp:label id="lblAPPROVAL_LEVEL" runat="server" Width="140px"></asp:label>
	<asp:textbox id="txtAPPROVAL_LEVEL" runat="server" Width="150px"></asp:textbox>
	<asp:imagebutton id="imgBtnAPPROVAL_LEVEL" runat="server" Height="21px"></asp:imagebutton>
	<!--// 4 //-->
	...
	<!--// 5 //-->
	<asp:image id="imgVALUE" runat="server" Height="21px" Width="21px"></asp:image>
