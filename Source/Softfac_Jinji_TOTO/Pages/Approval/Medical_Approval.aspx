					    ...
					    <td>
					        ...
					        <table id="Table6" cellspacing="0" cellpadding="0" border="0" runat="server">
					            ...
					            <tr>
					                ...
					                <td>
					                    <asp:LinkButton id="lnkBtnViewPending" runat="server" CssClass="wordstyle" Text="[ Pending Medical Claim ]" Enabled="false" ></asp:LinkButton>
					                    <asp:LinkButton id="lnkBtnClosePending" runat="server" CssClass="wordstyle11" Text="[ Pending Medical Claim ]" Visible="false" ></asp:LinkButton>
					                </td>
					                <td><asp:Image ID="imgBlank03" Width="10px" Height="25px" runat="server" /></td>
					                <td>
					                    <asp:LinkButton id="lnkBtnViewApproved" runat="server" CssClass="wordstyle" Text="[ Approved Medical Claim ]" Enabled="false" ></asp:LinkButton>
					                    <asp:LinkButton id="lnkBtnCloseApproved" runat="server" CssClass="wordstyle11" Text="[ Approved Medical Claim ]" Visible="false" ></asp:LinkButton>
					                </td>
					                <td><asp:Image ID="imgBlank04" Width="10px" Height="25px" runat="server" /></td>
					                <td>
					                    <asp:LinkButton id="lnkBtnViewReject" runat="server" CssClass="wordstyle" Text="[ Reject Medical Claim ]" Enabled="false" ></asp:LinkButton>
					                    <asp:LinkButton id="lnkBtnCloseReject" runat="server" CssClass="wordstyle11" Text="[ Reject Medical Claim ]" Visible="false" ></asp:LinkButton>
					                </td>
					                <td><asp:Image ID="imgBlank05" Width="10px" Height="25px" runat="server" /></td>
					                <td>
					                    <asp:LinkButton id="lnkBtnViewBalance" runat="server" CssClass="wordstyle" Text="[ Medical Balance ]" visible="false" ></asp:LinkButton>
					                    <asp:LinkButton id="lnkBtnCloseBalance" runat="server" CssClass="wordstyle11" Text="[ Medical Balance ]" Visible="false" ></asp:LinkButton>
					                </td>
					            </tr>
					        </table>
					    </td> 
