<%@ Page Language="VB" AutoEventWireup="false" CodeFile="SECONDARY_USER_APPROVAL.aspx.vb" Inherits="PAGES_APPROVAL_SECONDARY_USER_APPROVAL" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>SECONDARY_USER_APPROVAL</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server"> 
<form id="SECONDARY_USER_APPROVAL" runat="server">
<div>
<asp:Panel ID="pnlEdit" runat="server">
<!--// 1 //-->
<asp:imagebutton id="imgKeyPRIMARY_USER" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblPRIMARY_USER" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtPRIMARY_USER" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnPRIMARY_USER" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 2 //-->
<asp:imagebutton id="imgKeySECONDARY_USER" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblSECONDARY_USER" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtSECONDARY_USER" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnSECONDARY_USER" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
