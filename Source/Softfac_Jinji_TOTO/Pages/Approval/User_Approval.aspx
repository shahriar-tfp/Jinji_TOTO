<%@ Page Language="VB" AutoEventWireup="false" CodeFile="User_Approval.aspx.vb" Inherits="Pages_Approval_User_Approval" %>
...
<body id="body" runat="server">
    <form id="User_Approval" runat="server">
    <div>
	...
	<!--// 4 //-->
	<asp:image id="imgUSER_PROFILE_CODE" runat="server" Height="21px" Width="21px"></asp:image>
