<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TD_GRPLEVELGRADE.aspx.vb" Inherits="PAGES_TRAINING_TD_GRPLEVELGRADE" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>TD_GRPLEVELGRADE</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server"> 
<form id="TD_GRPLEVELGRADE" runat="server">
<div>
...
<!--// 2 //-->
<asp:imagebutton id="imgKeyJOBLEVEL_CODE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblJOBLEVEL_CODE" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtJOBLEVEL_CODE" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnJOBLEVEL_CODE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 3 //-->
<asp:imagebutton id="imgKeyGROUPBY" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblGROUPBY" runat="server" Width="140px" ></asp:label>
<asp:dropdownlist id="ddlGROUPBY" runat="server" Width="150px" ></asp:dropdownlist>
<asp:imagebutton id="imgbtnGROUPBY" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 4 //-->
<asp:imagebutton id="imgKeyGROUP_ID" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblGROUP_ID" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtGROUP_ID" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnGROUP_ID" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<!--// List Box 3 //-->
<asp:imagebutton id="imgbtnGROUP_ID2" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<!--// List Box 3 //-->
