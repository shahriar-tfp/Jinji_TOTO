<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TD_COURSETYPE.aspx.vb" Inherits="PAGES_TRAINING_TD_COURSETYPE" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>TD_COURSETYPE</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server"> 
<form id="TD_COURSETYPE" runat="server">
<div>
...
<!--// 4 //-->
<asp:imagebutton id="imgKeyCATEGORY_CODE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblCATEGORY_CODE" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtCATEGORY_CODE" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnCATEGORY_CODE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 5 //-->
<asp:imagebutton id="imgKeyBUDGETCOST" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblBUDGETCOST" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtBUDGETCOST" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnBUDGETCOST" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
...
<!--// 7 //-->
<asp:imagebutton id="imgKeyCONTENT" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblCONTENT" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtCONTENT" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnCONTENT" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 8 //-->
<asp:imagebutton id="imgKeyINCLUDE_TNA" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblINCLUDE_TNA" runat="server" Width="140px" ></asp:label>
<asp:dropdownlist id="ddlINCLUDE_TNA" runat="server" Width="150px" ></asp:dropdownlist>
<asp:imagebutton id="imgbtnINCLUDE_TNA" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
