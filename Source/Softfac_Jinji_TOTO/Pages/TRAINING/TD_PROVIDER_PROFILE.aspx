<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TD_PROVIDER_PROFILE.aspx.vb" Inherits="PAGES_TRAINING_TD_PROVIDER_PROFILE" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>TD_PROVIDER_PROFILE</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server"> 
<form id="TD_PROVIDER_PROFILE" runat="server">
<div>
...
<!--// 4 //-->
<asp:imagebutton id="imgKeyCONTACTPERSON" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblCONTACTPERSON" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtCONTACTPERSON" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnCONTACTPERSON" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
...
<!--// 7 //-->
<asp:imagebutton id="imgKeyPOSTALCODE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblPOSTALCODE" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtPOSTALCODE" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnPOSTALCODE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
...
<!--// 13 //-->
<asp:imagebutton id="imgKeyDISTANCE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblDISTANCE" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtDISTANCE" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnDISTANCE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
...
<!--// 15 //-->
<asp:imagebutton id="imgKeyINTEREXTER" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblINTEREXTER" runat="server" Width="140px" ></asp:label>
<asp:dropdownlist id="ddlINTEREXTER" runat="server" Width="150px" ></asp:dropdownlist>
<asp:imagebutton id="imgbtnINTEREXTER" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
