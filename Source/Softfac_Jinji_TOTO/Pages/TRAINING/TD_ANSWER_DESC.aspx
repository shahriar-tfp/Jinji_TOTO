<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TD_ANSWER_DESC.aspx.vb" Inherits="PAGES_TRAINING_TD_ANSWER_DESC" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>TD_ANSWER_DESC</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server"> 
<form id="TD_ANSWER_DESC" runat="server">
<div>
...
<!--// 2 //-->
<asp:imagebutton id="imgKeyANSWER_ID" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblANSWER_ID" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtANSWER_ID" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnANSWER_ID" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 3 //-->
<asp:imagebutton id="imgKeyANSWERDESC_ID" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblANSWERDESC_ID" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtANSWERDESC_ID" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnANSWERDESC_ID" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 4 //-->
<asp:imagebutton id="imgKeyANSWER_DESC" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblANSWER_DESC" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtANSWER_DESC" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnANSWER_DESC" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 5 //-->
<asp:imagebutton id="imgKeySEQUENCE_ID" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblSEQUENCE_ID" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtSEQUENCE_ID" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnSEQUENCE_ID" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
