<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TD_TRAINER_PROFILE.aspx.vb" Inherits="PAGES_TRAINING_TD_TRAINER_PROFILE" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>TD_TRAINER_PROFILE</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server"> 
<form id="TD_TRAINER_PROFILE" runat="server">
<div>
...
<!--// 5 //-->
<asp:imagebutton id="imgKeyTRAINER_REMARK" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblTRAINER_REMARK" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtTRAINER_REMARK" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnTRAINER_REMARK" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
