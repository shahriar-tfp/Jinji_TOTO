<%@ Page Language="VB" AutoEventWireup="false" CodeFile="EST_EMPLICENCE.aspx.vb" Inherits="PAGES_TRANSPORT_EST_EMPLICENCE" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>EST_EMPLICENCE</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server"> 
<form id="EST_EMPLICENCE" runat="server">
<div>
...
<!--// 3 //-->
<asp:imagebutton id="imgKeySERIALNO" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblSERIALNO" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtSERIALNO" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnSERIALNO" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 4 //-->
<asp:imagebutton id="imgKeyFROMDATE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblFROMDATE" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtFROMDATE" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnFROMDATE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 5 //-->
<asp:imagebutton id="imgKeyTODATE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblTODATE" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtTODATE" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnTODATE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
...
<!--// 6 //-->
<asp:imagebutton id="imgKeyA" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblA" runat="server" Width="140px" ></asp:label>
<asp:dropdownlist id="ddlA" runat="server" Width="150px" ></asp:dropdownlist>
<asp:imagebutton id="imgbtnA" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 6.5 //-->
<asp:imagebutton id="imgKeyA1" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblA1" runat="server" Width="140px" ></asp:label>
<asp:dropdownlist id="ddlA1" runat="server" Width="150px" ></asp:dropdownlist>
<asp:imagebutton id="imgbtnA1" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 7 //-->
<asp:imagebutton id="imgKeyB" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblB" runat="server" Width="140px" ></asp:label>
<asp:dropdownlist id="ddlB" runat="server" Width="150px" ></asp:dropdownlist>
<asp:imagebutton id="imgbtnB" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 8 //-->
<asp:imagebutton id="imgKeyB1" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblB1" runat="server" Width="140px" ></asp:label>
<asp:dropdownlist id="ddlB1" runat="server" Width="150px" ></asp:dropdownlist>
<asp:imagebutton id="imgbtnB1" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 9 //-->
<asp:imagebutton id="imgKeyB2" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblB2" runat="server" Width="140px" ></asp:label>
<asp:dropdownlist id="ddlB2" runat="server" Width="150px" ></asp:dropdownlist>
<asp:imagebutton id="imgbtnB2" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 10 //-->
<asp:imagebutton id="imgKeyC" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblC" runat="server" Width="140px" ></asp:label>
<asp:dropdownlist id="ddlC" runat="server" Width="150px" ></asp:dropdownlist>
<asp:imagebutton id="imgbtnC" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 11 //-->
<asp:imagebutton id="imgKeyD" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblD" runat="server" Width="140px" ></asp:label>
<asp:dropdownlist id="ddlD" runat="server" Width="150px" ></asp:dropdownlist>
<asp:imagebutton id="imgbtnD" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 11.5 //-->
<asp:imagebutton id="imgKeyDA" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblDA" runat="server" Width="140px" ></asp:label>
<asp:dropdownlist id="ddlDA" runat="server" Width="150px" ></asp:dropdownlist>
<asp:imagebutton id="imgbtnDA" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 12 //-->
<asp:imagebutton id="imgKeyE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblE" runat="server" Width="140px" ></asp:label>
<asp:dropdownlist id="ddlE" runat="server" Width="150px" ></asp:dropdownlist>
<asp:imagebutton id="imgbtnE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 13 //-->
<asp:imagebutton id="imgKeyE1" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblE1" runat="server" Width="140px" ></asp:label>
<asp:dropdownlist id="ddlE1" runat="server" Width="150px" ></asp:dropdownlist>
<asp:imagebutton id="imgbtnE1" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 14 //-->
<asp:imagebutton id="imgKeyE2" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblE2" runat="server" Width="140px" ></asp:label>
<asp:dropdownlist id="ddlE2" runat="server" Width="150px" ></asp:dropdownlist>
<asp:imagebutton id="imgbtnE2" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 15 //-->
<asp:imagebutton id="imgKeyGDL" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblGDL" runat="server" Width="140px" ></asp:label>
<asp:dropdownlist id="ddlGDL" runat="server" Width="150px" ></asp:dropdownlist>
<asp:imagebutton id="imgbtnGDL" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 16 //-->
<asp:imagebutton id="imgKeyPSV" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblPSV" runat="server" Width="140px" ></asp:label>
<asp:dropdownlist id="ddlPSV" runat="server" Width="150px" ></asp:dropdownlist>
<asp:imagebutton id="imgbtnPSV" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 17 //-->
<asp:imagebutton id="imgKeyFORKLIST" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblFORKLIST" runat="server" Width="140px" ></asp:label>
<asp:dropdownlist id="ddlFORKLIST" runat="server" Width="150px" ></asp:dropdownlist>
<asp:imagebutton id="imgbtnFORKLIST" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
