...
Partial Class PAGES_TRANSPORT_EST_BUSREQUEST
...
#Region "Private Declaration"
    ...
    Dim strCom, strEmp, strDoc, strReason, strPick, strSend, strRequester, strDept, strExt, strReD, strApp, strAppD, strRem1, strRem2, strStatus, strShift, strSSTime As String
#End Region
#Region "Page Setting"
    ...
    Sub PagePreload()
        ...
        mySetting.GetBtnImgUrl(imgBtnCopy, Session("Company").ToString, btnColourDef, "btnCreate.png")
        ...
        mySetting.GetImgBtnUrl(imgbtnSTAFF2, clsGlobalSetting.ImageType._LOOKUP, Session("Company").ToString)
...
#Region "Panel Edit"
    Protected Sub imgBtnSubmit_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnSubmit.Click
        lblresult2.Text = ""
        Dim AutoDocNo As String
        Dim AutoDocDS As DataSet

        If ValidateInsert() = True Then
            If txtREQDOCNO.Text = "" Then
                AutoDocNo = "exec sp_est_InsUpdDelRequest 'AUTOREQDOCNO','" & strDoc & "','" & strReason & "','" & strPick & "','" & strSend & "','" & strRequester & "','" & strDept & "','" & strExt & "','"
                AutoDocNo = AutoDocNo & strReD & "','" & strApp & "','" & strAppD & "','" & strRem1 & "','" & strRem2 & "','" & strStatus & "','" & strEmp & "','','','" & strSSTime & "','" & strShift & "','" & Session("EmpID").ToString & "'"
                AutoDocDS = mySQL.ExecuteSQL(AutoDocNo)

                If AutoDocDS.Tables.Count > 0 Then
                    If AutoDocDS.Tables(0).Rows.Count > 0 Then
                        txtREQDOCNO.Text = AutoDocDS.Tables(0).Rows(0).Item(0).ToString
                    End If
                End If
            End If
            strDoc = txtREQDOCNO.Text
            strReason = ddlREASON.SelectedValue
            strPick = txtPICKUPDATE.Text
            strSend = txtSENDBACKDATE.Text
            strRequester = txtREQUESTER.Text
            strDept = txtDEPTID.Text
            strExt = txtEXT.Text
            strReD = txtREQUESTDATE.Text
            strApp = txtAPPROVEDBY.Text
            strAppD = txtAPPROVEDDATE.Text
            strRem1 = txtREMARK1.Text
            strRem2 = txtREMARK2.Text
            strStatus = ddlSTATUS.SelectedValue
            strSSTime = txtSHIFTTIME.Text
            strShift = txtSHIFT.Text

            Dim getstring As String
            Dim getDS As DataSet

            getstring = "exec sp_est_InsUpdDelRequest 'Sel','" & strDoc & "','" & strReason & "','" & strPick & "','" & strSend & "','" & strRequester & "','" & strDept & "','" & strExt & "','"
            getstring = getstring & strReD & "','" & strApp & "','" & strAppD & "','" & strRem1 & "','" & strRem2 & "','" & strStatus & "','" & strEmp & "','','','" & strSSTime & "','" & strShift & "','" & Session("EmpID").ToString & "'"
            getDS = mySQL.ExecuteSQL(getstring)

            If getDS.Tables.Count > 0 Then
                If getDS.Tables(0).Rows.Count > 0 Then
                    strDoc = getDS.Tables(0).Rows(0).Item(0).ToString
                    strReason = getDS.Tables(0).Rows(0).Item(1).ToString
                    strPick = getDS.Tables(0).Rows(0).Item(2).ToString
                    strSend = getDS.Tables(0).Rows(0).Item(3).ToString
                    strRequester = getDS.Tables(0).Rows(0).Item(4).ToString
                    strDept = getDS.Tables(0).Rows(0).Item(5).ToString
                    strExt = getDS.Tables(0).Rows(0).Item(6).ToString
                    strReD = getDS.Tables(0).Rows(0).Item(7).ToString
                    strApp = getDS.Tables(0).Rows(0).Item(8).ToString
                    strAppD = getDS.Tables(0).Rows(0).Item(9).ToString
                    strRem1 = getDS.Tables(0).Rows(0).Item(10).ToString
                    strRem2 = getDS.Tables(0).Rows(0).Item(11).ToString
                    strStatus = getDS.Tables(0).Rows(0).Item(12).ToString
                    strEmp = getDS.Tables(0).Rows(0).Item(13).ToString
                    strSSTime = getDS.Tables(0).Rows(0).Item(16).ToString
                    strShift = getDS.Tables(0).Rows(0).Item(17).ToString
                End If
            End If

            getstring = "exec sp_est_InsUpdDelRequest 'DELALL','" & strDoc & "','" & strReason & "','" & strPick & "','" & strSend & "','" & strRequester & "','" & strDept & "','" & strExt & "','"
            getstring = getstring & strReD & "','" & strApp & "','" & strAppD & "','" & strRem1 & "','" & strRem2 & "','" & strStatus & "','" & strEmp & "','','','" & strSSTime & "','" & strShift & "','" & Session("EmpID").ToString & "'"
            mySQL.ExecuteSQL(getstring)

            For i = 0 To lstright.Items.Count - 1
                strEmp = lstright.Items(i).Value
                AddSubmit()
            Next
...
#Region "Panel Action"
    ...
    Protected Sub imgBtnAdd_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnAdd.Click
        ...
        imgBtnCopy.CssClass = buttonPosition4
...
#Region "Sub & Function"
                ...
                For i = 0 To myDS.Tables(0).Rows.Count - 1
                    ...
                    Select Case UCase(Trim(myDS.Tables(0).Rows(i).Item(dt).ToString))
                        ...
                        Case Else
                            ...
                            Select Case UCase(Trim(myDS.Tables(0).Rows(i).Item(posType).ToString))
                                Case "0"
                                    If UCase(Trim(myDS.Tables(0).Rows(i).Item(code).ToString)) = "STAFF" Then
                                        ' set lst pnl 
                                        ...
                                        imgKeySTAFF.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                                        imgKeySTAFF.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                                        imgKeySTAFF.Style.Add("position", "absolute")
                                        autonum += 1
                                        lblSTAFF.CssClass = "wordstyle12"
                                        lblSTAFF.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                                        lblSTAFF.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                                        lblSTAFF.Style.Add("position", "absolute")
                                        autonum += 1
                                        ...
                                        imgbtnSTAFF2.Visible = True
                                        imgbtnSTAFF.Visible = False
                                        imgbtnSTAFF2.Style.Add("left", mySetting.GetObjPositionRL(EctWidth, 6, "X"))
                                        imgbtnSTAFF2.Style.Add("top", mySetting.GetObjPositionRL(6, autonum2, "Y"))
                                        imgbtnSTAFF2.Style.Add("position", "absolute")
                                        autonum += 44
                                        imgbtnSTAFF2_Click(Nothing, Nothing)
                                    Else
    ...
    Private Sub AutoFillColumn()
        Dim autosql As String
        Dim AutoDs As DataSet

        autosql = "Exec sp_est_SelAutoFill '" & Session("EmpID").ToString & "'"
        AutoDs = mySQL.ExecuteSQL(autosql, Session("Company").ToString, Session("EmpID").ToString)

        If AutoDs.Tables.Count > 0 Then
            If AutoDs.Tables(0).Rows.Count > 0 Then
                txtCOMPANY_PROFILE_CODE.Text = AutoDs.Tables(0).Rows(0).Item(0).ToString
                txtREQUESTER.Text = AutoDs.Tables(0).Rows(0).Item(1).ToString
                txtREQUESTER.Enabled = False
                txtAPPROVEDBY.Text = AutoDs.Tables(0).Rows(0).Item(1).ToString
                txtAPPROVEDBY.Enabled = False

                txtPICKUPDATE.Text = AutoDs.Tables(0).Rows(0).Item(2).ToString
                txtSENDBACKDATE.Text = AutoDs.Tables(0).Rows(0).Item(2).ToString
                txtREQUESTDATE.Text = AutoDs.Tables(0).Rows(0).Item(2).ToString
                txtREQUESTDATE.Enabled = False
                txtAPPROVEDDATE.Text = AutoDs.Tables(0).Rows(0).Item(2).ToString
            End If
        End If

    End Sub

    Private Sub AutoFillShiftTime()
        Dim autosql As String
        Dim AutoDs As DataSet

        autosql = "Exec sp_est_SelAutoShift '" & txtSHIFT.Text & "'"
        AutoDs = mySQL.ExecuteSQL(autosql, Session("Company").ToString, Session("EmpID").ToString)

        If AutoDs.Tables.Count > 0 Then
            If AutoDs.Tables(0).Rows.Count > 0 Then
                txtSHIFTTIME.Text = AutoDs.Tables(0).Rows(0).Item(0).ToString
            End If
        End If

    End Sub

    Private Sub AddSubmit()
        Dim autosql As String
        
        autosql = "exec sp_est_InsUpdDelRequest 'ADD','" & strDoc & "','" & strReason & "','" & strPick & "','" & strSend & "','" & strRequester & "','" & strDept & "','" & strExt & "','"
        autosql = autosql & strReD & "','" & strApp & "','" & strAppD & "','" & strRem1 & "','" & strRem2 & "','" & strStatus & "','" & strEmp & "','','','" & strSSTime & "','" & strShift & "','" & Session("EmpID").ToString & "'"

        mySQL.ExecuteSQL(autosql, Session("Company").ToString, Session("EmpID").ToString)
    ...
    Private Sub AddUpdate()
        ...
        autosql = "exec sp_est_InsUpdDelRequest 'UPD','" & strDoc & "','" & strReason & "','" & strPick & "','" & strSend & "','" & strRequester & "','" & strDept & "','" & strExt & "','"
        autosql = autosql & strReD & "','" & strApp & "','" & strAppD & "','" & strRem1 & "','" & strRem2 & "','" & strStatus & "','" & strEmp & "','','','" & strSSTime & "','" & strShift & "','" & Session("EmpID").ToString & "'"
                ...
                Select Case myDS.Tables(0).Rows(i).Item(1).ToString
                    ...
                    Case Else   '"CHARACTER", "LOOKUP"
                        ...
                        If myTextBox.Visible = True Then
                            If mySetting.CheckTextNullAndReplaceSingleQuote(myTextBox) = True Then
                                ssql = ssql & myDS.Tables(0).Rows(i).Item(0) & ","
                                If myDS.Tables(0).Rows(i).Item(0).ToString.ToUpper = "STAFF" Then
                ...
                For i = 0 To myDS2.Tables(0).Rows.Count - 1
                    Select Case myDS2.Tables(0).Rows(i).Item(2).ToString
                        ...
                        Case Else '"CHARACTER","LOOKUP"
                            ...
                            If myTextBox.Visible = True Then
                                If mySetting.CheckTextNullAndReplaceSingleQuote(myTextBox) = True Then
                                    If myDS2.Tables(0).Rows(i).Item(0).ToString.ToUpper = "STAFF" Then
...
#End Region
    ...
    Protected Sub imgbtnSTAFF2_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgbtnSTAFF2.Click
        Dim ListSql As String
        Dim ListDS As DataSet

        ListSql = "exec sp_est_SelRequest '" & txtREQDOCNO.Text & "','" & Session("EmpID").ToString & "','EMP'"
        ListDS = mySQL.ExecuteSQL(ListSql, Session("Company").ToString, Session("EmpID").ToString)

        If ListDS.Tables(0).Rows.Count > 0 Then
            lstleft.DataSource = ListDS.Tables(0)
            lstleft.DataTextField = "Name"
            lstleft.DataValueField = "Code"
            lstleft.DataBind()
        End If
        If ListDS.Tables(1).Rows.Count > 0 Then
            lstright.DataSource = ListDS.Tables(1)
    ...
    Protected Sub txtSHIFT_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtSHIFT.TextChanged
        AutoFillShiftTime()
    End Sub

    Protected Sub imgBtnCopy_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnCopy.Click

        Dim AutoDocNo As String
        Dim AutoDocDS As DataSet
        If txtREQDOCNO.Text <> "" Then
            strDoc = txtREQDOCNO.Text
            AutoDocNo = "exec sp_est_InsUpdDelRequest 'COPY','" & strDoc & "','" & strReason & "','" & strPick & "','" & strSend & "','" & strRequester & "','" & strDept & "','" & strExt & "','"
            AutoDocNo = AutoDocNo & strReD & "','" & strApp & "','" & strAppD & "','" & strRem1 & "','" & strRem2 & "','" & strStatus & "','" & strEmp & "','','','" & strSSTime & "','" & strShift & "','" & Session("EmpID").ToString & "'"
            AutoDocDS = mySQL.ExecuteSQL(AutoDocNo)
