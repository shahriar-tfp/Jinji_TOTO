<%@ Page Language="VB" AutoEventWireup="false" CodeFile="EST_BUSROUTE.aspx.vb" Inherits="PAGES_TRANSPORT_EST_BUSROUTE" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>EST_BUSROUTE</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server"> 
<form id="EST_BUSROUTE" runat="server">
<div>
...
<!--// 2 //-->
<asp:imagebutton id="imgKeyZONENO" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblZONENO" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtZONENO" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnZONENO" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
