...
Partial Class PAGES_TRANSPORT_EST_EMPLICENCE
...
#Region "Sub & Function"
    Private Function checkLicence() As String
        ...
        If myDSf.Tables(0).Rows(0).Item(0).ToString = "1" And myDSf.Tables(0).Rows(0).Item(1).ToString = "C" Then
            If ddlD.SelectedValue = "Y" Or ddlDA.SelectedValue = "Y" Then
                Return "True"
            Else
                Return "Car"
            End If
        ElseIf myDSf.Tables(0).Rows(0).Item(0).ToString = "1" And myDSf.Tables(0).Rows(0).Item(1).ToString = "M" Then
            If ddlB.SelectedValue = "Y" Or ddlB1.SelectedValue = "Y" Or ddlB2.SelectedValue = "Y" Then
                Return "True"
            Else
                Return "Motor"
            End If
    ...
    Private Function ValidateInsert() As Boolean
        ...
        If licenceError.ToString <> "True" Then
            lblresult2.Text = "Invalid Input! Licence " & licenceError.ToString & " Not Select Yes!"
            Return False
        End If
        If myDS.Tables(0).Rows.Count > 0 Then
