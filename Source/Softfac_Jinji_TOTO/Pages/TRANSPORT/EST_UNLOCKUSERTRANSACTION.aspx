<%@ Page Language="VB" AutoEventWireup="false" CodeFile="EST_UNLOCKUSERTRANSACTION.aspx.vb" Inherits="PAGES_TRANSPORT_EST_UNLOCKUSERTRANSACTION" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>EST_UNLOCKUSERTRANSACTION</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server"> 
<form id="EST_UNLOCKUSERTRANSACTION" runat="server">
<div>
...
<!--// 2 //-->
<asp:imagebutton id="imgKeyUSERID" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblUSERID" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtUSERID" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnUSERID" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 3 //-->
<asp:imagebutton id="imgKeyUNLOCKDATESTART" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblUNLOCKDATESTART" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtUNLOCKDATESTART" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnUNLOCKDATESTART" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 4 //-->
<asp:imagebutton id="imgKeyUNLOCKDATEEND" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblUNLOCKDATEEND" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtUNLOCKDATEEND" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnUNLOCKDATEEND" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
