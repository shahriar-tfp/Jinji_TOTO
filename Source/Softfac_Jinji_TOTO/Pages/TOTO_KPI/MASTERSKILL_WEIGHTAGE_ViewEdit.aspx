...
<body>
    ...
    <asp:imagebutton id="imgBtnPreview" runat="server" Width="74" Height="21" ></asp:imagebutton>
    ...
    <tr><td><div id="div1" style="top: 200px;left: 15px;position :absolute; width: 100%; height: 15px;"><asp:Label ID="lblPROCESS" runat="server" Width="120px"></asp:Label>
    <asp:dropdownlist ID="ddlPROCESS" runat="server" Width="150px" AutoPostBack="true" Enabled = "false"></asp:dropdownlist>
    <asp:Label ID="lblITEM" runat="server" Width="120px"></asp:Label>
    <asp:dropdownlist ID="ddlITEM" runat="server" Width="150px" AutoPostBack="true" Enabled = "false"></asp:dropdownlist></div></td></tr>
	   <tr><td>	    
	    <div id="divGridview1" style="top: 250px;left: 15px;position :absolute; width: 100%; height: 200px;overflow: scroll">
            ...
            <asp:gridview id="gv2" Width="100%" runat="server" AutoGenerateColumns="true" Visible="false"
	         ...
	         <tr><td><div id="divGridview2" style="top: 500px;left: 15px;position :absolute; width: 98%; height: 140px;"><asp:Label ID="lblTotalSpecial" runat="server" text="Total Special Skill" Width="150px"></asp:Label><asp:textbox ID="txtTotalSpecialSkill" runat="server" text="" Width="150px" Enabled = "false"></asp:textbox>
