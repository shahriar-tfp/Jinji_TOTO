...
Partial Class PAGES_TOTO_KPI_MASTER_SKILL_SETUP
                    ...
                    If UCase(Trim(myDSDefault.Tables(0).Rows(j).Item(op).ToString)) = "YES" Then
                        Select Case UCase(Trim(myDSDefault.Tables(0).Rows(j).Item(dt).ToString))
                            ...
                            Case Else
                                ...
                                myTextBox.Text = ""
                        End Select
                        If Trim(myDSDefault.Tables(0).Rows(j).Item(code).ToString.ToUpper) = "YEAR" Then
                            Dim myDropdownlist As DropDownList = Page.FindControl("ddl" & Trim(myDSDefault.Tables(0).Rows(j).Item(code)))
                            myDropdownlist.SelectedValue = Trim(myDSDefault.Tables(0).Rows(j).Item(dv).ToString)
                ...
                If chkEdit.Checked Then
                    ...
                    If myDS1.Tables(0).Rows.Count > 0 Then
                        For j = 0 To myDS1.Tables(0).Rows.Count - 1
                            ...
                            End Select
                            If Trim(myDS1.Tables(0).Rows(j).Item(code).ToString.ToUpper) = "YEAR" Then
                                Dim myDropdownlist As DropDownList = Page.FindControl("ddl" & Trim(myDS1.Tables(0).Rows(j).Item(code)))
                                If Trim(gvHistory.Rows(i).Cells(num).Text) = "&nbsp;" Then
                                    myDropdownlist.SelectedValue = ""
                                Else
...
#Region "Sub & Function"
    Sub BindDepartment()
        ssql = "exec [sp_org_getOCPIDObject] 'DEPARTMENT_0_2','" & Session("Company") & "','','','','','','',''"
    ...
    Sub BindSection()
        ssql = "exec [sp_org_getOCPIDObject] 'SECTION_0_2','" & Session("Company") & "','','','','','','',''"
        myDS2 = mySQL.ExecuteSQL(ssql)
        If myDS2.Tables.Count > 0 Then
            If myDS2.Tables(0).Columns.Count > 1 Then
        ...
        Try
            ...
            If myDS.Tables(0).Rows.Count > 0 Then
                For i = 0 To myDS.Tables(0).Rows.Count - 1
                    ...
                    If Trim(myDS.Tables(0).Rows(i).Item(code).ToString.ToUpper) = "YEAR" Then
        ...
        For i = 0 To myDS.Tables(0).Rows.Count - 1
            Select Case myDS.Tables(0).Rows(i).Item(1).ToString.Trim
                ...
                Case Else
                    ...
                    If myDS.Tables(0).Rows(i).Item(0).ToString.ToUpper = "YEAR" Then
                        myTXT.Text = ddlYEAR.SelectedValue
                    Else
                        myTXT.Text = ""
                    End If
                    myTXT = Nothing
        ...
        If myDS.Tables(0).Rows.Count > 0 Then
            For i = 0 To myDS.Tables(0).Rows.Count - 1
                Select Case myDS.Tables(0).Rows(i).Item(1).ToString
                    ...
                    Case "DECIMAL", "INTEGER"
                        Dim myTextBox As TextBox = Page.FindControl("txt" & Trim(myDS.Tables(0).Rows(i).Item(0)))
                        If myTextBox.Visible = True Or Trim(myDS.Tables(0).Rows(i).Item(0).ToString.ToUpper) = "YEAR" Then
                            If mySetting.CheckTextNullAndReplaceSingleQuote(myTextBox) = True Then
...
#End Region
    ...
    Protected Sub ddlOCP_ID_DEPARTMENT_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ddlOCP_ID_DEPARTMENT.SelectedIndexChanged
        ...
        section = ddlOCP_ID_SECTION.SelectedValue

        If ddlOCP_ID_DEPARTMENT.SelectedValue <> "" Then
            ssql = "exec [sp_org_getOCPIDObject] 'DEPARTMENT_1_2','" & Session("Company") & "','','','" & ddlOCP_ID_DEPARTMENT.SelectedValue & "','','','',''"
            myDS2 = mySQL.ExecuteSQL(ssql)
            If myDS2.Tables.Count > 0 Then
                If myDS2.Tables(0).Columns.Count > 1 Then
                    ddlOCP_ID_SECTION.DataTextField = "Name"
        ...
        Else
            BindSection()
        End If
        mySetting.ArrangeDDLSelectedIndex(ddlOCP_ID_SECTION, clsGlobalSetting.DDLSelection.SelectedValue, section)
    End Sub
    ...
    Protected Sub ddlOCP_ID_SECTION_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ddlOCP_ID_SECTION.SelectedIndexChanged
        ...
        If ddlOCP_ID_SECTION.SelectedValue <> "" Then
            ssql = "exec [sp_org_getOCPIDObject] 'SECTION_2_2','" & Session("Company") & "','','','','" & ddlOCP_ID_SECTION.SelectedValue & "','','',''"
            myDS2 = mySQL.ExecuteSQL(ssql)
            If myDS2.Tables.Count > 0 Then
                If myDS2.Tables(0).Rows.Count > 1 And department = "" Then
                    department = myDS2.Tables(0).Rows(1).Item(0).ToString
                End If
            End If
            myDS2 = Nothing
        ...
        End If
        mySetting.ArrangeDDLSelectedIndex(ddlOCP_ID_DEPARTMENT, clsGlobalSetting.DDLSelection.SelectedValue, department)
    End Sub
    Protected Sub ddlYEAR_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ddlYEAR.SelectedIndexChanged
        txtYEAR.Text = ddlYEAR.SelectedValue
    End Sub
End Class