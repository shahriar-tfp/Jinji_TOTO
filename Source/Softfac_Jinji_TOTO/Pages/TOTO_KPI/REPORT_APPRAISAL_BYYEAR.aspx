<%@ Page Language="VB" AutoEventWireup="false" CodeFile="REPORT_APPRAISAL_BYYEAR.aspx.vb" Inherits="PAGES_TOTO_KPI_REPORT_APPRAISAL_BYYEAR" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>REPORT_APPRAISAL_BYYEAR</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server"> 
<form id="REPORT_APPRAISAL_BYYEAR" runat="server">
<div>
...
<!--// 3 //-->
<asp:imagebutton id="imgKeyFROM_YEAR" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblFROM_YEAR" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtFROM_YEAR" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnFROM_YEAR" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 4 //-->
<asp:imagebutton id="imgKeyTO_YEAR" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblTO_YEAR" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtTO_YEAR" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnTO_YEAR" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 5 //-->
<asp:imagebutton id="imgKeyREPORT_NAME" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblREPORT_NAME" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtREPORT_NAME" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnREPORT_NAME" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
