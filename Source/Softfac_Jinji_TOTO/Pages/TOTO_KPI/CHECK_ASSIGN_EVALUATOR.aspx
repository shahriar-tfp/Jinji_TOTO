<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CHECK_ASSIGN_EVALUATOR.aspx.vb" Inherits="Pages_TOTO_KPI_CHECK_ASSIGN_EVALUATOR" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>CHECK_ASSIGN_EVALUATOR View</title>
    <link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />

</head>
<body>
    <form id="CHECK_ASSIGN_EVALUATOR" runat="server">
    <div>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
	   <tr><td>	    
	    ...
	    <asp:Label ID="lblgv1" Text="Not Assign Skill Approval" runat="server" ForeColor="Red" Visible="false"></asp:Label>
