...
Partial Class PAGES_TOTO_KPI_EMPLOYEE_SKILL_POINT
...
#Region "Sub & Function"
    Private Sub getTotalPoint()
        Dim totalPoint, totalcommon, totalspecial As Double
        totalPoint = 0

        If Double.TryParse(txtCOMMONSKILLPOINT.Text, totalcommon) Then
            totalPoint = totalPoint + totalcommon
        End If

        If Double.TryParse(txtSPECIALSKILLPOINT.Text, totalspecial) Then
            totalPoint = totalPoint + totalspecial
        End If

        txtTOTALPOINT.Text = totalPoint
...
#End Region
    ...
    Protected Sub txtCOMMONSKILLPOINT_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtCOMMONSKILLPOINT.TextChanged
        getTotalPoint()
    End Sub

    Protected Sub txtSPECIALSKILLPOINT_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtSPECIALSKILLPOINT.TextChanged
        getTotalPoint()
    End Sub
End Class