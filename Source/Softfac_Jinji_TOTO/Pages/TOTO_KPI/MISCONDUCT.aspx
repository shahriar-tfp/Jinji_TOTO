<%@ Page Language="VB" AutoEventWireup="false" CodeFile="MISCONDUCT.aspx.vb" Inherits="PAGES_TOTO_KPI_MISCONDUCT" %>
...
<form id="MISCONDUCT" runat="server">
<div>
...
<!--// 4 //-->
<asp:imagebutton id="imgKeyMINOR" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblMINOR" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtMINOR" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnMINOR" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 5 //-->
<asp:imagebutton id="imgKeySERIOUS" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblSERIOUS" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtSERIOUS" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnSERIOUS" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 6 //-->
<asp:imagebutton id="imgKeyGROSS" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblGROSS" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtGROSS" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnGROSS" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
