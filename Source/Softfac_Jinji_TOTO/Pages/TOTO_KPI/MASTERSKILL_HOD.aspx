<%@ Page Language="VB" AutoEventWireup="false" CodeFile="MASTERSKILL_HOD.aspx.vb" Inherits="PAGES_TOTO_KPI_MASTERSKILL_HOD" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>MASTERSKILL_HOD</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server"> 
<form id="MASTERSKILL_HOD" runat="server">
<div>
...
<asp:dropdownlist id="ddlOCP_ID_DEPARTMENT" runat="server" Width="150px" ></asp:dropdownlist>
...
<asp:dropdownlist id="ddlOCP_ID_SECTION" runat="server" Width="150px" ></asp:dropdownlist>
