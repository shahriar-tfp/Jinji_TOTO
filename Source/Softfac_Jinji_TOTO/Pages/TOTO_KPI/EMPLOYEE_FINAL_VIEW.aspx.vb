...
Partial Class Pages_TOTO_KPI_EMPLOYEE_FINAL_VIEW
...
#End Region
    ...
    Protected Sub blindDepartment()
        ssql1 = "Exec sp_KPI_selFinalEvalaution '" & Session("EmpID").ToString & "','" & ddlCATEGORY.SelectedValue & "','','','','" & ddlYEAR.SelectedValue & "','BLINDDept'"
        myDS1 = New DataSet()
    ...
    Protected Sub blindSection()
        ssql1 = "Exec sp_KPI_selFinalEvalaution '" & Session("EmpID").ToString & "','" & ddlCATEGORY.SelectedValue & "','','','','" & ddlYEAR.SelectedValue & "','BLINDSect'"
        myDS1 = New DataSet()
        myDS1 = mySQL.ExecuteSQL(ssql1)
        If myDS1.Tables.Count > 0 Then
    ...
    Protected Sub blindDirect()
        ...
        ssql1 = "Exec sp_KPI_selFinalEvalaution '" & Session("EmpID").ToString & "','','','','','" & ddlYEAR.SelectedValue & "','BLINDDirect'"
        myDS1 = New DataSet()
        myDS1 = mySQL.ExecuteSQL(ssql1)
        If myDS1.Tables.Count > 0 Then
    ...
    '    ssql1 = "Exec sp_KPI_selFinalEvalaution '" & Session("EmpID").ToString & "','" & ddlCATEGORY.SelectedValue & "','','','','" & ddlYEAR.SelectedValue & "','BLINDEmp'"
    '    myDS1 = New DataSet()
    '    myDS1 = mySQL.ExecuteSQL(ssql1)
    '    If myDS1.Tables.Count > 0 Then
    ...
    Protected Sub blindFinal()
        ...
        ssql1 = "Exec sp_KPI_selFinalEvalaution '" & Session("EmpID").ToString & "','" & ddlCATEGORY.SelectedValue & "','" & ddlOCP_ID_DEPARTMENT.SelectedValue & "','" & ddlOCP_ID_SECTION.SelectedValue & "','','" & ddlYEAR.SelectedValue & "','FINAL'"
        myDS1 = New DataSet()
        myDS1 = mySQL.ExecuteSQL(ssql1)
        If myDS1.Tables.Count = 1 Then
            If ddlCATEGORY.SelectedValue = "DIRECT" Then
                ...
                For i As Integer = 0 To gv1.Rows.Count - 1
                    Dim row As GridViewRow = DirectCast(gv1.Rows(i), GridViewRow)
                    row.Cells(4).BackColor = Color.LightYellow
                    row.Cells(5).BackColor = Color.LightYellow
                    row.Cells(6).BackColor = Color.LightYellow
                    row.Cells(7).BackColor = Color.LightYellow
                    row.Cells(8).BackColor = Color.LightYellow
                    row.Cells(9).BackColor = Color.LightYellow
                    row.Cells(row.Cells.Count - 1).BackColor = Color.LightYellow
                Next
            End If
            ...
            If ddlCATEGORY.SelectedValue = "INDIRECT" Then
                ...
                For i As Integer = 0 To gv2.Rows.Count - 1
                    Dim row As GridViewRow = DirectCast(gv2.Rows(i), GridViewRow)
                    row.Cells(4).BackColor = Color.LightYellow
                    row.Cells(5).BackColor = Color.LightYellow
                    row.Cells(6).BackColor = Color.LightYellow
                    row.Cells(7).BackColor = Color.LightYellow
    ...
    Protected Sub gv1_RowCreated(ByVal sender As Object, ByVal e As GridViewRowEventArgs)
        If e.Row.RowType = DataControlRowType.Header Then
            ...
            HeaderGridRow.Cells.Add(HeaderCell)
            HeaderCell = New TableCell()
            HeaderCell.Text = "Common Skill Map Score"
            HeaderCell.ColumnSpan = 2
            HeaderGridRow.Cells.Add(HeaderCell)
            HeaderCell = New TableCell()
            HeaderCell.Text = "Special Skill Map Score "
            HeaderCell.ColumnSpan = 2
            HeaderGridRow.Cells.Add(HeaderCell)
            HeaderCell = New TableCell()
            HeaderCell.Text = "Total Score "
            HeaderCell.ColumnSpan = 2
            HeaderGridRow.Cells.Add(HeaderCell)
            HeaderCell = New TableCell()
            HeaderCell.Text = "Skil Improvement Points This Year"
            HeaderCell.RowSpan = 2
            HeaderGridRow.Cells.Add(HeaderCell)
            HeaderCell = New TableCell()
            HeaderCell.Text = "Skill Improvement"
            HeaderCell.RowSpan = 2
            HeaderGridRow.Cells.Add(HeaderCell)
            HeaderCell = New TableCell()
            HeaderCell.Text = "Personal Development"
            HeaderCell.RowSpan = 2
            HeaderGridRow.Cells.Add(HeaderCell)
            HeaderCell = New TableCell()
            HeaderCell.Text = "Kaizen"
            HeaderCell.RowSpan = 2
            HeaderGridRow.Cells.Add(HeaderCell)
            HeaderCell = New TableCell()
            HeaderCell.Text = "Safety Idea"
            HeaderCell.RowSpan = 2
            HeaderGridRow.Cells.Add(HeaderCell)
            HeaderCell = New TableCell()
            HeaderCell.Text = "Compulsory Training"
            HeaderCell.RowSpan = 2
            HeaderGridRow.Cells.Add(HeaderCell)
            HeaderCell = New TableCell()
            HeaderCell.Text = "P Score"
            HeaderCell.RowSpan = 2
            HeaderGridRow.Cells.Add(HeaderCell)
            HeaderCell = New TableCell()
            ...
            HeaderGridRow.Cells.Add(HeaderCell)
            HeaderCell = New TableCell()
            HeaderCell.Text = "Attendance Score"
            HeaderCell.RowSpan = 2
            HeaderGridRow.Cells.Add(HeaderCell)
            HeaderCell = New TableCell()
            HeaderCell.Text = "Misconduct"
            ...
            gv1.Controls(0).Controls.AddAt(0, HeaderGridRow)
        End If
    End Sub
    ...
    Protected Sub gv2_RowCreated(ByVal sender As Object, ByVal e As GridViewRowEventArgs)
        If e.Row.RowType = DataControlRowType.Header Then
            Dim HeaderGrid As GridView = DirectCast(sender, GridView)
            Dim HeaderGridRow As New GridViewRow(0, 0, DataControlRowType.Header, DataControlRowState.Insert)
            Dim HeaderCell As New TableCell()
            ...
            HeaderGridRow.Cells.Add(HeaderCell)
            HeaderCell = New TableCell()
            HeaderCell.Text = "Target Achievement"
            HeaderCell.RowSpan = 2
            HeaderGridRow.Cells.Add(HeaderCell)
            HeaderCell = New TableCell()
            HeaderCell.Text = "Achievement Score"
            HeaderCell.RowSpan = 2
            HeaderGridRow.Cells.Add(HeaderCell)
            HeaderCell = New TableCell()
            HeaderCell.Text = "Misconduct"
            ...
            gv2.Controls(0).Controls.AddAt(0, HeaderGridRow)
        End If
    End Sub
    ...
    Protected Sub imgBtnPrint_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnPrint.Click
        If gv1.Rows.Count > 0 or gv2.Rows.Count > 0 Then
    ...
    Protected Sub ddlOCP_ID_DEPARTMENT_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ddlOCP_ID_DEPARTMENT.SelectedIndexChanged
        ...
        ssql1 = "Exec sp_KPI_selFinalEvalaution '" & Session("EmpID").ToString & "','" & ddlCATEGORY.SelectedValue & "','" & ddlOCP_ID_DEPARTMENT.SelectedValue & "','','','" & ddlYEAR.SelectedValue & "','BLINDSect'"
        myDS1 = New DataSet()
        myDS1 = mySQL.ExecuteSQL(ssql1)
        If myDS1.Tables.Count > 0 Then
            ddlOCP_ID_SECTION.DataSource = myDS1.Tables(0)
        ...
        'ssql1 = "Exec sp_KPI_selFinalEvalaution '" & Session("EmpID").ToString & "','" & ddlCATEGORY.SelectedValue & "','" & ddlOCP_ID_DEPARTMENT.SelectedValue & "','" & ddlOCP_ID_SECTION.SelectedValue & "','','" & ddlYEAR.SelectedValue & "','BLINDEmp'"
        'myDS1 = New DataSet()
        'myDS1 = mySQL.ExecuteSQL(ssql1)
        'If myDS1.Tables.Count > 0 Then
        '    ddlEMPLOYEE_PROFILE_ID.DataSource = myDS1.Tables(0)
    ...
    Protected Sub ddlOCP_ID_SECTION_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ddlOCP_ID_SECTION.SelectedIndexChanged
        ...
        ssql1 = "Exec sp_KPI_selFinalEvalaution '" & Session("EmpID").ToString & "','" & ddlCATEGORY.SelectedValue & "','','" & ddlOCP_ID_SECTION.SelectedValue & "','','" & ddlYEAR.SelectedValue & "','BLINDDept'"
        myDS1 = New DataSet()
        myDS1 = mySQL.ExecuteSQL(ssql1)
        If myDS1.Tables.Count > 0 Then
            ddlOCP_ID_DEPARTMENT.DataSource = myDS1.Tables(0)
    ...
    Protected Sub ClearData()
        ddlOCP_ID_DEPARTMENT.SelectedIndex = -1
        ddlOCP_ID_SECTION.SelectedIndex = -1
        'ddlEMPLOYEE_PROFILE_ID.SelectedIndex = -1
        blindDepartment()
        blindSection()
        'blindEmp()
