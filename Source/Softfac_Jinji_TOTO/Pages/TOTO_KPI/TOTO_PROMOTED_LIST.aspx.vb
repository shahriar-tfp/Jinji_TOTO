...
Partial Class Pages_TOTO_KPI_TOTO_PROMOTED_LIST
...
#End Region
    ...
    Protected Sub blindFinal()
        ssql1 = "Exec sp_KPI_SelPromotedList '" & Session("EmpID").ToString & "','" & ddlCATEGORY.SelectedValue & "','" & ddlOCP_ID_DEPARTMENT.SelectedValue & "','" & ddlOCP_ID_SECTION.SelectedValue & "','" & ddlYEAR.SelectedValue & "'"
        myDS1 = New DataSet()
        myDS1 = mySQL.ExecuteSQL(ssql1)
        ...
        If myDS1.Tables.Count = 1 Then
            ...
            For i = 0 To myDS1.Tables(0).Rows.Count - 1
                ...
                Dim lblTotal As Label = TryCast(row.FindControl("grvlblTotal"), Label)

                If myDS1.Tables(0).Rows(i).Item(9).ToString = "Yellow" Then
                    lblTotal.BackColor = Color.Yellow
                    lblTotal.ForeColor = Color.White
                    row.Cells(8).BackColor = Color.Yellow

                ElseIf myDS1.Tables(0).Rows(i).Item(9).ToString = "Green" Then
                    lblTotal.BackColor = Color.Green
                    lblTotal.ForeColor = Color.White
                    row.Cells(8).BackColor = Color.Green
                End If
            Next
