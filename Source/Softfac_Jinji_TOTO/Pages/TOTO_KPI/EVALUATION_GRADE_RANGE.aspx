<%@ Page Language="VB" AutoEventWireup="false" CodeFile="EVALUATION_GRADE_RANGE.aspx.vb" Inherits="PAGES_TOTO_KPI_EVALUATION_GRADE_RANGE" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>EVALUATION_GRADE_RANGE</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server"> 
<form id="EVALUATION_GRADE_RANGE" runat="server">
<div>
<asp:Panel ID="pnlEdit" runat="server">
<!--// 1 //-->
<asp:imagebutton id="imgKeyJOBGRADE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblJOBGRADE" runat="server" Width="140px" ></asp:label>
<asp:dropdownlist id="ddlJOBGRADE" runat="server" Width="150px" ></asp:dropdownlist>
<asp:imagebutton id="imgbtnJOBGRADE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 2 //-->
<asp:imagebutton id="imgKeyFROM_POINT" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblFROM_POINT" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtFROM_POINT" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnFROM_POINT" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 3 //-->
<asp:imagebutton id="imgKeyTO_POINT" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblTO_POINT" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtTO_POINT" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnTO_POINT" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 4 //-->
<asp:imagebutton id="imgKeyLEVEL_UP" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblLEVEL_UP" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtLEVEL_UP" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnLEVEL_UP" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 5 //-->
<asp:imagebutton id="imgKeyRETENTION_PERIOD" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblRETENTION_PERIOD" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtRETENTION_PERIOD" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnRETENTION_PERIOD" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 6 //-->
<asp:imagebutton id="imgKeySPECIAL_PERIOD" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblSPECIAL_PERIOD" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtSPECIAL_PERIOD" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnSPECIAL_PERIOD" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
