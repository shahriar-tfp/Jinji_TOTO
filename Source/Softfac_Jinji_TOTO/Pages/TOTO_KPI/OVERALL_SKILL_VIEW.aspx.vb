...
Partial Class Pages_TOTO_KPI_OVERALL_SKILL_VIEW
...
#End Region
    ...
    Protected Sub blindProcess()
        ...
        ssql1 = "Exec sp_KPI_SelRptDropDownlist '" & Session("Company").ToString & "','" & Session("EmpID").ToString & "','" & ddlCATEGORY.SelectedValue & "','" & ddlOCP_ID_DEPARTMENT.SelectedValue & "','" & ddlOCP_ID_SECTION.SelectedValue & "','" & ddlPROCESS.SelectedValue & "','" & ddlITEM.SelectedValue & "','" & ddlMODEL.SelectedValue & "','" & ddlCOUNTRY.SelectedValue & "','','BLINDProcess','" & ddlYEAR.SelectedValue & "'"
        myDS1 = New DataSet()
        myDS1 = mySQL.ExecuteSQL(ssql1)
        If myDS1.Tables.Count > 0 Then
    ...
    Protected Sub blindItem()
        ...
        ssql1 = "Exec sp_KPI_SelRptDropDownlist '" & Session("Company").ToString & "','" & Session("EmpID").ToString & "','" & ddlCATEGORY.SelectedValue & "','" & ddlOCP_ID_DEPARTMENT.SelectedValue & "','" & ddlOCP_ID_SECTION.SelectedValue & "','" & ddlPROCESS.SelectedValue & "','" & ddlITEM.SelectedValue & "','" & ddlMODEL.SelectedValue & "','" & ddlCOUNTRY.SelectedValue & "','','BLINDItem','" & ddlYEAR.SelectedValue & "'"
        myDS1 = New DataSet()
        myDS1 = mySQL.ExecuteSQL(ssql1)
        If myDS1.Tables.Count > 0 Then
    ...
    Protected Sub blindModel()
        ...
        ssql1 = "Exec sp_KPI_SelRptDropDownlist '" & Session("Company").ToString & "','" & Session("EmpID").ToString & "','" & ddlCATEGORY.SelectedValue & "','" & ddlOCP_ID_DEPARTMENT.SelectedValue & "','" & ddlOCP_ID_SECTION.SelectedValue & "','" & ddlPROCESS.SelectedValue & "','" & ddlITEM.SelectedValue & "','" & ddlMODEL.SelectedValue & "','" & ddlCOUNTRY.SelectedValue & "','','BLINDModel','" & ddlYEAR.SelectedValue & "'"
        myDS1 = New DataSet()
        myDS1 = mySQL.ExecuteSQL(ssql1)
        If myDS1.Tables.Count > 0 Then
    ...
    Protected Sub blindCountry()
        ...
        ssql1 = "Exec sp_KPI_SelRptDropDownlist '" & Session("Company").ToString & "','" & Session("EmpID").ToString & "','" & ddlCATEGORY.SelectedValue & "','" & ddlOCP_ID_DEPARTMENT.SelectedValue & "','" & ddlOCP_ID_SECTION.SelectedValue & "','" & ddlPROCESS.SelectedValue & "','" & ddlITEM.SelectedValue & "','" & ddlMODEL.SelectedValue & "','" & ddlCOUNTRY.SelectedValue & "','','BLINDCountry','" & ddlYEAR.SelectedValue & "'"
        myDS1 = New DataSet()
        myDS1 = mySQL.ExecuteSQL(ssql1)
        If myDS1.Tables.Count > 0 Then
    ...
    Protected Sub blindFinal()
        ssql1 = "Exec sp_KPI_RptIdentifyCriticalSkill '" & Session("Company").ToString & "','" & Session("EmpID").ToString & "','" & ddlCATEGORY.SelectedValue & "','" & ddlOCP_ID_DEPARTMENT.SelectedValue & "','" & ddlOCP_ID_SECTION.SelectedValue & "','" & ddlPROCESS.SelectedValue & "','" & ddlITEM.SelectedValue & "','" & ddlMODEL.SelectedValue & "','" & ddlCOUNTRY.SelectedValue & "','','BAR','" & ddlYEAR.SelectedValue & "'"
        myDS1 = New DataSet()
        myDS1 = mySQL.ExecuteSQL(ssql1)
        ...
        If myDS1.Tables.Count = 1 Then
            ...
            Dim s1 As New Series(DirectCast("No of Person", String))
            ...
            For i = 0 To myDS1.Tables(0).Rows.Count - 1
                s1.Points.AddXY(myDS1.Tables(0).Rows(i).Item(0).ToString, New Object() {myDS1.Tables(0).Rows(i).Item(1).ToString})
    ...
    Protected Sub ddlOCP_ID_DEPARTMENT_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ddlOCP_ID_DEPARTMENT.SelectedIndexChanged
        ...
        If myDS1.Tables.Count > 0 Then
            ...
            If myDS1.Tables(0).Rows.Count = 2 And ddlOCP_ID_DEPARTMENT.SelectedValue <> "" Then
                ...
                ddlPROCESS.Items.Clear()
                ddlOCP_ID_SECTION_SelectedIndexChanged(sender, e)
            Else
