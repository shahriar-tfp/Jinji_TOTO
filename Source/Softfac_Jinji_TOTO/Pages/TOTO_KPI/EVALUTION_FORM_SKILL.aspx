<%@ Page Language="VB" AutoEventWireup="false" CodeFile="EVALUTION_FORM_SKILL.aspx.vb" Inherits="PAGES_TOTO_KPI_EVALUTION_FORM_SKILL" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>EVALUTION_FORM_SKILL</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server"> 
<form id="EVALUTION_FORM_SKILL" runat="server">
<div>
...
<!--// 5 //-->
<asp:imagebutton id="imgKeySORTBY" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblSORTBY" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtSORTBY" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnSORTBY" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
