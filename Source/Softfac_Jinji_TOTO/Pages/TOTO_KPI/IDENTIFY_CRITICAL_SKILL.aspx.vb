...
Partial Class Pages_TOTO_KPI_IDENTIFY_CRITICAL_SKILL
...
#End Region
        ...
        If myDS.Tables.Count > 1 Then
            ...
            If myDT2.Rows.Count > 0 Then
                For i = 0 To myDT2.Rows.Count - 1
                    ...
                    If myDT2.Rows(i).Item(2).ToString = "PERSON" Then
                        myLabel.Text = myDT2.Rows(i).Item(3).ToString & " (*You may specify your selection)"
                    End If
    ...
    Protected Sub blindFinal()
        ...
        ssql1 = "Exec sp_KPI_RptIdentifyCriticalSkill '" & Session("Company").ToString & "','" & Session("EmpID").ToString & "','" & ddlCATEGORY.SelectedValue & "','" & ddlOCP_ID_DEPARTMENT.SelectedValue & "','" & ddlOCP_ID_SECTION.SelectedValue & "','" & ddlPROCESS.SelectedValue & "','" & ddlITEM.SelectedValue & "','" & ddlMODEL.SelectedValue & "','" & ddlCOUNTRY.SelectedValue & "','" & txtPERSON.Text & "','VIEW','" & ddlYEAR.SelectedValue & "'"
        myDS1 = New DataSet()
        myDS1 = mySQL.ExecuteSQL(ssql1)
