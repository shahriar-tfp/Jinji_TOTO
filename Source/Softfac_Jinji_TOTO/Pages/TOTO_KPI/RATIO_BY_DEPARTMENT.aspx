<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RATIO_BY_DEPARTMENT.aspx.vb" Inherits="PAGES_TOTO_KPI_RATIO_BY_DEPARTMENT" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>RATIO_BY_DEPARTMENT</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server"> 
<form id="RATIO_BY_DEPARTMENT" runat="server">
<div>
...
<!--// 4 //-->
<asp:imagebutton id="imgKeyRATIO" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblRATIO" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtRATIO" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnRATIO" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 5 //-->
<asp:imagebutton id="imgKeyL4" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblL4" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtL4" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnL4" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 6 //-->
<asp:imagebutton id="imgKeyLOS" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblLOS" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtLOS" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnLOS" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
