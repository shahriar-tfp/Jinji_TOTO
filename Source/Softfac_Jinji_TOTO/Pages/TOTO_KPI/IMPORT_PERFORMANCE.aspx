<%@ Page Language="VB" AutoEventWireup="false" CodeFile="IMPORT_PERFORMANCE.aspx.vb" Inherits="PAGES_TOTO_KPI_IMPORT_PERFORMANCE" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>IMPORT_EMPLOYEE_RESIGN</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server"> 
<form id="IMPORT_PERFORMANCE" runat="server">
<div>
...
<!--// 2 //-->
<asp:imagebutton id="imgKeyDATE_JOIN" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblDATE_JOIN" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtDATE_JOIN" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnDATE_JOIN" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 3 //-->
<asp:imagebutton id="imgKeyDATE_CONFIRM" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblDATE_CONFIRM" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtDATE_CONFIRM" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnDATE_CONFIRM" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 4 //-->
<asp:imagebutton id="imgKeyDATE_RESIGN" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblDATE_RESIGN" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtDATE_RESIGN" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnDATE_RESIGN" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
...
<asp:imagebutton id="imgbtnDATETIME_MODIFY" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
    ...
    <table id="tableimport" cellspacing="0" cellpadding="0" border="0" runat="server" >
        ...
        <tr><td><asp:Label ID="lblYear" Width="140px" runat="server" Text="Year"></asp:Label><asp:dropdownlist id="ddlYear" runat="server" Width="150px" ></asp:dropdownlist>
        <asp:Label ID="lblMonth" Width="140px" runat="server" Text="Month"></asp:Label><asp:dropdownlist id="ddlMonth" runat="server" Width="150px" ></asp:dropdownlist></td>
        </tr>
