<%@ Page Language="VB" AutoEventWireup="false" CodeFile="MASTER_SKILL_SETUP.aspx.vb" Inherits="PAGES_TOTO_KPI_MASTER_SKILL_SETUP" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>MASTER_SKILL_SETUP</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server"> 
<form id="MASTER_SKILL_SETUP" runat="server">
<div>
...
<!--// 3 //-->
<asp:imagebutton id="imgKeyOPTION_CATEGORY" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblOPTION_CATEGORY" runat="server" Width="140px" ></asp:label>
<asp:dropdownlist id="ddlOPTION_CATEGORY" runat="server" Width="150px" ></asp:dropdownlist>
<asp:imagebutton id="imgbtnOPTION_CATEGORY" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
...
<!--// 11 //-->
<asp:imagebutton id="imgKeyCONDITION" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblCONDITION" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtCONDITION" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnCONDITION" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
