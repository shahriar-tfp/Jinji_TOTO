...
Partial Class PAGES_TOTO_KPI_MASTERSKILL_MODEL_PROFILES
...
#Region "Sub & Function"
    ...
    Private Function duplicateRecord() As Boolean
        ...
        ElseIf txtNAME.Text = "" Then
            ...
            Return False
        Else
            ssql3 = "Exec sp_KPI_ChkDuplicate 'ChkM','" & txtNAME.Text.Replace("'", "''") & "'"
            ...
            If myDS.Tables.Count > 1 Then
                ...
                Else
                    ...
                    ssql = "Exec sp_KPI_InsMaster 'AddM','" & company & "','" & myDS.Tables(1).Rows(0).Item(0).ToString & "','" & txtNAME.Text.Replace("'", "''") & "','" & Session("EmpID").ToString & "'"
                End If
            End If
        End If
        Return True
