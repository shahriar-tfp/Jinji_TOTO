<%@ Page Language="VB" AutoEventWireup="false" CodeFile="EMPLOYEE_SKILL_POINT.aspx.vb" Inherits="PAGES_TOTO_KPI_EMPLOYEE_SKILL_POINT" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>EMPLOYEE_SKILL_POINT</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server"> 
<form id="EMPLOYEE_SKILL_POINT" runat="server">
<div>
...
<!--// 3 //-->
<asp:imagebutton id="imgKeyCOMMONSKILLPOINT" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblCOMMONSKILLPOINT" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtCOMMONSKILLPOINT" runat="server" Width="150px" autopostback="true"></asp:textbox>
<asp:imagebutton id="imgbtnCOMMONSKILLPOINT" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 4 //-->
<asp:imagebutton id="imgKeySPECIALSKILLPOINT" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblSPECIALSKILLPOINT" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtSPECIALSKILLPOINT" runat="server" Width="150px" autopostback="true"></asp:textbox>
<asp:imagebutton id="imgbtnSPECIALSKILLPOINT" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 4 //-->
<asp:imagebutton id="imgKeyTOTALPOINT" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblTOTALPOINT" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtTOTALPOINT" runat="server" Width="150px"></asp:textbox>
<asp:imagebutton id="imgbtnTOTALPOINT" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
