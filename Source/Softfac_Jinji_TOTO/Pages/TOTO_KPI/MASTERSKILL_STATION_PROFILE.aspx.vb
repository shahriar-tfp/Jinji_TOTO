...
Partial Class PAGES_TOTO_KPI_MASTERSKILL_STATION_PROFILE
...
#Region "Sub & Function"
    ...
    Private Function duplicateRecord() As Boolean
        ...
        ElseIf txtNAME.Text = "" Then
            ...
            Return False
        Else
            ssql3 = "Exec sp_KPI_ChkDuplicate 'ChkS','" & txtNAME.Text.Replace("'", "''") & "'"
            ...
            If myDS.Tables.Count > 1 Then
                If myDS.Tables(0).Rows(0).Item(0).ToString = "YES" Then
                    ...
                    Return False
                Else
                    ssql = "Exec sp_KPI_InsMaster 'AddS','" & company & "','" & myDS.Tables(1).Rows(0).Item(0).ToString & "','" & txtNAME.Text.Replace("'", "''") & "','" & Session("EmpID").ToString & "'"
                End If
            End If
        End If
        Return True
