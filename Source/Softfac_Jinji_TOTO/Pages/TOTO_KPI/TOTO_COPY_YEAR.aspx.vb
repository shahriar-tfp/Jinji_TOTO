...
Partial Class Pages_TOTO_KPI_TOTO_COPY_YEAR
...
#End Region
    ...
    Private Sub PagePreload()
        ...
        If myDS.Tables.Count > 1 Then
            ...
            If myDT2.Rows.Count > 0 Then
                ...
                ddlYearssql = "exec sp_is_GetYear '-2'"
                myDS5 = mySQL.ExecuteSQL(ddlYearssql)
                If myDS5.Tables.Count > 0 Then
                    If myDS5.Tables(0).Columns.Count > 1 Then
                        ddlOLD_YEAR.DataTextField = "Name"
                        ddlOLD_YEAR.DataValueField = "Code"
                        ddlOLD_YEAR.DataSource = myDS5
                        ddlOLD_YEAR.DataBind()
                        ddlOLD_YEAR.SelectedValue = Year(Now()) - 1
    ...
    Protected Sub imgBtnUpdate_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnUpdate.Click
        If ValidatePrint() Then
            ssql = "Exec [sp_KPI_CalYearSkill] " & ddlYEAR.SelectedValue & " , '" & Session("EmpID").ToString & "'"
    ...
    Private Function ValidatePrint() As Boolean
        If ddlYEAR.SelectedValue = "" Then
            ...
            ddlYEAR.Focus()
            Return False
        ElseIf ddlOLD_YEAR.SelectedValue = "" Then
            lblresult2.Text = "[" & lblOLD_YEAR.Text & "] Is A Required Field!"
            ShowMessage(lblresult2.Text)
            ddlOLD_YEAR.Focus()
            Return False
        ElseIf ddlYEAR.SelectedValue <= ddlOLD_YEAR.SelectedValue Then
            lblresult2.Text = "[" & lblYEAR.Text & "] Must Be Bigger than [" & lblOLD_YEAR.Text & "]!"
            ShowMessage(lblresult2.Text)
            ddlYEAR.Focus()
            Return False
