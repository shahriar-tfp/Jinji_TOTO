<%@ Page Language="VB" AutoEventWireup="false" CodeFile="MONITOR_OVERALL_SKILL_VIEW.aspx.vb" Inherits="Pages_TOTO_KPI_MONITOR_OVERALL_SKILL_VIEW" %>
...
<head id="Head1" runat="server">
    <title>MONITOR OVERALL SKILL View</title>
    <link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />

</head>
<body>
    <form id="MONITOR_OVERALL_SKILL_VIEW" runat="server">
    <div>
	   ...
	   <tr><td>	    
	    <!--//<div id="divGridview1" style="top: 300px;left: 15px;position :absolute; width: 100%; height: 200px;overflow:scroll " visible="true">
            <asp:gridview id="gv1" Width="100%" runat="server" AutoGenerateColumns="true" Visible="true"
                ...
                Caption='<table border="0" width="100%" cellpadding="0" cellspacing="0"><tr><td><font color="#ff0000">Monitor Department Overall Skill Development</font></td></tr></table>' CaptionAlign="Top">
