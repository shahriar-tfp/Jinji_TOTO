<%@ Page Language="VB" AutoEventWireup="false" CodeFile="COMPULSORY_TRAINING.aspx.vb" Inherits="PAGES_TOTO_KPI_COMPULSORY_TRAINING" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>COMPULSORY_TRAINING</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server"> 
<form id="COMPULSORY_TRAINING" runat="server">
<div>
...
<!--// 4 //-->
<asp:imagebutton id="imgKeyPOINT" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblPOINT" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtPOINT" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnPOINT" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
