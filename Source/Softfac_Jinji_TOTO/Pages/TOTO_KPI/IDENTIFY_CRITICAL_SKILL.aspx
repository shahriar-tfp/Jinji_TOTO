<%@ Page Language="VB" AutoEventWireup="false" CodeFile="IDENTIFY_CRITICAL_SKILL.aspx.vb" Inherits="Pages_TOTO_KPI_IDENTIFY_CRITICAL_SKILL" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>IDENTIFY CRITICAL SKILL View</title>
    <link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />

</head>
<body>
    <form id="IDENTIFY_CRITICAL_SKILL" runat="server">
    <div>
...
<asp:ImageButton ID="imgKeyYEAR" runat="server" Width="21px" Height="21px"/>
    ...
    <asp:ImageButton ID="imgKeyPERSON" runat="server" Width="21px" Height="21px"/>
    <asp:Label ID="lblPERSON" runat="server" Width="120px"></asp:Label>
    <asp:Textbox ID="txtPERSON" runat="server" Width="150px" AutoPostBack="true"></asp:TextBox>
    <asp:ImageButton ID="imgBtnPERSON" runat="server" Width="21px" Height="21px"/>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
	   <tr><td>	    
	    ...
	    <asp:Label ID="lblgv1" Text="Identify Critical Skill at Each Dept/Section" runat="server" ForeColor="Red" Visible="false"></asp:Label>
            <asp:gridview id="gv1" Width="100%" runat="server" AutoGenerateColumns="true" Visible="true"
                cellspacing="0" cellpadding="1" EmptyDataText="This skill is not critical as your selection!" 
                >
