...
Partial Class PAGES_TOTO_KPI_MASTERSKILL_REASSIGNEMPSKILL_ViewEdit
...
#Region "Panel Edit"
    ...
    Protected Sub getMasterSkill()
        ...
        If myDS1.Tables(0).Rows.Count > 0 Then
            ssql = "exec sp_KPI_selLevelProcessCategory '" & myDS1.Tables(0).Rows(0).Item(0).ToString & "','" & ddlOPTION_YEAR.SelectedValue & "','" & ddlOPTION_LEVEL.SelectedValue & "','" & ddlOPTION_PROCESS.SelectedValue & "','" & ddlOPTION_CATEGORY.SelectedValue & "','REMasterSkill'"
            myDS = mySQL.ExecuteSQL(ssql, Session("Company").ToString, Session("EmpID").ToString)
            ...
            If lstleft.Visible = True Then
                If lstright.Visible = True And lstright.Items.Count > 0 Then
                    ...
                    If myDS1.Tables(0).Rows.Count > 0 Then
                        ...
                        ssql = "Exec sp_KPI_insUpdDelEmpSkill N'" & Session("Company").ToString & "',N'" & myDS1.Tables(0).Rows(0).Item(0).ToString & "',N'" & ddlOPTION_LEVEL.SelectedValue & "','" & ddlOPTION_PROCESS.SelectedValue & "','" & ddlOPTION_CATEGORY.SelectedValue & "'," & spid & ",'" & Session("EmpID").ToString & "','REASSIGN','" & ddlOPTION_YEAR.SelectedValue & "'"
