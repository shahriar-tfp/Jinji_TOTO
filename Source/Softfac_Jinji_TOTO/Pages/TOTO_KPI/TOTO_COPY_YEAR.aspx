<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TOTO_COPY_YEAR.aspx.vb" Inherits="Pages_TOTO_KPI_TOTO_COPY_YEAR" %>
...
<head id="Head1" runat="server">
    <title>TOTO Copy Year View</title>
    <link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />

</head>
<body>
    <form id="TOTO_COPY_YEAR" runat="server">
    <div>
...
<asp:ImageButton ID="imgKeyOLD_YEAR" runat="server" Width="21px" Height="21px"/>
    <asp:Label ID="lblOLD_YEAR" runat="server" Width="120px"></asp:Label>
    <asp:dropdownlist ID="ddlOLD_YEAR" runat="server" Width="150px" AutoPostBack="true"></asp:dropdownlist>
    <asp:ImageButton ID="imgbtnOLD_YEAR" runat="server" Width="21px" Height="21px"/>
    ...
    <asp:imagebutton id="imgBtnUpdate" runat="server" Width="74" Height="21" visible="true"></asp:imagebutton>
