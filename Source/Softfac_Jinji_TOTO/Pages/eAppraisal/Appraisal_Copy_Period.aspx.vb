...
Partial Class Pages_EAPPRAISAL_APPRAISAL_COPY_PERIOD
...
#Region "Page Setting"
    ...
    Sub PagePreload()
        ...
        If myDS.Tables.Count > 1 Then
            ...
            ddlMonthssql = "select distinct a.year+a.month as 'Code',datename(month,convert(datetime,'01/'+a.FROM_MONTH+ '/2015',103))"
            ddlMonthssql = ddlMonthssql + "+ ' - ' + datename(month,convert(datetime,'01/'+a.Month+ '/2015',103)) + space(3) + convert(nvarchar,a.year) as 'Name' from APPRAISAL_PERIOD a"
            ddlMonthssql = ddlMonthssql + " where a.ACTIVE = 'YES'"
            myDS5 = mySQL.ExecuteSQL(ddlMonthssql)
            If myDS5.Tables.Count > 0 Then
                If myDS5.Tables(0).Columns.Count > 1 Then
                    ddlAPPRAISAL_MONTH.DataTextField = "Name"
                    ddlAPPRAISAL_MONTH.DataValueField = "Code"
                    ddlAPPRAISAL_MONTH.DataSource = myDS5
                    ddlAPPRAISAL_MONTH.DataBind()
                End If
            End If
            myDS5 = Nothing
            ddlMonthssql = ""
            ...
            ddlMonthssql = "select distinct a.year+a.month as 'Code',datename(month,convert(datetime,'01/'+a.FROM_MONTH+ '/2015',103))"
            ddlMonthssql = ddlMonthssql + "+ ' - ' + datename(month,convert(datetime,'01/'+a.Month+ '/2015',103)) + space(3) + convert(nvarchar,a.year) as 'Name' from APPRAISAL_PERIOD a"
            ddlMonthssql = ddlMonthssql + " where a.ACTIVE = 'NO'"
            myDS5 = mySQL.ExecuteSQL(ddlMonthssql)
            If myDS5.Tables.Count > 0 Then
                If myDS5.Tables(0).Columns.Count > 1 Then
                    ddlCOPY_MONTH.DataTextField = "Name"
                    ddlCOPY_MONTH.DataValueField = "Code"
                    ddlCOPY_MONTH.DataSource = myDS5
                    ddlCOPY_MONTH.DataBind()
                End If
            End If
            myDS5 = Nothing
        Else
...
#Region "Sub & Function"
    ...
    Sub AutoAdjustPosition(ByVal strSelect As String)
        ...
        If myDS.Tables(0).Rows.Count > 0 Then
            For i = 0 To myDS.Tables(0).Rows.Count - 1
                ...
                If UCase(myDS.Tables(0).Rows(i).Item(1).ToString) = "APPRAISAL_MONTH" Then
                    If lblAPPRAISAL_MONTH.Visible = True And ddlAPPRAISAL_MONTH.Visible = True Then
                        autonum += 1
                        imgkeyAPPRAISAL_MONTH.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        imgkeyAPPRAISAL_MONTH.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        imgkeyAPPRAISAL_MONTH.Style.Add("position", "absolute")
                        autonum += 1
                        lblAPPRAISAL_MONTH.CssClass = "wordstyle12"
                        lblAPPRAISAL_MONTH.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        lblAPPRAISAL_MONTH.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        lblAPPRAISAL_MONTH.Style.Add("position", "absolute")
                        autonum += 1
                        ddlAPPRAISAL_MONTH.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        ddlAPPRAISAL_MONTH.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        ddlAPPRAISAL_MONTH.Style.Add("position", "absolute")
                        ddlAPPRAISAL_MONTH.Width = ddlWidth
                        autonum += 1
                        imgbtnAPPRAISAL_MONTH.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        imgbtnAPPRAISAL_MONTH.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        imgbtnAPPRAISAL_MONTH.Style.Add("position", "absolute")
                    End If
                End If

                If UCase(myDS.Tables(0).Rows(i).Item(1).ToString) = "COPY_MONTH" Then
                    If lblCOPY_MONTH.Visible = True And ddlCOPY_MONTH.Visible = True Then
                        autonum += 1
                        imgkeyCOPY_MONTH.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        imgkeyCOPY_MONTH.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        imgkeyCOPY_MONTH.Style.Add("position", "absolute")
                        autonum += 1
                        lblCOPY_MONTH.CssClass = "wordstyle12"
                        lblCOPY_MONTH.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        lblCOPY_MONTH.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        lblCOPY_MONTH.Style.Add("position", "absolute")
                        autonum += 1
                        ddlCOPY_MONTH.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        ddlCOPY_MONTH.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        ddlCOPY_MONTH.Style.Add("position", "absolute")
                        ddlCOPY_MONTH.Width = ddlWidth
                        autonum += 1
                        imgbtnCOPY_MONTH.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        imgbtnCOPY_MONTH.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        imgbtnCOPY_MONTH.Style.Add("position", "absolute")
                    End If
                End If
    ...
    Private Function Validatefield() As Boolean
        ...
        If ddlAPPRAISAL_MONTH.Text = "" Then
            lblresult2.Text = lblAPPRAISAL_MONTH.Text & " field is required..."
            Exit Function
        ElseIf ddlCOPY_MONTH.Text = "" Then
            lblresult2.Text = lblCOPY_MONTH.Text & " field is required..."
            Exit Function
        End If
        Validatefield = True
    End Function
...
#End Region
    ...
    Protected Sub imgBtnUpdate_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnUpdate.Click
        ...
        If Validatefield() Then
            ssql = "Exec sp_ap_Copy_AppraisalGroupSkill N'" & ddlAPPRAISAL_MONTH.SelectedValue & "','" & ddlCOPY_MONTH.SelectedValue & "','" & Session("EmpID").ToString & "'"
