<%@ Page Language="VB" AutoEventWireup="false" CodeFile="APPRAISAL_SKILLS_RATING.aspx.vb" Inherits="PAGES_EAPPRAISAL_APPRAISAL_SKILLS_RATING" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>APPRAISAL_SKILLS_RATING</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server"> 
<form id="APPRAISAL_SKILLS_RATING" runat="server">
<div>
...
<!--// 3 //-->
<asp:imagebutton id="imgKeySEQ" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblSEQ" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtSEQ" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnSEQ" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
...
<!--// 5 //-->
<asp:imagebutton id="imgKeyDESC2" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblDESC2" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtDESC2" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnDESC2" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
