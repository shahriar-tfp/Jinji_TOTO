<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Appraisal_Copy_Period.aspx.vb" Inherits="Pages_EAPPRAISAL_APPRAISAL_COPY_PERIOD" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>JINJI : E-Appraisal - Appraisal Copy Period Page</title>
    <link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body>
    <form id="APPRAISAL_COPY_PERIOD" runat="server">
    <div>
    ...
    <asp:ImageButton ID="imgkeyCOPY_MONTH" runat="server" Width="21px" Height="21px"/>
    <asp:Label ID="lblCOPY_MONTH" runat="server" Width="120px"></asp:Label>
    <asp:DropDownList ID="ddlCOPY_MONTH" runat="server" Width="150px" AutoPostBack=true></asp:DropDownList>
    <asp:ImageButton ID="imgbtnCOPY_MONTH" runat="server" Width="21px" Height="21px"/>
    ...
    <asp:imagebutton id="imgBtnUpdate" runat="server" Width="74" Height="21" OnClientClick="return confirm('Are you sure you want to Copy?')"></asp:imagebutton>
