...
Partial Class PAGES_EAPPRAISAL_APPRAISAL_GROUP
...
#Region "Page Setting"
    ...
    Sub PagePreload()
        ...
        If myDS.Tables.Count > 1 Then
            ...
            ddlYearssql = "exec sp_is_GetYear '0',2008"
                ...
                For i = 0 To myDS.Tables(0).Rows.Count - 1
                    ...
                    Select Case UCase(Trim(myDS.Tables(0).Rows(i).Item(dt).ToString))
                        ...
                        Case Else
                            ...
                            If Trim(myDS.Tables(0).Rows(i).Item(code)) = "YEAR" Then
        ...
        If myDS.Tables(0).Rows.Count > 0 Then
            For i = 0 To myDS.Tables(0).Rows.Count - 1
                Select Case myDS.Tables(0).Rows(i).Item(1).ToString
                    ...
                    Case "DECIMAL", "INTEGER"
                        Dim myTextBox As TextBox = Page.FindControl("txt" & Trim(myDS.Tables(0).Rows(i).Item(0)))
                        If Trim(myDS.Tables(0).Rows(i).Item(0)) = "YEAR" Then
                            txtYEAR.Visible = True
                        End If
                        If myTextBox.Visible = True Then
                            If mySetting.CheckTextNullAndReplaceSingleQuote(myTextBox) = True Then
                    ...
                    Case Else   '"CHARACTER", "LOOKUP"
                        ...
                        If myTextBox.Visible = True Then
                            If mySetting.CheckTextNullAndReplaceSingleQuote(myTextBox) = True Then
                                ssql = ssql & myDS.Tables(0).Rows(i).Item(0) & ","
                                If myDS.Tables(0).Rows(i).Item(0).ToString.ToUpper = "EMPLOYEE_PROFILE_ID" Or myDS.Tables(0).Rows(i).Item(0).ToString.ToUpper = "APPRAISER" Then
                ...
                For i = 0 To myDS.Tables(0).Rows.Count - 1
                    ...
                    Select Case myDR(2).ToString
                        ...
                        Case "INTEGER", "DECIMAL"
                            Dim myTxt As TextBox = Page.FindControl("txt" & myDR(0).ToString)
                            If (myTxt.Visible = True Or myDR(0).ToString = "YEAR") And Trim(myTxt.Text) <> "" Then
                ...
                For i = 0 To myDS2.Tables(0).Rows.Count - 1
                    Select Case myDS2.Tables(0).Rows(i).Item(2).ToString
                        ...
                        Case Else '"CHARACTER","LOOKUP"
                            ...
                            If myTextBox.Visible = True Then
                                If mySetting.CheckTextNullAndReplaceSingleQuote(myTextBox) = True Then
                                    If myDS2.Tables(0).Rows(i).Item(0).ToString.ToUpper = "EMPLOYEE_PROFILE_ID" Or myDS2.Tables(0).Rows(i).Item(0).ToString.ToUpper = "APPRAISER" Then
