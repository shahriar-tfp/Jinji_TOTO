...
Partial Class PAGES_EAPPRAISAL_APPRAISAL_PERIOD
        ...
        If myDS.Tables.Count > 1 Then
            ...
            If myDS5.Tables.Count > 0 Then
                If myDS5.Tables(0).Columns.Count > 1 Then
                    ...
                    ddlMONTH.DataBind()
                    ddlFROM_MONTH.DataTextField = "Name"
                    ddlFROM_MONTH.DataValueField = "Code"
                    ddlFROM_MONTH.DataSource = myDS5
                    ddlFROM_MONTH.DataBind()
                End If
            End If
            myDS5 = Nothing
    ...
    Private Sub SetEditable()
        ...
        For i = 0 To myDS.Tables(0).Rows.Count - 1
            ...
            Select Case myDS.Tables(0).Rows(i).Item(2).ToString.Trim
                ...
                Case Else
                    Dim myTXT As TextBox = Page.FindControl("txt" & myDS.Tables(0).Rows(i).Item(0).ToString.Trim)
                    If myDS.Tables(0).Rows(i).Item(0).ToString.Trim = "YEAR" Then
                        Dim myDDL As DropDownList = Page.FindControl("ddl" & myDS.Tables(0).Rows(i).Item(0).ToString.Trim)
                        If myDS.Tables(0).Rows(i).Item(3).ToString.Trim = "YES" Then
                            myDDL.Enabled = True
                        Else
