...
Partial Class PAGES_EAPPRAISAL_STAFFTARGET
    ...
    Private Sub ControlStatus()
        ...
        If strAppraisalStatus.ToUpper = "NEXT" Then
            ...
            If optPersonal.Checked And bIsAppraisee And bOpenAppraisee And lblLevel.Text <> "D" And lblLevel.Text <> "C" And lblLevel.Text <> "P" Then
