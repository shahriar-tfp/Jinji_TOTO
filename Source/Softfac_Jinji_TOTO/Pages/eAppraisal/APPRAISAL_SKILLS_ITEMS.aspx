<%@ Page Language="VB" AutoEventWireup="false" CodeFile="APPRAISAL_SKILLS_ITEMS.aspx.vb" Inherits="PAGES_EAPPRAISAL_APPRAISAL_SKILLS_ITEMS" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>APPRAISAL_SKILLS_ITEMS</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server"> 
<form id="APPRAISAL_SKILLS_ITEMS" runat="server">
<div>
...
<!--// 4 //-->
<asp:imagebutton id="imgKeySKILL_SEQ" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblSKILL_SEQ" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtSKILL_SEQ" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnSKILL_SEQ" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 5 //-->
<asp:imagebutton id="imgKeySKILL" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblSKILL" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtSKILL" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnSKILL" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 6 //-->
<asp:imagebutton id="imgKeyDESC_SEQ" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblDESC_SEQ" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtDESC_SEQ" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnDESC_SEQ" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 7 //-->
<asp:imagebutton id="imgKeyDESC1" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblDESC1" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtDESC1" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnDESC1" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
