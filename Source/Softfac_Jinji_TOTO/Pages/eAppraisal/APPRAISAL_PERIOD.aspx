<%@ Page Language="VB" AutoEventWireup="false" CodeFile="APPRAISAL_PERIOD.aspx.vb" Inherits="PAGES_EAPPRAISAL_APPRAISAL_PERIOD" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>APPRAISAL_PERIOD</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server"> 
<form id="APPRAISAL_PERIOD" runat="server">
<div>
<asp:Panel ID="pnlEdit" runat="server">
<!--// 1 //-->
<asp:imagebutton id="imgKeyFROM_MONTH" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblFROM_MONTH" runat="server" Width="140px" ></asp:label>
<asp:dropdownlist id="ddlFROM_MONTH" runat="server" Width="150px" ></asp:dropdownlist>
<asp:imagebutton id="imgbtnFROM_MONTH" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
...
<asp:textbox id="txtYEAR" runat="server" Width="150px" visible="false" autopostback="true"></asp:textbox>
...
<!--// 5 //-->
<asp:imagebutton id="imgKeyDATESTART_APPRAISEE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblDATESTART_APPRAISEE" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtDATESTART_APPRAISEE" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnDATESTART_APPRAISEE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 6 //-->
<asp:imagebutton id="imgKeyDATEEND_APPRAISEE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblDATEEND_APPRAISEE" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtDATEEND_APPRAISEE" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnDATEEND_APPRAISEE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 7 //-->
<asp:imagebutton id="imgKeyDATESTART_1STAPPRAISER" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblDATESTART_1STAPPRAISER" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtDATESTART_1STAPPRAISER" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnDATESTART_1STAPPRAISER" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 8 //-->
<asp:imagebutton id="imgKeyDATEEND_1STAPPRAISER" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblDATEEND_1STAPPRAISER" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtDATEEND_1STAPPRAISER" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnDATEEND_1STAPPRAISER" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 9 //-->
<asp:imagebutton id="imgKeyDATESTART_2NDAPPRAISER" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblDATESTART_2NDAPPRAISER" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtDATESTART_2NDAPPRAISER" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnDATESTART_2NDAPPRAISER" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 10 //-->
<asp:imagebutton id="imgKeyDATEEND_2NDAPPRAISER" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblDATEEND_2NDAPPRAISER" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtDATEEND_2NDAPPRAISER" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnDATEEND_2NDAPPRAISER" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
