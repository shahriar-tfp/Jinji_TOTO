<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Appraisal_Group_ViewEdit.aspx.vb" Inherits="Pages_EAPPRAISAL_APPRAISAL_GROUP_ViewEdit" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>JINJI : E-Appraisal - Appraisal Group View/Edit Page</title>
    <link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body>
    <form id="APPRAISAL_GROUP_ViewEdit" runat="server">
    <div>
    ...
    <asp:ImageButton ID="imgkeyAPPRAISAL_MONTH" runat="server" Width="21px" Height="21px"/>
    <asp:Label ID="lblAPPRAISAL_MONTH" runat="server" Width="120px"></asp:Label>
    <asp:DropDownList ID="ddlAPPRAISAL_MONTH" runat="server" Width="150px" AutoPostBack=true></asp:DropDownList>
    <asp:ImageButton ID="imgbtnAPPRAISAL_MONTH" runat="server" Width="21px" Height="21px"/>

    <asp:ImageButton ID="imgKeyOPTION_BYLIST" runat="server" Width="21px" Height="21px"/>
    <asp:Label ID="lblOPTION_BYLIST" runat="server" Width="120px"></asp:Label>
    <asp:DropDownList ID="ddlOPTION_BYLIST" runat="server" Width="150px" AutoPostBack=true></asp:DropDownList>
    <asp:ImageButton ID="imgbtnOPTION_BYLIST" runat="server" Width="21px" Height="21px"/>
    ...
    <asp:imagebutton id="imgKeyEMPLOYEE_PROFILE_ID_VALUE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
    <asp:label id="lblEMPLOYEE_PROFILE_ID_VALUE" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtEMPLOYEE_PROFILE_ID_VALUE" runat="server" Width="150px"></asp:textbox>
    <asp:imagebutton id="imgbtnEMPLOYEE_PROFILE_ID_VALUE" runat="server" Height="21px" ></asp:imagebutton>
