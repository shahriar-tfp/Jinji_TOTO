<%@ Page Language="VB" AutoEventWireup="false" CodeFile="APPRAISAL_SKILLS_CATEGORY.aspx.vb" Inherits="PAGES_EAPPRAISAL_APPRAISAL_SKILLS_CATEGORY" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>APPRAISAL_SKILLS_CATEGORY</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server"> 
<form id="APPRAISAL_SKILLS_CATEGORY" runat="server">
<div>
