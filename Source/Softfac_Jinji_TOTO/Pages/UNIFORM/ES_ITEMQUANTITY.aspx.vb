...
Partial Class PAGES_UNIFORM_ES_ITEMQUANTITY
...
#End Region
    ...
    Protected Sub txtITEMCATEGORY_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtITEMCATEGORY.TextChanged
        Dim code As String

        myDS = mySQL.ExecuteSQL("select dbo.fn_GetCode_ES_UNIFORMITEMCATEGORY_Vw('" & txtITEMCATEGORY.Text.Replace("'", "''") & "')")
