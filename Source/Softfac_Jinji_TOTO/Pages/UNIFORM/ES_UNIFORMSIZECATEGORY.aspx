<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ES_UNIFORMSIZECATEGORY.aspx.vb" Inherits="PAGES_UNIFORM_ES_UNIFORMSIZECATEGORY" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>ES_UNIFORMSIZECATEGORY</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server"> 
<form id="ES_UNIFORMSIZECATEGORY" runat="server">
<div>
