<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ES_ITEMQUANTITY.aspx.vb" Inherits="PAGES_UNIFORM_ES_ITEMQUANTITY" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>ES_ITEMQUANTITY</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server"> 
<form id="ES_ITEMQUANTITY" runat="server">
<div>
...
<!--// 2 //-->
<asp:imagebutton id="imgKeyITEMCATEGORY" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblITEMCATEGORY" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtITEMCATEGORY" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnITEMCATEGORY" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
...
<!--// 6 //-->
<asp:imagebutton id="imgKeySTOREDATE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblSTOREDATE" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtSTOREDATE" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnSTOREDATE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
