<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ES_UNIFORMSUPPLIER.aspx.vb" Inherits="PAGES_UNIFORM_ES_UNIFORMSUPPLIER" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>ES_UNIFORMSUPPLIER</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server"> 
<form id="ES_UNIFORMSUPPLIER" runat="server">
<div>
...
<!--// 4 //-->
<asp:imagebutton id="imgKeyADDRESS1" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblADDRESS1" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtADDRESS1" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnADDRESS1" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 5 //-->
<asp:imagebutton id="imgKeyADDRESS2" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblADDRESS2" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtADDRESS2" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnADDRESS2" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 6 //-->
<asp:imagebutton id="imgKeyCITY" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblCITY" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtCITY" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnCITY" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
...
<!--// 8 //-->
<asp:imagebutton id="imgKeySTATE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblSTATE" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtSTATE" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnSTATE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
...
<!--// 10 //-->
<asp:imagebutton id="imgKeyTELEPHONE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblTELEPHONE" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtTELEPHONE" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnTELEPHONE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 11 //-->
<asp:imagebutton id="imgKeyFAX" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblFAX" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtFAX" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnFAX" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
...
<!--// 13 //-->
<asp:imagebutton id="imgKeyPASSWORD" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
...
<asp:imagebutton id="imgbtnPASSWORD" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
