<%@ Page Language="VB" AutoEventWireup="false" CodeFile="UNI_EMPLOYEE_DISCIPLINARY.aspx.vb" Inherits="PAGES_DISCIPLINARY_UNI_EMPLOYEE_DISCIPLINARY" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>UNI_EMPLOYEE_DISCIPLINARY</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server"> 
<form id="UNI_EMPLOYEE_DISCIPLINARY" runat="server">
<div>
...
<!--// 8 //-->
<asp:imagebutton id="imgKeySUSPEN_FROM_DATE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblSUSPEN_FROM_DATE" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtSUSPEN_FROM_DATE" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnSUSPEN_FROM_DATE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 9 //-->
<asp:imagebutton id="imgKeySUSPEN_TO_DATE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblSUSPEN_TO_DATE" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtSUSPEN_TO_DATE" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnSUSPEN_TO_DATE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 10 //-->
<asp:imagebutton id="imgKeyWARNEDBY" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblWARNEDBY" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtWARNEDBY" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnWARNEDBY" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
