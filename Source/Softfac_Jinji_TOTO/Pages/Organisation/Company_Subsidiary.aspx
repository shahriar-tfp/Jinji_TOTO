<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Company_Subsidiary.aspx.vb" Inherits="Pages_System_Company_Subsidiary" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>JINJI : Organisation - Company Subsidiary Page</title>
    <link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server">
    <form id="company_Subsidiary" runat="server">
    <div>
	...
	<!--// 2 //-->
	<asp:image id="imgCOMPANY_PROFILE_CODE_SUBSIDIARY" runat="server" Width="21px" Height="21px"></asp:image>
	<asp:label id="lblCOMPANY_PROFILE_CODE_SUBSIDIARY" runat="server" Width="140px"></asp:label>
	<asp:textbox id="txtCOMPANY_PROFILE_CODE_SUBSIDIARY" runat="server" Width="150px"></asp:textbox>
	<asp:imagebutton id="imgBtnCOMPANY_PROFILE_CODE_SUBSIDIARY" runat="server" Height="21px"></asp:imagebutton>
	<!--// 3 //-->
	<asp:image id="imgPERCENTAGE" runat="server" Width="21px" Height="21px"></asp:image>
	...
	<asp:imagebutton id="imgBtnPERCENTAGE" runat="server" Height="21px"></asp:imagebutton>
	<!--// Panel //-->
