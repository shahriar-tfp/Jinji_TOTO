<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CUTOFF_DETAIL.aspx.vb" Inherits="PAGES_ORGANISATION_CUTOFF_DETAIL" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>CUTOFF_DETAIL</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server"> 
<form id="CUTOFF_DETAIL" runat="server">
<div>
...
<asp:imagebutton id="imgbtnMODULE_PROFILE_CODE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
