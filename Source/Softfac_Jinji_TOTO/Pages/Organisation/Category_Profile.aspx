<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Category_Profile.aspx.vb" Inherits="Pages_Organisation_Category_Profile" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>JINJI : Organisation - Category Profile Page</title>
    <link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server">
    <form id="Category_Profile" runat="server">
    <div>
	...
	<!--// 2 //-->
    <asp:image id="imgOPTION_CATEGORY" runat="server" Width="21px" Height="21px"></asp:image>
    <asp:label id="lblOPTION_CATEGORY" runat="server" Width="140px"></asp:label>
    <asp:dropdownlist id="ddlOPTION_CATEGORY" runat="server" Width="157px"></asp:dropdownlist>
    <asp:imagebutton id="imgBtnOPTION_CATEGORY" runat="server" Height="21px"></asp:imagebutton>
    <!--// 3 //-->
    <asp:image id="imgOCP_ID_CATEGORY" runat="server" Width="21px" Height="21px"></asp:image>
    <asp:label id="lblOCP_ID_CATEGORY" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtOCP_ID_CATEGORY" runat="server" Width="150px"></asp:textbox>
    <asp:imagebutton id="imgBtnOCP_ID_CATEGORY" runat="server" Height="21px"></asp:imagebutton>
    <asp:imagebutton id="imgBtnOCP_ID_CATEGORY2" runat="server" Height="21px"></asp:imagebutton>
    <!--// listbox //-->
