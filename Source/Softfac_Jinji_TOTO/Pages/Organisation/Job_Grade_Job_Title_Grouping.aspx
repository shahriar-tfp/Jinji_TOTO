<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Job_Grade_Job_Title_Grouping.aspx.vb" Inherits="Pages_Organisation_Job_Grade_Job_Title" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>JINJI : Organisation - Job Grade Job Title Grouping Page</title>
    <link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server">
    <form id="job_grade_job_title_grouping" runat="server">
    <div>
	...
	<!--// 2 //-->
	<asp:image id="imgOCP_ID_JOB_TITLE" runat="server" Height="21px" Width="21px"></asp:image>
	...
	<asp:imagebutton id="imgBtnOCP_ID_JOB_TITLE2" runat="server" Height="21px"></asp:imagebutton>
	<!--// listbox //-->
