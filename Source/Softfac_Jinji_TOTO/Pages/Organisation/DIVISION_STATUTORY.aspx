<%@ Page Language="VB" AutoEventWireup="false" CodeFile="DIVISION_STATUTORY.aspx.vb" Inherits="PAGES_ORGANISATION_DIVISION_STATUTORY" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>DIVISION_STATUTORY</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server"> 
<form id="DIVISION_STATUTORY" runat="server">
<div>
...
<!--// 4 //-->
<asp:imagebutton id="imgKeySTATUTORY_TYPE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblSTATUTORY_TYPE" runat="server" Width="140px" ></asp:label>
<asp:dropdownlist id="ddlSTATUTORY_TYPE" runat="server" Width="150px" ></asp:dropdownlist>
<asp:imagebutton id="imgbtnSTATUTORY_TYPE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
...
<!--// 10 //-->
<asp:imagebutton id="imgKeyCOUNTRY_CODE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblCOUNTRY_CODE" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtCOUNTRY_CODE" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnCOUNTRY_CODE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
