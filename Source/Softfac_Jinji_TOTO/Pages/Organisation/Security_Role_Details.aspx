<%@ Page Language="VB" AutoEventWireup="false" CodeFile="SECURITY_ROLE_DETAILS.aspx.vb" Inherits="PAGES_ORGANISATION_SECURITY_ROLE_DETAILS" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>JINJI : Organisation - Security Role Details Page</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server">
    <form id="Security_Role_Details" runat="server">
    <div>
    ...
    <asp:imagebutton id="imgbtnTABLE_PROFILE_CODE2" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

    <!--// 5 //-->
    <asp:imagebutton id="imgOPTION_FULL_ACCESS" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
    <asp:label id="lblOPTION_FULL_ACCESS" runat="server" Width="140px" ></asp:label>
    <asp:dropdownlist id="ddlOPTION_FULL_ACCESS" runat="server" Width="150px" ></asp:dropdownlist>
    <asp:imagebutton id="imgbtnOPTION_FULL_ACCESS" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
