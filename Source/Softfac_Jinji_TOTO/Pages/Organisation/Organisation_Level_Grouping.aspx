<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Organisation_Level_Grouping.aspx.vb" Inherits="Pages_Organisation_Organisation_Level_Grouping" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>JINJI : Organisation - Organisation Level Grouping Page</title>
    <link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server">
    <form id="Organisation_Level_Grouping" runat="server">
    <div>
    <asp:Panel ID="pnledit" runat="server" visible="true">
    <!--// 1 //-->
    <asp:image id="imgCompany_Profile_Code" runat="server" Width="21px" Height="21px"></asp:image>
    ...
    <!--// 2 //-->
    <asp:image id="imgOCP_Code_Sector" runat="server" Width="21px" Height="21px"></asp:image>
    <asp:label id="lblOCP_Code_Sector" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtOCP_Code_Sector" runat="server" Width="150px"></asp:textbox>
    <asp:imagebutton id="imgBtnOCP_Code_Sector" runat="server" Height="21px"></asp:imagebutton>
    <!--// 3 //-->
    <asp:image id="imgOCP_Code_Division" runat="server" Width="21px" Height="21px"></asp:image>
    <asp:label id="lblOCP_Code_Division" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtOCP_Code_Division" runat="server" Width="150px"></asp:textbox>
    <asp:imagebutton id="imgBtnOCP_Code_Division" runat="server" Height="21px"></asp:imagebutton>
    <asp:imagebutton id="imgBtnOCP_Code_Division2" runat="server" Height="21px"></asp:imagebutton>
    <!--// 4 //-->
    <asp:image id="imgOCP_Code_Department" runat="server" Width="21px" Height="21px"></asp:image>
    <asp:label id="lblOCP_Code_Department" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtOCP_Code_Department" runat="server" Width="150px"></asp:textbox>
    <asp:imagebutton id="imgBtnOCP_Code_Department" runat="server" Height="21px"></asp:imagebutton>
    <asp:imagebutton id="imgBtnOCP_Code_Department2" runat="server" Height="21px"></asp:imagebutton>
    <!--// 5 //-->
    <asp:image id="imgOCP_Code_Section" runat="server" Width="21px" Height="21px"></asp:image>
    <asp:label id="lblOCP_Code_Section" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtOCP_Code_Section" runat="server" Width="150px"></asp:textbox>
    <asp:imagebutton id="imgBtnOCP_Code_Section" runat="server" Height="21px"></asp:imagebutton>
    <asp:imagebutton id="imgBtnOCP_Code_Section2" runat="server" Height="21px"></asp:imagebutton>
    <!--// 6 //-->
    <asp:image id="imgOCP_Code_Line" runat="server" Width="21px" Height="21px"></asp:image>
    <asp:label id="lblOCP_Code_Line" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtOCP_Code_Line" runat="server" Width="150px"></asp:textbox>
    <asp:imagebutton id="imgBtnOCP_Code_Line" runat="server" Height="21px"></asp:imagebutton>
    <asp:imagebutton id="imgBtnOCP_Code_Line2" runat="server" Height="21px"></asp:imagebutton>
    <!--// 7 //-->
    <asp:image id="imgOCP_Code_Group" runat="server" Width="21px" Height="21px"></asp:image>
    <asp:label id="lblOCP_Code_Group" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtOCP_Code_Group" runat="server" Width="150px"></asp:textbox>
    <asp:imagebutton id="imgBtnOCP_Code_Group" runat="server" Height="21px"></asp:imagebutton>
    <asp:imagebutton id="imgBtnOCP_Code_Group2" runat="server" Height="21px"></asp:imagebutton>
    <!--// 8 //-->
    <asp:image id="imgOCP_Code_Process" runat="server" Width="21px" Height="21px"></asp:image>
    <asp:label id="lblOCP_Code_Process" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtOCP_Code_Process" runat="server" Width="150px"></asp:textbox>
    <asp:imagebutton id="imgBtnOCP_Code_Process" runat="server" Height="21px"></asp:imagebutton>
    <asp:imagebutton id="imgBtnOCP_Code_Process2" runat="server" Height="21px"></asp:imagebutton>
    <!--// listbox //-->
	...
	<table id="Table8" style="left: 10px; position: absolute; top: 10px" cellspacing="0" cellpadding="0" border="0" runat="server">
        <tr>
												...
												<asp:gridview id="myGridView" Width="100%" runat="server" AutoGenerateColumns="true" 
													...
													<%--<columns>
														<asp:TemplateField HeaderText="Select" ItemStyle-HorizontalAlign="Center">
															...
															<ItemTemplate>
																<asp:CheckBox ID="chkDelete" BorderStyle="None" Height="5" Width="5" Runat="server" />
															</ItemTemplate>
														</asp:TemplateField>
													</columns>--%>
												</asp:gridview>
