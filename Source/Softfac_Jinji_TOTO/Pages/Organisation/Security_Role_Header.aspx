<%@ Page Language="VB" AutoEventWireup="false" CodeFile="SECURITY_ROLE_HEADER.aspx.vb" Inherits="PAGES_ORGANISATION_SECURITY_ROLE_HEADER" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>JINJI : Organisation - Security Role Header Page</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server">
    <form id="Security_Role_Header" runat="server">
    <div>
