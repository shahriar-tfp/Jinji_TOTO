<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Group_Process_Grouping.aspx.vb" Inherits="Pages_Organisation_Group_Process" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>JINJI : Organisation - Group Process Page</title>
    <link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server">
    <form id="Group_Process_Grouping" runat="server">
    <div>
    <asp:Panel ID="pnledit" runat="server" visible="true">
    <!--// 1 //-->
    <asp:image id="imgOCP_ID_SECTOR" runat="server" Width="21px" Height="21px"></asp:image>
    <asp:label id="lblOCP_ID_SECTOR" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtOCP_ID_SECTOR" runat="server" Width="150px"></asp:textbox>
    <asp:imagebutton id="imgBtnOCP_ID_SECTOR" runat="server" Height="21px"></asp:imagebutton>
    <!--// 2 //-->
    <asp:image id="imgOCP_ID_DIVISION" runat="server" Width="21px" Height="21px"></asp:image>
    ...
    <asp:imagebutton id="imgBtnOCP_ID_DIVISION2" runat="server" Height="21px"></asp:imagebutton>
    <!--// 3 //-->
    <asp:image id="imgOCP_ID_DEPARTMENT" runat="server" Width="21px" Height="21px"></asp:image>
    ...
    <asp:imagebutton id="imgBtnOCP_ID_DEPARTMENT2" runat="server" Height="21px"></asp:imagebutton>
    <!--// 4 //-->
    <asp:image id="imgOCP_ID_SECTION" runat="server" Width="21px" Height="21px"></asp:image>
    ...
    <asp:imagebutton id="imgBtnOCP_ID_SECTION2" runat="server" Height="21px"></asp:imagebutton>
    <!--// 5 //-->
    <asp:image id="imgOCP_ID_LINE" runat="server" Width="21px" Height="21px"></asp:image>
    ...
    <asp:imagebutton id="imgBtnOCP_ID_LINE2" runat="server" Height="21px"></asp:imagebutton>
    <!--// 6 //-->
    <asp:image id="imgOCP_ID_GROUP" runat="server" Width="21px" Height="21px"></asp:image>
    ...
    <asp:imagebutton id="imgBtnOCP_ID_GROUP2" runat="server" Height="21px"></asp:imagebutton>
    <!--// 7 //-->
    <asp:image id="imgOCP_ID_PROCESS" runat="server" Width="21px" Height="21px"></asp:image>
    ...
    <asp:imagebutton id="imgBtnOCP_ID_PROCESS2" runat="server" Height="21px"></asp:imagebutton>
    <!--// listbox //-->
    ...
    <table id="Table5" cellspacing="0" cellpadding="0" border="0" runat="server">
        ...
        <tr>
            <td> 
                <div style="border-top-style: none; border-right-style:none; border-left-style: none; border-bottom-style: none;">
                    <asp:panel id="PnlLeftList" ScrollBars="Horizontal" runat="server" visible="true">
                        <asp:ListBox id="lstleft" Width="400px" Height="150px" SelectionMode="Multiple" runat="server" ></asp:ListBox>    
                    </asp:panel>  
                </div>
            </td>
        </tr>
    ...
    <table id="Table6" cellspacing="0" cellpadding="0" border="0" runat="server">
        ...
        <tr>
            <td>
                <div style="border-top-style: none; border-right-style:none; border-left-style: none; border-bottom-style: none;">
                    <asp:panel id="PnlRightList" ScrollBars="Horizontal" runat="server" visible="true">
                        <asp:ListBox id="lstright" Width="400px" Height="150px" SelectionMode="Multiple" runat="server" ></asp:ListBox> 
                    </asp:panel>
                </div>
            </td>
        </tr>
