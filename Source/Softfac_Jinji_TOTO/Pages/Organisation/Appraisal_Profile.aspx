<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Appraisal_Profile.aspx.vb" Inherits="Pages_Organisation_Appraisal_Profile" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>JINJI : Organisation - Appraisal Profile Page</title>
    <link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server">
    <form id="Appraisal_Profile" runat="server">
    <div>
    <asp:Panel ID="pnledit" runat="server" visible="true">
    <!--// 1 //-->
	<asp:image id="imgOCP_ID_APPRAISAL" runat="server" Height="21px" Width="21px"></asp:image>
	...
	<!--// 2 //-->
	<asp:image id="imgMIN_SCORE" runat="server" Height="21px" Width="21px"></asp:image>
	<asp:label id="lblMIN_SCORE" runat="server" Width="140px"></asp:label>
	<asp:textbox id="txtMIN_SCORE" runat="server" Width="150px"></asp:textbox>
	<asp:imagebutton id="imgBtnMIN_SCORE" runat="server" Height="21px"></asp:imagebutton>
	<!--// 3 //-->
	<asp:image id="imgMAX_SCORE" runat="server" Height="21px" Width="21px"></asp:image>
	<asp:label id="lblMAX_SCORE" runat="server" Width="140px"></asp:label>
	<asp:textbox id="txtMAX_SCORE" runat="server" Width="150px"></asp:textbox>
	<asp:imagebutton id="imgBtnMAX_SCORE" runat="server" Height="21px"></asp:imagebutton>
	<!--// 4 //-->
