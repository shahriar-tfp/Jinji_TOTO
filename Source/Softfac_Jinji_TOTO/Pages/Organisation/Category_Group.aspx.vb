                                ...
                                If mySetting.ValidateInput(myTextBox, myDS.Tables(0).Rows(i).Item(1).ToString) = True Then
                                    ...
                                    If myDST.Tables(0).Rows.Count > 0 Then
                                        ...
                                        ElseIf myDST.Tables(0).Rows(0).Item(2).ToString.Trim <> "" And myDST.Tables(0).Rows(0).Item(2).ToString.Trim = "COMPANY" Then
                                            ssql2 = ssql2 & "ISNULL(" & myDST.Tables(0).Rows(0).Item(0).ToString & "(N'" & myTextBox.Text.ToString & "',N'" & myDST.Tables(0).Rows(0).Item(1).ToString & "',N'" & Session("Company").ToString & "'),''),"
                                            ssql3 = ssql3 & myDS.Tables(0).Rows(i).Item(0) & "=ISNULL(" & myDST.Tables(0).Rows(0).Item(0).ToString & "(N'" & myTextBox.Text.ToString & "',N'" & myDST.Tables(0).Rows(0).Item(1).ToString & "',N'" & Session("Company").ToString & "'),'') And "
                                            ssql4 = ssql4 & myDS.Tables(0).Rows(i).Item(0) & "=ISNULL(" & myDST.Tables(0).Rows(0).Item(0).ToString & "(N'" & myTextBox.Text.ToString & "',N'" & myDST.Tables(0).Rows(0).Item(1).ToString & "',N'" & Session("Company").ToString & "'),''),"
