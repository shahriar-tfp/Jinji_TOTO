<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Company_Statutory.aspx.vb" Inherits="Pages_System_Company_Statutory" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>JINJI : Organisation - Company Statutory Page</title>
    <link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server">
    <form id="company_statutory" runat="server">
    <div>
	...
	<!--// 2 //-->
	<asp:image id="imgEFFECTIVE_DATE" runat="server" Width="21px" Height="21px"></asp:image>
	...
	<!--// 3 //-->
	<asp:image id="imgOPTION_TYPE" runat="server" Width="21px" Height="21px"></asp:image>
	...
	<!--// 4 //-->
	<asp:image id="imgVALUE" runat="server" Width="21px" Height="21px"></asp:image>
	...
	<!--// 5 //-->
	<asp:image id="imgOPTION_LOCATION" runat="server" Width="21px" Height="21px"></asp:image>
	<asp:label id="lblOPTION_LOCATION" runat="server" Width="140px"></asp:label>
	<asp:DropDownList ID="ddlOPTION_LOCATION" runat="server" Width="157"></asp:dropdownlist>
	<asp:ImageButton ID="imgBtnOPTION_LOCATION" runat="server" Height="21px" />
	<!--// Panel //-->
