<%@ Page Language="VB" AutoEventWireup="false" CodeFile="OCP_Code.aspx.vb" Inherits="Pages_Organisation_OCP_Code" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>JINJI : Organisation - OCP Code Page</title>
    <link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server">
    <form id="OCP_CODE_VW" runat="server">
    <div>
    <asp:Panel ID="pnledit" runat="server" visible="true">
    <!--// 1 //-->
	<asp:image id="imgOCP_ID" runat="server" Width="21px" Height="21px"></asp:image>
    ...
    <!--// 6 //-->
    <asp:image id="imgPIC" runat="server" Width="21px" Height="21px"></asp:image>
    <asp:label id="lblPIC" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtPIC" runat="server" Width="150px"></asp:textbox>
    <asp:imagebutton id="imgBtnPIC" runat="server" Height="21px"></asp:imagebutton>
    <!--// 7 //-->
    ...
    <!--// 8 //-->
    <asp:image id="imgOPTION_ACTIVE" runat="server" Width="21px" Height="21px"></asp:image>
