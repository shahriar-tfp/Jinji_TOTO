<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Security_Page_Button.aspx.vb" Inherits="PAGES_ORGANISATION_SECURITY_PAGE_BUTTON" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>JINJI : Organisation - Security Page</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server"> 
<form id="SECURITY_PAGE_BUTTON" runat="server">
<div>
...
<!--// 2 //-->
<asp:imagebutton id="imgKeySECURITY_ROLE_PROFILE_CODE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
...
<asp:imagebutton id="imgbtnPAGE_PROFILE_CODE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 4 //-->
<asp:imagebutton id="imgKeyOPTION_ALLOW_INSERT" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblOPTION_ALLOW_INSERT" runat="server" Width="140px" ></asp:label>
<asp:dropdownlist id="ddlOPTION_ALLOW_INSERT" runat="server" Width="150px" ></asp:dropdownlist>
<asp:imagebutton id="imgbtnOPTION_ALLOW_INSERT" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 5 //-->
<asp:imagebutton id="imgKeyOPTION_ALLOW_UPDATE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblOPTION_ALLOW_UPDATE" runat="server" Width="140px" ></asp:label>
<asp:dropdownlist id="ddlOPTION_ALLOW_UPDATE" runat="server" Width="150px" ></asp:dropdownlist>
<asp:imagebutton id="imgbtnOPTION_ALLOW_UPDATE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 6 //-->
<asp:imagebutton id="imgKeyOPTION_ALLOW_DELETE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblOPTION_ALLOW_DELETE" runat="server" Width="140px" ></asp:label>
<asp:dropdownlist id="ddlOPTION_ALLOW_DELETE" runat="server" Width="150px" ></asp:dropdownlist>
<asp:imagebutton id="imgbtnOPTION_ALLOW_DELETE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 7 //-->
<asp:imagebutton id="imgKeyOPTION_ALLOW_FILTER" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblOPTION_ALLOW_FILTER" runat="server" Width="140px" ></asp:label>
<asp:dropdownlist id="ddlOPTION_ALLOW_FILTER" runat="server" Width="150px" ></asp:dropdownlist>
<asp:imagebutton id="imgbtnOPTION_ALLOW_FILTER" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 8 //-->
<asp:imagebutton id="imgKeyOPTION_ALLOW_PRINT" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblOPTION_ALLOW_PRINT" runat="server" Width="140px" ></asp:label>
<asp:dropdownlist id="ddlOPTION_ALLOW_PRINT" runat="server" Width="150px" ></asp:dropdownlist>
<asp:imagebutton id="imgbtnOPTION_ALLOW_PRINT" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
