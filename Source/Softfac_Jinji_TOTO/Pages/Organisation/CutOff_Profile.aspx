...
<body id="body" runat="server">
	...
	<asp:image id="imgOPTION_PREVIOUS_MONTH" runat="server" Height="21px" Width="21px"></asp:image>
	<asp:label id="lblOPTION_PREVIOUS_MONTH" runat="server" Width="140px"></asp:label>
	<asp:dropdownlist id="ddlOPTION_PREVIOUS_MONTH" runat="server" Width="157px"></asp:dropdownlist>
	<asp:imagebutton id="imgBtnOPTION_PREVIOUS_MONTH" runat="server" Height="21px"></asp:imagebutton>
	<!--// Panel //-->
