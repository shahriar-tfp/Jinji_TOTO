<%@ Page Language="VB" AutoEventWireup="false" CodeFile="USER_EMPLOYEE_GROUPBYDIV.aspx.vb" Inherits="PAGES_ORGANISATION_USER_EMPLOYEE_GROUPBYDIV" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>USER_EMPLOYEE_GROUPBYDIV</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server"> 
<form id="USER_EMPLOYEE_GROUPBYDIV" runat="server">
<div>
