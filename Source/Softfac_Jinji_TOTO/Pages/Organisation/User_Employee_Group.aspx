<%@ Page Language="VB" AutoEventWireup="false" CodeFile="User_Employee_Group.aspx.vb" Inherits="Pages_Organisation_User_Employee_Group" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>JINJI : Organisation - User Employee Group Page</title>
    <link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server">
    <form id="User_Employee_Group" runat="server">
     <div>
    ...
    <asp:imagebutton id="imgbtnEMPLOYEE_GROUP_ID2" runat="server" Height="21px"></asp:imagebutton>
