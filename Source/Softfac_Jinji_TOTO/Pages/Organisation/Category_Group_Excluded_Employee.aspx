<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Category_Group_Excluded_Employee.aspx.vb" Inherits="Pages_Organisation_Category_Group_Excluded_Employee" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>JINJI : Organisation - Category Group Exclude Employee Page</title>
    <link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server">
    <form id="Category_Group_Excluded_Employee" runat="server">
    <div>
