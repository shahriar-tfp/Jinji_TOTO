<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Bank_Address.aspx.vb" Inherits="Pages_Organisation_Bank_Address" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>JINJI : Organisation - Bank Address Page</title>
    <link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server">
    <form id="Bank_Address" runat="server">
    <div>
    ...
    <!--// 2 //-->
    <asp:image id="imgBANK_PROFILE_CODE" runat="server" Width="21px" Height="21px"></asp:image>
