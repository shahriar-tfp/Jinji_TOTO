<%@ Page Language="VB" AutoEventWireup="false" CodeFile="COMPANY_ACCESS_BYUSER.aspx.vb" Inherits="PAGES_ORGANISATION_COMPANY_ACCESS_BYUSER" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>COMPANY_ACCESS_BYUSER</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server"> 
<form id="COMPANY_ACCESS_BYUSER" runat="server">
<div>
...
<!--// 2 //-->
<asp:imagebutton id="imgKeyACCESS_COMPANY" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblACCESS_COMPANY" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtACCESS_COMPANY" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnACCESS_COMPANY" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
