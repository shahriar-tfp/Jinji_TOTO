<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Security_Role_Profile.aspx.vb" Inherits="PAGES_ORGANISATION_SECURITY_ROLE_PROFILE" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>JINJI : Organisation - Security Role Profile Page</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server">
    <form id="Security_Role_Profile" runat="server">
    <div>
    ...
    <!--// 4 //-->
    <asp:imagebutton id="imgOPTION_EMPLOYEE_GROUP" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
    <asp:label id="lblOPTION_EMPLOYEE_GROUP" runat="server" Width="140px" ></asp:label>
    <asp:dropdownlist id="ddlOPTION_EMPLOYEE_GROUP" runat="server" Width="150px" ></asp:dropdownlist>
    <asp:imagebutton id="imgbtnOPTION_EMPLOYEE_GROUP" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
