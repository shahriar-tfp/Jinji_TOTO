<%@ Page Language="VB" AutoEventWireup="false" CodeFile="User_Security.aspx.vb" Inherits="Pages_System_User_Security" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>JINJI : Organisation - User Security Page</title>
    <link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server">
    <form id="user_security" runat="server">
    <div>
    ...
    <asp:imagebutton id="imgBtnUSER_PROFILE_CODE2" runat="server" Height="21px"></asp:imagebutton>
    <!--// 3 //-->
    ...
    <asp:imagebutton id="imgbtnSECURITY_ROLE_HEADER_CODE" runat="server" Height="21px"></asp:imagebutton>
    <!--// listbox //-->
