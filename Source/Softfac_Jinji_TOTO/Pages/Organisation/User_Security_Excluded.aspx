<%@ Page Language="VB" AutoEventWireup="false" CodeFile="User_Security_Excluded.aspx.vb" Inherits="Pages_Organisation_User_Security_Excluded" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>JINJI : Organisation - User Security Excluded Page</title>
     <link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body>
    <form id="User_Security_Excluded" runat="server">
    <div>
    ...
    <!--// 2 //-->
    <asp:imagebutton id="imgUSER_PROFILE_CODE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
    ...
    <asp:imagebutton id="imgbtnUSER_PROFILE_CODE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

    <!--// 3 //-->
    <asp:imagebutton id="imgTABLE_PROFILE_CODE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
    <asp:label id="lblTABLE_PROFILE_CODE" runat="server" Width="140px" ></asp:label>
    <asp:textbox id="txtTABLE_PROFILE_CODE" runat="server" Width="150px" ></asp:textbox>
    <asp:imagebutton id="imgbtnTABLE_PROFILE_CODE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
