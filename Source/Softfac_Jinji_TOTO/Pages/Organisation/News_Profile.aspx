<%@ Page Language="VB" AutoEventWireup="false" CodeFile="News_Profile.aspx.vb" Inherits="PAGES_ORGANISATION_NEWS_PROFILE" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>JINJI : Organisation - NEWS Profile Page</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server">
<form id="NEWS_PROFILE" runat="server">
<div>
...
<!--// 2 //-->
<asp:imagebutton id="imgKeyMESSAGE_TITLE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblMESSAGE_TITLE" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtMESSAGE_TITLE" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnMESSAGE_TITLE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 3 //-->
<asp:imagebutton id="imgKeyMESSAGE_DESCRIPTION" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblMESSAGE_DESCRIPTION" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtMESSAGE_DESCRIPTION" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnMESSAGE_DESCRIPTION" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
...
<!--// 5 //-->
<asp:imagebutton id="imgKeyOPTION_HYPERLINK" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblOPTION_HYPERLINK" runat="server" Width="140px" ></asp:label>
<asp:dropdownlist id="ddlOPTION_HYPERLINK" runat="server" Width="150px" ></asp:dropdownlist>
<asp:imagebutton id="imgbtnOPTION_HYPERLINK" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 6 //-->
<asp:imagebutton id="imgKeyHYPERLINK_URL" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblHYPERLINK_URL" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtHYPERLINK_URL" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnHYPERLINK_URL" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 7 //-->
<asp:imagebutton id="imgKeyOPTION_SHOW" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblOPTION_SHOW" runat="server" Width="140px" ></asp:label>
<asp:dropdownlist id="ddlOPTION_SHOW" runat="server" Width="150px" ></asp:dropdownlist>
<asp:imagebutton id="imgbtnOPTION_SHOW" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
