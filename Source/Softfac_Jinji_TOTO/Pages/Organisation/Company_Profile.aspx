<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Company_Profile.aspx.vb" Inherits="Pages_System_Company_Profile" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>JINJI : Organisation - Company Profile Page</title>
...
<body id="body" runat="server">
	...
	<!--// 3 //-->
	<asp:image id="imgCURRENCY_PROFILE_CODE" runat="server" Height="21px" Width="21px"></asp:image>
	...
	<!--// 4 //-->
	<asp:image id="imgLANGUAGE_PROFILE_CODE" runat="server" Height="21px" Width="21px"></asp:image>
	...
	<!--// 5 //-->
	<asp:image id="imgREGIONAL_DATE_TIME_WEEK_CODE" runat="server" Height="21px" Width="21px"></asp:image>
	<asp:label id="lblREGIONAL_DATE_TIME_WEEK_CODE" runat="server" Width="140px"></asp:label>
	<asp:textbox id="txtREGIONAL_DATE_TIME_WEEK_CODE" runat="server" Width="150px"></asp:textbox>
	<asp:imagebutton id="imgBtnREGIONAL_DATE_TIME_WEEK_CODE" runat="server" Height="21px"></asp:imagebutton>
	<!--// 6 //-->
	<asp:image id="imgNO_OF_USER" runat="server" Height="21px" Width="21px"></asp:image>
	<asp:label id="lblNO_OF_USER" runat="server" Width="140px"></asp:label>
	<asp:textbox id="txtNO_OF_USER" runat="server" Width="150px"></asp:textbox>
	<asp:imagebutton id="imgBtnNO_OF_USER" runat="server" Height="21px"></asp:imagebutton>
	<!--// 7 //-->
	<asp:image id="imgNO_OF_EMPLOYEE" runat="server" Height="21px" Width="21px"></asp:image>
	<asp:label id="lblNO_OF_EMPLOYEE" runat="server" Width="140px"></asp:label>
	<asp:textbox id="txtNO_OF_EMPLOYEE" runat="server" Width="150px"></asp:textbox>
	<asp:imagebutton id="imgBtnNO_OF_EMPLOYEE" runat="server" Height="21px"></asp:imagebutton>
	<!--// 8 //-->
	<asp:image id="imgPHONE_NO" runat="server" Height="21px" Width="21px"></asp:image>
	...
	<asp:imagebutton id="imgBtnPHONE_NO" runat="server" Height="21px"></asp:imagebutton>
	<!--// 9 //-->
	<asp:image id="imgEXTENSION_NO" runat="server" Height="21px" Width="21px"></asp:image>
	...
	<asp:imagebutton id="imgBtnEXTENSION_NO" runat="server" Height="21px"></asp:imagebutton>
	<!--// 10 //-->
	<asp:image id="imgFAX_NO" runat="server" Height="21px" Width="21px"></asp:image>
	...
	<!--// 11 //-->
	<asp:image id="imgCONTACT_PERSON" runat="server" Height="21px" Width="21px"></asp:image>
	...
	<asp:imagebutton id="imgBtnCONTACT_PERSON" runat="server" Height="21px"></asp:imagebutton>
	<!--// 12 //-->
	<asp:image id="imgEMAIL_ADDRESS" runat="server" Height="21px" Width="21px"></asp:image>
	...
	<!--// 13 //-->
	<asp:image id="imgWEB_ADDRESS" runat="server" Height="21px" Width="21px"></asp:image>
	...
	<asp:imagebutton id="imgBtnWEB_ADDRESS" runat="server" Height="21px"></asp:imagebutton>
	<!--// 14 //-->
	...
	<asp:dropdownlist id="ddlOPTION_TYPE" runat="server" Width="157"></asp:dropdownlist>
	<asp:imagebutton id="imgBtnOPTION_TYPE" runat="server" Height="21px"></asp:imagebutton>
	<!--// 17 //-->
	<asp:image id="imgCOMPANY_PROFILE_CODE_HQ" runat="server" Height="21px" Width="21px"></asp:image>
	<asp:label id="lblCOMPANY_PROFILE_CODE_HQ" runat="server" Width="140px"></asp:label>
	<asp:textbox id="txtCOMPANY_PROFILE_CODE_HQ" runat="server" Width="150px"></asp:textbox>
	<asp:imagebutton id="imgBtnCOMPANY_PROFILE_CODE_HQ" runat="server" Height="21px"></asp:imagebutton>
	<!--// Panel //-->
