<%@ Page Language="VB" AutoEventWireup="false" CodeFile="UNLOCK_USER_TRANSACTION.aspx.vb" Inherits="PAGES_INFORMATION_SYSTEM_EMPLOYEE_TAX_CATEGORY" %>
...
<form id="UNLOCK_USER_TRANSACTION" runat="server">
<div>
...
<!--// 3 //-->
<asp:imagebutton id="imgKeyUNLOCK_DATE_START" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblUNLOCK_DATE_START" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtUNLOCK_DATE_START" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnUNLOCK_DATE_START" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 4 //-->
<asp:imagebutton id="imgKeyUNLOCK_DATE_END" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblUNLOCK_DATE_END" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtUNLOCK_DATE_END" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnUNLOCK_DATE_END" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
