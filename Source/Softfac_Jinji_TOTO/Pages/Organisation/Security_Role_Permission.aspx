<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Security_Role_Permission.aspx.vb" Inherits="PAGES_ORGANISATION_SECURITY_ROLE_PERMISSION" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>JINJI : Organisation - Security Role Permission Page</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server">
    <form id="Security_Role_Permission" runat="server">
    <div>
    ...
    <asp:imagebutton id="imgbtnSECURITY_ROLE_PROFILE_CODE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

    <!--// 3 //-->
    <asp:imagebutton id="imgSECURITY_ROLE_HEADER_CODE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
    <asp:label id="lblSECURITY_ROLE_HEADER_CODE" runat="server" Width="140px" ></asp:label>
    <asp:textbox id="txtSECURITY_ROLE_HEADER_CODE" runat="server" Width="150px" ></asp:textbox>
    <asp:imagebutton id="imgbtnSECURITY_ROLE_HEADER_CODE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

    <!--// 4 //-->
    <asp:imagebutton id="imgSECURITY_ROLE_DETAILS_CODE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
    <asp:label id="lblSECURITY_ROLE_DETAILS_CODE" runat="server" Width="140px" ></asp:label>
    <asp:textbox id="txtSECURITY_ROLE_DETAILS_CODE" runat="server" Width="150px" ></asp:textbox>
    <asp:imagebutton id="imgbtnSECURITY_ROLE_DETAILS_CODE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

    <!--// 5 //-->
    <asp:imagebutton id="imgTABLE_FIELD_CODE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
    ...
    <asp:imagebutton id="imgbtnTABLE_FIELD_CODE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
    <asp:imagebutton id="imgbtnTABLE_FIELD_CODE2" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

    <!--// 6 //-->
    <asp:imagebutton id="imgOPTION_PERMISSION_INSERT" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
    <asp:label id="lblOPTION_PERMISSION_INSERT" runat="server" Width="140px" ></asp:label>
    <asp:dropdownlist id="ddlOPTION_PERMISSION_INSERT" runat="server" Width="157px" ></asp:dropdownlist>
    <asp:imagebutton id="imgbtnOPTION_PERMISSION_INSERT" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

    <!--// 7 //-->
    <asp:imagebutton id="imgOPTION_PERMISSION_MODIFY" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
    <asp:label id="lblOPTION_PERMISSION_MODIFY" runat="server" Width="140px" ></asp:label>
    <asp:dropdownlist id="ddlOPTION_PERMISSION_MODIFY" runat="server" Width="157px" ></asp:dropdownlist>
    <asp:imagebutton id="imgbtnOPTION_PERMISSION_MODIFY" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

    <!--// 8 //-->
    <asp:imagebutton id="imgOPTION_PERMISSION_DELETE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
    <asp:label id="lblOPTION_PERMISSION_DELETE" runat="server" Width="140px" ></asp:label>
    <asp:dropdownlist id="ddlOPTION_PERMISSION_DELETE" runat="server" Width="157px" ></asp:dropdownlist>
    <asp:imagebutton id="imgbtnOPTION_PERMISSION_DELETE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

    <!--// 9 //-->
    <asp:imagebutton id="imgOPTION_PERMISSION_PREVIEW" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
    <asp:label id="lblOPTION_PERMISSION_PREVIEW" runat="server" Width="140px" ></asp:label>
    <asp:dropdownlist id="ddlOPTION_PERMISSION_PREVIEW" runat="server" Width="157px" ></asp:dropdownlist>
    <asp:imagebutton id="imgbtnOPTION_PERMISSION_PREVIEW" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

    <!--// 10 //-->
    <asp:imagebutton id="imgOPTION_PERMISSION_PRINT" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
    <asp:label id="lblOPTION_PERMISSION_PRINT" runat="server" Width="140px" ></asp:label>
    <asp:dropdownlist id="ddlOPTION_PERMISSION_PRINT" runat="server" Width="157px" ></asp:dropdownlist>
    <asp:imagebutton id="imgbtnOPTION_PERMISSION_PRINT" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
