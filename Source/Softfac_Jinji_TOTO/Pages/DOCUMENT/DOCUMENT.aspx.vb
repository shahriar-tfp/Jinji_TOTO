...
Partial Class PAGES_DOCUMENT_DOCUMENT
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Else
            ...
            If FUFILENAME.HasFile = True Then
                hFILENAME.Value = FUFILENAME.FileName.ToString
            End If
...
#Region "Panel Edit"
    Protected Sub imgBtnSubmit_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnSubmit.Click
        ...
        If ValidateInsert() = True Then
            ...
            FUFILENAME.SaveAs(Server.MapPath("~/PAGES/DOCUMENT/Upload/") & FUFILENAME.FileName.ToString)
            pnlEdit.Visible = False
            pnlMain.Visible = True
            BindGrid()
        End If
    ...
    Protected Sub imgBtnUpdate_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnUpdate.Click
        If ValidateUpdate() Then
            If File.Exists(Server.MapPath("~/PAGES/DOCUMENT/Upload/") & FUFILENAME.FileName.ToString) Then
                File.Delete(Server.MapPath("~/PAGES/DOCUMENT/Upload/") & FUFILENAME.FileName.ToString)
            End If
            File.Delete(Server.MapPath("~/PAGES/DOCUMENT/Upload/") & OldFILENAME.Value)
            mySQL.ExecuteSQL(ssql, Session("Company").ToString, Session("EmpID").ToString)
            FUFILENAME.SaveAs(Server.MapPath("~/PAGES/DOCUMENT/Upload/") & FUFILENAME.FileName.ToString)
            pnlEdit.Visible = False
            pnlMain.Visible = True
    ...
    Protected Sub imgBtnEdit_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnEdit.Click
        If ActionValidateEdit() Then
            ...
            For i = 0 To myGridView.Rows.Count - 1
                Dim chkEdit As CheckBox = myGridView.Rows(i).Cells(0).Controls(1)
                If chkEdit.Checked Then
                    OldFILENAME.Value = myGridView.Rows(i).Cells(5).Text
                    chkEdit.Checked = False
                    myDS = New DataSet
        ...
        If ActionValidateDelete() Then
            For i = 0 To myGridView.Rows.Count - 1
                ...
                If chkDelete.Checked Then
                    ...
                    If ssql <> Nothing Then
                        File.Delete(Server.MapPath("~/PAGES/DOCUMENT/Upload/") & myGridView.Rows(i).Cells(5).Text)
...
#Region "Sub & Function"
                ...
                For i = 0 To myDS.Tables(0).Rows.Count - 1
                    ...
                    Select Case UCase(Trim(myDS.Tables(0).Rows(i).Item(dt).ToString))
                        ...
                        Case Else
                            ...
                            Select Case UCase(Trim(myDS.Tables(0).Rows(i).Item(posType).ToString))
                                Case "0"
                                    If myLabel.Visible = True And (myTextBox.Visible = True Or Trim(myDS.Tables(0).Rows(i).Item(code)) = "FILENAME") Then
                                        autonum = autonum + 1
                                        myImage.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                                        myImage.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                                        myImage.Style.Add("position", "absolute")
                                        ...
                                        myLabel.Style.Add("position", "absolute")
                                        autonum = autonum + 1
                                        If Trim(myDS.Tables(0).Rows(i).Item(code)) = "FILENAME" Then
                                            FUFILENAME.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                                            FUFILENAME.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                                            FUFILENAME.Style.Add("position", "absolute")
                                            FUFILENAME.Width = txtWidth
                                            txtFILENAME.Visible = False
                                        End If
    ...
    Private Function ValidateInsert() As Boolean
            ...
            For i = 0 To myDS.Tables(0).Rows.Count - 1
                Select Case myDS.Tables(0).Rows(i).Item(1).ToString
                    ...
                    Case Else   '"CHARACTER", "LOOKUP"
                        Dim myTextBox As TextBox = Page.FindControl("txt" & Trim(myDS.Tables(0).Rows(i).Item(0)))
                        If (myTextBox.Visible = True Or Trim(myDS.Tables(0).Rows(i).Item(0)) = "FILENAME") Then
                            If mySetting.CheckTextNullAndReplaceSingleQuote(myTextBox) = True Then
                                ssql = ssql & myDS.Tables(0).Rows(i).Item(0) & ","
        ...
        If myDS.Tables(0).Rows.Count > 0 Then
            ...
            Return False
        ElseIf File.Exists(Server.MapPath("~/PAGES/DOCUMENT/Upload/") & FUFILENAME.FileName.ToString) Then
            lblresult2.Text = FUFILENAME.FileName.ToString & " file name already exists!"
            Return False
        End If
        myDS = Nothing
        Return True
...
#End Region
    ...
    Protected Sub hFILENAME_ValueChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles hFILENAME.ValueChanged
        txtFILENAME.Text = hFILENAME.Value
    End Sub
End Class