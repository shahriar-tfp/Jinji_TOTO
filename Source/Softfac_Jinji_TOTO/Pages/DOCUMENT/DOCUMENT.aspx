<%@ Page Language="VB" AutoEventWireup="false" CodeFile="DOCUMENT.aspx.vb" Inherits="PAGES_DOCUMENT_DOCUMENT" %>
...
<script type="text/javascript">
      function callme(oFile) {
          document.getElementById("hFILENAME").value = oFile.value;
      }
...
<!--// 4 //-->
<asp:imagebutton id="imgKeyDISPLAY_NAME" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblDISPLAY_NAME" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtDISPLAY_NAME" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnDISPLAY_NAME" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 5 //-->
<asp:imagebutton id="imgKeyFILENAME" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblFILENAME" runat="server" Width="140px" ></asp:label>
<asp:FileUpload ID="FUFILENAME" runat="server" onchange="callme(this)"/>
...
<asp:imagebutton id="imgbtnFILENAME" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
