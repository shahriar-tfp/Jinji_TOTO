...
Partial Class PAGES_BUSROUTE_UNI_BUSREQUEST
                        ...
                        If myTextBox.Visible = True Then
                            If mySetting.CheckTextNullAndReplaceSingleQuote(myTextBox) = True Then
                                ...
                                If myDS.Tables(0).Rows(i).Item(0).ToString.ToUpper = "EMPLOYEE_PROFILE_ID" Then
                                    ...
                                    ssql4 = "exec sp_is_JobCategoryLevel '" & Session("Company").ToString & "', N'" & txtEMPLOYEE_PROFILE_ID.Text.Replace("'", "''") & "'"
                                    Dim myDSG As New DataSet
                                    myDSG = mySQL.ExecuteSQL(ssql4, Session("Company").ToString, Session("EmpID").ToString)

                                    If myDSG.Tables(0).Rows.Count > 0 Then
                                        If myDSG.Tables(0).Rows(0).Item(0).ToString = "E" Or myDSG.Tables(0).Rows(0).Item(0).ToString = "MGT" Or myDSG.Tables(0).Rows(0).Item(0).ToString = "NE" Or myDSG.Tables(0).Rows(0).Item(0).ToString = "TRAIN" Then
                                            lblresult2.Text = "[" & Trim(myDS.Tables(0).Rows(i).Item(5)) & "] Only Operator can has bus Request!"
                                            myTextBox.Focus()
                                            Return False
                                        End If
                                    End If
