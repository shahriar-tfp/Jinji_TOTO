<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Emp_Daily_Task.aspx.vb" Inherits="PAGES_PERFORMANCE_EMP_DAILY_TASK" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>JINJI : Performance - Employee Daily Task Page</title>
<link href="../../App_Themes/hcrmStyles2.css" type="text/css" rel="stylesheet" />
</head>
<body>
<form id="EMP_DAILY_TASK" runat="server">
<div>
...
<!--// 3 //-->
<asp:imagebutton id="imgKeyCUSTOMER_DEVELOPMENT" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblCUSTOMER_DEVELOPMENT" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtCUSTOMER_DEVELOPMENT" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnCUSTOMER_DEVELOPMENT" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
...
<!--// 5 //-->
<asp:imagebutton id="imgKeyDOI" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblDOI" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtDOI" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnDOI" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 6 //-->
<asp:imagebutton id="imgKeyOWNER" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblOWNER" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtOWNER" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnOWNER" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
...
<!--// 9 //-->
<asp:imagebutton id="imgKeyCOMPLETION" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblCOMPLETION" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtCOMPLETION" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnCOMPLETION" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
...
<!--// 11 //-->
<asp:imagebutton id="imgKeyTESTED_DATE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblTESTED_DATE" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtTESTED_DATE" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnTESTED_DATE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
