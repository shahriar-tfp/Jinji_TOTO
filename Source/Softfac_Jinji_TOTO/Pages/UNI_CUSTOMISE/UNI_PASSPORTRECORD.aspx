<%@ Page Language="VB" AutoEventWireup="false" CodeFile="UNI_PASSPORTRECORD.aspx.vb" Inherits="PAGES_UNI_CUSTOMISE_UNI_PASSPORTRECORD" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>UNI_PASSPORTRECORD</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server"> 
<form id="UNI_PASSPORTRECORD" runat="server">
<div>
...
<!--// 3 //-->
<asp:imagebutton id="imgKeyBORROW_DATE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblBORROW_DATE" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtBORROW_DATE" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnBORROW_DATE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 4 //-->
<asp:imagebutton id="imgKeyPASSPORT_STATUS" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblPASSPORT_STATUS" runat="server" Width="140px" ></asp:label>
<asp:dropdownlist id="ddlPASSPORT_STATUS" runat="server" Width="150px" ></asp:dropdownlist>
<asp:imagebutton id="imgbtnPASSPORT_STATUS" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 5 //-->
<asp:imagebutton id="imgKeyACTUAL_RETURN_DATE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblACTUAL_RETURN_DATE" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtACTUAL_RETURN_DATE" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnACTUAL_RETURN_DATE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 6 //-->
<asp:imagebutton id="imgKeyPASSPORT_NO" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblPASSPORT_NO" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtPASSPORT_NO" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnPASSPORT_NO" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
