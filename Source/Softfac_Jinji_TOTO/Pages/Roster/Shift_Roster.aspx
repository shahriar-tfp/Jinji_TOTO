<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Shift_Roster.aspx.vb" Inherits="Pages_Roster_Shift_Roster" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>JINJI : Roster - Shift Roster Page</title>
    <link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server">
    <form id="Shift_Roster" runat="server">
    <div>
                    ...
                    <table cellpadding="0" cellspacing="0" border="0">
                        <tr>
                            <td align="left" width="140px">
                                <asp:Label ID="lblOCP_ID_TMS" runat="Server" Text="Calendar Type" Width="140px" CssClass="wordstyle3"></asp:Label>
                            </td>
                            <td align="left" width="150px">    
                                <asp:TextBox ID="txtOCP_ID_TMS" runat="server" Width="150px" ></asp:TextBox>
                            </td>
                            <td align="left" width="25px">
                                <asp:ImageButton ID="imgbtnOCP_ID_TMS" runat="server" Height="21px" />
                            </td>  
     ...
     <asp:Panel ID="pnlEdit" runat="server">
        <table  cellpadding="0" cellspacing="0" border="0">
            ...
            <tr>
                <td align="left" width="140px"><asp:Label ID="lblOCP_ID_SHIFT" runat="server" CssClass="wordstyle3" Text="Day Type" Width="140px"></asp:Label></td> 
                <td align="left" width="150px"><asp:TextBox ID="txtOCP_ID_SHIFT" runat="server" Width="150px" ></asp:TextBox></td> 
                <td align="left" width="25px"><asp:ImageButton ID="imgbtnOCP_ID_SHIFT" runat="server" Height="21px" /></td> 
                <td align="left" width="14px"></td> 
                <td align="left" width="140px"></td> 
                <td align="left" width="150px"></td> 
                <td align="left" width="25px"></td> 
        ...
        <table>
            <tr>
                ...
                <td valign="top"><asp:Label id="lblResult" runat="server" CssClass="wordstyle2" Visible="false"></asp:Label><br /></td>
            </tr>
        </table>
    </asp:Panel>
    </div>
