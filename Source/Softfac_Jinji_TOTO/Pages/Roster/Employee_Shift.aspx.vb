...
Partial Class Pages_Roster_Employee_Shift
    ...
    Private Function ValidateInput() As Boolean
        ...
        If Trim(txtFromDate.Text.ToString) <> "" And Trim(txtToDate.Text.ToString) <> "" Then
            ...
            End If
        End If
        Dim PayCycle As String, ssql2 As String

        ssql2 = "Select a.Option_Pay_Cycle from employee_salary a, employee_codename_vw b where a.Employee_Profile_id = b.employee_profile_id and b.codename = '" & txtEMPLOYEE_PROFILE_ID.Text.Replace("'", "''") & "'"
        ...
        Date3 = mySetting.ConvertDateToDecimal(Trim(txtFromDate.Text.ToString), Session("Company").ToString, Session("Module").ToString)
