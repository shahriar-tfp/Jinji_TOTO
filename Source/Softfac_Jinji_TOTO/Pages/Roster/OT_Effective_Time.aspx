<%@ Page Language="VB" AutoEventWireup="false" CodeFile="OT_Effective_Time.aspx.vb" Inherits="Pages_Roster_OT_Effective_Time" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>JINJI : Roster - OT Effective Time Page</title>
    <link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server">
    <form id="OT_EFFECTIVE_TIME" runat="server">
    <div>
    ...
    <asp:CheckBox ID="chkOPTION_DAY_TYPE" runat="server" ToolTip="Select All" AutoPostBack="true"/>
    <!--// 5 //-->
    ...
    <!--// 7 //-->
    <asp:imagebutton id="imgKeyEFFECTIVE_TIME" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
    <asp:label id="lblEFFECTIVE_TIME" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtEFFECTIVE_TIME" runat="server" Width="150px"></asp:textbox>
    <asp:imagebutton id="imgbtnEFFECTIVE_TIME" runat="server" Height="21px" ></asp:imagebutton>
