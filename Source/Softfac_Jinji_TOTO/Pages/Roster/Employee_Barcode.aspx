<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Employee_Barcode.aspx.vb" Inherits="Pages_Roster_Employee_Barcode" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>JINJI : Roster - Employee Matching Page</title>
    <link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server">
    <form id="EMPLOYEE_BARCODE" runat="server">
    <div>
    ...
    <!--// 2 //-->
    <asp:imagebutton id="imgKeyBARCODE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
    <asp:label id="lblBARCODE" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtBARCODE" runat="server" Width="150px"></asp:textbox>
    <asp:imagebutton id="imgbtnBARCODE" runat="server" Height="21px" ></asp:imagebutton>
    <!--// 3 //-->
