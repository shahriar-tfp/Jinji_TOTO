<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CLOCK_INDICATE.aspx.vb" Inherits="PAGES_ROSTER_CLOCK_INDICATE" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>CLOCK_INDICATE</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server"> 
<form id="CLOCK_INDICATE" runat="server">
<div>
<asp:Panel ID="pnlEdit" runat="server">
<!--// 1 //-->
<asp:imagebutton id="imgKeyCLOCK_NO" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblCLOCK_NO" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtCLOCK_NO" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnCLOCK_NO" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
