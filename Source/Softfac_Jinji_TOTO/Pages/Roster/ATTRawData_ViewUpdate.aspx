<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ATTRawData_ViewUpdate.aspx.vb" Inherits="Pages_Roster_ATTRawData_ViewUpdate" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>JINJI : Roster - ATT RawData View Page</title>
    <link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body>
    <form id="ATTRawData_ViewUpdate" runat="server">
    <div>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
	   <tr><td>	    
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
	   <tr><td><asp:Label ID="lblDateIn" Text="Date" runat="server" Width="120px" Font-Bold="true"></asp:Label>
    ...
    <asp:Label ID="lblDateOut" Text="Date Out" runat="server" Width="120px" Font-Bold="true" Visible="false"></asp:Label>
    <asp:TextBox ID="txtDateOut" runat="server" Width="150px"  Visible="false" ></asp:TextBox>
    <asp:ImageButton ID="imgBtnDateOut" runat="server" Width="21px" Height="21px" Visible="false"/>
    </td></tr>
    <tr><td><asp:Label ID="lblspace1" Text="&nbsp;" runat="server" Width="10px"></asp:Label></td></tr>
    <tr><td><asp:Label ID="lblOption_Reason_Type" Text="Clock Location" runat="server" Width="120px" Font-Bold="true"></asp:Label>
    <asp:dropdownlist ID="ddlOption_Reason_Type" runat="server" Width="180px" AutoPostBack=true></asp:dropdownlist>
    <asp:Label ID="lblReason" Text="Reason" runat="server" Width="120px" Font-Bold="true" Visible="false"></asp:Label>
    <asp:TextBox ID="txtReason" runat="server" Width="150px" Visible="false"></asp:TextBox>
