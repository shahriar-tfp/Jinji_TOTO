...
#Region "Panel Edit"
    ...
    Protected Sub imgBtnSearch_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnSearch.Click
        If ValidateSearch() = True Then
            ...
            BindGrid()
            myDS = New DataSet
            myDS = mySQL.ExecuteSQL("SELECT Code,Option_Primary_Key,Option_Data_Type,Option_Mandatory FROM Table_Field Where Table_Profile_Code='" & Form.ID & "' ORDER BY SEQUENCE_NO")
...
#Region "Panel Action"
    ...
    Protected Sub imgBtnFilter_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnFilter.Click
        ...
        'EnableAll()
        myDS = New DataSet
        myDS = mySQL.ExecuteSQL("SELECT Code,Option_Data_Type FROM Table_Field Where Table_Profile_Code='" & Form.ID & "' ORDER BY SEQUENCE_NO")
        For i = 0 To myDS.Tables(0).Rows.Count - 1
...
#Region "Sub & Function"
                                ...
                                Else
                                    ...
                                    If myDST.Tables(0).Rows.Count > 0 Then
                                        ...
                                        ElseIf myDST.Tables(0).Rows(0).Item(1).ToString.Trim <> "" And myDST.Tables(0).Rows(0).Item(2).ToString.Trim <> "" Then
                                            ...
                                            htb.Add(myDS.Tables(0).Rows(i).Item(0).ToString.ToUpper, "ISNULL(" & myDST.Tables(0).Rows(0).Item(0).ToString & "(N'" & myTextBox.Text.ToString & "',N'" & myDST.Tables(0).Rows(0).Item(1).ToString.Trim & "',N'" & Session("Company") & "'),'')")
                                        Else
    ...
    Private Function ValidateSearch() As Boolean
        ...
        ssql3 = ""
        myDS = New DataSet
        myDS = mySQL.ExecuteSQL("Select Code,Name,Option_Data_Type From Table_Field Where Table_Profile_Code='" & Form.ID & "' Order By Table_Profile_Code,Sequence_No")
        If Not myDS Is Nothing Then
            If myDS.Tables.Count > 0 Then
                For i = 0 To myDS.Tables(0).Rows.Count - 1
                                ...
                                Else
                                    ...
                                    If myDST.Tables(0).Rows.Count > 0 Then
                                        ...
                                        ElseIf myDST.Tables(0).Rows(0).Item(1).ToString.Trim <> "" And myDST.Tables(0).Rows(0).Item(2).ToString.Trim <> "" Then
                                            ...
                                            htb.Add(myDS.Tables(0).Rows(i).Item(0).ToString.ToUpper, "ISNULL(" & myDST.Tables(0).Rows(0).Item(0).ToString & "(N'" & myTextBox.Text.ToString & "',N'" & myDST.Tables(0).Rows(0).Item(1).ToString.Trim & "',N'" & Session("Company").ToString & "'),'')")
                                        Else
                                    ...
                                    Else
                                        ...
                                        If myDST2.Tables(0).Rows.Count > 0 Then
                                            ...
                                            ElseIf myDST2.Tables(0).Rows(0).Item(1).ToString.Trim <> "" And myDST2.Tables(0).Rows(0).Item(2).ToString.Trim <> "" Then
                                                ...
                                                htb.Add(myDS2.Tables(0).Rows(i).Item(0).ToString.ToUpper, "ISNULL(" & myDST2.Tables(0).Rows(0).Item(0).ToString & "(N'" & myTextBox.Text.ToString & "',N'" & myDST2.Tables(0).Rows(0).Item(1).ToString.Trim & "',N'" & Session("Company") & "'),'')")
                                            Else
