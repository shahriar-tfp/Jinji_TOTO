...
#Region "Page Setting"
    ...
    Sub PagePreload()
        ...
        If myDS.Tables.Count > 1 Then
            ...
            myDS10 = New DataSet
            ssql10 = "Exec sp_sa_GetLookupCodeName " & """" & Session("Company").ToString & """," & """" & "APPROVAL" & """," & """" & "MARKING_ATTENDANCE" & """," & """" & "SUPERVISOR" & """," & """" & """," & """" & Session("EmpID").ToString & """"
            myDS10 = mySQL.ExecuteSQL(ssql10.ToString.Replace("""", "'"))
        ...
        Try
            ...
            Else
                If SearchByPage = True Then
                    ssql = "Exec sp_sa_GetTableRecordsWithSecurity '" & Session("Company").ToString & "','" & EmpCode & "','" & Session("Module").ToString & "','" & Form.ID & "','" & myGridView.PageSize & "','" & txtGoToPage.Text & "'"
                    ssql2 = "Exec sp_sa_CompareTableRecords '" & Session("Company").ToString & "','" & EmpCode & "','" & Session("Module").ToString & "','" & Form.ID & "','" & gvHistory.PageSize & "','" & txtGoToPage.Text & "'"
                Else
                    ssql = "Exec sp_sa_GetTableRecordsWithSecurity '" & Session("Company").ToString & "','" & EmpCode & "','" & Session("Module").ToString & "','" & Form.ID & "','" & myGridView.PageSize & "','" & _currentPageNumber & "'"
                    ssql2 = "Exec sp_sa_CompareTableRecords '" & Session("Company").ToString & "','" & EmpCode & "','" & Session("Module").ToString & "','" & Form.ID & "','" & gvHistory.PageSize & "','" & _currentPageNumber & "'"
                End If
            End If
        ...
        If Not myDS Is Nothing Then
            If myDS.Tables.Count > 0 Then
                ...
                Else
                    ...
                    Session("SearchSQL") = "Exec sp_Generate_Query_Filter_WithSecurity N'" & Session("Company").ToString & "',N'" & EmpCode & "',N'" & _
                            Session("Module").ToString & "',N'" & ssql & "',N'" & ssql2 & "',N'" & ssql3 & _
                            "','" & myGridView.PageSize & "','"
                    Session("SearchSQL1") = "Exec sp_Compare_Query_Filter_WithSecurity N'" & Session("Company").ToString & "',N'" & EmpCode & "',N'" & _
                            Session("Module").ToString & "',N'" & ssql & "',N'" & ssql2 & "',N'" & ssql3 & _
                            "','" & myGridView.PageSize & "','"
