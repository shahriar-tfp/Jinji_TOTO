...
Partial Class Pages_Roster_LateIn_Approved
...
#End Region
    ...
    Protected Sub imgBtnPrint_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnPrint.Click
        ...
        If myDS.Tables.Count > 0 Then
            If myDS.Tables(0).Rows.Count > 0 Then
                ssql1 = "Exec [sp_Tms_Lateinapproved] '" & Session("Company").ToString & "','" & myDS.Tables(0).Rows(0).Item(0).ToString & "','','" & myDS.Tables(0).Rows(0).Item(1).ToString & "','" & myDS.Tables(0).Rows(0).Item(2).ToString & "','PENDING','','','" & Session("EmpID").ToString & "','DETAILS'"
                myDS1 = New DataSet()
    ...
    Protected Sub imgBtnSubmit_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnSubmit.Click
        ...
        Else
            ...
            If myDS.Tables.Count > 0 Then
                If myDS.Tables(0).Rows.Count > 0 Then
                    ssql1 = "Exec sp_Tms_Lateinapproved '" & Session("Company").ToString & "','" & myDS.Tables(0).Rows(0).Item(0).ToString & "','" & myDS.Tables(0).Rows(0).Item(3).ToString & "','" & myDS.Tables(0).Rows(0).Item(1).ToString & "','" & myDS.Tables(0).Rows(0).Item(2).ToString & "','" & ddlYES.SelectedValue & "','" & txtApprovedBy.Text & "','" & txtReason.Text & "','" & Session("EmpID").ToString & "','UPD'"
        ...
        If ActionValidateDelete() Then
            For i = 0 To gv1.Rows.Count - 1
                ...
                If chkDelete.Checked Then
                    ...
                    If myDS.Tables.Count > 0 Then
                        If myDS.Tables(0).Rows.Count > 0 Then
                            ssql1 = "Exec sp_Tms_Lateinapproved '" & Session("Company").ToString & "','" & myDS.Tables(0).Rows(0).Item(0).ToString & "','" & myDS.Tables(0).Rows(0).Item(3).ToString & "','" & myDS.Tables(0).Rows(0).Item(1).ToString & "','" & myDS.Tables(0).Rows(0).Item(2).ToString & "','" & ddlYES.SelectedValue & "','" & txtApprovedBy.Text & "','" & txtReason.Text & "','" & Session("EmpID").ToString & "','DEL'"
                            mySQL.ExecuteSQL(ssql1, Session("Company").ToString, Session("EmpID").ToString)
                        End If
                    End If
                End If
