<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Marking_Attendance.aspx.vb" Inherits="Pages_Roster_Marking_Attendance" %>
...
<body id="body" runat="server">
    <form id="Marking_Attendance" runat="server">
    <div>
					    ...
					    <td>
					        ...
					        <table id="Table6" cellspacing="0" cellpadding="0" border="0" runat="server">
					            ...
					            <tr>
					                ...
					                <td>
					                    <asp:LinkButton id="lnkBtnViewPending" runat="server" CssClass="wordstyle" Text="[ Pending Leave ]" Enabled="false" Visible="false"></asp:LinkButton>
					                    <asp:LinkButton id="lnkBtnClosePending" runat="server" CssClass="wordstyle11" Text="[ Pending Leave ]" Visible="false" ></asp:LinkButton>
					                    <asp:LinkButton id="lnkBtnViewToday" runat="server" CssClass="wordstyle" Text="[ Today ]" Enabled="true" Visible="true"></asp:LinkButton>
					                    <asp:LinkButton id="lnkBtnCloseToday" runat="server" CssClass="wordstyle11" Text="[ Today ]" Visible="false" ></asp:LinkButton>
					                </td>
					                <td><asp:Image ID="imgBlank03" Width="10px" Height="25px" runat="server" /></td>
					                <td>
					                    <asp:LinkButton id="lnkBtnViewYesterday" runat="server" CssClass="wordstyle" Text="[ Yesterday ]" Enabled="true" Visible="true"></asp:LinkButton>
					                    <asp:LinkButton id="lnkBtnCloseYesterday" runat="server" CssClass="wordstyle11" Text="[ Yesterday ]" Visible="false" ></asp:LinkButton>
					                    
					                </td>
					                <td><asp:Image ID="imgBlank04" Width="10px" Height="25px" runat="server" /></td>
					                <td>
					                    <asp:LinkButton id="lnkBtnViewReject" runat="server" CssClass="wordstyle" Text="[ Reject Leave ]" Enabled="false" Visible="false"></asp:LinkButton>
					                    <asp:LinkButton id="lnkBtnCloseReject" runat="server" CssClass="wordstyle11" Text="[ Reject Leave ]" Visible="false" ></asp:LinkButton>
					                    <asp:LinkButton id="lnkBtnViewAll" runat="server" CssClass="wordstyle" Text="[ Two Week ]" Enabled="true" Visible="true"></asp:LinkButton>
					                    <asp:LinkButton id="lnkBtnCloseAll" runat="server" CssClass="wordstyle11" Text="[ Two Week ]" Visible="false" ></asp:LinkButton>
					                </td>
					                <td><asp:Image ID="imgBlank05" Width="10px" Height="25px" runat="server" /></td>
					                <td>
					                    <asp:LinkButton id="lnkBtnViewBalance" runat="server" CssClass="wordstyle" Text="[ Leave Balance ]" Enabled="false" Visible="false"></asp:LinkButton>
					                    <asp:LinkButton id="lnkBtnCloseBalance" runat="server" CssClass="wordstyle11" Text="[ Leave Balance ]" Visible="false" ></asp:LinkButton>
					                    <asp:LinkButton id="lnkBtnViewApproved" runat="server" CssClass="wordstyle" Text="[ Approved ]" Enabled="true" Visible="true"></asp:LinkButton>
					                    <asp:LinkButton id="lnkBtnCloseApproved" runat="server" CssClass="wordstyle11" Text="[ Approved ]" Visible="false" ></asp:LinkButton>
					                </td>
					            </tr>
					        </table>
					    </td> 
				               ...
				               <asp:Panel id="pnlpart2" runat="server" visible="False">
				                   <table id="Table16" cellspacing="0" cellpadding="0" border="0" width="99%" runat="server">
		                               <tr>
		                                   ...
		                                   <td style="width:5px">&nbsp;</td>
		                                   <td style="width:100%"><asp:Textbox id="txtAID" Width="98%" CssClass="wordstyle" runat="server"></asp:Textbox><asp:DropDownList ID="ddlSelectAID" Width="98%" CssClass="wordstyle" runat="server" AutoPostBack="true" Visible="false"></asp:DropDownList></td>
				                        ...
				                        <td>
				                            <div style="margin-left:5px; margin-top:5px; margin-right:5px">
					                            <asp:panel id="pnlgridview1" ScrollBars="Auto" runat="server" visible="true">
						                            <asp:gridview id="myGridView1" Width="100%" runat="server" AutoGenerateColumns="false" AutoGenerateEditButton="false" AutoGenerateDeleteButton="false" AutoGenerateSelectButton="false" 
							                            ...
							                            <columns>
                                                            ...
                                                            <asp:BoundField DataField="EmpName" HeaderText="ID / Employee Name"  />
                                                            <asp:BoundField DataField="TimeIn" HeaderText="Time In"  />
                                                            <asp:BoundField DataField="InError" HeaderText="Attendance In Error"  />
                                                            <asp:BoundField DataField="InStatus" HeaderText="In Status"  />
                                                            <asp:TemplateField HeaderText="Approve" ItemStyle-HorizontalAlign="Center">
									                            <HeaderStyle HorizontalAlign="Center" Width="2%"></HeaderStyle>
									                            <ItemTemplate>
										                            <asp:CheckBox ID="chkA3" BorderStyle="None" Runat="server" />
									                            </ItemTemplate>
								                            </asp:TemplateField>
								                            <asp:TemplateField HeaderText="Reject" ItemStyle-HorizontalAlign="Center">
									                            <HeaderStyle HorizontalAlign="Center" Width="2%"></HeaderStyle>
									                            <ItemTemplate>
										                            <asp:CheckBox ID="chkR3" BorderStyle="None" Runat="server" />
									                            </ItemTemplate>
								                            </asp:TemplateField>
								                            <asp:BoundField DataField="TimeOut" HeaderText="Time Out"  />
                                                            <asp:BoundField DataField="OutError" HeaderText="Attendance Out Error"  />
                                                            <asp:BoundField DataField="OutStatus" HeaderText="Out Status"  />
								                ...
								                <asp:panel id="pnlgridview2" ScrollBars="Horizontal" runat="server" visible="false">
									                <asp:gridview id="myGridview2" Width="100%" Height="100%" runat="server" AutoGenerateColumns="false" AutoGenerateEditButton="false" AutoGenerateDeleteButton="false" AutoGenerateSelectButton="false" 
										                CssClass="wordstyle" cellspacing="0" cellpadding="1" EmptyDataText="No data found!">
                                                        <AlternatingRowStyle BackColor="#F2F4FF" />
										                <EditRowStyle BackColor="#FFC7C6" CssClass="dgstyle_i" />
										                <SelectedRowStyle BackColor="#D1DDF1" Font-Bold="True" ForeColor="#333333" />
										                ...
										                <columns>
                                                            ...
                                                            <asp:BoundField DataField="Empid" HeaderText="ID / Employee Name"  />
                                                            <asp:BoundField DataField="Date_Time_in" HeaderText="Time In"  />
                                                            <asp:BoundField DataField="In_Error" HeaderText="Attendance In Error"  />
                                                            <asp:BoundField DataField="In_Status" HeaderText="In Status"  />
                                                            <asp:TemplateField HeaderText="Approve" ItemStyle-HorizontalAlign="Center">
									                            <HeaderStyle HorizontalAlign="Center" Width="2%"></HeaderStyle>
									                            <ItemTemplate>
										                            <asp:CheckBox ID="chkA4" BorderStyle="None" Runat="server" />
									                            </ItemTemplate>
								                            </asp:TemplateField>
								                            <asp:TemplateField HeaderText="Reject" ItemStyle-HorizontalAlign="Center">
									                            <HeaderStyle HorizontalAlign="Center" Width="2%"></HeaderStyle>
									                            <ItemTemplate>
										                            <asp:CheckBox ID="chkR4" BorderStyle="None" Runat="server" />
									                            </ItemTemplate>
								                            </asp:TemplateField>
								                            <asp:BoundField DataField="Date_Time_Out" HeaderText="Time Out"  />
                                                            <asp:BoundField DataField="Out_Error" HeaderText="Attendance Out Error"  />
                                                            <asp:BoundField DataField="Out_Status" HeaderText="Out Status"  />
                                                            <asp:BoundField DataField="Leaveid" HeaderText="Leave"  />
                                                            <asp:BoundField DataField="Tmsid" HeaderText="Group"  />
                                                            <asp:BoundField DataField="DayTypeID" HeaderText="Day Type"  />
									        ...
									        <asp:panel id="pnlprevnext1" runat="server" visible="true">
								                ...
								                <table id="Table11" cellspacing="0" cellpadding="0" border="0" runat="server">
				                                   <tr>
				                                       ...
				                                       <td style="height:5px" Width="150px"></td>
				                                       <td style="height:5px"><asp:CheckBox ID="chkAOAll" AutoPostBack="true" Width="120px" CssClass="wordstyle" BorderStyle="None" Runat="server" visible=true/></td>
				                                       <td style="height:5px"><asp:CheckBox ID="chkROAll" AutoPostBack="true" Width="120px" CssClass="wordstyle" BorderStyle="None" Runat="server" visible=false/></td>
				                                   </tr>
				                                </table>
									        </asp:panel>
								        </td>
