<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AttendancePaid_View.aspx.vb" Inherits="Pages_Roster_AttendancePaid_View" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>JINJI : Roster - Attendance Paid View Page</title>
    <link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body>
    <form id="AttendancePaid_View" runat="server">
    <div>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
	   <tr><td>	    
	    <div id="divGridview1" style="top: 200px;left: 15px;position :absolute; width: 100%; height: 50px;">
