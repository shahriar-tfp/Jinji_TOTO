<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Shift_Profile.aspx.vb" Inherits="Pages_Roster_Shift_Profile" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>JINJI : Roster - Shift Profile Page</title>
    <link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server">
    <form id="Shift_Profile" runat="server">
    <div>
    ...
    <!--// 4 //-->
    <asp:imagebutton id="imgKeyTIME_IN" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
    ...
    <!--// 5 //-->
    <asp:imagebutton id="imgKeyTIME_OUT" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
    ...
    <!--// 6 //-->
    <asp:imagebutton id="imgKeyCUT_OFF_TIME_1" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
    <asp:label id="lblCUT_OFF_TIME_1" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtCUT_OFF_TIME_1" runat="server" Width="150px"></asp:textbox>
    <asp:imagebutton id="imgbtnCUT_OFF_TIME_1" runat="server" Height="21px" ></asp:imagebutton>
    <!--// 7 //-->
    <asp:imagebutton id="imgKeyCUT_OFF_TIME_2" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
    <asp:label id="lblCUT_OFF_TIME_2" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtCUT_OFF_TIME_2" runat="server" Width="150px"></asp:textbox>
    <asp:imagebutton id="imgbtnCUT_OFF_TIME_2" runat="server" Height="21px" ></asp:imagebutton>
    <!--// 8 //-->
    ...
    <!--// 10 //-->
    <asp:imagebutton id="imgKeyOPTION_WORK_TOMORROW" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
    <asp:label id="lblOPTION_WORK_TOMORROW" runat="server" Width="140px"></asp:label>
    <asp:dropdownlist id="ddlOPTION_WORK_TOMORROW" runat="server" Width="157px"></asp:dropdownlist>
    <asp:imagebutton id="imgbtnOPTION_WORK_TOMORROW" runat="server" Height="21px" ></asp:imagebutton>
    <!--// 11 //-->
