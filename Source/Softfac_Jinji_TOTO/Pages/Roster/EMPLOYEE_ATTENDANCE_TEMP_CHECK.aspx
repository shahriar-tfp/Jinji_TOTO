<%@ Page Language="VB" AutoEventWireup="false" CodeFile="EMPLOYEE_ATTENDANCE_TEMP_CHECK.aspx.vb" Inherits="PAGES_ROSTER_EMPLOYEE_ATTENDANCE_TEMP_CHECK" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>EMPLOYEE_ATTENDANCE_TEMP_CHECK</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server"> 
<form id="EMPLOYEE_ATTENDANCE_TEMP_CHECK" runat="server">
<div>
...
<!--// 3 //-->
<asp:imagebutton id="imgKeyOPTION_IN_OUT" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblOPTION_IN_OUT" runat="server" Width="140px" ></asp:label>
<asp:dropdownlist id="ddlOPTION_IN_OUT" runat="server" Width="150px" ></asp:dropdownlist>
<asp:imagebutton id="imgbtnOPTION_IN_OUT" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
...
<!--// 5 //-->
<asp:imagebutton id="imgKeySPID" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblSPID" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtSPID" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnSPID" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
											...
											<table cellspacing="0" cellpadding="0" border="0">
												...
												<tr>
												    ...
												    <td align="left">
														...
														<asp:imagebutton id="imgbtnReProcess" runat="server" Height="21px" Width="74px"></asp:imagebutton>
													</td>
													<td align="left">
