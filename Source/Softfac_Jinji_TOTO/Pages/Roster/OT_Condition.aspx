<%@ Page Language="VB" AutoEventWireup="false" CodeFile="OT_Condition.aspx.vb" Inherits="Pages_Roster_OT_Condition" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>JINJI : Roster - OT Condition Page</title>
    <link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server">
    <form id="OT_CONDITION" runat="server">
    <div>
    ...
    <!--// 2 //-->
    <asp:imagebutton id="imgKeySALARY_RANGE_1" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
    <asp:label id="lblSALARY_RANGE_1" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtSALARY_RANGE_1" runat="server" Width="150px"></asp:textbox>
    <asp:imagebutton id="imgbtnSALARY_RANGE_1" runat="server" Height="21px" ></asp:imagebutton>
    <!--// 3 //-->
    <asp:imagebutton id="imgKeySALARY_RANGE_2" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
    <asp:label id="lblSALARY_RANGE_2" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtSALARY_RANGE_2" runat="server" Width="150px"></asp:textbox>
    <asp:imagebutton id="imgbtnSALARY_RANGE_2" runat="server" Height="21px" ></asp:imagebutton>
    <!--// 4 //-->
    ...
    <!--// 6 //-->
    <asp:imagebutton id="imgKeyOT_DURATION" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
    <asp:label id="lblOT_DURATION" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtOT_DURATION" runat="server" Width="150px"></asp:textbox>
    <asp:imagebutton id="imgbtnOT_DURATION" runat="server" Height="21px" ></asp:imagebutton>
    <!--// 7 //-->
    <asp:imagebutton id="imgKeyADJUSTED_OT_DURATION" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
    <asp:label id="lblADJUSTED_OT_DURATION" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtADJUSTED_OT_DURATION" runat="server" Width="150px"></asp:textbox>
    <asp:imagebutton id="imgbtnADJUSTED_OT_DURATION" runat="server" Height="21px" ></asp:imagebutton>
