...
Partial Class PAGES_Roster_PreApproved_Overtime
...
#Region "Private Declaration"
    ...
    Dim buttonPosition1 As String = "B1", buttonPosition2 As String = "B2", buttonPosition3 As String = "B3", labelPosition1 As String = "L1_"
    Dim workingHour, actualhour, tobehour As Decimal
    Dim buttonPosition1Top As Integer
    Dim buttonTop As String

    Dim btnColourDef, btnColourAlt As String
    Dim strPath As String = "../../Images"
    Dim logic As Boolean
    Dim EmpCode As String, UserCode As String
...
#Region "Page Setting"
    ...
    Sub PagePreload()
        ...
        mySetting.GetImgBtnUrl(imgbtnAdjustOCP_ID_SHIFT_CHANGE, clsGlobalSetting.ImageType._LOOKUP, Session("Company").ToString)
        mySetting.GetLookupValue_ImageButton(imgbtnAdjustOCP_ID_SHIFT_CHANGE, Form.ID, "txtAdjustOCP_ID_SHIFT_CHANGE", "CodeName", "Exec sp_sa_GetLookupCodeName " & """" & Session("Company").ToString & """," & """" & Session("Module").ToString & """," & """" & Form.ID & """," & """" & "OCP_ID_SHIFT_CHANGE" & """," & """" & """," & """" & Session("EmpID").ToString & """")
        imgbtnAdjustOVERTIME_HOUR.Visible = False
        body.Style("background-image") = strPath & "/" & Session("strTheme") & "/background2.jpg"

        chkAAll.Text = "Select All"
        'get Page Title
        BindDivision()
        ...
        If myDS.Tables.Count > 1 Then
            ...
            If myDT2.Rows.Count > 0 Then
                For i = 0 To myDT2.Rows.Count - 1
                    ...
                    If myLabel.ID = "lblOVERTIME_HOUR" Then
                        lblAdjustOVERTIME_HOUR.Text = myLabel.Text
                        lblAdjustOVERTIME_HOUR.CssClass = "wordstyle12"
                    End If
                    If myLabel.ID = "lblOCP_ID_SHIFT_CHANGE" Then
                        lblAdjustOCP_ID_SHIFT_CHANGE.Text = myLabel.Text
                        lblAdjustOCP_ID_SHIFT_CHANGE.CssClass = "wordstyle12"
                    End If
            ...
            Dim myDS10 As DataSet, ssql10 As String, defaultuser As String
            defaultuser = Mid(Session("EmpID").ToString, 1, Len(Session("EmpID").ToString) - 2).ToUpper

            myDS10 = New DataSet
            ssql10 = "Exec sp_Tms_GetSuperiorCode " & """" & Session("Company").ToString & """,""" & Session("EmpID").ToString & """"
            myDS10 = mySQL.ExecuteSQL(ssql10, Session("Company").ToString, Session("EmpID").ToString)
            If myDS10.Tables.Count > 0 Then
                If myDS10.Tables(0).Columns.Count > 1 Then
                    ddlSubO.DataTextField = "CodeName"
                    ddlSubO.DataValueField = "Code"
                    ddlSubO.DataSource = myDS10
                    ddlSubO.DataBind()
                    ddlSubO.SelectedValue = defaultuser
                    ddlEditSubO.DataTextField = "CodeName"
                    ddlEditSubO.DataValueField = "Code"
                    ddlEditSubO.DataSource = myDS10
                    ddlEditSubO.DataBind()
                    ddlEditSubO.SelectedValue = ddlSubO.SelectedValue
                End If
            End If
            myDS10 = Nothing
            ssql10 = Nothing
    ...
    Sub BindGrid()
        Try
            ...
            If EmpCode = "" Then
                EmpCode = Session("EmpID").ToString
            End If
            If UserCode = "" Then
                UserCode = ddlEditSubO.SelectedValue
            End If
            ...
            Else
                If SearchByPage = True Then
                    ssql = "Exec sp_sa_GetTableRecordsWithSecurity '" & Session("Company").ToString & "','" & ddlSubO.SelectedValue & "','" & Session("Module").ToString & "','" & Form.ID & "','" & myGridView.PageSize & "','" & txtGoToPage.Text & "'"
                    ssql2 = "Exec sp_sa_CompareTableRecords '" & Session("Company").ToString & "','" & ddlSubO.SelectedValue & "','" & Session("Module").ToString & "','" & Form.ID & "','" & gvHistory.PageSize & "','" & txtGoToPage.Text & "'"
                Else
                    ssql = "Exec sp_sa_GetTableRecordsWithSecurity '" & Session("Company").ToString & "','" & ddlSubO.SelectedValue & "','" & Session("Module").ToString & "','" & Form.ID & "','" & myGridView.PageSize & "','" & _currentPageNumber & "'"
                    ssql2 = "Exec sp_sa_CompareTableRecords '" & Session("Company").ToString & "','" & ddlSubO.SelectedValue & "','" & Session("Module").ToString & "','" & Form.ID & "','" & gvHistory.PageSize & "','" & _currentPageNumber & "'"
                End If
            End If
...
#Region "Panel Action"
    ...
    Protected Sub imgBtnAdd_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnAdd.Click
        ...
        txtAdjustOVERTIME_HOUR.Visible = True
        txtAdjustOCP_ID_SHIFT_CHANGE.Visible = True
        ddlEditSubO.Visible = True
        
        lblAdjustOVERTIME_HOUR.Visible = True
        lblAdjustOCP_ID_SHIFT_CHANGE.Visible = True
        imgbtnAdjustOCP_ID_SHIFT_CHANGE.Visible = True
        lblEditSubO.Visible = True
        ...
        imgBtnCancel.Style.Add("left", "182px")
        imgBtnClear.Style.Add("left", "102px")
        imgBtnSubmit.Style.Add("left", "22px")

        imgBtnCancel.Style.Add("position", "absolute")
        imgBtnClear.Style.Add("position", "absolute")
        imgBtnSubmit.Style.Add("position", "absolute")

        imgBtnCancel.Style.Add("Top", buttonTop)
        imgBtnClear.Style.Add("Top", buttonTop)
        imgBtnSubmit.Style.Add("Top", buttonTop)
    ...
    Protected Sub imgBtnEdit_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnEdit.Click
        If ActionValidateEdit() Then
            ...
            imgBtnCancel.Style.Add("left", "182px")
            imgBtnClear.Style.Add("left", "102px")
            imgBtnUpdate.Style.Add("left", "22px")

            imgBtnCancel.Style.Add("position", "absolute")
            imgBtnClear.Style.Add("position", "absolute")
            imgBtnUpdate.Style.Add("position", "absolute")

            imgBtnCancel.Style.Add("Top", buttonTop)
            imgBtnClear.Style.Add("Top", buttonTop)
            imgBtnUpdate.Style.Add("Top", buttonTop)
        ...
        If ActionValidateDelete() Then
            For i = 0 To myGridView.Rows.Count - 1
                ...
                If chkDelete.Checked Then
                    txtCOMPANY_PROFILE_CODE.Text = Replace(Replace(Server.HtmlDecode(gvHistory.Rows(i).Cells(1).Text.ToString.Trim), "&nbsp;", "&"), "&amp;", "&")
                    txtEMPLOYEE_PROFILE_ID.Text = Replace(Replace(Server.HtmlDecode(gvHistory.Rows(i).Cells(4).Text.ToString.Trim), "&nbsp;", "&"), "&amp;", "&")
                    txtDATE.Text = Replace(Replace(Server.HtmlDecode(gvHistory.Rows(i).Cells(2).Text.ToString.Trim), "&nbsp;", "&"), "&amp;", "&")
                    ssql = "select isnull(dbo.fn_ReturnCompanyProfileCode(N'" & txtCOMPANY_PROFILE_CODE.Text & "'),''),isnull(dbo.fn_UnDisplayDate('" & txtDATE.Text & "',dbo.fn_ReturnCompanyProfileCode(N'" & txtCOMPANY_PROFILE_CODE.Text & "'),'" & Session("Module").ToString & _
                    "'),''),dbo.fn_GetEmpIDUsingCodeName('" & txtEMPLOYEE_PROFILE_ID.Text.Replace("'", "''") & "')"
                    myDS = New DataSet()
                    myDS = mySQL.ExecuteSQL(ssql)

                    ssql1 = "exec sp_tms_insupddelPerApprovedOT """ & myDS.Tables(0).Rows(0).Item(0).ToString & """,'',""" & myDS.Tables(0).Rows(0).Item(2).ToString & """,""" & _
                        myDS.Tables(0).Rows(0).Item(1).ToString & """,'','','','','',0,0,0,'','','DEL'"
                    mySQL.ExecuteSQL(ssql1, Session("Company"), Session("EmpID"))
    ...
    Protected Sub imgBtnFilter_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnFilter.Click
        txtAction.Value = "FILTER"
        pnlgridview1.Visible = False
        txtAdjustOVERTIME_HOUR.Visible = False
        txtAdjustOCP_ID_SHIFT_CHANGE.Visible = False
        ddlEditSubO.Visible = False

        lblAdjustOVERTIME_HOUR.Visible = False
        lblAdjustOCP_ID_SHIFT_CHANGE.Visible = False
        imgbtnAdjustOCP_ID_SHIFT_CHANGE.Visible = False
        lblEditSubO.Visible = False
        ...
        imgBtnCancel.Style.Add("left", "182px")
        imgBtnClear.Style.Add("left", "102px")
        imgBtnSearch.Style.Add("left", "22px")

        imgBtnCancel.Style.Add("position", "absolute")
        imgBtnClear.Style.Add("position", "absolute")
        imgBtnSearch.Style.Add("position", "absolute")

        imgBtnCancel.Style.Add("Top", buttonTop)
        imgBtnClear.Style.Add("Top", buttonTop)
        imgBtnSearch.Style.Add("Top", buttonTop)
...
#Region "Sub & Function"
    ...
    Public Sub BlindTMS()
        If txtDATE.Text <> "" And mySetting.CheckIsDateNull(txtDATE.Text) = False Then
            ssql2 = "exec sp_tms_CalPreApprovedOT '" & mySetting.GetCompanyCodebyCodeName_ReturnString(txtCOMPANY_PROFILE_CODE.Text) & "','','','','','','" & mySetting.UnDisplayDateTime(txtDATE.Text, Session("Company"), Session("Module")) & "','" & txtFORMID.Text & "','OT','TMS','" & ddlEditSubO.SelectedValue & "'"
            myDS2 = mySQL.ExecuteSQL(ssql2, Session("Company").ToString, Session("EmpID").ToString)
            If myDS2.Tables.Count > 0 Then
                If myDS2.Tables(0).Columns.Count > 1 Then
                    ddlOCP_ID_TMS.DataTextField = "Name"
                    ddlOCP_ID_TMS.DataValueField = "Code"
                    ddlOCP_ID_TMS.DataSource = myDS2
                    ddlOCP_ID_TMS.DataBind()
                End If
            End If
            myDS2 = Nothing
        Else
    ...
    Public Sub RetrieveShift()
        ...
        If txtCOMPANY_PROFILE_CODE.Text <> "" And txtDATE.Text <> "" And ddlOCP_ID_TMS.SelectedValue <> "" Then
            ssql1 = "select dbo.fn_ReturnCompanyProfileCode(N'" & txtCOMPANY_PROFILE_CODE.Text & "'),'" & ddlOCP_ID_TMS.SelectedValue & "',dbo.fn_undisplaydate('" & txtDATE.Text & "','" & Session("Company") & "','" & Session("Module") & "')"
    ...
    Sub AutoAdjustPosition(ByVal strSelect As String)
        ...
        Try
            ...
            autonum = autonum + 1
            autonum = autonum + 1
            lblEditSubO.CssClass = "wordstyle12"
            lblEditSubO.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
            lblEditSubO.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
            lblEditSubO.Style.Add("position", "absolute")
            autonum = autonum + 1
            ddlEditSubO.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
            ddlEditSubO.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
            ddlEditSubO.Style.Add("position", "absolute")
            ddlEditSubO.Width = ddlWidth
            autonum = autonum + 1
            autonum = autonum + 8
            ...
            If pnlgridview1.Visible = True Then
                ...
                '    rowCount = rowCount - 158
                'End If
                rowCount = rowCount - CInt(rowCount * 0.312)
                ...
                If EditRowCount > 0 Then
                    EditRowCount = rowCount * 8
                End If
                'pnlgridview1.CssClass = panelPosition & (autonum - 1)

                autonum2 = autonum2 + 10 + EditRowCount
                lblAdjustOVERTIME_HOUR.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum2, "X"))
                lblAdjustOVERTIME_HOUR.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum2, "Y"))
                lblAdjustOVERTIME_HOUR.Style.Add("position", "absolute")
                autonum2 = autonum2 + 1
                txtAdjustOVERTIME_HOUR.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum2, "X"))
                txtAdjustOVERTIME_HOUR.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum2, "Y"))
                txtAdjustOVERTIME_HOUR.Style.Add("position", "absolute")
                txtAdjustOVERTIME_HOUR.Width = txtWidth
                autonum2 = autonum2 + 1
                imgbtnAdjustOVERTIME_HOUR.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum2, "X"))
                imgbtnAdjustOVERTIME_HOUR.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum2, "Y"))
                imgbtnAdjustOVERTIME_HOUR.Style.Add("position", "absolute")

                autonum2 = autonum2 + 2
                lblAdjustOCP_ID_SHIFT_CHANGE.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum2, "X"))
                lblAdjustOCP_ID_SHIFT_CHANGE.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum2, "Y"))
                lblAdjustOCP_ID_SHIFT_CHANGE.Style.Add("position", "absolute")
                autonum2 = autonum2 + 1
                txtAdjustOCP_ID_SHIFT_CHANGE.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum2, "X"))
                txtAdjustOCP_ID_SHIFT_CHANGE.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum2, "Y"))
                txtAdjustOCP_ID_SHIFT_CHANGE.Style.Add("position", "absolute")
                txtAdjustOCP_ID_SHIFT_CHANGE.Width = txtWidth
                autonum2 = autonum2 + 1
                imgbtnAdjustOCP_ID_SHIFT_CHANGE.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum2, "X"))
                imgbtnAdjustOCP_ID_SHIFT_CHANGE.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum2, "Y"))
                imgbtnAdjustOCP_ID_SHIFT_CHANGE.Style.Add("position", "absolute")


                autonum2 = autonum2 + 2
                lblREASON.CssClass = "wordstyle12"
                lblREASON.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum2, "X"))
                lblREASON.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum2, "Y"))
                lblREASON.Style.Add("position", "absolute")
                autonum2 = autonum2 + 1
                ddlREASON.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum2, "X"))
                ddlREASON.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum2, "Y"))
                ddlREASON.Style.Add("position", "absolute")
                ddlREASON.Width = txtWidth
                autonum2 = autonum2 + 1
                imgbtnREASON.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum2, "X"))
                imgbtnREASON.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum2, "Y"))
                ...
                buttonPosition1Top = 177 + ((autonum + rowCount) * 32)
                buttonTop = CStr(buttonPosition1Top) + "px"

                labelPosition1 = labelPosition1 & autonum + 1 + rowCount
                lblresult2.CssClass = labelPosition1
                lblresult2.Text = "Click on Cancel Button to return..."
            Else
                buttonPosition1Top = 177 + ((autonum - 1) * 32)
                buttonTop = CStr(buttonPosition1Top) + "px"
    ...
    Sub BindTMS1()
        ssql = "exec [sp_org_getOCPIDObject] 'TMS_1','" & Session("Company") & "','','','','','','',''"
        myDS2 = mySQL.ExecuteSQL(ssql)
        If myDS2.Tables.Count > 0 Then
            If myDS2.Tables(0).Columns.Count > 1 Then
                ddlOCP_ID_TMS.DataTextField = "Name"
        ...
        If Not myDS Is Nothing Then
            If myDS.Tables.Count > 0 Then
                ...
                Else
                    ...
                    ssql = "Exec sp_Generate_Query_Filter_WithSecurity N'" & Session("Company").ToString & "',N'" & ddlSubO.SelectedValue & "',N'" & _
...
#End Region
            ...
            If ddlOCP_ID_DEPARTMENT.SelectedIndex > 0 Then
                If Not sender Is Nothing Then
                    ...
                    Else
                        ...
                        For i = 0 To tmpDS2.Tables(0).Rows.Count - 1
    ...
    Protected Sub txtDATE_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtDATE.TextChanged
        If txtAction.Value = "EDIT" Then
            BindTMS1()
        ElseIf txtAction.Value <> "FILTER" Then
            BlindTMS()
            RetrieveShift()
            ValueChange()
        End If
    ...
    Protected Sub txtOCP_ID_TMS_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtOCP_ID_TMS.TextChanged
        If txtAction.Value <> "FILTER" Then
            RetrieveShift()
            ValueChange()
        End If
    End Sub
    ...
    Public Sub RetrieveDetail()
        If txtCOMPANY_PROFILE_CODE.Text <> "" And txtOCP_ID_TMS.Text <> "" And txtDATE.Text <> "" Then
            ssql1 = "select dbo.fn_ReturnCompanyProfileCode(N'" & txtCOMPANY_PROFILE_CODE.Text & "'),dbo.fn_GetCOMOCPIDByCodeName('" & txtOCP_ID_TMS.Text & "','TMS',dbo.fn_ReturnCompanyProfileCode(N'" & txtCOMPANY_PROFILE_CODE.Text & "')),dbo.fn_GetcomOCPIDByCodeName('" & txtOCP_ID_SHIFT.Text & "','Shift',dbo.fn_ReturnCompanyProfileCode(N'" & txtCOMPANY_PROFILE_CODE.Text & "')),dbo.fn_GetcomOCPIDByCodeName('" & txtOCP_ID_DAY_TYPE.Text & "','Day_Type',dbo.fn_ReturnCompanyProfileCode(N'" & txtCOMPANY_PROFILE_CODE.Text & "')),dbo.fn_undisplaydate('" & txtDATE.Text & "','" & Session("Company") & "','" & Session("Module") & "')"
        ElseIf txtCOMPANY_PROFILE_CODE.Text <> "" And txtDATE.Text <> "" Then
            ssql1 = "select dbo.fn_ReturnCompanyProfileCode(N'" & txtCOMPANY_PROFILE_CODE.Text & "'),dbo.fn_GetCOMOCPIDByCodeName('" & txtOCP_ID_TMS.Text & "','TMS',dbo.fn_ReturnCompanyProfileCode(N'" & txtCOMPANY_PROFILE_CODE.Text & "')),dbo.fn_GetcomOCPIDByCodeName('" & txtOCP_ID_SHIFT.Text & "','Shift',dbo.fn_ReturnCompanyProfileCode(N'" & txtCOMPANY_PROFILE_CODE.Text & "')),dbo.fn_GetcomOCPIDByCodeName('" & txtOCP_ID_DAY_TYPE.Text & "','Day_Type',dbo.fn_ReturnCompanyProfileCode(N'" & txtCOMPANY_PROFILE_CODE.Text & "')),dbo.fn_undisplaydate('" & txtDATE.Text & "','" & Session("Company") & "','" & Session("Module") & "')"
        Else
            ssql1 = ""
        End If
        ...
        If myDS1.Tables.Count > 0 Then
            If myDS1.Tables(0).Rows.Count = 1 Then
                ssql = "exec sp_tms_CalPreApprovedOT '" & myDS1.Tables(0).Rows(0).Item(0).ToString & "','" & ddlOCP_ID_DIVISION.SelectedValue & "','" & ddlOCP_ID_DEPARTMENT.SelectedValue & "','" & ddlOCP_ID_TMS.SelectedValue & "','" & myDS1.Tables(0).Rows(0).Item(2).ToString & "','" & myDS1.Tables(0).Rows(0).Item(3).ToString & "','" & myDS1.Tables(0).Rows(0).Item(4).ToString & "','" & txtFORMID.Text & "','OT','','" & ddlEditSubO.SelectedValue & "'"
            Else
                ssql = "exec sp_tms_CalPreApprovedOT '','','','','','','','','OT','','" & ddlEditSubO.SelectedValue & "'"
            End If
        Else
            ssql = "exec sp_tms_CalPreApprovedOT '','','','','','','','','OT','','" & ddlEditSubO.SelectedValue & "'"
        End If
    ...
    Private Sub insupdOTForm()
        Dim PayCycle As String, employeeCode As String
        ssql = "select isnull(dbo.fn_ReturnCompanyProfileCode(N'" & txtCOMPANY_PROFILE_CODE.Text & "'),''),isnull(dbo.fn_UnDisplayDate('" & txtDATE.Text & "',dbo.fn_ReturnCompanyProfileCode(N'" & txtCOMPANY_PROFILE_CODE.Text & "'),'" & Session("Module").ToString & _
    "'),''),isnull('" & txtAdjustOVERTIME_HOUR.Text & _
    "',''),isnull(dbo.fn_GetComOCPIDByCodeName('" & txtAdjustOCP_ID_SHIFT_CHANGE.Text & "','SHIFT',dbo.fn_ReturnCompanyProfileCode(N'" & txtCOMPANY_PROFILE_CODE.Text & _
    "')),''),'" & ddlOCP_ID_DIVISION.SelectedValue & "','" & ddlOCP_ID_DEPARTMENT.SelectedValue & "'," & _
    "'" & ddlOCP_ID_TMS.SelectedValue & "',isnull(dbo.fn_getcomOCPIDBYCODENAME('" & txtOCP_ID_SHIFT.Text & "','SHIFT',dbo.fn_ReturnCompanyProfileCode(N'" & txtCOMPANY_PROFILE_CODE.Text & "')),'')," & _
    "isnull(dbo.fn_getcomOCPIDBYCODENAME('" & txtOCP_ID_DAY_TYPE.Text & "','DAY_TYPE',dbo.fn_ReturnCompanyProfileCode(N'" & txtCOMPANY_PROFILE_CODE.Text & "')),'')"
        myDS = New DataSet()
        myDS = mySQL.ExecuteSQL(ssql)
        If ValidateForm2(myDS) Then
            For i = 0 To myGridView1.Rows.Count - 1
                Dim chkEdit As CheckBox = myGridView1.Rows(i).Cells(0).Controls(1)
                If chkEdit.Checked Then
                    txtEMPLOYEE_PROFILE_ID.Text = Replace(Replace(Server.HtmlDecode(myGridview2.Rows(i).Cells(1).Text.ToString.Trim), "&nbsp;", "&"), "&amp;", "&").Replace("'", "''")
                    employeeCode = Replace(Replace(Server.HtmlDecode(myGridView1.Rows(i).Cells(1).Text.ToString.Trim), "&nbsp;", "&"), "&amp;", "&").Replace("'", "''")
                    workingHour = Replace(Replace(Server.HtmlDecode(myGridview2.Rows(i).Cells(4).Text.ToString.Trim), "&nbsp;", "&"), "&amp;", "&")
                    actualhour = Replace(Replace(Server.HtmlDecode(myGridview2.Rows(i).Cells(2).Text.ToString.Trim), "&nbsp;", "&"), "&amp;", "&")
                    tobehour = Replace(Replace(Server.HtmlDecode(myGridview2.Rows(i).Cells(3).Text.ToString.Trim), "&nbsp;", "&"), "&amp;", "&")
                    ssql2 = "Select Option_Pay_Cycle from employee_salary where Employee_Profile_id = '" & txtEMPLOYEE_PROFILE_ID.Text & "'"
                    myDS2 = mySQL.ExecuteSQL(ssql2, Session("Company").ToString, Session("EmpID").ToString)
                    ...
                    Date3 = myDS.Tables(0).Rows(0).Item(1).ToString
                    ...
                    If Trim(myDS2.Tables(0).Rows(0).Item(0).ToString) = "" Then
                        ssql = "exec sp_tms_insupddelPerApprovedOT '" & myDS.Tables(0).Rows(0).Item(0).ToString & "','" & txtFORMID.Text & "','" & txtEMPLOYEE_PROFILE_ID.Text & "','" & _
                        myDS.Tables(0).Rows(0).Item(1).ToString & "','" & myDS.Tables(0).Rows(0).Item(4).ToString & "','" & myDS.Tables(0).Rows(0).Item(5).ToString & "','" & myDS.Tables(0).Rows(0).Item(6).ToString & "','" & _
                        myDS.Tables(0).Rows(0).Item(7).ToString & "','" & myDS.Tables(0).Rows(0).Item(8).ToString & "','" & actualhour & "','" & tobehour & "','" & _
                        myDS.Tables(0).Rows(0).Item(2).ToString & "','" & myDS.Tables(0).Rows(0).Item(3).ToString & "','" & ddlREASON.SelectedValue & "','ADD'"
                        mySQL.ExecuteSQL(ssql, Session("Company"), Session("EmpID"))
                    Else
                        ShowMessage("The following date already locked! (" & Date3 & ") ; Employee : " & employeeCode)
                    End If
            ...
            'myTargetURL = myTargetURL & "&Company_Profile_Code=" & myDS.Tables(0).Rows(0).Item(0).ToString & "&Date=" & myDS.Tables(0).Rows(0).Item(1).ToString & "&FormID=" & txtFORMID.Text & "&rdTemplate=Roster_OTFormDetails"
            'Response.Write("<script>window.open('" & myTargetURL & "');</script>")
            'myTargetURL = clsRpt.GetPDFReportURL()
            myTargetURL = myTargetURL & "&Company_Profile_Code=" & myDS.Tables(0).Rows(0).Item(0).ToString & "&Date=" & myDS.Tables(0).Rows(0).Item(1).ToString & "&FormID=" & txtFORMID.Text & "&rdTemplate=Roster_OTFormSummary"
            Response.Write("<script>window.open('" & myTargetURL & "');</script>")
        End If
    End Sub
    ...
    Private Function ValidateForm() As Boolean
        ...
        If Trim(txtCOMPANY_PROFILE_CODE.Text) = "" Then
        ...
        ElseIf IsNumeric(mySetting.ConvertDateToDecimal(txtDATE.Text, Session("Company").ToString, Session("Module").ToString)) = False Then
            ...
            txtDATE.Focus()
            Return False
            'ElseIf Trim(ddlOCP_ID_DIVISION.SelectedValue) = "" Then
            '    lblresult2.Text = "[" & lblOCP_ID_DIVISION.Text & "] Is A Required Field!"
            '    ddlOCP_ID_DIVISION.Focus()
            '    Return False
            'ElseIf Trim(ddlOCP_ID_DEPARTMENT.SelectedValue) = "" Then
            '    lblresult2.Text = "[" & lblOCP_ID_DEPARTMENT.Text & "] Is A Required Field!"
            '    ddlOCP_ID_DEPARTMENT.Focus()
            '    Return False
            'ElseIf Trim(txtOCP_ID_TMS.Text) = "" Then
            '    lblresult2.Text = "[" & lblOCP_ID_TMS.Text & "] Is A Required Field!"
            '    txtOCP_ID_TMS.Focus()
            '    Return False
        ElseIf Trim(ddlOCP_ID_TMS.SelectedValue) = "" Then
            lblresult2.Text = "[" & lblOCP_ID_TMS.Text & "] Is A Required Field!"
            ShowMessage(lblresult2.Text)
            ddlOCP_ID_TMS.Focus()
            Return False
        ElseIf Trim(txtOCP_ID_SHIFT.Text) = "" Then
            lblresult2.Text = "[" & lblOCP_ID_SHIFT.Text & "] Is A Required Field!"
            ShowMessage(lblresult2.Text)
            txtOCP_ID_SHIFT.Focus()
            Return False
        ElseIf Trim(txtOCP_ID_DAY_TYPE.Text) = "" Then
            lblresult2.Text = "[" & lblOCP_ID_DAY_TYPE.Text & "] Is A Required Field!"
            ShowMessage(lblresult2.Text)
            txtOCP_ID_DAY_TYPE.Focus()
            Return False
        ElseIf Trim(txtAdjustOVERTIME_HOUR.Text) = "" Then
            lblresult2.Text = "[" & lblAdjustOVERTIME_HOUR.Text & "] Is A Required Field!"
            ShowMessage(lblresult2.Text)
            txtAdjustOVERTIME_HOUR.Focus()
            Return False
        ElseIf Trim(ddlREASON.SelectedValue) = "" Then
            lblresult2.Text = "[" & lblREASON.Text & "] Is A Required Field!"
            ShowMessage(lblresult2.Text)
            ddlREASON.Focus()
            Return False
        ElseIf IsNumeric(txtAdjustOVERTIME_HOUR.Text) = False Then
            lblresult2.Text = "[" & lblAdjustOVERTIME_HOUR.Text & "] Must Be Numeric!"
            ShowMessage(lblresult2.Text)
            txtAdjustOVERTIME_HOUR.Focus()
            Return False
        ElseIf CInt(txtAdjustOVERTIME_HOUR.Text) > 12 Then
            lblresult2.Text = "[" & lblAdjustOVERTIME_HOUR.Text & "] Cannot More Than 12 Hour!"
            ShowMessage(lblresult2.Text)
            txtAdjustOVERTIME_HOUR.Focus()
            Return False
        Else
            ...
            ssql = "Exec sp_tms_ChkPReOvertime '" & Session("Company").ToString & "','" & txtDATE.Text & "','" & ddlOCP_ID_TMS.SelectedValue & "','" & txtOCP_ID_SHIFT.Text & "','" & txtOCP_ID_DAY_TYPE.Text & "','" & txtOCP_ID_SHIFT_CHANGE.Text & "'," & txtAdjustOVERTIME_HOUR.Text & ",'CHK'"
            myDS = mySQL.ExecuteSQL(ssql, Session("Company").ToString, Session("EmpID").ToString)

            If myDS.Tables.Count > 0 Then
                If myDS.Tables(0).Rows.Count > 0 Then
                    If myDS.Tables(0).Rows(0).Item(0).ToString = "0" Then
                        ShowMessage("Not Allow to Apply OT on " & txtDATE.Text & " (Day Type: " & txtOCP_ID_DAY_TYPE.Text & " , 12 Hour Shift")
                        Return False
                    ElseIf myDS.Tables(0).Rows(0).Item(0).ToString = "1" Then
                        ShowMessage("Not Allow to Apply OT Hour(" & txtAdjustOVERTIME_HOUR.Text & ") (Day Type: " & txtOCP_ID_DAY_TYPE.Text & " ,12 Hour Shift Only Can Apply 6,12 Hours OT.")
                        Return False
                    ElseIf myDS.Tables(0).Rows(0).Item(0).ToString = "2" Then
                        ShowMessage("Not Allow to Apply OT Hour(" & txtAdjustOVERTIME_HOUR.Text & ") (Day Type: " & txtOCP_ID_DAY_TYPE.Text & " ,Normal Only Can Apply 4,8,9,10,11,12 Hours OT.")
                        Return False
                    ElseIf myDS.Tables(0).Rows(0).Item(0).ToString = "3" Then
                        ShowMessage("Not Allow to Apply OT Hour(" & txtAdjustOVERTIME_HOUR.Text & ") (Day Type: " & txtOCP_ID_DAY_TYPE.Text & " ,12 Hour Shift Only Can Apply 12 Hours OT.")
                        Return False
                    ElseIf myDS.Tables(0).Rows(0).Item(0).ToString = "4" Then
                        ShowMessage("Not Allow to Apply OT Hour(" & txtAdjustOVERTIME_HOUR.Text & ") (Day Type: " & txtOCP_ID_DAY_TYPE.Text & " ,Normal Shift Only Can Apply 8,9,10,11,12 Hours OT.")
                        Return False
                    ElseIf myDS.Tables(0).Rows(0).Item(0).ToString = "5" Then
                        ShowMessage("Not Allow to Apply OT Hour(" & txtAdjustOVERTIME_HOUR.Text & ") (Only Can Apply In hour, Not For Minutes.")
                        Return False
                    ElseIf myDS.Tables(0).Rows(0).Item(0).ToString = "6" Then
                        ShowMessage("Not Allow to Apply OT Hour(" & txtAdjustOVERTIME_HOUR.Text & ") (Day Type: " & txtOCP_ID_DAY_TYPE.Text & " ,Normal Only Can Apply 1,2,3,4 Hours OT.")
                        Return False
                    End If
                End If
            End If
    ...
    End Function
    Private Function ValidateForm2(ByVal myds As DataSet) As Boolean
        ...
        ElseIf (myds.Tables(0).Rows(0).Item(2).ToString = "") Then
            lblresult2.Text = "Pre-Approve Time Is A Required Field!."
            ShowMessage(lblresult2.Text)
            txtAdjustOVERTIME_HOUR.Focus()
            Return False
        ElseIf IsNumeric(myds.Tables(0).Rows(0).Item(2).ToString) = False Then
            lblresult2.Text = "Invalid Input Date Format For [" & lblAdjustOVERTIME_HOUR.Text & "] !"
            ShowMessage(lblresult2.Text)
            txtAdjustOVERTIME_HOUR.Focus()
            Return False
            ...
            '    ddlOCP_ID_DIVISION.Focus()
            '    Return False
            'ElseIf myds.Tables(0).Rows(0).Item(5).ToString = "" Then
            '    lblresult2.Text = "[" & lblOCP_ID_DEPARTMENT.Text & "] Is A Required Field!"
            '    ddlOCP_ID_DEPARTMENT.Focus()
            '    Return False
        ElseIf myds.Tables(0).Rows(0).Item(6).ToString = "" Then
            lblresult2.Text = "[" & lblOCP_ID_TMS.Text & "] Is A Required Field!"
            ShowMessage(lblresult2.Text)
            txtOCP_ID_TMS.Focus()
            Return False
        ElseIf myds.Tables(0).Rows(0).Item(7).ToString = "" Then
            lblresult2.Text = "[" & lblOCP_ID_SHIFT.Text & "] Is A Required Field!"
            ShowMessage(lblresult2.Text)
            txtOCP_ID_SHIFT.Focus()
            Return False
        ElseIf myds.Tables(0).Rows(0).Item(8).ToString = "" Then
            lblresult2.Text = "[" & lblOCP_ID_DAY_TYPE.Text & "] Is A Required Field!"
            ShowMessage(lblresult2.Text)
            txtOCP_ID_DAY_TYPE.Focus()
            Return False
    ...
    Protected Sub ddlSubO_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ddlSubO.SelectedIndexChanged
        ddlEditSubO.SelectedValue = ddlSubO.SelectedValue
        Session("SearchByFilter") = "false"
        BindGrid()
    End Sub
    ...
    Protected Sub ddlOCP_ID_TMS_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ddlOCP_ID_TMS.SelectedIndexChanged
        RetrieveShift()
        ValueChange()
    End Sub

    Protected Sub ddlEditSubO_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ddlEditSubO.SelectedIndexChanged
        BlindTMS()
        ddlSubO.SelectedValue = ddlEditSubO.SelectedValue
        ValueChange()
    End Sub
End Class