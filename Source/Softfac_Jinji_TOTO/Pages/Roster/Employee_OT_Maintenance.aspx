<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Employee_OT_Maintenance.aspx.vb" Inherits="Pages_Roster_Employee_OT_Maintenance" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>JINJI : Roster - Employee OT Maintenance Page</title>
    <link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server">
    <form id="EMPLOYEE_OT_MAINTENANCE" runat="server">
    <div>
    ...
    <!--// 6 //-->
    <asp:imagebutton id="imgKeyAPPROVED_DATE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
    <asp:label id="lblAPPROVED_DATE" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtAPPROVED_DATE" runat="server" Width="150px"></asp:textbox>
    <asp:imagebutton id="imgbtnAPPROVED_DATE" runat="server" Height="21px" ></asp:imagebutton>
    <!--// 7 //-->
    <asp:imagebutton id="imgKeyAPPROVED_BY" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
    <asp:label id="lblAPPROVED_BY" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtAPPROVED_BY" runat="server" Width="150px"></asp:textbox>
    <asp:imagebutton id="imgbtnAPPROVED_BY" runat="server" Height="21px" ></asp:imagebutton>
    <!--// 8 //-->
