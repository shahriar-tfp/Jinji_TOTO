...
Partial Class Pages_Roster_ATTRawData_ViewUpdate
...
#End Region
    ...
    Protected Sub imgBtnPrint_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnPrint.Click
        ...
        If myDS.Tables.Count > 0 Then
            If myDS.Tables(0).Rows.Count > 0 Then
                ssql1 = "Exec sp_tms_InsUpdDelAttRawData '" & Session("Company").ToString & "','" & myDS.Tables(0).Rows(0).Item(0).ToString & "','" & myDS.Tables(0).Rows(0).Item(1).ToString & "','" & myDS.Tables(0).Rows(0).Item(2).ToString & "','','','VIEW'"
                myDS1 = New DataSet()
            ...
            If myDS.Tables.Count > 0 Then
                If myDS.Tables(0).Rows.Count > 0 Then
                    ...
                    If Trim(myDS2.Tables(0).Rows(0).Item(0).ToString) = "" Then
                        ssql1 = "Exec sp_tms_InsUpdDelATTRawData '" & Session("Company").ToString & "','" & myDS.Tables(0).Rows(0).Item(0).ToString & "','" & myDS.Tables(0).Rows(0).Item(1).ToString & "','" & myDS.Tables(0).Rows(0).Item(2).ToString & "','" & myDS.Tables(0).Rows(0).Item(3).ToString & "','" & ddlOption_Reason_Type.SelectedValue & "','UPD'"
                ...
                If chkDelete.Checked Then 'And gv1.Rows(i).Cells(4).Text.Replace("&nbsp;", "&").Replace("&amp;", "&").ToUpper = "BY HR" Then
                    ...
                    If myDS.Tables.Count > 0 Then
                        If myDS.Tables(0).Rows.Count > 0 Then
                            ...
                            If Trim(myDS2.Tables(0).Rows(0).Item(0).ToString) = "" Then
                                ssql1 = "Exec sp_tms_InsUpdDelATTRawData '" & Session("Company").ToString & "','" & myDS.Tables(0).Rows(0).Item(0).ToString & "','" & myDS.Tables(0).Rows(0).Item(1).ToString & "','" & myDS.Tables(0).Rows(0).Item(2).ToString & "','" & myDS.Tables(0).Rows(0).Item(3).ToString & "','','DEL'"
