<%@ Page Language="VB" AutoEventWireup="false" CodeFile="EarlyOut_Approved.aspx.vb" Inherits="Pages_Roster_EarlyOut_Approved" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>JINJI : Roster - Early Out View Page</title>
    <link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body>
    <form id="EarlyOut_Approved" runat="server">
    <div>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
	   <tr><td>	    
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
	   <tr><td>
	   <asp:Label ID="lblDate" Text="Date" runat="server" Width="120px" Font-Bold="true"></asp:Label>
    <asp:TextBox ID="txtDate" runat="server" Width="157px"></asp:TextBox>
    <asp:ImageButton ID="imgbtnDate" runat="server" Width="21px" Height="21px"/>
	   <asp:Label ID="lblYES" Text="Approved (Yes/No)" runat="server" Width="120px" Font-Bold="true"></asp:Label>
    <asp:dropdownlist ID="ddlYES" runat="server" Width="157px"></asp:dropdownlist>
    </td></tr>
    <tr><td>
    <asp:Label ID="lblApprovedBy" Text="ApprovedBy" runat="server" Width="120px" Font-Bold="true"></asp:Label>
    <asp:TextBox ID="txtApprovedBy" runat="server" Width="157px"></asp:TextBox>
    <asp:ImageButton ID="imgBtnApprovedBy" runat="server" Width="21px" Height="21px"/>
    ...
    <tr><td><asp:ImageButton id="imgBtnSubmit" runat="server" Width="74" Height="21"/><asp:ImageButton id="ImgBtnDelete" runat="server" Width="74" Height="21"/></td></tr>
</table></div></asp:Panel>
    </asp:Panel>
    </div>
    </form>
