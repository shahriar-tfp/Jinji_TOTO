<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Shift_Break.aspx.vb" Inherits="Pages_Roster_Shift_Break" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>JINJI : Roster - Shift Break Page</title>
    <link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server">
    <form id="SHIFT_BREAK" runat="server">
    <div>
    ...
    <asp:dropdownlist id="ddlOPTION_DAY_TYPE" runat="server" Width="150px"></asp:dropdownlist>
    <asp:imagebutton id="imgbtnOPTION_DAY_TYPE" runat="server" Height="21px" ></asp:imagebutton>
    <!--// 4 //-->
    <asp:imagebutton id="imgKeyBREAK_START" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
    <asp:label id="lblBREAK_START" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtBREAK_START" runat="server" Width="150px"></asp:textbox>
    <asp:imagebutton id="imgbtnBREAK_START" runat="server" Height="21px" ></asp:imagebutton>
    <!--// 5 //-->
