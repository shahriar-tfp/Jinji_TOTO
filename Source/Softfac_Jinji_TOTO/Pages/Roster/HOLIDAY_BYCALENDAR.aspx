<%@ Page Language="VB" AutoEventWireup="false" CodeFile="HOLIDAY_BYCALENDAR.aspx.vb" Inherits="PAGES_ROSTER_HOLIDAY_BYCALENDAR" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>HOLIDAY_BYCALENDAR</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server"> 
<form id="HOLIDAY_BYCALENDAR" runat="server">
<div>
...
<asp:imagebutton id="imgbtnOCP_ID_CALENDAR" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:CheckBox ID="chkOCP_ID_CALENDAR" runat="server" ToolTip="Select All" Text="" AutoPostBack="true"/>
