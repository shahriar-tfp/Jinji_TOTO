<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Day_Type_Profile.aspx.vb" Inherits="Pages_Roster_Day_Type_Profile" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>JINJI : Roster - Day Type Profile Page</title>
    <link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server">
    <form id="DAY_TYPE_PROFILE" runat="server">
    <div>
    ...
    <!--// 2 //-->
    <asp:imagebutton id="imgKeyOPTION_ATTENDANCE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
    <asp:label id="lblOPTION_ATTENDANCE" runat="server" Width="140px"></asp:label>
    <asp:dropdownlist id="ddlOPTION_ATTENDANCE" runat="server" Width="157px"></asp:dropdownlist>
    <asp:imagebutton id="imgbtnOPTION_ATTENDANCE" runat="server" Height="21px" ></asp:imagebutton>
    <!--// 3 //-->
    <asp:imagebutton id="imgKeyOPTION_PAY" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
    <asp:label id="lblOPTION_PAY" runat="server" Width="140px"></asp:label>
    <asp:dropdownlist id="ddlOPTION_PAY" runat="server" Width="157px"></asp:dropdownlist>
    <asp:imagebutton id="imgbtnOPTION_PAY" runat="server" Height="21px" ></asp:imagebutton>
    <!--// 4 //-->
    <asp:imagebutton id="imgKeyOPTION_PUBLIC_HOLIDAY" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
    <asp:label id="lblOPTION_PUBLIC_HOLIDAY" runat="server" Width="140px"></asp:label>
    <asp:dropdownlist id="ddlOPTION_PUBLIC_HOLIDAY" runat="server" Width="157px"></asp:dropdownlist>
    <asp:imagebutton id="imgbtnOPTION_PUBLIC_HOLIDAY" runat="server" Height="21px" ></asp:imagebutton>
