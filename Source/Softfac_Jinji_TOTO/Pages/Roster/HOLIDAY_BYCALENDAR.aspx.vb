...
Partial Class PAGES_ROSTER_HOLIDAY_BYCALENDAR
...
#Region "Public Declaration"
    ...
    Public i As Integer, j As Integer, SearchByPage As Boolean, RecFound As Boolean, CountRecord As Integer
...
#Region "Panel Edit"
    Protected Sub imgBtnSubmit_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnSubmit.Click
        lblresult2.Text = ""
        If chkOCP_ID_CALENDAR.Checked = False Then
        ...
        Else
            If ValidateInsertAll() = True Then
                ...
                ssql = "select dbo.fn_ReturnCompanyProfileCode(N'" & txtCOMPANY_PROFILE_CODE.Text & "'),dbo.fn_undisplaydate(N'" & txtDATE.Text & "','" & Session("Company").ToString & "','" & Session("Module").ToString & "'),dbo.fn_GetComOCPIDByCodeName(N'" & txtOCP_ID_DAY_TYPE.Text & "','DAY_TYPE','" & Session("Company").ToString & "')"
                myDS = mySQL.ExecuteSQL(ssql, Session("Company").ToString, Session("EmpID").ToString)

                If myDS.Tables(0).Rows.Count > 0 Then
                    ssql2 = "Exec sp_tms_chkinsupddelHolidayCalendar """ & myDS.Tables(0).Rows(0).Item(0).ToString & """,""" & myDS.Tables(0).Rows(0).Item(1).ToString & """,""" & myDS.Tables(0).Rows(0).Item(2).ToString & """,""" & txtREASON.Text & """,""" & Session("EmpID").ToString & """,'CHK'"
                    ssql3 = "Exec sp_tms_chkinsupddelHolidayCalendar """ & myDS.Tables(0).Rows(0).Item(0).ToString & """,""" & myDS.Tables(0).Rows(0).Item(1).ToString & """,""" & myDS.Tables(0).Rows(0).Item(2).ToString & """,""" & txtREASON.Text & """,""" & Session("EmpID").ToString & """,'ADD'"
                ...
                pnlEdit.Visible = False
                pnlMain.Visible = True
                chkOCP_ID_CALENDAR.Checked = False
                BindGrid()
            End If
        End If
    End Sub
...
#Region "Panel Action"
	...
	Protected Sub imgBtnAdd_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnAdd.Click
        ...
        chkOCP_ID_CALENDAR.Visible = True
    ...
    Protected Sub imgBtnEdit_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnEdit.Click
        If ActionValidateEdit() Then
            chkOCP_ID_CALENDAR.Visible = False
            pnlEdit.Visible = True
            pnldescription.Visible = True
            pnlMain.Visible = False
                            ...
                            Select Case UCase(Trim(myDS.Tables(0).Rows(i).Item(posType).ToString))
                                Case "0"
                                    If myLabel.Visible = True And myTextBox.Visible = True Then
                                        ...
                                        myImageButton.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                                        myImageButton.Style.Add("position", "absolute")
                                        If myImageButton.ID = "imgbtnOCP_ID_CALENDAR" Then
                                            myImageButton.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                                            myImageButton.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                                            myImageButton.Style.Add("position", "absolute")
                                            chkOCP_ID_CALENDAR.Style.Add("left", mySetting.GetObjPosition(EctWidth + 10, autonum, "X"))
                                            chkOCP_ID_CALENDAR.Style.Add("top", mySetting.GetObjPosition(EctWidth + 10, autonum, "Y"))
                                            chkOCP_ID_CALENDAR.Style.Add("position", "absolute")
                                        Else
                                            myImageButton.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                                            myImageButton.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                                            myImageButton.Style.Add("position", "absolute")
            ...
            For i = 0 To myDS.Tables(0).Rows.Count - 1
                Select Case myDS.Tables(0).Rows(i).Item(1).ToString
                    ...
                    Case Else   '"CHARACTER", "LOOKUP"
                        Dim myTextBox As TextBox = Page.FindControl("txt" & Trim(myDS.Tables(0).Rows(i).Item(0)))
                        If myTextBox.Visible = True Then
                            If myTextBox.Enabled = True Then
                                If mySetting.CheckTextNullAndReplaceSingleQuote(myTextBox) = True Then
                                    ssql = ssql & myDS.Tables(0).Rows(i).Item(0) & ","
                                    Dim myDST As New DataSet
                                    myDST = mySQL.ExecuteSQL("Select Function_Name,Default_Value,Default_Value2 From User_Define_Function Where Company_Profile_Code='" & Session("Company").ToString & "' And Module_Profile_Code='" & Session("Module").ToString & "' And Table_Profile_Code='" & Form.ID & "' And Table_Field_Code='" & myDS.Tables(0).Rows(i).Item(0).ToString & "' And Query_Action='INSERT'")
                                ...
                                End If
                            Else
                                If chkOCP_ID_CALENDAR.Checked = True Then
                                    ssql = ssql & myDS.Tables(0).Rows(i).Item(0) & ","
                                    ssql2 = ssql2 & "'ALL',"
                                    ssql3 = ssql3 & myDS.Tables(0).Rows(i).Item(0) & " In ('" & "ALL" & "') And "
                                End If
                            End If
...
#End Region
    ...
    Protected Sub chkOCP_ID_CALENDAR_CheckedChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles chkOCP_ID_CALENDAR.CheckedChanged
        If chkOCP_ID_CALENDAR.Checked = True Then
            txtOCP_ID_CALENDAR.Enabled = False
            imgbtnOCP_ID_CALENDAR.Enabled = False
        Else
            txtOCP_ID_CALENDAR.Enabled = True
            imgbtnOCP_ID_CALENDAR.Enabled = True
        End If
    End Sub

    Protected Sub txtOCP_ID_CALENDAR_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtOCP_ID_CALENDAR.TextChanged
        If txtOCP_ID_CALENDAR.Text = "" Then
            chkOCP_ID_CALENDAR.Enabled = True
        Else
            chkOCP_ID_CALENDAR.Enabled = False
        End If
    End Sub
End Class