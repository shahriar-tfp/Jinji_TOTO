<%@ Page Language="VB" AutoEventWireup="false" CodeFile="EMPLOYEE_TIME_FLEXIBLE.aspx.vb" Inherits="PAGES_ROSTER_EMPLOYEE_TIME_FLEXIBLE" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>EMPLOYEE_TIME_FLEXIBLE</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server"> 
<form id="EMPLOYEE_TIME_FLEXIBLE" runat="server">
<div>
