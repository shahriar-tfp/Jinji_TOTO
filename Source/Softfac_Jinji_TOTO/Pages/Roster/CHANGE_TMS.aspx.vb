...
Partial Class Pages_Roster_CHANGE_TMS
...
#Region "Panel Edit"
    ...
    Protected Sub imgbtnGROUP_CODE2_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgbtnGROUP_CODE2.Click
        ...
        If Validatefield() Then
            ssql = "Exec sp_sa_getListBoxValue 'TimeSheet','" & Session("Company") & "','ADD','" & Session("EmpID").ToString & "','ALL','','',''"
            myDS = mySQL.ExecuteSQL(ssql, Session("Company").ToString, Session("EmpID").ToString)
            If myDS.Tables(0).Rows.Count > 0 Then
...
#Region "Sub & Function"
            ...
            For i = 0 To myDS.Tables(0).Rows.Count - 1
                ...
                If UCase(myDS.Tables(0).Rows(i).Item(1).ToString) = "EFFECTIVE_DATE" Then
                    If lblEFFECTIVE_DATE.Visible = True And txtEFFECTIVE_DATE.Visible = True Then
                        ...
                        imgKeyEFFECTIVE_DATE.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                ...
                If UCase(myDS.Tables(0).Rows(i).Item(1).ToString) = "OCP_ID_TMS" Then
                    If lblOCP_ID_TMS.Visible = True And txtOCP_ID_TMS.Visible = True Then
                        autonum += 1
                        imgKeyOCP_ID_TMS.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        imgKeyOCP_ID_TMS.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        imgKeyOCP_ID_TMS.Style.Add("position", "absolute")
                        autonum += 1
                        lblOCP_ID_TMS.CssClass = "wordstyle12"
                        lblOCP_ID_TMS.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        lblOCP_ID_TMS.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        lblOCP_ID_TMS.Style.Add("position", "absolute")
                        autonum += 1
                        txtOCP_ID_TMS.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        txtOCP_ID_TMS.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        txtOCP_ID_TMS.Style.Add("position", "absolute")
                        txtOCP_ID_TMS.Width = txtWidth
                        autonum += 1
                        imgbtnOCP_ID_TMS.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        imgbtnOCP_ID_TMS.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        imgbtnOCP_ID_TMS.Style.Add("position", "absolute")
                    End If
                End If
    ...
    Private Function Validatefield() As Boolean
        ...
        If txtEFFECTIVE_DATE.Text = "" Then
            lblresult2.Text = lblEFFECTIVE_DATE.Text & " field is required..."
            Exit Function
        ElseIf txtOCP_ID_TMS.Text = "" Then
            lblresult2.Text = lblOCP_ID_TMS.Text & " field is required..."
            Exit Function
        End If
        Validatefield = True
    End Function
...
#End Region
    ...
    Protected Sub imgBtnUpdate_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnUpdate.Click
        ...
        Dim effective As String, tmsid As String
        If Validatefield() Then
            If lstleft.Visible = True Then
                If lstright.Visible = True And lstright.Items.Count > 0 Then
                    ssql1 = "exec sp_tms_selInsChangeTMS 'SEL','" & Session("Company").ToString & "',N'" & txtEFFECTIVE_DATE.Text & "',N'" & txtOCP_ID_TMS.Text & "'," & spid & ",'" & Session("EmpID").ToString & "'"
                    myDS1 = mySQL.ExecuteSQL(ssql1, Session("Company").ToString, Session("EmpID").ToString)
                    If myDS1.Tables(0).Rows.Count > 0 Then

                        effective = myDS1.Tables(0).Rows(0).Item(0).ToString
                        tmsid = myDS1.Tables(0).Rows(0).Item(1).ToString
                        ...
                        For k = 0 To itemCount - 1
                            ...
                            ssql2 = Nothing
                        Next
                        ssql = "exec sp_tms_selInsChangeTMS 'ADD','" & Session("Company").ToString & "',N'" & effective & "',N'" & tmsid & "'," & spid & ",'" & Session("EmpID").ToString & "'"
