<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ATTENDANCE_ViewUpdate.aspx.vb" Inherits="Pages_Roster_ATTENDANCE_ViewUpdate" %>
...
<body>
    <form id="ATTENDANCE_ViewUpdate" runat="server">
    <div>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
	   <tr><td>	    
	    <div id="divGridview1" style="top: 200px;left: 15px;position :absolute; width: 98%; height: 300px; overflow: scroll">
	    ...
	    <div id="divGridview3" style="top: 420px;left: 15px;position :absolute; width: 100%; height: 50px;">
            <asp:gridview id="gv3" Width="100%" runat="server" AutoGenerateColumns="true" Visible="true"
	         ...
	         <div id="div1" style="top: 520px;left: 15px;position :absolute; width: 98%; height: 140px;">
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
        <tr><td><asp:ImageButton id="imgBtnSelect" runat="server" Width="74" Height="21"/></td></tr>
        <tr><td><asp:Label ID="Label2" Text="&nbsp;" runat="server" Width="10px"></asp:Label></td></tr>
        <tr><td><asp:Label ID="lblEmployee" Text="Employee ID" runat="server" Width="120px" Font-Bold="true"></asp:Label>
    <asp:TextBox ID="txtEmployee" runat="server" Width="150px"></asp:TextBox>
    <asp:ImageButton ID="imgbtnEmployee" runat="server" Width="21px" Height="21px"/>
    <asp:HiddenField ID="HbEmployee" runat="server" />
    </td></tr>
    <tr><td><asp:Label ID="Label5" Text="&nbsp;" runat="server" Width="10px"></asp:Label></td></tr>
    ...
    <asp:HiddenField ID="HbDateIn" runat="server" />
    <asp:Label ID="lblDateOut" Text="Date Out" runat="server" Width="120px" Font-Bold="true" Visible="true"></asp:Label>
    <asp:TextBox ID="txtDateOut" runat="server" Width="150px"  Visible="true" ></asp:TextBox>
    <asp:ImageButton ID="imgBtnDateOut" runat="server" Width="21px" Height="21px" Visible="true"/>
    <asp:HiddenField ID="HbDateOut" runat="server" />
    </td></tr>
    <tr><td><asp:Label ID="lblspace1" Text="&nbsp;" runat="server" Width="10px"></asp:Label></td></tr>
    <tr><td><asp:Label ID="lblOption_Reason_Type" Text="Clock Location" runat="server" Width="120px" Font-Bold="true" Visible="false"></asp:Label>
    <asp:dropdownlist ID="ddlOption_Reason_Type" runat="server" Width="180px" AutoPostBack=true Visible="false"></asp:dropdownlist>
    <asp:Label ID="lblReason" Text="Reason" runat="server" Width="120px" Font-Bold="true" Visible="true"></asp:Label>
    <asp:TextBox ID="txtReason" runat="server" Width="150px" Visible="true"></asp:TextBox>
    <asp:ImageButton ID="imgbtnReason" runat="server" Width="21px" Height="21px" Visible="true"/>
    </td></tr>
