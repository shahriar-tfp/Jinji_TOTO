<%@ Page Language="VB" AutoEventWireup="false" CodeFile="UNLOCK_TIMESHEET.aspx.vb" Inherits="PAGES_ROSTER_UNLOCK_TIMESHEET" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>UNLOCK_TIMESHEET</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server"> 
<form id="UNLOCK_TIMESHEET" runat="server">
<div>
...
<asp:imagebutton id="imgbtnOCP_ID_LINE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 3 //-->
<asp:imagebutton id="imgKeyUNLOCK_DATE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblUNLOCK_DATE" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtUNLOCK_DATE" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnUNLOCK_DATE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
