<%@ Page Language="VB" AutoEventWireup="false" CodeFile="OT_Break.aspx.vb" Inherits="Pages_Roster_OT_Break" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>JINJI : Roster - OT Break Page</title>
    <link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server">
    <form id="OT_BREAK" runat="server">
    <div>
    ...
    <!--// 4 //-->
    <asp:imagebutton id="imgKeyOPTION_DAY_TYPE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
    <asp:label id="lblOPTION_DAY_TYPE" runat="server" Width="140px"></asp:label>
    <asp:dropdownlist id="ddlOPTION_DAY_TYPE" runat="server" Width="157px" AutoPostBack="true" ></asp:dropdownlist>
    <asp:imagebutton id="imgbtnOPTION_DAY_TYPE" runat="server" Height="21px" ></asp:imagebutton>
     <asp:CheckBox ID="chkOPTION_DAY_TYPE" runat="server" ToolTip="Select All" Text="" AutoPostBack="true"/>
    <!--// 5 //-->
    <asp:imagebutton id="imgKeyOCP_ID_BY" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
    <asp:label id="lblOCP_ID_BY" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtOCP_ID_BY" runat="server" Width="150px"></asp:textbox>
    <asp:imagebutton id="imgbtnOCP_ID_BY" runat="server" Height="21px" ></asp:imagebutton>
    <!--// 6 //-->
    <asp:imagebutton id="imgKeyOPTION_OT_TYPE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
    <asp:label id="lblOPTION_OT_TYPE" runat="server" Width="140px"></asp:label>
    <asp:dropdownlist id="ddlOPTION_OT_TYPE" runat="server" Width="157px"></asp:dropdownlist>
    <asp:imagebutton id="imgbtnOPTION_OT_TYPE" runat="server" Height="21px" ></asp:imagebutton>
    <!--// 7 //-->
    <asp:imagebutton id="imgKeyOPTION_OT_BY" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
    <asp:label id="lblOPTION_OT_BY" runat="server" Width="140px"></asp:label>
    <asp:dropdownlist id="ddlOPTION_OT_BY" runat="server" Width="157px"></asp:dropdownlist>
    <asp:imagebutton id="imgbtnOPTION_OT_BY" runat="server" Height="21px" ></asp:imagebutton>
    <!--// 8 //-->
    <asp:imagebutton id="imgKeyOT_BY_VALUE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
    <asp:label id="lblOT_BY_VALUE" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtOT_BY_VALUE" runat="server" Width="150px"></asp:textbox>
    <asp:imagebutton id="imgbtnOT_BY_VALUE" runat="server" Height="21px" ></asp:imagebutton>
    <!--// 9 //-->
    <asp:imagebutton id="imgKeyDURATION" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
    <asp:label id="lblDURATION" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtDURATION" runat="server" Width="150px"></asp:textbox>
    <asp:imagebutton id="imgbtnDURATION" runat="server" Height="21px" ></asp:imagebutton>
    <!--// 10 //-->
    <asp:imagebutton id="imgKeyOPTION_DEDUCT_ONCE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
    <asp:label id="lblOPTION_DEDUCT_ONCE" runat="server" Width="140px"></asp:label>
    <asp:dropdownlist id="ddlOPTION_DEDUCT_ONCE" runat="server" Width="157px"></asp:dropdownlist>
    <asp:imagebutton id="imgbtnOPTION_DEDUCT_ONCE" runat="server" Height="21px" ></asp:imagebutton>
    <!--// 11 //-->
    <asp:imagebutton id="imgKeyOPTION_ONLY_AFTER_WORK" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
    <asp:label id="lblOPTION_ONLY_AFTER_WORK" runat="server" Width="140px"></asp:label>
    <asp:dropdownlist id="ddlOPTION_ONLY_AFTER_WORK" runat="server" Width="157px"></asp:dropdownlist>
    <asp:imagebutton id="imgbtnOPTION_ONLY_AFTER_WORK" runat="server" Height="21px" ></asp:imagebutton>
    <!--// 12 //-->
