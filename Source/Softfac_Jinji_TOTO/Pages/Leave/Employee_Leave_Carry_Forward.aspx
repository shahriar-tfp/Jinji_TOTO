<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Employee_Leave_Carry_Forward.aspx.vb" Inherits="Pages_Leave_Employee_Leave_Carry_Forward" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>JINJI : Leave - Employee Carry Forward Page</title>
    <link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server">
    <form id="Employee_Leave_Carry_Forward" runat="server">
    <div>
	...
	<!--// 2 //-->
	<asp:image id="imgYEAR" runat="server" Height="21px" Width="21px"></asp:image>
	...
	<!--// 4 //-->
	<asp:image id="imgDAYS_ENTITLEMENT" runat="server" Height="21px" Width="21px"></asp:image>
	<asp:label id="lblDAYS_ENTITLEMENT" runat="server" Width="140px"></asp:label>
	<asp:textbox id="txtDAYS_ENTITLEMENT" runat="server" Width="150px"></asp:textbox>
	<asp:imagebutton id="imgBtnDAYS_ENTITLEMENT" runat="server" Height="21px"></asp:imagebutton>
	<!--// 5 //-->
	<asp:image id="imgDAYS_BALANCE" runat="server" Height="21px" Width="21px"></asp:image>
	<asp:label id="lblDAYS_BALANCE" runat="server" Width="140px"></asp:label>
	<asp:textbox id="txtDAYS_BALANCE" runat="server" Width="150px"></asp:textbox>
	<asp:imagebutton id="imgBtnDAYS_BALANCE" runat="server" Height="21px"></asp:imagebutton>
	<!--// 6 //-->
	<asp:image id="imgDAYS_CARRY_FORWARD" runat="server" Height="21px" Width="21px"></asp:image>
	<asp:label id="lblDAYS_CARRY_FORWARD" runat="server" Width="140px"></asp:label>
	<asp:textbox id="txtDAYS_CARRY_FORWARD" runat="server" Width="150px"></asp:textbox>
	<asp:imagebutton id="imgBtnDAYS_CARRY_FORWARD" runat="server" Height="21px"></asp:imagebutton>
	<!--// 7 //-->
	...
	<asp:label id="lblresult2" runat="server" Height="22"></asp:label>
	</asp:Panel>
