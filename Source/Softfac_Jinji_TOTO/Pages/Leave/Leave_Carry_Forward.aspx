<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Leave_Carry_Forward.aspx.vb" Inherits="Pages_Leave_Leave_Carry_Forward" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>JINJI : Leave - Carry Forward Page</title>
    <link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server">
    <form id="Leave_Carry_Forward" runat="server">
    <div>
	...
	<!--// 3 //-->
	<asp:image id="imgOPTION_METHOD" runat="server" Height="21px" Width="21px"></asp:image>
	<asp:label id="lblOPTION_METHOD" runat="server" Width="140px"></asp:label>
	<asp:dropdownlist id="ddlOPTION_METHOD" runat="server" Width="157"></asp:dropdownlist>
	<asp:imagebutton id="imgBtnOPTION_METHOD" runat="server" Height="21px"></asp:imagebutton>
	<!--// 4 //-->
