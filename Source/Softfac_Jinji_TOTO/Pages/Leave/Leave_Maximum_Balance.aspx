<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Leave_Maximum_Balance.aspx.vb" Inherits="Pages_Leave_Leave_Maximum_Balance" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>JINJI : Leave - Maximum Balance Page</title>
    <link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server">
    <form id="Leave_Maximum_Balance" runat="server">
    <div>
	...
	<!--// 3 //-->
	<asp:image id="imgMAXIMUM_DAY" runat="server" Height="21px" Width="21px"></asp:image>
	<asp:label id="lblMAXIMUM_DAY" runat="server" Width="140px"></asp:label>
	<asp:textbox id="txtMAXIMUM_DAY" runat="server" Width="150px"></asp:textbox>
	<asp:imagebutton id="imgBtnMAXIMUM_DAY" runat="server" Height="21px"></asp:imagebutton>
	<!--// Panel //-->
