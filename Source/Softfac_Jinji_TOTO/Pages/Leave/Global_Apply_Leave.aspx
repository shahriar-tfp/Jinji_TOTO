<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Global_Apply_Leave.aspx.vb" Inherits="Pages_Leave_Global_Apply_Leave" %>
...
<body id="body" runat="server">
    <form id="Global_Apply_Leave" runat="server">
    <div>
	...
	<asp:dropdownlist id="ddlOPTION_ADVANCE_LEAVE" runat="server" Width="150px"></asp:dropdownlist>
	...
	<!--// 6 //-->
	<asp:image id="imgFROM_DATE" runat="server" Height="21px" Width="21px"></asp:image>
	...
	<asp:imagebutton id="imgbtnFROM_DATE" runat="server" Height="21px"></asp:imagebutton>
	<!--// 7 //-->
	<asp:image id="imgTO_DATE" runat="server" Height="21px" Width="21px"></asp:image>
	<asp:label id="lblTO_DATE" runat="server" Width="140px"></asp:label>
	<asp:textbox id="txtTO_DATE" runat="server" Width="150px"></asp:textbox>
	<asp:imagebutton id="imgbtnTO_DATE" runat="server" Height="21px"></asp:imagebutton>
	<!--// 5 //-->
