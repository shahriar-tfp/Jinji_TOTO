<%@ Page Language="VB" AutoEventWireup="false" CodeFile="GLOBAL_LEAVE_TRANSACTION.aspx.vb" Inherits="PAGES_LEAVE_GLOBAL_LEAVE_TRANSACTION" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>GLOBAL_LEAVE_TRANSACTION</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server"> 
<form id="GLOBAL_LEAVE_TRANSACTION" runat="server">
<div>
...
<!--// 9 //-->
<asp:imagebutton id="imgKeyERRMESSAGE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblERRMESSAGE" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtERRMESSAGE" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnERRMESSAGE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
...
<!--// 11 //-->
<asp:imagebutton id="imgKeyOPTION_ADVANCE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblOPTION_ADVANCE" runat="server" Width="140px" ></asp:label>
<asp:dropdownlist id="ddlOPTION_ADVANCE" runat="server" Width="150px" ></asp:dropdownlist>
<asp:imagebutton id="imgbtnOPTION_ADVANCE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
