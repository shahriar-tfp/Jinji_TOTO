<%@ Page Language="VB" AutoEventWireup="false" CodeFile="LEAVE_FIXENTITLEMENT.aspx.vb" Inherits="PAGES_LEAVE_LEAVE_FIXENTITLEMENT" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>LEAVE_FIXENTITLEMENT</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server"> 
<form id="LEAVE_FIXENTITLEMENT" runat="server">
<div>
...
<!--// 2 //-->
<asp:imagebutton id="imgKeyENTITLEMENT" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblENTITLEMENT" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtENTITLEMENT" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnENTITLEMENT" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 3 //-->
<asp:imagebutton id="imgKeyNO_OF_MONTH" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblNO_OF_MONTH" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtNO_OF_MONTH" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnNO_OF_MONTH" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 4 //-->
<asp:imagebutton id="imgKeyEARN" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblEARN" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtEARN" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnEARN" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
