<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PASS.aspx.vb" Inherits="PAGES_LEAVE_PASS" %>
...
<asp:textbox id="txtA" runat="server" Width="150px" ></asp:textbox>
...
<asp:textbox id="txtB" runat="server" Width="150px" ></asp:textbox>
