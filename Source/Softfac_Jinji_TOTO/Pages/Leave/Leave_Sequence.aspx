<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Leave_Sequence.aspx.vb" Inherits="Pages_Leave_Leave_Sequence" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>JINJI : Leave - Sequence Page</title>
    <link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server">
    <form id="Leave_Sequence" runat="server">
    <div>
	...
	<!--// 2 //-->
	<asp:image id="imgSEQUENCE_NO" runat="server" Height="21px" Width="21px"></asp:image>
	...
	<asp:imagebutton id="imgBtnSEQUENCE_NO" runat="server" Height="21px"></asp:imagebutton>
	<!--// 3 //-->
	<asp:image id="imgOCP_ID_LEAVE_APPLIED" runat="server" Height="21px" Width="21px"></asp:image>
	<asp:label id="lblOCP_ID_LEAVE_APPLIED" runat="server" Width="140px"></asp:label>
	<asp:textbox id="txtOCP_ID_LEAVE_APPLIED" runat="server" Width="150px"></asp:textbox>
	<asp:imagebutton id="imgBtnOCP_ID_LEAVE_APPLIED" runat="server" Height="21px"></asp:imagebutton>
	<!--// Panel //-->
