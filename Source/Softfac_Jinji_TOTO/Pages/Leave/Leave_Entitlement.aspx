<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Leave_Entitlement.aspx.vb" Inherits="Pages_Leave_Leave_Entitlement" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>JINJI : Leave - Entitlement Page</title>
    <link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server">
    <form id="Leave_Entitlement" runat="server">
    <div>
	...
	<!--// 3 //-->
	<asp:image id="imgYEAR_FROM" runat="server" Height="21px" Width="21px"></asp:image>
	<asp:label id="lblYEAR_FROM" runat="server" Width="140px"></asp:label>
	<asp:textbox id="txtYEAR_FROM" runat="server" Width="150px"></asp:textbox>
	<asp:imagebutton id="imgBtnYEAR_FROM" runat="server" Height="21px"></asp:imagebutton>
	<!--// 4 //-->
	<asp:image id="imgYEAR_TO" runat="server" Height="21px" Width="21px"></asp:image>
	<asp:label id="lblYEAR_TO" runat="server" Width="140px"></asp:label>
	<asp:textbox id="txtYEAR_TO" runat="server" Width="150px"></asp:textbox>
	<asp:imagebutton id="imgBtnYEAR_TO" runat="server" Height="21px"></asp:imagebutton>
	<!--// 5 //-->
