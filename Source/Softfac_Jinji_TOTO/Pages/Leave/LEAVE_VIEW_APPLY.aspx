<%@ Page Language="VB" AutoEventWireup="false" CodeFile="LEAVE_VIEW_APPLY.aspx.vb" Inherits="PAGES_LEAVE_LEAVE_VIEW_APPLY" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>LEAVE_VIEW_APPLY</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server"> 
<form id="LEAVE_VIEW_APPLY" runat="server">
<div>
...
<!--// 4 //-->
<asp:imagebutton id="imgKeyOPTION_VIEW" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblOPTION_VIEW" runat="server" Width="140px" ></asp:label>
<asp:dropdownlist id="ddlOPTION_VIEW" runat="server" Width="150px" ></asp:dropdownlist>
<asp:imagebutton id="imgbtnOPTION_VIEW" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 5 //-->
<asp:imagebutton id="imgKeyOPTION_APPLY" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblOPTION_APPLY" runat="server" Width="140px" ></asp:label>
<asp:dropdownlist id="ddlOPTION_APPLY" runat="server" Width="150px" ></asp:dropdownlist>
<asp:imagebutton id="imgbtnOPTION_APPLY" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 5 //-->
<asp:imagebutton id="imgKeyOPTION_CANCEL" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblOPTION_CANCEL" runat="server" Width="140px" ></asp:label>
<asp:dropdownlist id="ddlOPTION_CANCEL" runat="server" Width="150px" ></asp:dropdownlist>
<asp:imagebutton id="imgbtnOPTION_CANCEL" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
