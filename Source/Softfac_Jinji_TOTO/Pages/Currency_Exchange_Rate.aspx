<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Currency_Exchange_Rate.aspx.vb" Inherits="PAGES_ORGANISATION_CURRENCY_EXCHANGE_RATE" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>JINJI : System Admin - Currency Exchange Rate Page</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server"> 
<form id="CURRENCY_EXCHANGE_RATE" runat="server">
<div>
...
<asp:imagebutton id="imgbtnEXCHANGE_RATE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
