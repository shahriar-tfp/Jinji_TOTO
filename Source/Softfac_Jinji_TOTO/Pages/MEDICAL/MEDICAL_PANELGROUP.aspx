<%@ Page Language="VB" AutoEventWireup="false" CodeFile="MEDICAL_PANELGROUP.aspx.vb" Inherits="PAGES_MEDICAL_MEDICAL_PANELGROUP" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>MEDICAL_PANELGROUP</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server"> 
<form id="MEDICAL_PANELGROUP" runat="server">
<div>
...
<!--// 2 //-->
<asp:imagebutton id="imgKeyPANEL_GROUP" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblPANEL_GROUP" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtPANEL_GROUP" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnPANEL_GROUP" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 3 //-->
<asp:imagebutton id="imgKeyPANEL_DOCTOR" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblPANEL_DOCTOR" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtPANEL_DOCTOR" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnPANEL_DOCTOR" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
